-   **docs/user/**
    ...
    * **purchases/**
        ...
        * `android.md`
            ...
            * `## Restore Purchases`
                ...
                * `#### Other Cases`
            * `## Giftcards`
        * `android_new.md` *(Not in original structure)*
            * `## Introduction`
            * `## Install OsmAnd`
            * `## Purchase Options`
        ...
        * `ios.md`
            ...
            * `## Restore Purchases`
            * `## Giftcards`
        * `ios_new.md` *(Not in original structure)*
            * `## Install OsmAnd`
        * `osmand_features_capabilities.md` *(Not in original structure)*
    ...
    * **web/**
        * `index.md`
            ...
            * `## [Map](./web-map.md)`
            * `## [User Data](./web-userdata.mdx)` *(Skipped .mdx)*
