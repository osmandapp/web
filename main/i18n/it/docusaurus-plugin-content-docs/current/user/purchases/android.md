...
Per i dispositivi Android, è possibile scaricare le versioni **gratuite** e a **pagamento** dell'applicazione dai seguenti mercati:
...
| :------------- | :------------- | :------------- | :------------- |
| ![Maps+](@site/static/img/svg/osmand_maps.svg) OsmAnd | ✔ &nbsp;&nbsp;[Installa](https://play.google.com/store/apps/details?id=net.osmand) | ✔ &nbsp;&nbsp;[Installa](https://appgallery.huawei.com/#/app/C101486645) | Gratuita |
...
| :------------- | :------------- | :------------- | :------------- |
| ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) Maps+ in-app | ✔ | ✔ | OsmAnd |
...
3. **OsmAnd Pro è un abbonamento *multipiattaforma***. Ciò significa che puoi acquistarlo in un negozio (ad esempio, *Google Play, Huawei AppGallery, AppStore* e *osmand.net*) e ripristinarlo in un altro [collegando il tuo acquisto all'account OsmAnd Cloud](../personal/osmand-cloud.md#cross-platform).

4. Puoi aggiungere **OsmAnd+** alla **[Libreria di famiglia di Google Play](https://support.google.com/googleplay/answer/7007852?hl=it)** per condividere l'acquisto con i membri della famiglia.


## Prezzi {#prices}

Nell'elenco, sono presenti informazioni sui prezzi del prodotto OsmAnd per le regioni degli Stati Uniti e dell'Europa. Per le altre regioni, i prezzi sono equivalenti nelle valute locali.
...
| | OsmAnd Gratuito | [OsmAnd+](#install-osmand-android) /<br/> [Maps+](#install-osmand-android) In-App | [Maps+](#install-osmand-android) Abbonamento | [OsmAnd Pro](#install-osmand-android) |
| :------------- | :------------- | :----------------------- | :------------------- | :----------- |
| | ![Maps+](@site/static/img/svg/osmand_maps.svg) | ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) | ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) | ![Pro](@site/static/img/svg/pro_icon.svg) |
...
La tabella seguente illustra le funzionalità incluse nei pacchetti gratuiti e a pagamento di OsmAnd, insieme ai rispettivi prezzi.
...
| [Download illimitati di mappe](../start-with/download-maps.md) | <details><summary>**7 download di mappe**</summary> - Il download o l'aggiornamento di una mappa si riferisce solo al download-aggiornamento di una mappa di un paese (regione). <br/> - La **mappa panoramica del mondo**, la **correzione dell'altitudine del mondo**, i **caratteri della mappa** e i **messaggi vocali** non sono conteggiati come 7 possibilità di download. </details> | ✔ | ✔ |
| [Aggiornamenti mensili delle mappe](../personal/maps-resources.md#update-maps)<br/>Una volta al mese (con 2 giorni di ritardo) | <details><summary>**7 download di mappe**</summary> L'aggiornamento della mappa conta come download.</details> | ✔ | ✔ |
...
| [Esportazione tracce GPX](../personal/tracks/manage-tracks.md) | ✔ | ✔ | ✔ |
| [Importazione tracce GPX/KML](../personal/tracks/manage-tracks.md#import--export-track) | ✔ | ✔ | ✔ |
| [Strumento per pianificare un percorso](../plan-route/create-route.md) | ✔ | ✔ | ✔ |
| [Widget metriche veicolo](../plugins/vehicle-metrics.md#widgets) | <details><summary>**2 widget gratuiti**</summary><ul><li>*Velocità veicolo*</li><li>*Giri motore*</li></ul></details> | <details><summary>**2 widget gratuiti**</summary><ul><li>*Velocità veicolo*</li><li>*Giri motore*</li></ul></details> | ✔ |
| [Strumento marcatori mappa](../personal/markers.md) | ✔ | ✔ | ✔ |
| [Sorgenti mappa online](../plugins/online-map.md) | ✔ | ✔ | ✔ |
...
| [Tracker GPS online OsmAnd](../plugins/osmand-tracker.md) | ✔ | ✔ | ✔ |
| [Esporta / Importa profilo app](../personal/profiles.md#actions) | ✔ | ✔ | ✔ |

#### ** Aggiornamenti mappa {#-map-updates}

[Gratuito](../personal/maps-resources.md#free-for-osm-mappers). Aggiornamenti in tempo reale e download illimitati di mappe sono disponibili per i mappatori OSM.
...
| [Rilievo 3D](../plugins/topography.md#3d-relief) | Ti permette di avere e osservare un modello in scala del tuo quartiere o di un intero continente. |
| [OsmAnd Live](../personal/maps-resources.md#osmand-live) | Le mappe OsmAnd si aggiornano ogni 15 minuti dopo il miglioramento di [OpenStreetMap](https://www.openstreetmap.org/). |
| [Plugin Meteo](../plugins/weather.md) | Previsioni orarie 24 ore su 24 per 7 giorni sulla mappa. |
| [Plugin metriche veicolo (OBD-II)](../plugins/vehicle-metrics.md) | Ti permette di collegare uno scanner OBD-II per visualizzare dati dettagliati del veicolo nell'app OsmAnd e memorizzare le informazioni nelle registrazioni delle tracce. |
| [Personalizza linea percorso](../navigation/guidance/map-during-navigation.md#route-line-appearance) | Modifica del colore e della larghezza della linea del percorso durante la navigazione. |
...
| [Widget altitudine - Altitudine: Centro mappa](../widgets/info-widgets.md#elevation-map-center) | Ti permette di conoscere l'altitudine del centro mappa corrente sul livello del mare. |
| [Correzione altitudine (offline)](../map/tracks/track-context-menu.md#calculate-missing-elevation) | Ti permette di calcolare un grafico dell'altitudine per la tua traccia ([mappa del terreno](../plugins/topography.md#download-maps) richiesta per la regione scelta). |


### Come acquistare {#how-to-buy}

Un modo semplice per scegliere e acquistare il piano desiderato tramite il menu **Acquisti**. Naturalmente, vedrai un menu di proposte per le funzionalità a pagamento.
...
![Maps+](@site/static/img/svg/osmand_maps_plus.svg) Piano di abbonamento / in-app *Maps+*. Qui puoi scegliere l'abbonamento annuale o il pagamento una tantum:
...
I nuovi abbonamenti iniziano con la versione 4.0 di OsmAnd (agosto 2021). Tutti gli abbonamenti precedenti sono obsoleti ed equivalgono tecnicamente a un *Abbonamento Mappa*, sebbene gli abbonamenti più vecchi siano idonei per aggiornamenti orari delle mappe. Gli utenti non possono acquistare vecchi abbonamenti, ma i vecchi abbonamenti vengono rinnovati automaticamente fino alla disdetta (il prezzo potrebbe cambiare in futuro).
...
Per ripristinare l'acquisto, controlla quale piano OsmAnd hai acquistato.
...
- Aggiorna l'app del Market (Google Play, Huawei AppGallery).
- Accedi con **lo stesso account** al Market (Google Play, Huawei AppGallery) con cui hai effettuato un acquisto OsmAnd.
...
[Guida dettagliata all'acquisto di carte regalo Google Play](https://support.google.com/googleplay/answer/3422734?hl=it).

Puoi acquistare OsmAnd utilizzando le carte regalo Google Play, che offrono un'alternativa sicura alla condivisione delle informazioni della carta di credito online. Basta acquistare una carta regalo da un rivenditore di tua scelta e riscattare il codice su Google Play.
