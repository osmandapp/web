...
| [Download illimitati di mappe](../start-with/download-maps.md) | <details><summary>**7 download di mappe**</summary>  - Il download o l'aggiornamento di una mappa si intende solo il download-aggiornamento di una mappa di un paese (regione). <br/> - La **mappa di panoramica mondiale**, la **correzione altimetrica mondiale**, i **caratteri delle mappe** e i **suggerimenti vocali** non vengono conteggiati come 7 possibilità di download. </details> | ✔ | ✔ |
