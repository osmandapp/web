...
- (*Solo Android*) Per **Mettere in pausa** o **Salvare** una traccia in registrazione, utilizzare la [notifica](#notifications) di sistema nell'area di notifica del dispositivo.<br/><br/> ![stop-save-pause](@site/static/img/plugins/trip-recording/stop-save-pause_andr.png)
...
![panoramica](@site/static/img/plugins/trip-recording/overview_screen_graphs_new_andr.png)  ![panoramica](@site/static/img/plugins/trip-recording/overview_screen_graphs_1_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Termina registrazione su iOS](@site/static/img/plugins/trip-recording/start_rec_ios_3.png)  ![Termina registrazione su iOS](@site/static/img/plugins/trip-recording/overview_screen_graphs_1_new_ios.png)
...
| ![dati](@site/static/img/plugins/trip-recording/graph_altitude_new_andr.png)  ![dati](@site/static/img/plugins/trip-recording/graph_altitude_new_ios.png) |
...
| ![dati](@site/static/img/plugins/trip-recording/graph_speed_new_andr.png)  ![dati](@site/static/img/plugins/trip-recording/graph_speed_new_ios.png) |
...
I widget consentono di visualizzare informazioni chiave sulla registrazione della traccia direttamente sullo schermo, come *Pendenza media*, *Distanza*, *Discesa*, *Durata*, *Velocità massima*, *Tempo in movimento* e *Salita*. Su Android, è possibile anche aggiungere il widget *Velocità media*.
...
![Aggiunta del widget Distanza/Avvio-Stop su Android](@site/static/img/plugins/trip-recording/add_new_widg_andr.png)
...
![Aggiunta del widget Distanza/Avvio-Stop su iOS](@site/static/img/plugins/trip-recording/add_recording_widgets_ios_moving_time.png)
...
|**Velocità media** *(Solo Android)*. Mostra la velocità media per il viaggio attualmente registrato, o la velocità media durante l'ultima sezione di salita o discesa, a seconda della modalità selezionata. |
|![widget](@site/static/img/widgets/tr_rec_wid_average_speed.png)|
...
|![widget](@site/static/img/widgets/tr_rec_wid_dur_new.png)|
...
|**Tempo in movimento**. Mostra il tempo in movimento per il viaggio attualmente registrato, o il tempo per l'ultima salita e discesa, a seconda della modalità selezionata. |
|![widget](@site/static/img/widgets/tr_rec_wid_moving_time.png)|  
