...
### Gradi e Minuti {#degrees-and-minutes}

![Ricerca Coordinate Android](@site/static/img/search/coordinates_search_DM_andr.png)  

**<Translate android="true" ids="navigate_point_format_DM"/>**. In questo formato, le coordinate di latitudine e longitudine vengono registrate utilizzando gradi e minuti. Ad esempio, 37:46.29 di latitudine e -122:25.10 di longitudine per San Francisco. Questo formato può essere meno preciso e richiedere più tempo per l'inserimento.
...
- [Inserimento Coordinate](../plan-route/coordinate-input.md)
- [Menu contestuale della mappa](../map/map-context-menu.md)
- [Widget informativi](../widgets/info-widgets.md)
