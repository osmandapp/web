...
1. **Registra un [account](#login) su OsmAnd Cloud**:
   ...
   Scopri di più sull'acquisto per [Android](../purchases/android.md#how-to-buy) o [iOS](../purchases/ios.md#how-to-buy).
    ...
    2.1 **Utilizza il piano gratuito OsmAnd Start** per i backup cloud di preferiti, impostazioni e modifiche/note OSM.
...
OsmAnd supporta il raggruppamento di tracce GPX in **raccolte**, che ti consente di organizzare tracce correlate sotto un'unica etichetta.

Quando si utilizza **OsmAnd Cloud**, le raccolte GPX sono:

- Eseguite il backup insieme ai tuoi dati personali.
...
> *Ciò garantisce che l'organizzazione dei tuoi percorsi sia preservata, anche dopo aver reinstallato l'app o essere passato a un nuovo dispositivo.*

Per utilizzare questa funzionalità:

1. Crea o assegna tracce a una raccolta tramite *Menu → I miei luoghi → Tracce*.
2. Vai a *Menu → Impostazioni → OsmAnd Cloud → Esegui backup dati* e abilita la sincronizzazione.
...
3. **Risorse**. Qui puoi scegliere di eseguire il backup di risorse come preferiti, informazioni di routing, istruzioni vocali e elementi aggiuntivi.
...
- È assolutamente fondamentale che il tuo account Cloud sia registrato sul dispositivo in cui è stato effettuato l'acquisto originale.
- Accesso per un altro anno dopo la fine dell'abbonamento.
