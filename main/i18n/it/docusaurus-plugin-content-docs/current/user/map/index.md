...
Come interagire con la mappa usando pulsanti e gesti, in modo da poter spostare, ruotare e ingrandire/ridurre la mappa, come ruotare la mappa manualmente o automaticamente tramite bussola o direzione e come cambiare la scala dello zoom.
...
## [Mappe Vettoriali](./vector-maps.md) {#vector-maps}
...
## [Stili Mappa (Mappe Vettoriali)](./map-styles.md) {#map-styles-vector-maps}

Gli stili di mappa definiscono come i dati della mappa vettoriale vengono renderizzati in OsmAnd. Uno stile controlla l'aspetto visivo degli oggetti della mappa come strade, edifici, uso del suolo, acqua e punti di interesse, inclusi colori, motivi di linea ed etichette.
...
## [Percorsi](./routes/index.md) {#routes}

OsmAnd ha molte potenti funzionalità per visualizzare vari percorsi sulla mappa.

### [Tipi di Percorsi](./routes/types-of-routes.md) {#type-of-routes}

Tutte le informazioni sui tipi di percorsi disponibili in OsmAnd.