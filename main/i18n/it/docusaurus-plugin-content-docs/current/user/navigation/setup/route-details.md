...
- [**Strade invernali e ghiacciate**](https://wiki.openstreetmap.org/wiki/Proposed_features/Winter_roads). Mostra lo schema di colori del percorso in base alla classificazione delle [strade invernali](../../map/map-styles.md#winter-and-ski).  
