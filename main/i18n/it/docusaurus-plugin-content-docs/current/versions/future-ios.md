...
- Miglioramenti nella selezione del percorso e nell'integrazione del grafico dell'altitudine sotto il nuovo schema di rendering.
...
- Apertura più rapida dei menu contestuali al tocco di POI, Preferiti, tracce e edifici.
- Gestione corretta dei POI basati su relazioni su multipoligoni.
- Corretto l'apparizione di “null” al posto del nome della città nei risultati di ricerca POI e migliorata la coerenza dello sfondo in modalità notturna.
- Ripristinato il comportamento toccabile per i percorsi fitness, corsa e canoa con scudi.