...
# Attività di navigazione sulla mappa {#navigate-map-activity}
È presente una mappa e un interruttore per il rendering OpenGL, ha un longClickListener sulla mapView, dopo il primo tocco viene selezionato il punto di partenza, dopo il secondo tocco seleziona la destinazione e avvia il calcolo del percorso.
