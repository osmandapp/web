...
- Améliorations dans la sélection d'itinéraire et l'intégration du graphique d'altitude sous le nouveau schéma de rendu.
...
- Ouverture plus rapide des menus contextuels lors de l'appui sur les POI, Favoris, traces et bâtiments.
