...
- Le nouveau widget de navigation combine la flèche de virage et les instructions de navigation
- Widget d'informations sur l'itinéraire actuel : affiche l'heure d'arrivée estimée, l'heure d'arrivée et la distance
- Sélectionnez les pistes de ski et les sentiers VTT sur la carte pour des informations détaillées
...
- Introduction d'une apparence personnalisable des boutons de carte et d'une grille précise.
...
- Correction de "Enregistrer automatiquement la piste pendant la navigation".
...
- Météo : rafraîchissement de l'interface utilisateur, ajout d'une animation de vent.
...
- Ajout de l'option de thème d'application pour suivre le mode carte.
...
- Panneaux de widgets supérieurs et inférieurs améliorés pour accueillir tous les widgets.
...
- Android Auto : nouveau menu de démarrage pour accéder aux favoris, aux pistes et aux catégories de POI.
...
- Accessibilité : la taille de la cible tactile pour les boutons a été modifiée à 48 dp ; correction du problème de l'interface utilisateur de la carte visible pour les lecteurs d'écran.
...
- Refonte des widgets : nouveau look & feel, regroupement par pages, modification de l'ordre et combinaison à volonté.
...
- Dialogue "Enregistrement de trajet" mis à jour
...
- Dialogue repensé pour la sélection de la langue des instructions de navigation
...
- Amélioration de la visibilité des nœuds cyclables.
- Les pistes sont désormais cliquables, ont un menu contextuel avec des informations de base.
- Amélioration des algorithmes de "Recherche"
...
- Wikipedia comme couche séparée dans la configuration de la carte, sélection des langues nécessaires uniquement
- Création de vos propres filtres/cartes de POI avec une flexibilité totale
...
- Ajout des données de lever/coucher du soleil à la configuration de la carte
...
- Application et paramètres de profil mis à jour. Organisation pratique des paramètres par type, possibilité de personnaliser chaque profil.
- Nouveau dialogue de téléchargement de carte qui suggère une carte à télécharger lors de la navigation
- Corrections du thème nuit
- Correction de quelques problèmes de routage dans le monde entier
- Carte de base mise à jour avec un réseau routier plus détaillé
...
- Nouvel écran Directions : affiche les boutons de destination Domicile et Travail, le raccourci vers l'itinéraire précédent, la liste des pistes actives, l'historique de recherche
...
- Édition OSM : Possibilité de modifier les balises pour les objets non ponctuels et les chemins, correction des commentaires manquants sur les notes, sauvegarde des modifications
...
- Géocodage inversé affichant l'adresse d'un lieu en appuyant sur la carte
...
- Nouvelle interface utilisateur contextuelle pour les emplacements sur la carte et sur d'autres écrans
...
- Nouvelles données Wikipédia, téléchargements désormais par pays, et avec des données beaucoup plus complètes
...
- Affichage des flèches de virage sur l'itinéraire
...
- Notifications visuelles et audio optionnelles à l'approche des points de passage
...
- La navigation tient compte des feux de circulation
- Les avertissements de circulation peuvent désormais être annoncés par type, comme les panneaux stop ou les dos d'âne (voix TTS uniquement).
...
- Statistiques détaillées / fractionnement de la piste GPX par heure ou distance et vérification de la différence d'altitude/vitesse
...
- Boutons de masquage automatique en mode navigation
- Calcul de l'itinéraire hors ligne jusqu'au premier point de l'itinéraire GPX (option "passer toute la piste")
...
- Fichiers de courbes de niveau désormais regroupés par pays/régions
- Nouvelle carte de base mondiale avec les routes principales, les chemins de fer et les grandes caractéristiques géographiques comme les forêts.
...
- Prise en charge des limitations de vitesse conditionnelles au temps (Pays-Bas)
...
- Packs d'ombrage pour le plugin de courbes de niveau
...
- Corrections de bugs
- Option de style de carte "Vue touristique" avec plus de détails cartographiques, de nouveaux styles de routes, plus de contraste et une option de randonnée alpine (échelle SAC)
...
- Direction par voies
- Informations sur les limitations de vitesse, les radars et les dos d'âne
...
- Explorateur GPX dans l'application (afficher les détails de la piste, la distance, la vitesse moyenne, l'altitude, etc.)
...
- Amélioration du suivi GPX (filtrer certaines positions imprécises et enregistrer la précision/l'altitude/la vitesse)
