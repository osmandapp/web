...
- ou la version pratique du [plugin de développement OsmAnd](/docs/user/navigation/guidance/voice-navigation#testing-of-voice-prompts), qui simule différentes commandes vocales à tester.