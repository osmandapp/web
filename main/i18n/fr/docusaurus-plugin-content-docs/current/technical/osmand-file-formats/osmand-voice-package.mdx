---
source-hash: 9d80a119c410016a5b2a0fd3bf00ac8893018273296f7e7a83c2de9dd1b90a15
sidebar_position: 10
---
...
Un paquet vocal est généralement distribué sous forme de .voice.zip, où le zip contient un dossier avec [lang_tts.js](https://github.com/osmandapp/OsmAnd-resources/blob/master/voice/de/de_tts.js) (fichier de **configuration** principal) et des fichiers audio s'ils sont présents.
...
- ou la version pratique du [plugin de développement OsmAnd](/docs/user/navigation/guidance/voice-navigation#testing-of-voice-prompts-android), qui simule différentes commandes vocales à tester.