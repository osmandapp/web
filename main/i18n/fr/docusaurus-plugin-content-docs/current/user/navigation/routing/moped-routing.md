...
Le *guidage pour mobylette* permet aux conducteurs de construire un itinéraire optimal (le plus rapide), en tenant compte des spécificités de la conduite d'un véhicule tel qu'une mobylette ou un scooter. Le processus de guidage prend en compte divers facteurs pour un déplacement sûr, confortable et légal sur les routes ou les pistes cyclables. Le Profil Mobylette évite les routes à grande vitesse : en particulier, il n'utilise pas les autoroutes et les routes où la limitation de vitesse est supérieure à 80 km/h lors du calcul d'un itinéraire.
...
![Paramètres de guidage pour mobylette iOS](@site/static/img/navigation/routing/moped_routing_new_ios.png)  
...
| *<Translate android="true" ids="temporary_conditional_routing"/>* |  Prend en compte les restrictions temporaires d'OpenStreetMap lors du calcul de l'itinéraire (par exemple, fermetures saisonnières ou travaux de construction).  | Les données OSM peuvent être obsolètes, de sorte que certaines restrictions temporaires peuvent ne plus être valides au moment de la navigation.   |