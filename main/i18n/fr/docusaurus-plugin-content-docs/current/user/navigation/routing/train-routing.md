...
![Paramètres de routage des trains Android](@site/static/img/navigation/routing/train_routing_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Paramètres de routage des trains iOS](@site/static/img/navigation/routing/train_routing_ios.png)

</TabItem>

</Tabs>

L'*acheminement des trains* peut être configuré selon vos besoins dans la section [Paramètres d'itinéraire](../guidance/navigation-settings.md#route-parameters) des paramètres de navigation.
