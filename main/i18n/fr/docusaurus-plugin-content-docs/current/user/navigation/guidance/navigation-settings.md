...
- **Directions virage par virage** (Android uniquement) – permet d'activer ou de désactiver les instructions de navigation standard telles que *« Tournez à gauche »*, *« Tournez à droite »*, ou *« Dans 200 mètres… »*. Lorsque l'option est désactivée, les annonces de virages et de noms de rues ne sont pas fournies, tandis que les notifications pour les points de passage, les points utilisateur et les événements d'itinéraire restent actives. Ce mode est destiné à des activités comme le rafting, la randonnée ou le cyclisme le long de traces préenregistrées, lorsque seules les alertes pour les points de passage ajoutés manuellement sont requises.
