...
| **Zoom avant** | Double-tapez la carte avec **un** doigt. <br/> Double-tapez avec **un** doigt et balayez vers le bas. <br/> Pincez avec **deux** doigts pour zoomer. |
| **Zoom arrière** | Double-tapez avec **deux** doigts. <br/> Double-tapez avec **un** doigt et balayez vers le haut. <br/> Pincez avec **deux** doigts pour dézoomer. |
| **Rotation** | Appuyez sur la carte avec **deux** doigts, puis faites pivoter vos doigts en mouvement circulaire. |
...
Vous pouvez personnaliser les icônes du bouton **Ma position** à l'aide des paramètres d'apparence du profil. En savoir plus sur la façon de procéder [ici](../personal/profiles.md#profile-appearance).
...
Les *modes d'orientation de la carte* vous permettent de choisir comment la carte est affichée sur l'écran de l'appareil. OsmAnd propose des modes tels que **Rotation manuelle**, **Direction du mouvement**, **Direction de la boussole** et **Le Nord est en haut**. L'activation de chaque mode modifie la façon dont la carte est orientée en fonction de l'option sélectionnée. Pour tous les détails, consultez l'article [Boutons de carte](../widgets/map-buttons.md#compass).
...
Vous pouvez activer cette fonctionnalité via *Menu → Paramètres → Profils → Paramètres généraux → Apparence → Orientation de la carte* ou en double-tappant sur le [bouton Boussole](../widgets/map-buttons.md#compass-tapping-behavior). Pour plus de détails sur le relèvement, voir [ici](../widgets/nav-widgets.md#bearing-widget).
...
L'utilisation du brouillard est nécessaire car l'affichage d'objets éloignés sur la carte nécessite des ressources informatiques importantes et n'est pas toujours justifié en raison des [distorsions](../plugins/development.md#comparison-with-a-satellite-imagery) de la carte à de petits angles de vue. Ainsi, la distance visible sur la carte OsmAnd est actuellement limitée à 35 tuiles.
...
Vous pouvez désactiver toutes les animations de carte pendant les interactions avec la carte, y compris les gestes et les boutons.
...
|**P**| *Clavier* | Changer - Profil d'application suivant |
|**O**| *Clavier* | Changer - Profil d'application précédent |
...
| **Bouton multimédia** <br/> (*Android uniquement*)| *Clavier* | Afficher / Masquer - [Notes AV](../plugins/audio-video-notes.md#manage-a-single-note) |
...
### Ajouter une action et des attributions de clés {#add-action--key-asssigments}
...
- Sélectionnez un type de périphérique, puis appuyez sur l'élément **Attributions de clés**.
- Appuyez sur le bouton ***Ajouter*** (&nbsp;"**＋**"&nbsp;) dans le coin inférieur droit de l'écran.
- Sélectionnez l'action requise, puis appuyez sur le champ ***Ajouter une clé*** et appuyez sur le bouton de votre appareil pour l'attribuer à l'action.
...
- Plus tard, vous pourrez modifier les actions et les attributions de clés ou en ajouter d'autres pour les actions déjà créées, il suffit de sélectionner un élément dans la liste des attributions de clés.

:::

### Supprimer l'attribution de clé {#delete-key-assignment}
...
- ***Supprimer toutes les attributions de clés*** pour le type sélectionné en appuyant sur le bouton dans le coin supérieur droit de l'écran à côté de *Modifier le nom*.
