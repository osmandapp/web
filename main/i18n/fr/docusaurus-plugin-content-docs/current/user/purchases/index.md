...
Dans cette section, vous pouvez acheter des abonnements et des fonctionnalités intégrées d'OsmAnd,  
ainsi que comparer les différences entre les forfaits disponibles.
...
### [Cadeaux](./giveaway.md) {#giveaway}

Vous pouvez obtenir OsmAnd gratuitement grâce à l'un de nos concours réguliers. Lisez comment vous inscrire et participer.

### Nouvel appareil / Nouveau compte {#new-device--new-account}

- **Android.** Connectez-vous simplement à Google Play en utilisant le même compte que celui que vous avez utilisé pour acheter OsmAnd, puis recherchez OsmAnd via *Recherche* et réinstallez-le. Assurez-vous d'installer OsmAnd+ si vous l'avez acheté, ou installez OsmAnd si vous l'avez acheté dans l'application.
