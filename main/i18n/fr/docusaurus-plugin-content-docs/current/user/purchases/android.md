...
Dans la liste, vous trouverez des informations sur les prix des produits OsmAnd pour les régions des États-Unis et d'Europe. Pour les autres régions, les prix sont équivalents dans les devises locales.
...
|    | OsmAnd Free   | [OsmAnd+](#install-osmand-android) /<br/> [Maps+](#install-osmand-android) intégré | [Maps+](#install-osmand-android) Abonnement | [OsmAnd Pro](#install-osmand-android) |
| :------------- | :------------- | :----------------------- | :------------------- | :----------- |
|  | ![Maps+](@site/static/img/svg/osmand_maps.svg) | ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) | ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) | ![Pro](@site/static/img/svg/pro_icon.svg) |
...
|  | OsmAnd Gratuit | [OsmAnd+](#install-osmand-android) <br/> [Maps+](#install-osmand-android) (intégré & abonnement) | [OsmAnd Pro](#install-osmand-android) |
| :------ | :------------- | :------------------ | :------------------ |
...
| [Enregistrement de trajets](../plugins/trip-recording.md) | ✔ | ✔ | ✔ |
...
| [Exporter / Importer le profil d'application](../personal/profiles.md#actions) | ✔ | ✔ | ✔ |
...
| [Plugin Métriques du véhicule (OBD-II)](../plugins/vehicle-metrics.md) | Vous permet de connecter un scanner OBD-II pour afficher des données détaillées du véhicule dans l'application OsmAnd et stocker les informations dans les enregistrements de traces.  |
| [Personnaliser la ligne d'itinéraire](../navigation/guidance/map-during-navigation.md#route-line-appearance) | Changer la couleur et l'épaisseur de la ligne d'itinéraire pendant la navigation. |
...
| [Correction d'altitude (hors ligne)](../map/tracks/track-context-menu.md#calculate-missing-elevation) | Vous permet de calculer un graphique d'altitude pour votre trace (carte [Terrain](../plugins/topography.md#download-maps) requise pour la région choisie). |
...
Vous pouvez acheter OsmAnd en utilisant des cartes-cadeaux Google Play, ce qui offre une alternative sécurisée au partage d'informations de carte de crédit en ligne. Achetez simplement une carte-cadeau chez un détaillant de votre choix et échangez le code sur Google Play.
