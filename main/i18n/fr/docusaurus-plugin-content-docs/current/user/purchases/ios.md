...
|------------|------------|------------|------------|
| **OsmAnd Start** | Un **plan gratuit** qui donne accès à [OsmAnd Cloud](../personal/osmand-cloud.md#osmand-start) pour les *Favoris*, *Paramètres* et l'*édition/notes OSM*. | Disponible pour tous les utilisateurs de la version gratuite d'OsmAnd. | Limité aux fonctionnalités de base du cloud et à **5 Mo** de stockage. |
...
| ![Pro](@site/static/img/svg/pro_icon.svg) **OsmAnd Pro** | Un **plan d'abonnement** qui débloque des fonctionnalités avancées supplémentaires et des [fonctionnalités pro](#pro-features). | Disponible sur l'[App Store](https://apps.apple.com/us/app/osmand-maps-travel-navigate/id934850257). | Prend en charge l'accès **multiplateforme** (voir note ci-dessous). |
...
|  | OsmAnd Free | [OsmAnd Maps+](#install-osmand-ios)<br/>(achat intégré & abonnement) | [OsmAnd Pro](#install-osmand-ios) |
| :------ | :------------- | :------------------ | :------------------ |
...
| [Téléchargements de cartes](../start-with/download-maps.md) |  <details><summary>**5 téléchargements de cartes** <br /> (la mise à jour de carte compte comme un téléchargement) :</summary> <br /> - Le téléchargement ou la mise à jour d'une carte désigne uniquement le téléchargement-mise à jour de la carte d'un pays (région).<br /> - La **carte de vue d'ensemble du monde**, la **correction d'altitude mondiale**, les **polices de carte** et les **invites vocales** ne sont pas comptées comme 5 possibilités de téléchargement.</details> | ✔ | ✔ |
| [Mises à jour mensuelles des cartes](../personal/maps-resources.md#update-maps) |  <details><summary>**Une fois par mois** <br /> (avec 2 jours de délai) :</summary> * limité à 5 téléchargements (la mise à jour de carte compte comme un téléchargement) </details> |  ✔ | ✔ |
...
| [Visualisation 3D des traces](../map/tracks/appearance.md) | **-** | ✔ | ✔ |
...
Un moyen simple de choisir et d'acheter le plan nécessaire est le menu **Achats**. Bien sûr, vous verrez un menu de propositions pour les fonctionnalités payantes.
...
Les nouveaux abonnements sont devenus actifs à partir d'OsmAnd 4.3 (décembre 2022). Tous les abonnements antérieurs sont hérités et techniquement équivalents à l'"abonnement Maps", bien que les abonnements hérités donnent droit aux mises à jour horaires des cartes. Les utilisateurs ne peuvent pas acheter d'abonnements hérités, mais les anciens abonnements sont automatiquement renouvelés jusqu'à ce que vous vous désabonniez (le prix de ceux-ci pourrait changer à l'avenir).
