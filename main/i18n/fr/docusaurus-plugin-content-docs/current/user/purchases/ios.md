...
| [Téléchargements de cartes](../start-with/download-maps.md) |  <details><summary>**5 téléchargements de cartes** <br /> (la mise à jour de carte compte comme un téléchargement) :</summary> <br /> - Le téléchargement ou la mise à jour de carte signifie uniquement le téléchargement-mise à jour d'une carte de pays (région).<br /> - La **carte d'ensemble du monde**, la **correction d'altitude du monde**, les **polices de carte** et les **invites vocales** ne sont pas comptées comme 5 possibilités de téléchargement.</details> | ✔ | ✔ |
...
| [Widgets d'altitude - Élévation : Centre de la carte](../widgets/info-widgets.md#elevation-map-center) | Vous permet de connaître l'altitude du centre actuel de la carte au-dessus du niveau de la mer.  |
