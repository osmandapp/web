---
source-hash: c5108ca74f714c508aaa34bc5d380903b114ed43ecbd5ba30e0a9305a6be9ba3
sidebar_position: 7
...
Une carte nautique est une carte topographique très détaillée pour aider les skippers à naviguer sur un parcours sélectionné sur l'eau. Elle est similaire à une carte routière pour ceux qui voyagent en voiture. Souvent appelée « *Carte* » pour des raisons historiques, c'est une représentation graphique détaillée des océans, des mers, des zones côtières et des rivières.
...
1. [Acheter](../plugins/index.md#purchase) et [activer](../plugins/index.md#enable--disable) le plugin Vue Carte Nautique.
2. [Télécharger](#download-nautical-maps) les cartes nautiques.
...
Aller à : *<Translate android="true" ids="shared_string_menu,configure_map,map_widget_map_rendering,map_widget_renderer,nautical_renderer"/>*

![Type de carte nautique dans Android](@site/static/img/plugins/nautical-charts/and_map_style1.png)

</TabItem>

<TabItem value="ios" label="iOS">

Aller à : *<Translate ios="true" ids="shared_string_menu,configure_map,map_settings_type,map_settings_offline"/>*

![Type de carte nautique dans iOS](@site/static/img/plugins/nautical-charts/ios_nautical_map_type1.png)
...
Aller à : *<Translate android="true" ids="shared_string_menu,maps_and_resources,nautical_maps"/>*
...
Aller à : *<Translate ios="true" ids="shared_string_menu,res_mapsres,region_nautical"/>*
...
![Courbes de niveau de profondeur nautiques dans Android](@site/static/img/plugins/nautical-charts/and_boat_profile-2.png)
...
![Courbes de niveau de profondeur dans iOS](@site/static/img/plugins/nautical-charts/ios_boat_profile-2.png)
...
Le plugin Nautique dans OsmAnd étend les styles de carte de la couche vectorielle avec le style de carte Nautique. Il vous permet d'afficher les données cartographiques selon les règles des cartes nautiques, par exemple : zones jaunes pour la terre et les hauts-fonds, zones bleu clair pour les eaux peu profondes, etc. Pour plus d'informations, consultez la [Légende de la carte](../../user/map-legend/nautical-map.md).
...
Aller à : *<Translate android="true" ids="shared_string_menu,configure_map,shared_string_show,nautical_depth"/>*

![Courbes de niveau de profondeur nautiques dans Android](@site/static/img/plugins/nautical-charts/and_depth_contours-3.png)

</TabItem>

<TabItem value="ios" label="iOS">

Aller à : *<Translate ios="true" ids="shared_string_menu,configure_map,map_settings_style,nautical_depth"/>*

![Courbes de niveau de profondeur dans iOS](@site/static/img/plugins/nautical-charts/ios_depth_contours-2.png)
...
Aller à : *<Translate android="true" ids="shared_string_menu,configure_map,rendering_category_others,rendering_attr_seabedDetail_name"/>*
...
- **Catégorie** - en plus du symbole de balisage maritime, affiche également la balise de balisage maritime pertinente, indiquant le matériau naturel, ou la catégorie d'algues et d'herbiers marins.
- **Tout** - en plus du symbole, de la balise ou de la catégorie de balisage maritime, affiche également des qualifications telles que fin, collant, grossier, etc. Pour les herbiers marins et les algues, affiche les données marquées avec les balises *taxon* et *genre*.
- **Omettre** - n'affiche pas les détails du fond marin.

:::info NOTE
Pour plus de détails sur la classification des détails de surface et les options de rendu, consultez le [wiki seamark d'OSM](https://wiki.openstreetmap.org/wiki/Seamarks/INT-1_Section_J).
:::
