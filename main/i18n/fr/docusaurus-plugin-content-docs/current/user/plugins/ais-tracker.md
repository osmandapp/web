---
source-hash: 28e373f58ed11c366fc85cde4e34f8f87c61f852c1241c4283f10cc38130e3e0
sidebar_position: 2
...
![Suivi de navires AIS](@site/static/img/plugins/ais/ais.png)
...
![Suivi de navires AIS](@site/static/img/plugins/ais/ais_menu.png) ![Suivi de navires AIS](@site/static/img/plugins/ais/ais_menu_2.png)
...
2. Informations dynamiques (données en temps réel).  
    *Envoyées à différents intervalles selon la vitesse et les manœuvres.*
    ...
    - **Vitesse de giration (ROT)** (*Vitesse de changement de cap*)  
...
| *Triangle rouge clignotant*   | Navire spécial (par exemple, pilote, brise-glace) |
