---
source-hash: ac1d19c843d7a206ff997be0e696fc8e289d1ecfbca4bfe1e23800a08a0f085f
sidebar_position: 2
...
Si vous touchez le bouton *Marque-page*, l'article sera enregistré pour une lecture ultérieure et sera disponible dans l'onglet Marque-pages. Dans l'onglet *Articles marqués*, les articles sont classés par ordre d'enregistrement, les articles les plus récents étant en haut.
...
![Menu du sommaire des guides de voyage](@site/static/img/guides/travel_guides_navigation_menu.png)
...
Pour passer d'un article à l'autre dans les *articles des guides de voyage*, utilisez le **Menu de navigation**. Vous pouvez y accéder en tapant sur le champ d'adresse au-dessus de l'image. NOTEZ que les articles des Guides de voyage sont regroupés comme suit : *Continent → Région → Pays → Province (région) → Ville*.
Si vous tapez sur la flèche dans le coin supérieur gauche de l'écran, vous irez directement à l'onglet *Explorer* ou *Articles marqués* (selon l'onglet que vous avez ouvert précédemment).
...
![Menu du sommaire des guides de voyage](@site/static/img/guides/travel_guides_contents_menu_android.png)
...
La plupart des *articles des guides de voyage* ont la même structure de contenu : *introduction* (images et description du site touristique) et *chapitres suivants*.
...
Après avoir activé l'affichage des *Itinéraires de voyage* dans le menu *Configurer la carte*, des cercles de différentes couleurs apparaîtront sur la carte. Les oranges représentent les traces d'itinéraires, les articles d'itinéraires et certains points de passage. Touchez un itinéraire, un article ou un point spécifique, puis touchez le bouton *Télécharger* (&#9047;), et vous pourrez les [gérer comme une trace](#manage-as-gpx-track).
...
Dans certains cas, l'*[onglet Marque-pages](#explore-and-bookmark)* d'OsmAnd vous invitera à télécharger la [couche de carte Wikipédia](../plugins/wikipedia.md#download-wikipedia-packages) pour parcourir les articles connexes hors ligne.
