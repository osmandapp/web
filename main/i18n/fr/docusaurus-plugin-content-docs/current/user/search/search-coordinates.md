...
### Degrés et Minutes {#degrees-and-minutes}

![Recherche de coordonnées Android](@site/static/img/search/coordinates_search_DM_andr.png)  

**<Translate android="true" ids="navigate_point_format_DM"/>**. Dans ce format, les coordonnées de latitude et de longitude sont enregistrées en utilisant les degrés et les minutes. Par exemple, 37:46.29 de latitude et -122:25.10 de longitude pour San Francisco. Ce format peut être moins précis et peut prendre plus de temps à saisir.
...
### Degrés, Minutes et Secondes {#degrees-minutes-and-seconds}
...
- [Saisie de coordonnées](../plan-route/coordinate-input.md)
- [Menu contextuel de la carte](../map/map-context-menu.md)
- [Widgets informatifs](../widgets/info-widgets.md)
