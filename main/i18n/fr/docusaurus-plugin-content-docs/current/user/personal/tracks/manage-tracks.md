...
Vous pouvez ajouter des traces dans OsmAnd de plusieurs manières :
...
![Mes Lieux avec les traces dans Android](@site/static/img/personal/tracks/view_all_tracks_andr.png)
...
![Mes Lieux avec les traces dans iOS](@site/static/img/personal/tracks/my_places_tracks_menu_1_ios.png)
...
Chaque trace, comme les dossiers, possède un menu, vous permettant de gérer les traces efficacement. Voici comment y accéder :
...
-   **Analyser sur la carte** (*Android*) / **Analyser** (*iOS*) — Ouvre l'outil [Analyser sur la carte](../../navigation/setup/route-details.md#analyze-on-map) dans les Détails de l'itinéraire pour une analyse plus poussée.
...
![Fonction de recherche des traces dans Mes Lieux Android](@site/static/img/personal/tracks/my_places_tracks_search_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Fonction de recherche des traces dans Mes Lieux iOS](@site/static/img/personal/tracks/my_places_tracks_search_ios.png)
...
Une fois votre choix effectué, les étapes suivantes sont proposées :  
...
-   **Partager** (*Android*) / **Exporter** (*iOS*) — Si vous souhaitez partager les données sélectionnées avec d'autres utilisateurs ou les enregistrer sur un service cloud, la fonction *Partager/Exporter* vous permet d'envoyer des traces et des dossiers en utilisant différentes méthodes de partage.
...
-   [Changer d'activité](../../map/tracks/track-context-menu.md#track-information-activity) (*Android uniquement*) — Cette action vous permet de changer le type d'activité, par exemple en *Voiture*, *Sports mécaniques d'aventure*, *Randonnée avec sac à dos* ou autres, pour la trace sélectionnée.

-   [Changer d'apparence](../../map/tracks/appearance.md#change-appearance-for-multiple-tracks) — Cette option vous permet de personnaliser l'apparence des traces sélectionnées, les rendant plus visibles et reconnaissables sur la carte.
...
OsmAnd offre un moyen simple de trier vos traces, vous aidant à gérer une large collection ou à trouver rapidement des caractéristiques spécifiques. Pour accéder au menu de tri, appuyez sur **Trier par** en haut de la liste des traces.

***Options de tri :***

-   **Les plus proches** — Affiche les traces les plus proches de votre position actuelle.

-   **Dernière modification** — Affiche les traces triées par leur date de modification la plus récente.

-   **Nom : A - Z** — Arrange les traces alphabétiquement de A à Z.

-   **Nom : Z - A** — Arrange les traces alphabétiquement de Z à A.
...
L'option de tri sélectionnée s'applique non seulement au sous-dossier actuel, mais aussi à tous les dossiers imbriqués et à toutes les traces à tous les niveaux. Cela garantit une structure cohérente dans vos données enregistrées.
...
Le menu du dossier de traces vous permet d'afficher, renommer, exporter et gérer les dossiers.
...
-   [Changer l'apparence par défaut](../../map/tracks/appearance.md) (*Android*) / **Apparence** (*iOS*) — Change l'apparence d'affichage de toutes les traces du dossier.
...
![Mes Lieux avec les traces dans Android](@site/static/img/personal/tracks/dashboard_andr.png)
...
![Mes Lieux avec les traces dans Android](@site/static/img/personal/tracks/tracks_delete_folder_andr.png)
...
1.  **Importation directe de fichiers :**
    ...
    -   Appuyez sur un fichier GPX, KML ou KMZ depuis des applications de messagerie, des e-mails, Google Drive ou des gestionnaires de fichiers.
...
3.  Par le [fichier de sauvegarde locale](../../personal/import-export.md#export-to-file). Exportation des traces GPX en tant que fichiers `.osf`.


## Articles connexes {#related-articles}

-   [Afficher une trace sur la carte](../../map/tracks/index.md)
