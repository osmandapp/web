...
Aller à : *<Translate android="true" ids="shared_string_menu,shared_string_my_places,shared_string_gpx_tracks"/> tab*
...
OsmAnd offre un moyen simple de trier vos traces, vous aidant à gérer une grande collection ou à trouver rapidement des caractéristiques spécifiques. Pour accéder au menu de tri, appuyez sur **Trier par** en haut de la liste des traces.
...
-   **Date la plus récente en premier** — Liste les traces par date de création, les plus récentes étant en haut.

-   **Date la plus ancienne en premier** — Liste les traces par date de création, les plus anciennes étant en haut.

-   **Distance la plus longue en premier** — Affiche les traces triées par longueur, les plus longues étant en haut.

-   **Distance la plus courte en premier** — Affiche les traces triées par longueur, les plus courtes étant en haut.

-   **Durée la plus longue en premier** — Trie les traces par durée, plaçant les plus longues en haut.

-   **Durée la plus courte en premier** — Trie les traces par durée, plaçant les plus courtes en haut.
...
L'option de tri sélectionnée est appliquée non seulement au sous-dossier actuel, mais également à tous les dossiers imbriqués et à toutes les traces à tous les niveaux. Cela garantit une structure cohérente dans vos données enregistrées.
...
-   **Afficher toutes les traces sur la carte** (*Android uniquement*) — Affiche toutes les traces du dossier sur la carte —
    *NOTE : S'il y a beaucoup de traces, cela peut entraîner un blocage de l'appareil.*
...
Aller à : *<Translate android="true" ids="shared_string_menu,shared_string_my_places,shared_string_tracks"/> tab*
...
Au bas de la liste dans l'onglet *Traces*, et sous la liste des traces **dans chacun de vos dossiers**, se trouve une section d'information qui vous permet de visualiser les statistiques globales récapitulatives des traces dans le dossier sélectionné. Toutes les valeurs sont affichées dans les [unités](../../personal/profiles.md#units--formats) que vous avez sélectionnées.
...
-   *Somme du temps de* **Durée** — Affiche le temps total nécessaire pour parcourir toutes les traces du dossier sélectionné.
...
-   [Importer](#import) — Télécharge les fichiers GPX ou autres fichiers de trace depuis votre appareil vers OsmAnd pour une utilisation hors ligne.
...
1.  **Importation directe de fichier :**
...
| Exporter | Importer |
|:------------|:---------------|
| ![import multitrack](@site/static/img/personal/tracks/import_gpx_ios_1.png) <details><summary> Exporter </summary> ![import multitrack](@site/static/img/personal/tracks/import_gpx_ios.png) </details> | ![import multitrack](@site/static/img/personal/tracks/import_gpx_ios_3.png) <details><summary> Exporter </summary> ![import multitrack](@site/static/img/personal/tracks/import_gpx_ios_2.png) </details> |
...
Il existe plusieurs façons d'exporter un ou plusieurs fichiers de trace vers n'importe quel messager, e-mail, gestionnaire de fichiers ou application.
...
3.  Par le [Fichier de sauvegarde locale](../../personal/import-export.md#export-to-file). Exportation des traces GPX sous forme de fichiers `.osf`.
