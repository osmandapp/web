---
source-hash: 019d1ef391196d9ad6bd343bf16503e28e7937736a4851cf3988d221410afd79
sidebar_position: 6
...
## Les traces enregistrées ont des lacunes {#recorded-tracks-have-gaps}
...
### Configuration d'OsmAnd pour l'enregistrement de trace {#configuring-osmand-for-track-recording}
...
- (6) **Optimiser les paramètres** = OFF (dans Android 10 sous *Entretien de l'appareil / Avancé*, dans Android 11 semble disparu)
...
- (9) **Optimiser l'utilisation de la batterie** (sous *Applications / OsmAnd / Batterie* ou *Applications / 3 points / Accès spécial / Optimiser l'utilisation de la batterie / Tout / OsmAnd*) = il est conseillé d'exempter OsmAnd de l'optimisation de la batterie (bien que ce ne soit pas nécessaire sur tous les appareils)
...
- *Entretien de l'appareil / 3 points / Automatisation*
- *Entretien de l'appareil / Avancé*
- *Entretien de l'appareil / Batterie*
- *Entretien de l'appareil / Batterie / Paramètres*
- *Entretien de l'appareil / Batterie / Gestion de l'alimentation des applications*
- *Entretien de l'appareil / Batterie / Plus de paramètres de batterie*
...
- (A1) Pendant qu'OsmAnd est utilisé, par exemple la navigation. Nous maintenons le module GPS du système allumé en permanence, car les informations de localisation continues sont essentielles ici. L'effet sur l'utilisation de la batterie (ordre de grandeur) semble être d'environ 5 % par heure sur les anciens systèmes jusqu'à Android 4.4, et de 2 à 3 % pour les systèmes plus récents.
...
Atténuation : Nous n'utilisons désormais setRepeating() que jusqu'à Android 4.2, la nouvelle méthode setExact() à partir d'Android 4.4, et setExactAndAllowWhileIdle() pour Android 8+. ([Problème #5632](https://github.com/osmandapp/Osmand/issues/5632))
