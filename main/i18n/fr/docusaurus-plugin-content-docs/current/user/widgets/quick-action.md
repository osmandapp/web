...
<!--
- Pour ouvrir le menu Action rapide, il suffit de toucher le bouton.
- Par défaut, le bouton Action rapide apparaîtra dans le coin droit (au-dessus des boutons de zoom), mais il peut être déplacé vers n'importe quelle partie de l'écran en le touchant longuement. -->
...
- Les écrans, numérotés numériquement comme Écran 1, Écran 2, etc., sont créés automatiquement lorsque le nombre d'actions dans la liste augmente à 6 éléments.
...
- **Ne pas afficher de boîte de dialogue intermédiaire**. Les sources de la carte changent dans un ordre défini.
...
| Action | Description |
|:-------------|:-------------|
| Afficher / Masquer <br/> [**Routes**](../map/vector-maps.md#routes) | Vous pouvez sélectionner les types de routes pour activer ou désactiver leur affichage. <br/> Certaines routes ont des paramètres supplémentaires. Par défaut, si vous n'avez rien sélectionné dans le menu [Configurer la carte](../map/configure-map-menu.md), le premier type de route de la liste sera attribué, sinon, un type de votre choix sera attribué. Vous pouvez en savoir plus dans l'article [Routes](../map/routes.md). <br/> - ***Routes cyclables*** &nbsp;(*Route*, *Réseaux de nœuds*) <br/> - ***Routes de VTT*** &nbsp;(*Échelle VTT*, *IMBA*) <br/> - ***Routes de randonnée*** &nbsp;(*Échelle OSMC*, *Affiliation réseau*, *Réseaux de nœuds*) <br/> - ***Difficulté des sentiers de randonnée*** &nbsp;(*Échelle SAC*, *Échelle CAI*) <br/> - ***Pistes de ski*** <br/> - ***Routes équestres*** <br/> - ***Sports d'eau vive*** <br/> - ***Routes de course à pied*** <br/> - ***Parcours de fitness*** <br/> - ***Routes de voyage*** &nbsp;(*Traces*, *Carnets de voyage*, *Points*) <br/> |
...
| Afficher / Masquer <br/> [**Couches météo**](../plugins/weather.md#weather-layers) | Toutes les données météorologiques sont présentées sous forme de couches de carte distinctes. Avec Action rapide, vous pouvez obtenir un accès rapide pour basculer la visibilité de ces couches sur la carte. <br/> - ***Couche de précipitations*** <br/> - ***Couche de nuages*** <br/> - ***Couche de pression*** <br/> - ***Couche de vent*** <br/> - ***Couche de température*** |
...
| Changer <br/> [**Profil d'application vers le suivant**](../personal/profiles.md) | Passe au profil suivant dans la liste. |
| Changer <br/> [**Profil d'application vers le précédent**](../personal/profiles.md) | Passe au profil précédent dans la liste. |
