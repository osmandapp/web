...
### Apparence du bouton Action rapide {#quick-action-button-appearance}
...
| Action | Description |
|:-------------|:-------------|
| Afficher / Masquer <br/> [**Routes**](../map/vector-maps.md#routes) | Vous pouvez sélectionner les types de routes pour activer ou désactiver leur affichage. <br/> Certaines routes ont des paramètres supplémentaires. Par défaut, si vous n'avez rien sélectionné dans le menu [Configurer la carte](../map/configure-map-menu.md), le premier type de route de la liste sera attribué, sinon, un type de votre choix sera attribué. Vous pouvez en savoir plus dans l'article [Routes](../map/routes.md). <br/> - ***Routes cyclables*** &nbsp;(*Route*, *Réseaux de nœuds*) <br/> - ***Routes de VTT*** &nbsp;(*Échelle VTT*, *IMBA*) <br/> - ***Routes de randonnée*** &nbsp;(*Échelle OSMC*, *Affiliation au réseau*, *Réseaux de nœuds*) <br/> - ***Difficulté des sentiers de randonnée*** &nbsp;(*Échelle SAC*, *Échelle CAI*) <br/> - ***Pistes de ski*** <br/> - ***Routes équestres*** <br/> - ***Sports d'eau vive*** <br/> - ***Routes de course à pied*** <br/> - ***Sentiers de fitness*** <br/> - ***Routes de voyage*** &nbsp;(*Traces*, *Carnets de voyage*, *Points*) <br/> |
...
| Changer <br/> [**Schéma de couleurs du terrain**](../plugins/topography.md#modify-color-scheme) | Vous permet de sélectionner une ou plusieurs palettes dans une liste existante, qui changeront lorsque vous appuierez sur le bouton. |
...
| Déplacer <br/> [**Carte vers le haut**](../map/interact-with-map.md) | Lorsque vous appuyez sur le bouton, l'écran de la carte se déplace vers le haut. |
...
| Ajouter <br/> [**Marqueur de carte**](../map/configure-map-menu.md#map-layers) | Ajoute un marqueur à un emplacement de carte sélectionné (central). |
| Ajouter <br/> [**Place de parking**](../plugins/parking.md) | Ajoute un parking à un emplacement de carte sélectionné (central). L'ancienne position de parking est supprimée. |
| Ajouter <br/> [**POI**](../map/point-layers-on-map.md#points-of-interest-poi) | Ajoute un POI à un emplacement de carte sélectionné (central) (identique à l'action du menu contextuel). <br /> - *Afficher une boîte de dialogue intermédiaire*. Affiche une boîte de dialogue de confirmation. <br /> - *Type de POI* (facultatif). Présélectionne le type de POI OSM. <br /> - *Balise/Valeur* (multiple). Ajoute des balises/valeurs [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Map_Features) |
...
| Ajouter <br/> [**Notes multimédia**](../plugins/audio-video-notes.md) | Démarre l'enregistrement de notes audio/photo/vidéo pour un emplacement de carte sélectionné (central). |
| Créer <br/> [**Nouvelle route**](../plan-route/create-route.md) <br /> *Android uniquement* | Ouvre l'outil [Planifier une route](../plan-route/create-route.md) et crée une route pour l'emplacement sélectionné (central) sur la carte. |
...
| Définir <br/> [**Point de départ**](../navigation/setup/route-navigation.md#set-destinations) | Marquer un emplacement de carte sélectionné (central) comme point de départ. |
...
| Remplacer <br/> [**Destination**](../navigation/setup/route-navigation.md#intermediate-destinations) | Définir / Remplacer un emplacement de carte sélectionné (central) comme destination. La destination précédente est supprimée. |
