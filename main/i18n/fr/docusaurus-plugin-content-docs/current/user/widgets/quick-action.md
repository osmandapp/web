...
| Action | Description |
|:-------------|:-------------|
| Afficher / Masquer <br/> [**Itinéraires**](../map/vector-maps.md#routes) | Vous pouvez sélectionner des types d'itinéraires pour activer ou désactiver leur affichage. <br/> Certains itinéraires ont des paramètres supplémentaires. Par défaut, si vous n'avez rien sélectionné dans le menu [Configurer la carte](../map/configure-map-menu.md), le premier type d'itinéraire de la liste sera assigné, sinon, un type de votre choix sera assigné. Vous pouvez en savoir plus dans l'article [Itinéraires](../map/routes/index.md). <br/> - ***Itinéraires cyclables***  &nbsp;(*Itinéraire*, *Réseaux de nœuds*) <br/> - ***Itinéraires VTT***  &nbsp;(*Échelle VTT*, *IMBA*) <br/> - ***Itinéraires de randonnée***  &nbsp;(*OSMC*, *Affiliation au réseau*, *Réseaux de nœuds*) <br/> - ***Niveau de difficulté des sentiers de randonnée***  &nbsp;(*Échelle SAC*, *Échelle CAI*) <br/> - ***Pistes de ski*** <br/> - ***Itinéraires équestres*** <br/> - ***Sports en eaux vives*** <br/> - ***Itinéraires de course à pied*** <br/> - ***Parcours de santé*** <br/> - ***Itinéraires de voyage***  &nbsp;(*Traces*, *Carnets de voyage*, *Points*) <br/> |
