...
| <Translate android="true" ids="one_tap_active"/> | Avec un seul appui sur le marqueur requis sur la carte, ce marqueur se déplace en haut de la liste des marqueurs de carte actifs sans ouvrir le menu contextuel. |
