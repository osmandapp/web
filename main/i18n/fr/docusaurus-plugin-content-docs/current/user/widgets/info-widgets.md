...
Les widgets d'information vous offrent un accès rapide aux données importantes. Il peut s'agir de données sur la vitesse, la météo, la position de stationnement, les données de capteurs externes, et bien plus encore. Les widgets peuvent être configurés selon vos besoins spécifiques, permettant leur visibilité sur l'écran de l'application ou les désactivant si nécessaire.
...
- Pour plus de détails, visitez [Cartes & Ressources](../personal/maps-resources.md#downloads).
:::
...
&nbsp;<ProFeature/> Pour accéder au widget *Élévation : centre de la carte*, abonnez-vous à OsmAnd Pro pour [Android](../purchases/android.md#pro-features) ou [iOS](../purchases/ios.md#pro-features).
:::
...
2. ***Intervalle de temps.***
   ...
   - La vitesse moyenne est calculée en fonction de l'intervalle de temps sélectionné, qui peut varier de **15 secondes à 60 minutes**.
...
3. ***Prendre en compte les arrêts.***
   ...
   **Activé** — Si la vitesse enregistrée est inférieure à 1 unité par heure, elle est ignorée, évitant ainsi des baisses inutiles de la vitesse moyenne lors d'arrêts aux feux de circulation ou de courtes pauses.
...
|:--------|:---------|
| ![Ratio de plané](@site/static/img/widgets/glide_ratio_3.png) | ![Ratio de plané](@site/blog/2023-12-22-android-4-6/img/glide_ratio_2.png) |
...
| Widgets | Widgets à l'écran |
|:--------|:---------|
| ![Ratio de plané](@site/static/img/widgets/glide_ratio_1_widget_ios.png) | ![Ratio de plané](@site/static/img/widgets/glide_ratio_widget_ios.png) |

</TabItem>

</Tabs>

Le widget [simple](../widgets/configure-screen.md#widgets-for-all-panels) *Ratio de plané* fournit des informations précieuses sur le ratio de plané pour aider à prendre des décisions éclairées lors de la planification des itinéraires aériens. Le widget *Ratio de plané* dans OsmAnd vous aide à évaluer l'efficacité de votre descente ou de votre ascension lorsque vous naviguez vers un emplacement spécifique (position du [marqueur](../personal/markers.md) sur la carte). Il calcule le ratio de plané comme le rapport entre la distance et la différence d'altitude entre votre position actuelle et votre destination prévue. Vous pouvez en savoir plus à ce sujet [ici](https://en.wikipedia.org/wiki/Lift-to-drag_ratio#Glide_ratio).

**Utilisation des widgets :**

- *Planification des vols de vol à voile.* Pour les pilotes de vol à voile, le widget *Ratio de plané vers la cible* devient un outil indispensable pour planifier et exécuter les vols de vol à voile. Les pilotes peuvent estimer jusqu'où ils peuvent voler vers leur cible compte tenu des conditions actuelles et du ratio de plané requis.
- *Optimiser les montées et les descentes.* Le ratio de plané moyen permet aux pilotes d'optimiser les montées et les descentes en fonction des conditions actuelles. Les pilotes peuvent choisir le moment optimal pour les montées afin de maximiser le temps de vol, ou pour les descentes afin d'atteindre un point cible.
- *Réagir aux conditions changeantes.* Le widget fournit des mises à jour continues du ratio de plané, permettant aux pilotes de réagir instantanément aux changements des conditions atmosphériques ou des itinéraires. Ils peuvent ajuster leur plan de vol pour assurer la sécurité et l'efficacité.
- *Utilisation maximale de la distance horizontale.* Connaître le ratio de plané permet aux pilotes de maximiser l'utilisation de la distance horizontale pour se déplacer vers la cible, ce qui est particulièrement important lors de la planification de longs vols.
- *Réduction des risques*. Le widget *Ratio de plané vers la cible* aide les pilotes à éviter les situations où atteindre la cible devient impossible en raison d'un ratio de plané insuffisant. Cela contribue à réduire les risques et à améliorer la sécurité des vols.
...
### Ratio de plané vers la cible {#glide-ratio-to-target}

- **Ratio de plané vers la cible** indique le ratio de plané exact requis pour atteindre le point cible.
- **Altitude cible** indique l'altitude du point cible. Le [marqueur de carte](../personal/markers.md) doit être utilisé comme point cible.

| | |
|:------------|:------------|
| Activer | **Android :** *<Translate android="true" ids="shared_string_menu,map_widget_config"/> → Choisir un panneau → Ajouter un widget → Ratio de plané* |
| | **iOS :** *<Translate ios="true" ids="shared_string_menu,layer_map_appearance"/> → Choisir un panneau → Ajouter un widget → Ratio de plané* |
| En tapant | Change le *Ratio de plané vers la cible* ou l'*Altitude cible* |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |

### Ratio de plané moyen {#average-glide-ratio}

- **Ratio de plané moyen** indique le ratio de plané moyen pour un intervalle de temps spécifié.
...
| Activer | **Android :** *<Translate android="true" ids="shared_string_menu,map_widget_config"/> → Choisir un panneau → Ajouter un widget → Ratio de plané* |
| | **iOS :** *<Translate ios="true" ids="shared_string_menu,layer_map_appearance"/> → Choisir un panneau → Ajouter un widget → Ratio de plané* |
| En tapant | Change le *Ratio de plané moyen* ou la *Vitesse verticale moyenne* |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
## Widget de coordonnées {#coordinates-widget}
...
Les widgets de coordonnées sont affichés en haut de l'écran. Les icônes avec un fond vert affichent la latitude et la longitude du point au centre de la partie visible de la carte, et celles avec un fond bleu affichent les coordonnées de votre emplacement actuel. Des informations sur les *formats de coordonnées* pris en charge peuvent être trouvées dans l'article [Coordonnées de recherche](../search/search-coordinates.md#coordinate-format).
...
| En tapant | Copie les coordonnées dans le presse-papiers. |
...
| En tapant | Ouvre le menu d'état GPS avec des outils tiers pour configurer l'appareil GPS embarqué. |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
Les widgets de position du soleil affichent les prochaines heures de lever et de coucher du soleil pour le centre de la carte. Lorsque vous appuyez dessus, ils affichent le temps restant jusqu'au coucher ou au lever du soleil prévu. Dans les deux cas, l'heure est basée sur l'heure configurée de votre appareil.
...
| En tapant | Bascule entre le temps restant et l'heure du prochain lever/coucher du soleil. |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
Le widget Règle de rayon affiche la distance entre votre emplacement et le point central de la Règle de rayon. Le rayon du premier cercle est égal à [l'échelle de la carte](../widgets/radius-ruler.md#ruler).
...
| En tapant | Change l'état du widget entre les modes échelle noire, niveaux de gris et invisible. |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
Le **widget Compteur de vitesse** est un affichage graphique de la vitesse actuelle du véhicule basé sur les *données reçues du GPS*. Il vous permet de surveiller en temps réel la conformité entre votre vitesse et la limite de vitesse autorisée. La limite de vitesse autorisée est fournie par les [données OpenStreetMap](https://wiki.openstreetmap.org/wiki/Key:maxspeed) pour une section de route particulière et le réglage [Tolérance de limite de vitesse](../navigation/guidance/voice-navigation.md#speed-limit) d'OsmAnd.
...
Les widgets d'enregistrement de trajet se réfèrent au [plugin <Translate android="true" ids="record_plugin_name"/>](../plugins/trip-recording.md#widgets). Vous pouvez utiliser les widgets pour afficher de brèves informations sur l'enregistrement de la trace à l'écran. Tels que *Distance*, *Durée*, *Montée* et *Descente*.
...
| En tapant | Démarre/Arrête l'enregistrement de la trace ou Affiche le graphique. |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
| En tapant | Pas de changements (*Android*) / Bascule le mode entre les données du capteur et le niveau de batterie (*iOS*). |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |

### Widgets de métriques du véhicule {#vehicle-metrics-widgets}

:::note
Pour ajouter des widgets de métriques du véhicule à l'écran de la carte, activez le [plugin Métriques du véhicule](../plugins/vehicle-metrics.md) d'OsmAnd.
:::
...
| | **iOS :** *<Translate ios="true" ids="shared_string_menu,layer_map_appearance"/> → Choisir un panneau → Ajouter un widget → <Translate ios="true" ids="obd_plugin_name"/>* |
| En tapant | Pas de changements |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
- **Nuage**. <Translate android="true" ids="clouds_widget_desc"/>
...
| En tapant | Affiche dans une boîte de dialogue contextuelle la date et l'heure de pertinence des informations météorologiques. |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
| En tapant | Déplace la vue de la carte vers la position de stationnement. |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
Il s'agit d'un widget de plugin Mapillary qui fournit un accès rapide à l'application Mapillary, ce qui vous permet d'ajouter des [*images au niveau de la rue*](../plugins/mapillary.md#enable-layer). Le widget est automatiquement ajouté à la carte lorsque le plugin est activé.
...
| En tapant | Ouvre l'application [Mapillary](https://www.mapillary.com/). |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
Ce sont des widgets de plugin de notes audio/vidéo qui fournissent un accès rapide pour démarrer/arrêter la prise de notes audio, vidéo ou photo.
...
| En tapant | Démarre/arrête la prise d'une note |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
| En tapant | Ouvre l'application OsmAnd Online GPS Tracker. |

### Widgets de développeur {#developer-widgets}

:::note
Pour ajouter des widgets de développeur à l'écran de la carte, activez le [plugin de développement OsmAnd](../plugins/development.md).
:::

Les **widgets de développeur** fournissent des informations sur la [vitesse de rendu de la carte](../plugins/development.md#map-rendering-fps-widget) et les paramètres de position de la caméra virtuelle, y compris le [niveau de zoom](../plugins/development.md#zoom-level), la [distance](../plugins/development.md#distance-to-target) au centre de la carte, l'[élévation de la caméra](../plugins/development.md#camera-elevation) et l'[angle d'inclinaison de la caméra](../plugins/development.md#camera-tilt).
...
| En tapant | Bascule entre les modes (*Niveau de zoom*) / Pas de changements (*Autres*) |
| Appui long | Ouvre le [menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
Le widget **RAM disponible** est un outil de surveillance de l'utilisation de la mémoire de votre appareil par rapport à OsmAnd. Il fournit des données détaillées pour aider à optimiser les performances de l'application.

- **RAM d'application disponible.** Affiche la quantité de RAM disponible pour qu'OsmAnd puisse l'utiliser sans causer de problèmes de performances.
