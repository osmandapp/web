---
source-hash: 247c21af8274ff353de562c1037d130791ee4d9f0f9d8a57061e0b4204597c62
...
- *Réduction des risques*. Le widget *Taux de plané vers la cible* aide les pilotes à éviter les situations où atteindre la cible devient impossible en raison d'un taux de plané insuffisant. Cela contribue à réduire les risques et à améliorer la sécurité des vols.
...
| En appuyant | Change *Taux de plané vers la cible* ou *Élévation de la cible*  |
| Appui long | Ouvre le [Menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |


### Taux de plané moyen {#average-glide-ratio}

- Le **taux de plané moyen** indique le taux de plané moyen pour un intervalle de temps spécifié.
...
| Activer | **Android :** *<Translate android="true" ids="shared_string_menu,map_widget_config"/> → Choisir un panneau → Ajouter un widget → Taux de plané* |
|   | **iOS :** *<Translate ios="true" ids="shared_string_menu,layer_map_appearance"/> → Choisir un panneau → Ajouter un widget → Taux de plané* |
| En appuyant | Change *Taux de plané moyen* ou *Vitesse verticale moyenne*  |
| Appui long | Ouvre le [Menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
| En appuyant | Basculer entre le temps restant et l'heure du prochain lever/coucher du soleil. |
| Appui long | Ouvre le [Menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
![Écran Règle de rayon](@site/static/img/widgets/radius_ruler_widget.png)
...
- Pour ajouter des widgets de métriques de véhicule à l'écran de la carte, [activer](../plugins/index.md#enable--disable) le **plugin Métriques de véhicule**.
...
:::note
Pour ajouter des widgets Parking à l'écran de la carte, activez le [**plugin Position de stationnement**](../plugins/parking.md) d'OsmAnd.
:::  

![Widget Parking](@site/static/img/plugins/parking/parking_widget.png)  

Le widget du plugin Parking affiche la distance entre le centre de l'écran et l'emplacement de stationnement. Pour définir un emplacement de stationnement sur la carte, zoomez au niveau requis, puis appuyez longuement sur l'endroit sur la carte pour ouvrir le menu contextuel. Suivez [ces paramètres](../plugins/parking.md#set-a-spot).  

**Remarque :** Le widget Parking n'apparaîtra que si une position de stationnement a été ajoutée à la carte. Sans position de stationnement enregistrée, le widget ne sera pas visible.
...
Il s'agit d'un widget du plugin Mapillary qui permet un accès rapide à l'application Mapillary, ce qui vous permet d'ajouter des [*images au niveau de la rue*](../plugins/mapillary.md#enable-layer). Le widget est ajouté automatiquement à la carte lorsque le plugin est activé.
...
Ce sont des widgets du plugin Notes audio/vidéo qui permettent un accès rapide pour démarrer/arrêter la prise de notes audio, vidéo ou photo.  
...
#### Widgets caméra {#camera-widgets}

<Tabs groupId="operating-systems">

<TabItem value="android" label="Android">

![Widgets position de la caméra](@site/static/img/widgets/camera_position_widgets_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Widgets position de la caméra 2](@site/static/img/widgets/camera_position_widgets_2_ios.png)

</TabItem>

</Tabs>

Les **widgets caméra** vous permettent de surveiller l'alignement entre la carte OsmAnd et la surface de la Terre.
...
| En appuyant | Basculer entre les modes (*Niveau de zoom*)  / Pas de changements (*Autres*) |
| Appui long | Ouvre le [Menu contextuel du widget](../widgets/configure-screen.md#widget-context-menu) |
...
![Widgets Vitesse moyenne](@site/static/img/widgets/available_RAM_2_andr.png)
