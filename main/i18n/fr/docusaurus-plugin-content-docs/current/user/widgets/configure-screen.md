...
Tous les widgets dépendent du [profil](../personal/profiles.md) : chaque profil a sa propre disposition, son propre ordre, sa propre visibilité et ses propres paramètres.
...
- [Widgets capteurs externes](../widgets/info-widgets.md#external-sensors-widgets).  
    L'ensemble permet de suivre les données des capteurs BLE/ANT+ en temps réel.  
...
- [Mapillary](../widgets/info-widgets.md#mapillary-widget).  
    Ouvre l'application Mapillary pour les images au niveau de la rue.

- [Statut OsmAnd Tracker](../widgets/info-widgets.md#tracker-widget).  
...
- [Widget de stationnement](../widgets/info-widgets.md#parking-widget).  
    Distance entre le centre de l'écran et l'emplacement de stationnement enregistré.
...
La fonctionnalité **Mode ligne** vous permet d'ajouter autant de lignes que nécessaire aux panneaux supérieur et inférieur. Vous pouvez afficher plusieurs widgets par ligne, augmentant ainsi la quantité d'informations visibles.
...
Les widgets dans les panneaux droit et gauche peuvent être regroupés en **Pages**. La fonctionnalité **Mode pages** vous permet d'ajouter 5 pages aux panneaux gauche et droit.
...
- **Rayon des coins**. Ajustez ce paramètre pour modifier la forme du bouton, allant de coins nets et carrés à des bords lisses et arrondis.
...
- [Distance par appui](../widgets/radius-ruler.md#distance-by-tap). Permet de mesurer la distance entre votre position et le point sélectionné.
...
- **Réinitialiser par défaut**. Cette fonctionnalité vous permet de réinitialiser tous les paramètres aux valeurs par défaut si vous souhaitez recommencer, ou d'utiliser uniquement les paramètres prédéfinis lors du démarrage d'OsmAnd.
