...
- [Updates for Widgets](#widgets-update):
   ...
   - Added [Glide Ratio](#glide-ratio-widgets) widget.
...
- Updates to [Plan a route](#update-in-plan-a-route-tool) tool.
...
- The OpenPlaceReviews project has been permanently discontinued and is only available now up to Android 4.5. 
- Fixed map freezing for Android Auto, improving the stability of the app.
- Renamed the *Terrain* menu to [*Topography*](https://osmand.net/docs/user/plugins/topography#hillshade-slope-and-altitude-layers) for better understanding and matching terminology.
