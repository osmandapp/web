...
We've added an incredibly useful new [Touch Screen Lock](https://osmand.net/docs/user/map/interact-with-map#touch-screen-lock)  option to the Quick Actions menu that helps you easily lock and unlock the map interface.
