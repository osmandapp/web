...
In this release, we have added the ability to switch between [terrain](https://osmand.net/docs/user/plugins/topography#terrain) color palettes, similar to switching between layers. This can be done using the Quick Actions tool.  
...
The legend provides an easy way to view and understand the different markings on the map. New color palette schemes have been added to display [**speed** for tracks](https://osmand.net/docs/user/map/tracks-on-map/track-appearance#color), [**line type** for routes](https://osmand.net/docs/user/navigation/guidance/map-during-navigation#color), [**altitude and slope** for terrain](https://osmand.net/docs/user/plugins/topography#color-scheme), and all [**weather layer**](https://osmand.net/docs/user/plugins/weather#weather-layers) color palettes.
...
- Default [3D icons](#3d-my-location-icons) for [map rendering Version 2 (OpenGL)](https://osmand.net/docs/user/personal/global-settings/#map-rendering-engine).
...
3D icons are only available for [map rendering Version 2 (OpenGL)](https://osmand.net/docs/user/personal/global-settings/#map-rendering-engine).  
...
Added a new quick action *Show/Hide [Routes on the map](https://osmand.net/docs/user/map/vector-maps#routes)*. Now you can turn on or off routes on the map with one tap.
...
[Layer animations and improved labels](https://osmand.net/docs/user/plugins/weather) make the weather interface more visual and informative. These changes help you better understand current weather conditions and forecasts. Improved label visibility makes navigating weather data much easier.  
...
Updated 3D track visualizations provide a more detailed view of routes.  In this release, we have added the following improvements to the [3D track appearance](https://osmand.net/docs/user/map/tracks/appearance#3d-track). 
...
A new Detailed track guidance setting has been added for the [*Attach to the roads*](https://osmand.net/docs/user/navigation/setup/gpx-navigation#attach-to-the-roads) feature. The options for using the feature are:
...
The new POI [Water (Man made)](https://github.com/osmandapp/OsmAnd/issues/16021) category includes objects with drinking water sources. Searching this [сategories](https://osmand.net/docs/user/search/search-poi#poi-search-by-categories) will help you easily find water on the map when traveling.  
...
- Significant speed improvement for [Attach to roads](https://osmand.net/docs/user/navigation/setup/gpx-navigation#attach-to-the-roads) algorithm.
...
- Updated detailed [Sharing text](https://osmand.net/docs/user/map/map-context-menu/#share) screen for Android 14.
