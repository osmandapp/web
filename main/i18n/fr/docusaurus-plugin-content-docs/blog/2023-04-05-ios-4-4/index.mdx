...
Added ability to [select routes on the map](https://osmand.net/docs/user/map/vector-maps#routes) for viewing additional information or starting navigation by the chosen route. Just tap hiking routes on the map to open the Track Context menu:
