...
# Aktywność nawigacji po mapie {#navigate-map-activity}
Dostępna jest mapa i przełącznik renderowania OpenGL, z długim kliknięciem na widoku mapy (mapView). Po pierwszym dotknięciu wybierany jest punkt początkowy, po drugim dotknięciu wybierany jest punkt końcowy i rozpoczyna się obliczanie trasy.
