...
![Siatka dla przycisków pionowa Android](@site/static/img/widgets/grid_buttons_v_and.png) 

![Siatka dla przycisków pozioma Android](@site/static/img/widgets/grid_buttons_h_1_and.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Siatka dla przycisków pionowa iOS](@site/static/img/widgets/grid_buttons_v_ios.png) 

![Siatka dla przycisków pozioma iOS](@site/static/img/widgets/grid_buttons_h_1_ios.png)
...
Siatka dostosowuje się do otaczającego interfejsu i ponownie pozycjonuje przyciski, gdy jest to wymagane, zapewniając, że pozostają widoczne i nie przeszkadzają innym elementom na ekranie. Gdy widżety lub panele są dodawane, usuwane lub rearrangeowane, układ aktualizuje się odpowiednio, tak aby kolejność przycisków pozostała spójna i żaden element nie został ukryty.

[Profile zaimportowane](https://osmand.net/docs/user/personal/import-export#export) z innego urządzenia są dostosowywane do układu siatki, zachowując poprawne pozycje przycisków na różnych rozmiarach ekranów i platformach.
...
| Pokaż / Ukryj <br/> [**Warstwy pogodowe**](../plugins/weather.md#weather-layers) | Wszystkie dane pogodowe są prezentowane jako oddzielne warstwy mapy. Dzięki Szybkiej akcji możesz uzyskać szybki dostęp do przełączania widoczności tych warstw na mapie. <br/> - ***Warstwa opadów*** <br/> - ***Warstwa chmur*** <br/> - ***Warstwa ciśnienia*** <br/> - ***Warstwa wiatru*** <br/> - ***Warstwa animacji wiatru*** *(tylko Android)* <br/> - ***Warstwa temperatury*** <br/> Na Androidzie istnieje również **Warstwy pogodowe** — główny przełącznik dla wszystkich aktywnych warstw pogodowych. Wyłącza wszystkie obecnie włączone warstwy pogodowe naraz. Po ponownym włączeniu przywraca dokładnie ten sam zestaw warstw, który był aktywny wcześniej. |
| Otwórz <br/> [**Ekran pogody**](../plugins/weather.md) | Otwiera ekran prognozy [*Pogody*](../plugins/weather.md#weather-forecast-screen) ze szczegółowymi informacjami. |
...
| Otwórz <br/> **WunderLINQ Datagrid** | Otwiera interfejs danych WunderLINQ do wyświetlania informacji o podłączonym urządzeniu; przekierowuje do App Store, jeśli wymagana aplikacja WunderLINQ nie jest zainstalowana. |
...
| Dodaj <br/> [**Notatki multimedialne**](../plugins/audio-video-notes.md) | Rozpoczyna nagrywanie notatki audio / foto / wideo dla wybranej (środkowej) lokalizacji na mapie; powtórne naciśnięcie zatrzymuje nagrywanie. |
...
![Urządzenia zewnętrzne](@site/static/img/map/external_custom_2_ios.png)
