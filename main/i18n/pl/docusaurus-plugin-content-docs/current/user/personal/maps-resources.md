...
- ***Zasoby*** (*niebieski*).  
    Obejmuje mapy ([Standardowe](../map/vector-maps.md), &nbsp;[Morskie](../plugins/nautical-charts.md), &nbsp;[Topograficzne](../plugins/topography.md), &nbsp;[Pogodowe](../plugins/weather.md)), &nbsp;[Wikipedia](../plugins/wikipedia.md) i [Przewodniki turystyczne](../plan-route/travel-guides.md), &nbsp;[Aktualizacje na żywo](../personal/maps-resources.md#live-updates), &nbsp;**Tylko drogi**,  &nbsp;[Źródła map](../map/raster-maps.md), &nbsp;[Style renderowania](../map/map-styles.md#default-map-styles), &nbsp;**Czcionki map, &nbsp;Komunikaty głosowe (nagrane i TTS), &nbsp;Pamięć podręczna**.  
...
Dla map standardowych niektóre elementy mogą być pogrupowane według regionu. W takich przypadkach każdy wpis mapy wyświetla zarówno podregion, jak i jego region nadrzędny. Kolejność tych nazw zależy od wybranej metody sortowania: podczas sortowania według nazwy podregion jest wyświetlany jako pierwszy, a następnie region; podczas sortowania według kraju region jest wyświetlany jako pierwszy, a następnie podregion.
...
:::info Pro feature
Aktualizacje na żywo to płatna funkcja [**OsmAnd Pro**](../purchases/index.md) <ProFeature />.
:::
<Tabs groupId="operating-systems" queryString="current-os">
...
![Menu map OsmAnd live iOS](@site/static/img/personal/maps/maps_menu_live_updates_ios.png) ![Menu map OsmAnd live edycja iOS](@site/static/img/personal/maps/maps_menu_live_updates_edit_ios.png)
