...
---
I will translate the document now, following all the rules.
...
## Instalacja OsmAnd (Android) {#install-osmand-android}

Na urządzenia z systemem Android można pobrać **darmową** i **płatną** wersję aplikacji z następujących sklepów:
...
|  Aplikacja  | Google Play | Huawei AppGallery | Darmowa / Płatna |
| :------------- | :------------- | :------------- | :------------- |
| ![Maps+](@site/static/img/svg/osmand_maps.svg) OsmAnd  | ✔ &nbsp;&nbsp;[Zainstaluj](https://play.google.com/store/apps/details?id=net.osmand) | ✔ &nbsp;&nbsp;[Zainstaluj](https://appgallery.huawei.com/#/app/C101486545) | Darmowa |
...
| :------------- | :------------- | :------------- | :------------- |
| ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) Maps+ w aplikacji | ✔ | ✔ | OsmAnd |
| ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) Subskrypcja Maps+ | ✔ | ✔ | OsmAnd |
...
1. **OsmAnd+** i **Maps+** oferują te same funkcje. Jedyna różnica polega na tym, że OsmAnd+ to **oddzielna płatna aplikacja**, podczas gdy Maps+ to **subskrypcja lub zakup w aplikacji**.

2. **Android Auto** jest obsługiwany tylko w aplikacji OsmAnd pobranej z **Google Play**. **Nie jest dostępny** dla Maps+ pobranego z *Huawei AppGallery*.

3. **OsmAnd Pro**, **OsmAnd+** i **Maps+** to zakupy *międzyplatformowe*. Oznacza to, że można je kupić w jednym sklepie (np. *Google Play, Huawei AppGallery, AppStore* i *osmand.net*) i przywrócić w innym, [łącząc zakup z kontem OsmAnd Cloud](../personal/osmand-cloud.md#cross-platform).
...
Poniższa tabela szczegółowo opisuje funkcje zawarte zarówno w darmowych, jak i płatnych pakietach OsmAnd, wraz z ich cenami.

|  | OsmAnd Darmowy | [OsmAnd+](#install-osmand-android) <br/> [Maps+](#install-osmand-android) (w aplikacji i subskrypcja) | [OsmAnd Pro](#install-osmand-android) |
| :------ | :------------- | :------------------ | :------------------ |
...
| [Nielimitowane pobieranie map](../start-with/download-maps.md) | <details><summary>**7 pobrań map**</summary>  - Pobranie lub aktualizacja mapy oznacza tylko pobranie-aktualizację mapy kraju (regionu). <br/> - **Mapa przeglądowa świata**, **Korekta wysokości na świecie**, **Czcionki map** i **Komunikaty głosowe** nie są wliczane do 7 możliwości pobierania. </details> | ✔ | ✔ |
| [Miesięczne aktualizacje map](../personal/maps-resources.md#updates)<br/>Raz w miesiącu (z 2-dniowym opóźnieniem) | <details><summary>**7 pobrań map**</summary> Aktualizacja mapy liczy się jako pobranie.</details> | ✔ | ✔ |
| [Godzinowe aktualizacje map](../personal/maps-resources.md#live-updates)<br/>Aktualizacje na żywo (opóźnienie 1 godzina) - [**](#-map-updates) | **-** | **-** | ✔ |
...
| [Import tras GPX/KML](../personal/tracks/manage-tracks.md#import--export-track) | ✔ | ✔ | ✔ |
...
[Darmowe](../personal/maps-resources.md#free-for-osm-mappers). Aktualizacje na żywo i nieograniczone pobieranie map są dostępne dla maperów OSM.

#### *** Android Auto {#-android-auto}

Funkcja [Android Auto](https://www.android.com/auto/) działa tylko w aplikacjach OsmAnd z [Google Play](https://play.google.com/store/apps/dev?id=8483587772816822023).
...
Subskrypcja **Pro** obejmuje obecnie następujące funkcje:
...
| [Wtyczka Metryki pojazdu (OBD-II)](../plugins/vehicle-metrics.md) | Umożliwia podłączenie skanera OBD-II w celu wyświetlania szczegółowych danych o pojeździe w aplikacji OsmAnd i przechowywania informacji w zapisach tras. Informacje o prędkości pojazdu i prędkości obrotowej silnika są dostępne w darmowej wersji OsmAnd.  |
...
Łatwy sposób na wybranie i zakupienie potrzebnego planu przez menu **Zakupy**. Oczywiście, zobaczysz menu propozycji dla płatnych funkcji.
...
![Maps+](@site/static/img/svg/osmand_maps_plus.svg)  Plan subskrypcji / w aplikacji *Maps+*. Tutaj możesz wybrać roczną subskrypcję lub jednorazową płatność:
...
Aby przywrócić zakup, sprawdź, który plan OsmAnd kupiłeś.
...
- Zaktualizuj aplikację sklepu (Google Play, Huawei AppGallery).
- Zaloguj się na **to samo konto** w sklepie (Google Play, Huawei AppGallery), na którym masz zakup OsmAnd.
...
- *Aby otworzyć Przywracanie zakupów*, wykonaj następujące kroki: *<Translate android="true" ids="shared_string_menu,shared_string_settings,purchases,restore_purchases"/>* i na górze ekranu powinno pojawić się, że Maps+(Pro) jest aktywowane.
- *Zarejestruj funkcje Pro* z subskrypcją OsmAnd Pro dla wszystkich platform (Android i iOS). Jeśli masz konto OsmAnd Pro, musisz go użyć [do aktywacji OsmAnd Pro](../personal/osmand-cloud.md) na swoim urządzeniu.
...
Możesz kupić OsmAnd za pomocą kart podarunkowych Google Play, co stanowi bezpieczną alternatywę dla udostępniania informacji o karcie kredytowej online. Wystarczy kupić kartę podarunkową u wybranego sprzedawcy i zrealizować kod w Google Play.
```