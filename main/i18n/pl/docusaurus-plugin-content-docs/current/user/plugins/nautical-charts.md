...
:::tip Zakup
Wtyczka Widok mapy morskiej jest [płatną funkcją](../purchases/index.md).  
:::
...
Przejdź do: *<Translate ios="true" ids="shared_string_menu,res_mapsres,nautical_maps"/>*  
...
Przejdź do: *Menu → Konfiguruj mapę → Styl mapy → Szczegóły → Szczegóły dna morskiego*
