...
Na Androidzie ta opcja jest dostępna tylko wtedy, gdy wtyczka Topografia jest włączona.  
...
Elementy sterujące **<Translate android="true" ids="shared_string_appearance"/>** określają, jak budynki 3D wyglądają na mapie. Obejmują one dwa ustawienia: Kolor i Widoczność. 

**<Translate android="true" ids="shared_string_color"/>** pozwala zmienić kolor budynku. Po dotknięciu Koloru OsmAnd otwiera oddzielny ekran podglądu, na którym możesz zobaczyć mapę podczas dostosowywania ustawienia. Ekran podglądu pokazuje żywą mapę, dzięki czemu możesz natychmiast zobaczyć, jak wybrany kolor wpływa na budynki.
...
Elementy sterujące **<Translate android="true" ids="performance"/>** określają, jak renderowane są budynki 3D. Obejmują one dwa ustawienia: Poziom szczegółowości i Odległość widoku.
