...
Web 1.03 to najnowsza wersja internetowa OsmAnd, która zawiera nowe przydatne funkcje i ulepszenia. Ten artykuł opisuje wszystkie główne aktualizacje [Planera tras w wersji internetowej](../user/web/index.md).


## Co nowego {#whats-new}

- Przeprojektowanie interfejsu nawigacji
- Obsługa inteligentnych folderów
- Ustawienia wyglądu śladu (kolor i szerokość)
- Przystanki transportu publicznego
- Ulepszenia menu kontekstowego POI
...
- [Eksport GPX jako uproszczony ślad](https://github.com/osmandapp/web/issues/436)
- [Godziny otwarcia wyświetlane w menu kontekstowym POI](https://github.com/osmandapp/web/issues/1277)
- [Przypięte foldery ulubionych](https://github.com/osmandapp/web/issues/1193)
- [Ulepszenia metadanych Wikimedia](https://github.com/osmandapp/OsmAnd-Issues/issues/2959)
- [Ulepszone zachowanie menu warstw](https://github.com/osmandapp/web/issues/918)
- [Wskazówka dotycząca śladu po najechaniu](https://github.com/osmandapp/web/issues/1305)
- [Ulepszenia wyszukiwania danych osobowych](https://github.com/osmandapp/web/issues/1065)
- [Ulepszenia galerii POI](https://github.com/osmandapp/OsmAnd/issues/22671)
- [Ulepszenia wyboru znaczników](https://github.com/osmandapp/web/issues/1297)
- [Ulepszone zachowanie wyszukiwania kategorii POI](https://github.com/osmandapp/web/issues/1126)
- [Ukrywanie wygasłych zakupów na stronie konta](https://github.com/osmandapp/web/issues/1328)
