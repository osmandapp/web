...
**Big Spoiler:** 
- OsmAnd Cloud backup for Favorites, OsmAnd Settings and OSM Notes going free
...
* [Free "OsmAnd Cloud" account (for backup)](#free-osmand-cloud-account-for-backup)
* [New format for Terrain maps and 3D Relief](#terrain-maps-updates)
...
* [Custom routing files](#custom-routing-files-option)
* [Fixed](#fixed)
...
## Free "OsmAnd Cloud" account (for backup)
...
We have added *Terrain map* for countries in [Download maps](https://osmand.net/docs/user/start-with/download-maps) menu. This data type can be used to generate [Slopes, Hillshades (paid)](https://osmand.net/docs/user/purchases/android#free-and-paid-features), and 3D maps ([OsmAnd Pro](https://osmand.net/docs/user/purchases/android#pro-features)).

_OsmAnd menu → Download maps_

Our updates:
- [Slope](https://osmand.net/docs/user/plugins/topography#hillshade-slope-and-altitude-layers) and [Hillshades](https://osmand.net/docs/user/plugins/topography#hillshade-slope-and-altitude-layers) can be generated from _Terrain map_ data
...
- Added ["3D Relief"](https://osmand.net/docs/user/plugins/topography#3d-relief) button ([OsmAnd Pro](https://osmand.net/docs/user/purchases/android#pro-features)) for Terrain menu. It allows you to activate 3D view for relief (offline).
...
["Contour lines"](https://osmand.net/docs/user/plugins/topography#contour-lines-map) function works with any ["Map source"](https://osmand.net/docs/user/map/configure-map-menu):
