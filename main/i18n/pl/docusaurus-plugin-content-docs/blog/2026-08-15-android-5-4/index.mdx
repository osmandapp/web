...
- Roof shapes and custom colorsfor 3D Buildings
...
OsmAnd 5.4 brings several improvements to **Android Auto**, making the map, search, and navigation experience more convenient on the car display.
...
- **More reliable route calculation.** Routing has been improved for cases with outdated or inconsistent offline maps, reducing interruptions and allowing OsmAnd to use an alternative calculation method when needed.  
  [#22987](https://github.com/osmandapp/OsmAnd/issues/22987)
