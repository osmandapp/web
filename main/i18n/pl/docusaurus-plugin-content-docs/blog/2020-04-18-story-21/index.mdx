...
_“It became my default <a href="https://osmand.net/docs/user/navigation/"> navigation</a> app a few years ago. While <a href="https://osmand.net/docs/user/plan-route/"> preparing for a new trip</a> (being it in my own region or a country on the other side of the world), I spend some evenings doing <a href="https://osmand.net/docs/user/map/point-layers-on-map#points-of-interest-pois"> research on the different POIs</a> to visit in this region. After that, I tend to open the cycle map layer on <a href="https://www.openstreetmap.org/"> OpenStreetMap</a> to see if there are any cycling routes nearby. If I can't find any, I try to find alternatives on other websites. If there are cycling trails, I use <a href="https://osmand.net/docs/user/plan-route/travel-guides#prepare-the-files"> the BRouter</a> web app to create a GPX, which I then use in <a href="https://osmand.net/">OsmAnd</a> during my ride.”_

![Story 21](./6.jpg)

From the vast variety of <a href="https://osmand.net/docs/user/">functions</a> Dries regularly uses just three. He adds GPX files to a map, applies <a href="https://osmand.net/docs/user/plugins/osm-editing"> OSM edits</a> to make POI changes, and creates <a href="https://osmand.net/docs/user/personal/favorites"> favorites</a> for all the places to remember.

![Story 21](./7.jpg)

_“Last year during my long bicycle tour I created <a href="https://osmand.net/docs/user/personal/favorites"> favorites</a> for all places we' had slept in, all recommendations received from locals, and our highlights. Furthermore, I also added my notes and changes on, among others, the new border crossing between Kazakhstan & China, one of the very few hotels in the Xinjiang province in China, and a crazy underground bicycle parking in Japan to <a href="https://www.openstreetmap.org/">OpenStreetMap</a>.”_

Dries’ device holds battery up to one day. It might need charging if the app is constantly on, though.

_“That was the case in several long-stretched Japanese cities with many small streets. At the beginning of our journey I also wanted to use <a href="https://osmand.net/docs/user/plugins/trip-recording"> trip recording</a>. That was a bit too battery-consuming on a daily basis, because i knew that I wouldn’t always be able to charge my battery in the evening while camping.”_
