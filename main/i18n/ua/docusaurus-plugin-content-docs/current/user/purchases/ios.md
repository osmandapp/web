...
| [Завантаження карт](../start-with/download-maps.md) |  <details><summary>**5 завантажень карт** <br /> (оновлення карти вважається завантаженням):</summary> <br /> - Завантаження або оновлення карти означає лише завантаження-оновлення карти країни (регіону).<br /> - **Карта світового огляду**, **Корекція висоти світу**, **Шрифти карт** та **Голосові підказки** не враховуються як 5 можливостей для завантаження.</details> | ✔ | ✔ |
