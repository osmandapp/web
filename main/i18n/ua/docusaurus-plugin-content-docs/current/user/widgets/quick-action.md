...
- **Початковий вигляд**. За замовчуванням віджет швидкої дії розміщується в нижньому правому кутку інтерфейсу мапи.
...
| Показати / Приховати <br/> [**Треки**](../personal/tracks/manage-tracks.md#show-tracks-on-map) | Показати або приховати останні видимі треки на мапі. |
| Показати / Приховати <br/> [**POI**](../map/point-layers-on-map.md#points-of-interest-poi) | Увімкнути або вимкнути відображення шарів POI з вибраними категоріями на мапі.<br/>Ви можете вибрати кілька категорій POI. Дія замінює категорії POI, вибрані в Налаштуваннях мапи без використання Швидких дій. |
...
| Показати / Приховати <br/> [**<Translate android="true" ids="osm_notes"/>**](../plugins/osm-editing.md) | Ви можете вибрати відображення або приховання всіх приміток OSM на мапі одним натисканням кнопки. |
...
| Дія | Опис |
|:-------------|:-------------|
| Почати / Призупинити <br/> [**Запис поїздки**](../plugins/trip-recording.md#new-track-recording) | Розпочати запис поточного треку або призупинити, щоб тимчасово зупинити, не завершуючи поїздку. |
...
| Додати <br/> [**Точку треку**](../map/point-layers-on-map.md#track-waypoints) | Додає нову точку треку до [поточного запису треку](../plugins/trip-recording.md) або [будь-якого треку в Моїх місцях](../personal/tracks/manage-tracks.md). <br /> - *Показати проміжний діалог*. Відображає діалог підтвердження. <br /> - *Група*. Додає вибране до вибраної групи. <br /> - *Колір*. Додає вибране з попередньо вибраним кольором <br /> - *Назва*. Додає вибране із зазначеним префіксом назви. |
...
| Додати <br/> [**Медіа-примітки**](../plugins/audio-video-notes.md) | Розпочинає запис аудіо/фото/відео примітки для вибраного (центрального) розташування на мапі. |
| Створити <br/> [**Новий маршрут**](../plan-route/create-route.md) <br /> *Тільки для Android* | Відкриває інструмент [Планування маршруту](../plan-route/create-route.md) та створює маршрут для вибраного (центрального) розташування на мапі. |
