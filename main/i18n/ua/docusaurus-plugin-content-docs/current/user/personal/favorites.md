...
**Вибране** — це функція OsmAnd, яка дозволяє створювати закладки (нотатки) на карті. За замовчуванням ці вибрані точки відображаються як жовті зірочки, але ви можете повністю налаштувати їх за допомогою різних кольорів, форм та іконок. Вибране групується в окремий шар карти, який стає видимим з *6-го рівня масштабування*.
...
- [Шукати](#order--sorting--search) конкретні вибрані або групи.
- [Масові операції](#bulk-edit--delete) — Перейменовувати, переміщувати або видаляти кілька вибраних одночасно.
...
1. Щоб керувати кількома вибраними, натисніть іконку **Видалити** (*іконка кошика на Android*) або кнопку **Редагувати** (*іконка олівця на iOS*).
2. Виберіть окремі вибрані або цілі папки для масових операцій.
...
Використовуйте ***Меню з трьома крапками*** (*Android*) поруч з кожною папкою та ***довге натискання*** (*iOS*) на папку, щоб керувати групами вибраного:

- **<Translate android="true" ids="shared_string_rename"/>** — Використовуйте цю опцію, щоб змінити назву вибраної папки.

- **<Translate android="true" ids="change_default_appearance"/>** — Налаштуйте, як точки вибраного в папці відображаються на карті, змінюючи їх іконки, кольори або мітки.

- **<Translate android="true" ids="shared_string_show_on_map"/>** або **Приховати на карті** — Перемикайте цю опцію, щоб відображати або приховувати точки вибраного з папки на карті.

- **<Translate android="true" ids="shared_string_add_to_map_markers"/>** або **Видалити з маркерів карти** (*лише Android*) — Додайте всі точки вибраного з папки до *Списку маркерів карти* або видаліть їх за потреби для зручного доступу.

- **<Translate android="true" ids="shared_string_share"/>** — Поділіться точками вибраного в папці, експортувавши їх як файл *Favorites.gpx*, що полегшує передачу або резервне копіювання ваших даних.

- **<Translate android="true" ids="shared_string_delete"/>** — Назавжди видаліть вибрану папку вибраного та всі точки в ній.
...
- **Іконка, колір, форма** — Встановіть стандартний стиль для всіх вибраних у групі.
- **Послідовність** — Нові вибрані, додані до групи, автоматично успадковують стандартний вигляд.
- **Налаштування** — Перевизначте стандартні налаштування для існуючих точок у папці, лише для нових вибраних або застосуйте до всіх.
...
[Безкоштовне резервне копіювання вибраного](../personal/osmand-cloud.md#osmand-start) — це спеціальний план покупки, який дозволяє створювати резервні копії ваших вибраних точок (місць) для версій **Android, iOS** або **Web** у додатку OsmAnd та відновлювати їх з OsmAnd Cloud. Цей план доступний для користувачів [OsmAnd Free або Maps+](../purchases/index.md).
...
- **Зберігайте вибрані точки**. Регулярно зберігайте свої вибрані точки в OsmAnd, щоб уникнути їх втрати, якщо ваш пристрій вийде з ладу або додаток буде видалено.
- **Передавайте вибрані точки**. Імпортуйте свої вибрані точки на новий пристрій за допомогою функції *Безкоштовне резервне копіювання вибраного*, якщо ви використовуєте OsmAnd на кількох пристроях.
...
Вам потрібен обліковий запис OsmAnd Cloud, щоб використовувати функцію *Безкоштовне резервне копіювання налаштувань*. Якщо у вас є обліковий запис в *OsmAnd Pro* або активний обліковий запис в *OsmAnd Cloud*, ви не побачите рекламний банер.

- *Банер безкоштовного резервного копіювання вибраного*. Натисніть на цей банер, щоб розпочати процес резервного копіювання.
...
- *[Пакет OsmAnd Start](../personal/osmand-cloud.md#osmand-start)*. Виберіть цю опцію, щоб отримати доступ до функції Безкоштовне резервне копіювання налаштувань.
...
Ви можете експортувати та імпортувати своє вибране за допомогою спеціальних кнопок внизу екрана Вибране. Файл [.gpx](../../technical/osmand-file-formats/osmand-gpx.md) (*favorites.gpx*) можна надіслати до Dropbox, електронної пошти, месенджерів та інших програм, встановлених на вашому пристрої, які підтримують цю функцію.

- Кнопка **Імпорт** (*Android*) / **Імпортувати вибране** (*iOS*). Дозволяє імпортувати вибрані точки (*favorites.gpx*) як шляхові точки з файлу *GPX* (поширений формат даних GPS) зі сховища вашого пристрою.
- Кнопка **Поділитися** (*Android*) / **Експортувати вибране** (*iOS*). Дозволяє експортувати (поділитися) всіма вашими вибраними як файл *favorites.gpx*.
...
- Виберіть кнопку **Поділитися**, щоб надіслати файл *Favorites.gpx* до пам'яті вашого пристрою або поділитися ним через програми для обміну повідомленнями.
...
- **iOS**: Файли знаходяться в *Файли → На моєму iPhone → OsmAnd Maps → favourites_backup*.
