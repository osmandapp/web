...
### الإصدار 5.3 {#version-53}

تاريخ الإصدار 04/2026:

- مكون إضافي فلكي مع طبقة فلكية تعرض مسارات الشمس والكواكب والنجوم على الخريطة.
- تخطيط أكثر مرونة للأدوات وأزرار الخريطة.
- مبانٍ ثلاثية الأبعاد.
- عرض الكرة الأرضية.
- أدوات تسجيل الرحلة الجديدة: متوسط السرعة وزمن الحركة.
- أداة عداد السرعة مع مؤشر مرئي لتجاوز السرعة وتحذير التفاوت وحالات تجاوز الحد.
- محرر لوحة ألوان جديد لإنشاء وتعديل مخططات ألوان مخصصة للمسارات وتصور التضاريس.
- تحسين توجيه الدراجات مع مراعاة عرض الدراجة.
...
- تنسيط جديد لخرائط التضاريس مع دعم الإغاثة ثلاثية الأبعاد.
...
- قائمة "المظهر" الجديدة للمسارات: اختر اللون، السمخ، عرض أسهم الاتجاه، أيقونات البدء/الانتهاء
...
<Download link="net.osmand-0.6.5%20beta-45.apk" />