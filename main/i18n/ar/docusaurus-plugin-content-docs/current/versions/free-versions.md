...
- أداة معلومات المسار الحالي: تعرض وقت الوصول المتوقع، ووقت الوصول، والمسافة
- حدد مسارات التزلج ومسارات الدراجات الجبلية على الخريطة للحصول على معلومات مفصلة
- إمكانية تحديد حجم الأداة للوحات اليسرى واليمنى
- تمت إضافة "شبكة الإحداثيات" مع الإحداثيات الجغرافية
- تمت إضافة إمكانية تخصيص المظهر الافتراضي لمجموعات المفضلة
- أندرويد أوتو: عرض وقت الوصول المتوقع والمسافة إلى نقطة الطريق التالية؛ تظهر أسماء المدن الآن في نتائج البحث
- أصبحت القمم البارزة قابلة للاكتشاف عبر الخريطة والبحث
...
- تم تنفيذ إجراءات سريعة جديدة لتسجيل الرحلات وقفل شاشة اللمس.
...
- التبديل إلى ورقة مشاركة النظام بدءًا من Android 14.
...
- أداة "عداد السرعة" الجديدة متوافقة مع Android Auto.
...
- تمت إضافة فلاتر بواسطة بيانات المستشعر للمسارات.
...
- Android Auto: تمت إضافة وضع ثلاثي الأبعاد وشاشة بحث محسنة.
...
- OsmAnd Cloud: الآن يمكنك الوصول إلى الملفات المحذوفة.
- تحسين تلوين المسار في وضع الميل مع تدرج متماثل جديد.
- تم حل المشكلات المتعلقة بشريط الحالة الشفاف.
- تمت إضافة دعم لأداة درجة الحرارة ANT+.
- تم تقديم أداة "ذاكرة الوصول العشوائي المتاحة".
...
- Android Auto: قائمة بدء جديدة للوصول إلى المفضلة والمسارات وفئات نقاط الاهتمام.
...
- تمت إضافة خيار "الإعلان عن الانحراف عن المسار".
- شاشة البدء: تمت إضافة خيار استعادة حالة OsmAnd من ملف.
- تمت إضافة فئات "المواد الخطرة" للملاحة بالشاحنات في أمريكا الشمالية.
- تمت إضافة دعم "Via ferrata" للتوجيه للمشاة.
...
- إمكانية الوصول: تم تغيير حجم هدف اللمس للأزرار إلى 48dp؛ تم إصلاح مشكلة رؤية واجهة مستخدم الخريطة لقارئات الشاشة.
...
- شاشة بدء مبسطة
- تم إصلاح موضع الموقع في وضع الشاشة المقسمة في Android Auto
- تمت إضافة رسم بياني "السرعة/الميل" لتحليل المسار
- تم نقل اختيار لغة التطبيق إلى إعدادات النظام في Android 13
- تم إصلاح المشكلات المتعلقة بعرض الأماكن النباتية
- تمت إضافة إمكانية تنزيل البلاط عبر الإنترنت المستخدم كخرائط "تراكب" أو "تغطية"
- تمت إضافة دعم لوحدات القياس الإمبراطورية لـ "معلمات المركبة"
- ملف تعريف جديد للدراجة البخارية
- "عرض الموضع" تمت إضافة خيار جديد "تلقائي"
- تم إصلاح إيماءات الخريطة للإمالة والتكبير والتصغير والدوران
...
- إعادة تصميم الأدوات: مظهر وإحساس جديد، تجميع حسب الصفحات، تغيير الترتيب والجمع كما تريد.
...
- تمت إضافة دعم مبدئي لـ Android Auto
- تحديث واجهة المستخدم للبحث عن إحداثيات UTM
- فلتر GPS لمسارات GPX
- أداة الارتفاع (Pro)
- المفضلة: تمت إضافة إمكانية عرض الأيقونات المستخدمة مؤخرًا
...
- تمت إضافة وضع الليل لنمط عرض التضاريس
...
- تخطيط المسار: رسوم بيانية لأجزاء المسار مع المسار، وتمت إضافة إمكانية إنشاء وتحرير أجزاء مسار متعددة.
- تمت إضافة طريقة مصادقة OAuth لـ OpenStreetMap، وتم تحسين واجهة مستخدم مربعات حوار OSM.
...
- تخصيص ترتيب العناصر في القائمة السياقية، وتكوين الخريطة، والدرج
...
- تمت إضافة رقم الخروج في التنقل
...
- تمت إضافة إمكانية تغيير ترتيب أو إخفاء فئات نقاط الاهتمام في البحث
...
- تم إصلاح المناطق المغمورة بالمياه حول العالم
...
- ملفات تعريف التطبيق: أنشئ ملفًا شخصيًا مخصصًا لاحتياجاتك الخاصة، مع أيقونة ولون مخصصين
...
- تحسين تنزيل الخرائط في الخلفية
...
- شاشة اتجاهات جديدة: تعرض أزرار وجهة المنزل والعمل، واختصار المسار السابق، وقائمة المسارات النشطة، وسجل البحث
...
- تم إصلاح المناطق المغمورة بالمياه في ألمانيا، جنوب إفريقيا، كيبيك
...
- تم إصلاح العطل عند بدء التشغيل الذي حدث مع الخرائط غير اللاتينية
- تحسين مشكلات سرعة العرض على أجهزة Android 8.0
- دعم تحرير كائنات المضلع (غير المرافق)
- قياس المسافة: أضف زر قياس إلى الإجراءات في القائمة السياقية
...
- التنقل بالقارب: دعم مجرى الملاحة المائية
...
- علامات الخريطة: استيراد المجموعات المحددة من ملفات GPX، مظهر جديد لإدخال الإحداثيات
...
- تم تحديث القائمة السياقية: تظهر متى تفتح / تغلق نقطة الاهتمام
...
- أداة المسطرة لقياس المسافات المباشرة على الخريطة
...
- قائمة بحث محسنة. بحث تقليدي خطوة بخطوة مدمج مع البحث الحديث
...
- نمط خريطة Topo. نمط جديد تمامًا للمتنزهين والسياح
...
- تكامل نظام صوت السيارة. استخدم نظام صوت سيارتك للملاحة الصوتية
- معلومات أفضل عن النقل العام. عرض مسارات النقل العام الكاملة المرتبطة بالمحطات
- تحسينات أخرى. توجيه صوتي أفضل، مؤشر مسار انعطاف جديد، وإصلاحات التخزين
...
- بيانات ويكيبيديا جديدة، يتم تنزيلها الآن حسب البلد، وببيانات أكثر اكتمالاً
- إعادة حساب مسار أفضل (بعد محاولات متكررة، يقترح المحرك مسارًا مختلفًا)
...
- إعادة حساب توجيه أفضل (بعد عدة محاولات، يقترح المحرك مسارًا مختلفًا)
...
- تحديد الطرق كغير سالكة (لكل جلسة)
- دعم مسارات الانعطاف
...
- يقوم OsmAnd الآن بتمكين خدمة وضع السكون لنظام تحديد المواقع العالمي (GPS) تلقائيًا إذا تم تنشيط التنقل أو تسجيل الرحلة، بحيث يستمر هذا في العمل أثناء إيقاف تشغيل شاشة الجهاز. فقط إذا رغبت في ذلك، لا يزال من الممكن مقاطعة خدمة وضع السكون لنظام تحديد المواقع العالمي (GPS) يدويًا أو تكوينها عبر النقر على أداة "حالة نظام تحديد المواقع العالمي (GPS)".
...
- مراقبة حية متقدمة
- بث موقعك لأصدقائك وشاهد مواقعهم على الخريمة
...
- حساب المسار بين نقاط المسار لـ GPX
...
- ميزة تكبير الخريطة (نقرة طويلة على زر التكبير) - مفيدة لكل من خرائط البلاط والخرائط المتجهة
- تحديد/تحرير مصادر بلاط الإنترنت المخصصة (وتحديد وقت انتهاء الصلاحية)
...
- المزيد من إمكانيات الإشارة الصوتية (الإعلان عن أسماء الشوارع)
- أيقونات خرائط عالية الكثافة
- إصلاحات الأخطاء في عرض المسافة، ومحلل GPX، ومعالجة نقاط الطريق، وأداة التخطيط، وتحميل OSM، و https.
...
- ترتيب نقاط الطريق بأفضل طريقة لزيارة الجميع (بائع متجول، من الباب إلى الباب)
...
- دعم النوافذ المتعددة لأجهزة Samsung الحديثة
- فلتر كالمان للبوصلة
...
- تحسين مكون الصوت/الفيديو الإضافي (صور بمعلومات EXIF)
- تم إصلاح سهولة الاستخدام وإعادة هيكلة مكون خطوط الكنتور الإضافي
...
- تمكين خدمة الحفاظ على تشغيل GPS أثناء التنقل.
...
- مكون إضافي لمواقف السيارات ("أين سيارتي متوقفة؟")
- نقاط الطريق
- توجيه مسار محسّن
- إعداد تجنب الطرق السريعة أثناء التنقل
- أدوات خريطة ديناميكية
- زر قفل الشاشة مع خدمات التسجيل
- دعم اللغات العربية، الكانادا، ولغات RTL
...
- اكتشاف الاتجاه: يتم الإشارة إلى "القيام بدوران للخلف" والإعلان عنه عند التوجه في الاتجاه المعاكس أو بعد تفويت منعطف
...
- تنفيذ البحث عن نقاط الاهتمام بالاسم في مناطق كبيرة (البلدان)
- مدير البيانات دون اتصال بالإنترنت (تنزيل، حذف، تفعيل / تعطيل البيانات دون اتصال بالإنترنت مباشرة في OsmAnd)
...
- محرك تحويل النص إلى كلام للملاحة الصوتية
