...
تحتوي بعض المسارات على الكثير من البيانات المشوشة التي تحتاج إلى تصفية أولاً. في الوقت الحالي، نطبق التصفية على جميع المسارات، ولكن المسارات المعدة مثل تلك التي تم إنشاؤها بواسطة 
أداة تخطيط المسار، أو أداة الملاحة، أو بعد تصحيح SRTM، لا ينبغي أن يكون للتصفية أي تأثير.
...
2. استخدام الطرق القريبة (الارتباط بالطرق)
