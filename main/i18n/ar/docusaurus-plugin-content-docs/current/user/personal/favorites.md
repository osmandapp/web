...
تتيح خيار **تغيير مظهر المجموعة** تعيين نمط افتراضي لجميع المفضلة في مجلد. يمكنك تعديل المعلمات التالية:
...
توفر هذه المرونة إمكانية توحيد مظهر مجلد أو الحفاظ على تخصيصات فريدة مع تعيين الافتراضيات للنقاط الجديدة.
