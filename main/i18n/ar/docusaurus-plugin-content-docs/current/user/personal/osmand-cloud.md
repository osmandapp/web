...
- يعمل النسخ الاحتياطي التلقائي تقريبًا كل ساعة أثناء عمل OsmAnd في المقدمة. هذه الفترة غير قابلة للتعديل حاليًا في التطبيق. يمكن تغييرها عن طريق استيراد ملف .osf.
- يمكن أن يبدأ النسخ الاحتياطي التلقائي عند فتحك أو العودة إلى شاشة الخريطة.
- بالإضافة إلى التشغيلات المجدولة، يمكن أن يبدأ النسخ الاحتياطي التلقائي أيضًا بعد تغييرات في بعض أنواع البيانات (على سبيل المثال، المفضلة)، باستخدام أنواع النسخ الاحتياطي المفعلة في إعدادات النسخ الاحتياطي التلقائي.
