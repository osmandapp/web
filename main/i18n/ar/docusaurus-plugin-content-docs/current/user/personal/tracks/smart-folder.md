...
- **<Translate android="true" ids="organize_by"/>** — تنظيم المسارات في المجلد الذكي تلقائيًا إلى مجموعات بناءً على معلمة محددة. تشمل أنواع التجميع المتاحة *عام*، *التاريخ والوقت*، *الموقع*، *السرعة*، *الارتفاع والارتفاع*، و*بيانات المستشعر*. 
