...
## [الخرائط المتجهة](./vector-maps.md) {#vector-maps}
...
## [أنماط الخرائط (الخرائط المتجهة)](./map-styles.md) {#map-styles-vector-maps}

تحدد أنماط الخرائط كيفية عرض بيانات الخريطة المتجهة في OsmAnd. يتحكم النمط في المظهر البصري لكائنات الخريطة مثل الطرق، والمباني، واستخدام الأراضي، والمياه، ونقاط الاهتمام، بما في ذلك الألوان، وأنماط الخطوط، والتسميات.
