...
يوفر OsmAnd لك العديد من أنماط الخريطة وطبقات البيانات التي تتناسب مع الإعدادات الافتراضية. يصف هذا القسم الرئيسي منها لوضعي النهار والليل.
...
نمط عرض الخريطة القياسي في OsmAnd يوازن بين التفاصيل والبساطة، مما يجعله مثاليًا للاستكشاف الحضري والخارجي. يوضح تفاصيل ميزات المدينة مثل الشوارع، والمباني، ومحطات النقل بينما يبسط الفوضى البصرية بجعل الخرائط أوضح.  
...
![نمط الخريطة البحري](@site/static/img/map/map-style-nautical.png)
...
![نمط الخريطة البحري المتقدم](@site/static/img/map/map-style-marine.png)
...
### الدراجة الثلجية {#snowmobile}

![نمط خريطة الدراجة الثلجية](@site/static/img/map/map-style-snowmobile.png)

مخصص لملاحة الدراجة الثلجية، يبرز هذا النمط المسارات، والطرق، والتراكات المناسبة للدراجة الثلجية. يبرز المسارات المتخصصة في المناطق الثلجية، مما يقدم ملاحة واضحة عبر التضاريس المغطاة بالثلج حيث قد لا تكون الطرق القياسية متاحة. 
