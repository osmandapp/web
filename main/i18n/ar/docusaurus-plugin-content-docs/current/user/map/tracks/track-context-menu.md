...
- **<Translate android="true" ids="follow_track"/>** (*أندرويد*) / **<Translate ios="true" ids="shared_string_navigation"/>** (*iOS*) – تبدأ [الملاحة حسب المسار](../../navigation/setup/gpx-navigation.md)، مع محاذاة مسارك مع المسار المحدد.
...
- **<Translate android="true" ids="upload_to_openstreetmap"/>** - [تحميل](../../plugins/osm-editing.md#upload-gps-track) المسار المحدد إلى OpenStreetMap.
...
- **<Translate android="true" ids="shared_string_gps_filter"/>** (*أندرويد فقط*) - يسمح [بتصفية نقاط المسار](#gps-filter) لتحسين الدقة.
- **<Translate android="true" ids="altitude_correction"/>** (*أندرويد فقط*) - [لاستقبال بيانات الارتفاع](#calculate-missing-elevation)، [ربط مسارك بالطرق](../../navigation/setup/gpx-navigation.md#attach-to-the-roads) أو حسابها دون اتصال (مطلوب [خرائط التضاريس](../../plugins/topography.md#download-maps)).
...
يعرض هذا القسم من علامة التبويب *نظرة عامة* ***بيانات العلامات*** و***جميع المعلومات العامة***.

- **الوصف**. زر *<Translate android="true" ids="shared_string_edit"/>* (*أندرويد*) / *<Translate ios="true" ids="context_menu_edit_descr"/>* (*iOS*) يستخدم لتحرير وصف المسار. علامة `desc`.
...
- [علامات النشاط لمسارات GPX](../../plugins/trip-recording.md#recording-settings). عند تسجيل مسار GPX، يمكنك تعيين نوع نشاط. يساعد هذا الوسم على تصنيف المسارات مبدئيًا.
- [مرشح النشاط](../../personal/tracks/smart-folder.md#search-filter). يمكنك تصفية مسارات GPX المسجلة حسب النشاط، مما يتيح لك التركيز على العثور على أنواع محددة من التسجيلات، مثل جميع مسارات ركوب الدراجات أو المشي لمسافات طويلة.
...
- **قائمة الأنشطة**. يتم تحديد فئات ومجموعات الأنشطة في موارد OsmAnd. للمطورين والمساهمين، يتم الاحتفاظ بقائمة الأنشطة بتنسيق منظم في [activities.json](https://github.com/osmandapp/OsmAnd-resources/blob/master/poi/activities.json)، والذي يوضح تفاصيل مجموعات وأنواع الأنشطة المتاحة.
...
- ***وضع نقطة على الرسم البياني***. إذا كنت ترغب في رؤية المعلومات عند نقطة معينة من المسار، يمكنك النقر في أي مكان على الرسم البياني وسيظهر مؤشر مع القيم. في نفس الوقت، ستظهر علامة زرقاء على الخريطة، تشير إلى هذا الموقع على المسار.
...
![قائمة سياق المسار رسوم بيانية أندرويد](@site/static/img/personal/tracks/track_menu_graph_1_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![قائمة سياق المسار رسوم بيانية iOS](@site/static/img/personal/tracks/track_menu_graph_2_ios.png)
...
- زر **<Translate android="true" ids="shared_string_options"/>** يفتح قائمة تحتوي على:
  ...
  - *حذف* يسمح لك بإزالة العنصر المحدد من المسار.
...
- *<Translate android="true" ids="max_speed"/>*. يظهر أقصى سرعة أثناء الرحلة.
- *<Translate android="true" ids="moving_time"/>*. يظهر إجمالي الوقت أثناء الرحلة في الحركة فقط.
...
3. إذا كنت تنشئ مسارًا باستخدام أداة [تخطيط مسار](../../plan-route/create-route.md#graph) باستخدام طريقة *الخط المستقيم* ولا توجد بيانات ارتفاع على الرسم البياني، فستحتاج إلى:
...
![قائمة سياق المسار نقاط أندرويد](@site/static/img/personal/tracks/track_context_points_android.png)

</TabItem>

<TabItem value="ios" label="iOS">

![قائمة سياق المسار نقاط iOS](@site/static/img/personal/tracks/track_context_points_ios.png)
...
- استخدم [قائمة سياق الخريطة](../../map/map-context-menu.md#-add--edit-track-waypoint--add--edit-track-waypoint).
  - تظهر نقاط الطريق تلقائيًا إذا تم تمكين المسار المحدد على الخريطة.
...
2. **اختر** المجموعة.
    ...
    - اختر فئات المجموعات التي تم إنشاؤها مسبقًا أو أنشئ واحدة جديدة.
...
3. إعداد **المظهر**:
    ...
    - اختر [**رمزًا**](../../personal/favorites.md#favorite-icons) من قائمة جميع رموز فئات نقاط الاهتمام.
    - اختر **لون** الرمز.
    - ثم اختر **شكل** الرمز: *دائرة، مثمن، مربع*.
...
![قائمة المسار قائمة المجموعة أندرويد](@site/static/img/personal/tracks/track_menu_group_menu_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![قائمة المسار قائمة المجموعة iOS](@site/static/img/personal/tracks/track_menu_group_menu_ios.png)

</TabItem>

</Tabs>

تفتح *قائمة النقاط الثلاث* ( &#8285; ) *قائمة مجموعة* نقطة الطريق.

**الإجراءات:**

- **<Translate android="true" ids="shared_string_show_on_map"/>** - يسمح لك بعرض أو عدم عرض نقاط طريق المجموعة على الخريطة. أو يمكنك استخدام [زر الشاشة](#points--waypoints) لعرض أو حذف نقاط طريق المجموعة على الخريطة.
...
![قائمة المسار مجموعة الخريطة أندرويد](@site/static/img/personal/tracks/waypoints_group_map_android.png) ![قائمة المسار مجموعة الخريطة أندرويد](@site/static/img/personal/tracks/waypoints_group_map_1_android.png)

</TabItem>

<TabItem value="ios" label="iOS">

![قائمة المسار مجموعة الخريطة iOS](@site/static/img/personal/tracks/waypoints_group_map_ios.png) ![قائمة المسار مجموعة الخريطة iOS](@site/static/img/personal/tracks/waypoints_group_map_1_ios.png)
...
يمكنك تشغيل أو إيقاف نقاط طريق المجموعة على الخريطة باستخدام الزر في الزاوية العلوية اليمنى من قائمة سياق المسار على الخريطة. انقر عليه وحدد الإجراء المطلوب.
...
| الإضافة | الوصف |
| --- | --- |
| `osmand:icon` | **الرمز** هو اسم الرمز الذي اخترته. |
| `osmand:color` | **اللون** هو اللون بتنسيق HEX. |
| `osmand:background` | **الخلفية** هي شكل الرمز، مثل دائرة، مثمن، أو مربع. |
...
**علامات المرافق** التي تصف معلومات إضافية، مثل ساعات العمل أو رقم الهاتف، خاصة بنقطة الاهتمام، تأخذ تلك المعلومات من بيانات OpenStreetMap أو البيانات التي أدخلتها عند إنشاء نقطة الاهتمام. يمكنك تحرير هذه العلامات و[العلامات المخصصة](#display-custom-gpx-tags) فقط في رمز ملف GPX، والذي يمكنك فتحه بأي محرر نصوص على جهازك.
...
يمكنك تقسيم المسار إلى فواصل زمنية، مثل المسافة والوقت، وتحليله.
...
![شاشة مرشح GPS أندرويد](@site/static/img/personal/tracks/gps_filter_android.png)
...
يسمح لك هذا المرشح بتحسين إحصائيات مسارك عن طريق استبعاد البيانات غير الضرورية أو غير الصحيحة. يمكنك تصفية نقاط المسار التي لا تتناسب مع معلمات مسارك، ونتيجة لذلك، الحصول على رسم بياني أكثر دقة وخط مسار مرئي بدون تشويه أو ضوضاء تسجيل. يمكنك إجراء تغييرات باستخدام مرشحات مثل *التنعيم* و*السرعة* و*الارتفاع* و*دقة GPS*، والتي تخفي النقاط المصفاة من المسار الحالي. بالإضافة إلى ذلك، في قائمة *الإحصائيات*، يمكنك التحقق من كيفية عرض تغييراتك على الرسم البياني قبل حفظها. يمكنك أيضًا *إعادة التعيين إلى الأصل* و*الحفظ كنسخة* من مسارك في هذا المرشح دون حفظ المسار الأصلي.
...
تتضمن صفحة تطبيق مرشح GPS لنظام أندرويد ما يلي:
...
- كتل *المرشح*، *الإحصائيات*، *الإجراء*.


### قائمة المرشح {#filter-menu}

في هذه القائمة، يمكنك تغيير بعض معلمات مسارك مثل *التنعيم*، *السرعة*، *الارتفاع*، أو *دقة GPS* باستخدام المرشحات. تنقسم القائمة إلى *جزء النقاط* و*جزء الإجراءات*.

| ***النقاط*** |
|:------------|
|يعرض هذا الجزء عدد النقاط بعد التصفية والعدد الإجمالي للنقاط على المسار المحدد قبل استخدام المرشحات.|
|![أرقام نقاط شاشة مرشح GPS أندرويد](@site/static/img/personal/tracks/gps_filter_points_numbers_android.png) |
| ***الإجراءات*** |
|*التنعيم*. يحدد مسافة العتبة بين النقاط. يتم إخفاء نقاط المسار التي تبعد على الأقل هذه المسافة عن آخر نقطة مرئية. سيتم إخفاء جميع النقاط على المسار، التي تبعد عن بعضها البعض مسافة أقل من المسافة المحددة بواسطة المرشح. يتم حساب نقاط المسار من آخر نقطة مرئية. لاحظ أن العتبات العالية يمكن أن تبسط هندسة المسار بشكل مفرط.|
|![أرقام تنعيم مرشح GPS أندرويد](@site/static/img/personal/tracks/gps_filter_smoothing_android.png) |
|*السرعة*. يتم عرض نقاط المسار التي تتوافق مع فاصل السرعة المحدد فقط على الرسم البياني والخريطة، ويتم إخفاء الأخرى.|
|![أرقام سرعة مرشح GPS أندرويد](@site/static/img/personal/tracks/gps_filter_speed_android.png) |
|*الارتفاع*. يتم عرض نقاط المسار التي تتوافق مع فاصل الارتفاع المحدد فقط على الرسم البياني والخريطة، ويتم إخفاء الأخرى.|
|![أرقام ارتفاع مرشح GPS أندرويد](@site/static/img/personal/tracks/gps_filter_altitude_android.png) |
|*دقة GPS*. يحدد القيمة القصوى المسموح بها لـ HDOP. يتم إخفاء النقاط ذات القيمة الأعلى.|
|![أرقام دقة مرشح GPS أندرويد](@site/static/img/personal/tracks/gps_filter_precision_android.png) |


### الإحصائيات {#statistics}

![رسم بياني لمرشح GPS أندرويد](@site/static/img/personal/tracks/gps_filter_graph_statistics_andr.png)

تعرض علامة تبويب الإحصائيات معلومات حول المسار **المعدّل**، أي المسار بدون القيم المصفاة. يتم عرضها في كتل الإحصائيات وبيانات الرسم البياني.

- يعرض جزء *البيانات* إحصائيات مشابهة [لقائمة المرشح](#filter-menu).
...
![إجراء مرشح GPS أندرويد](@site/static/img/personal/tracks/gps_filter_action_android.png)

تتوفر قائمة الإجراءات في الجزء السفلي من علامة التبويب **المرشح** أو **الإحصائيات**. يطبق OsmAnd جميع التغييرات التي تم إجراؤها على المسار دون تحديث الملف، ولكن يمكنك حفظ التغييرات يدويًا.
...
- [مكون Trip Recording الإضافي](../../plugins/trip-recording.md)
- [تحليل على الخريطة](../index.md#analyze-track-on-map)
