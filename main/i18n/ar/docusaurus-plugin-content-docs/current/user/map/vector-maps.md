...
- **لون الشبكة:** متاح بشكل منفصل للوضع النهاري/الليلي. تخصيص لون الشبكة هو ميزة مدفوعة [متاحة في Maps+ (شراء داخل التطبيق أو اشتراك) وOsmAnd+](https://osmand.net/docs/user/purchases/).
