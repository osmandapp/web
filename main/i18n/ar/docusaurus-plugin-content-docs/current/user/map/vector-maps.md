...
:::info ملاحظة
قد تُبسط أو تُشوه المضلعات الصغيرة جدًا أثناء إنشاء بيانات الخريطة. قد لا تُعرض الكائنات ذات المساحة الأصغر من متر مربع تقريبًا. للتصور الصحيح، يجب رسم الميزات الصغيرة كنقاط فردية بدلاً من المضلعات.
:::
...
![نمط خريطة طبوغرافي](@site/static/img/map/map-style-topo.png)
...
إذا لم تكن الأسماء على الخريطة مترجمة إلى اللغة المطلوبة من قبل مجتمع OSM، يمكنك استخدام [الأسماء المترجمة حرفيًا](https://en.wikipedia.org/wiki/Transliteration): *<Translate android="true" ids="use_latin_name_if_missing"/>* (أندرويد) أو *<Translate ios="true" ids="translit_names"/>* (iOS).
