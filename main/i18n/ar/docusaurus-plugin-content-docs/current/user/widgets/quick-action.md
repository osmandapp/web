...
:::info note
بعض الإجراءات مثل *مصدر الخريطة*، *نمط الخريطة*، *الطبقة العلوية*، *الطبقة السفلية*، *نظام ألوان التضاريس*، و*إضافة ملف شخصي* يمكن تعيينها كحلقة. يتغير كل نقرة على الزر عبر الطبقات المحددة. يمكن إظهار مربع حوار مؤقت للاختيار يدويًا من القائمة، أو إخفاؤه للتبديل بالترتيب المحدد.
:::
