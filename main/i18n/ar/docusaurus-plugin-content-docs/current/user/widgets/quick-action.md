...
عنصر واجهة المستخدم التفاعلي "الإجراء السريع" (Quick Action) هو عنصر واجهة مستخدم تفاعلي يوفر وصولاً سريعًا إلى الوظائف أو الإجراءات الرئيسية دون الحاجة إلى فتح إعدادات إضافية. يتم وضع هذه الأداة على شاشة الخريطة الرئيسية وتسمح بتبسيط وتسريع التفاعل مع التطبيق، مما يجعله أكثر ملاءمة وفعالية.
...
![أداة الإجراء السريع_أندرويد_إضافة](@site/static/img/widgets/quick_action_widget_andr.png) ![زر مخصص أندرويد](@site/static/img/widgets/add_action_screen_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

انتقل إلى: *<Translate ios="true" ids="shared_string_menu,layer_map_appearance,configure_screen_quick_action"/> ← انقر على تعديل (أيقونة القلم في الزاوية العلوية اليمنى) ← حدد الإجراءات*

![أداة الإجراء السريع_iOS_إضافة](@site/static/img/widgets/quick_action_widget_2_ios.png) ![زر مخصص أندرويد](@site/static/img/widgets/add_action_screen_ios.png)

</TabItem>

</Tabs>

جميع الإجراءات منظمة في قائمة **إضافة إجراء** ومجمعة حسب النوع. يمكن العثور على قائمة كاملة بالإجراءات ووصفها في قسم [أنواع الإجراءات](#action-types).

يمكنك تعيين إجراء واحد أو أكثر [إجراءات](#action-types) لزر الإجراء السريع. هناك طريقتان لإضافة الإجراءات.

- **في شاشة التكوين**. حدد زرًا من القائمة، ثم انقر على زر "**＋**". تحتاج إلى تحديد [نوع الإجراء](#action-types) أولاً، ثم تغيير اسمه و[معلماته](#actions-in-loop).
- **في لوحة زر الإجراء السريع**. انقر على *زر الإجراء السريع* على شاشة الخريطة. في نهاية القائمة، في الشاشة الأخيرة في اللوحة، يوجد مربع "**＋**" *إضافة إجراء*. انقر عليه وحدد إجراءً من [قائمة الأنواع](#action-types).


:::note

- يجب أن يكون لكل إجراء اسم فريد.
- يتم إنشاء الشاشات، المسماة رقميًا الشاشة 1، الشاشة 2، إلخ، تلقائيًا عندما يزداد عدد الإجراءات في القائمة إلى 6 عناصر.
...
![أداة الإجراء السريع_أندرويد_ترتيب](@site/static/img/widgets/quick_action_widget_android_order.png)

</TabItem>

<TabItem value="ios" label="iOS">

![أداة الإجراء السريع_iOS_ترتيب](@site/static/img/widgets/quick_action_widget_ios_order.png)
...
- انقر على *تعديل* (أيقونة القلم)، ثم *اضغط مع السحب* على أيقونة الخطوط العمودية الثلاثة لإعادة ترتيب الإجراءات.

#### الإجراءات في حلقة {#actions-in-loop}

![زر مخصص أندرويد](@site/static/img/widgets/actions_in_loop_andr.png)

بالنسبة لبعض الإجراءات، يمكنك تعيين قائمة من الطبقات التي ستتغير في دائرة مع كل نقرة: *مصدر الخريطة*، *نمط الخريطة*، *تراكب*، *أسفل*، *نظام ألوان التضاريس*، *إضافة ملف تعريف*.
...
تظهر أداة *الإجراء السريع* في الزاوية السفلية من شاشة الخريطة عند تمكينها لأول مرة. يمكنك نقل الأداة إلى أي جزء من الشاشة عن طريق الضغط مع السحب. لوضع الأزرار بدقة على شاشة الخريطة، يتم محاذاتها تلقائيًا إلى أقرب موضع شبكة غير مرئية عند سحبها.

- **المظهر الأولي**. بشكل افتراضي، يتم وضع أداة الإجراء السريع في الزاوية اليمنى السفلية من واجهة الخريطة.

    ![عرض أداة الإجراء السريع](@site/static/img/widgets/quick_action_widget_view.png)

- **نقل الأداة**. بالضغط مطولاً وسحب الأداة، يمكنك إعادة وضعها على الشاشة، مع محاذاة تلقائية للأعمدة والصفوف.

    ![نقر أداة الإجراء السريع](@site/static/img/widgets/quick_action_widget_tap.png)
...
- **أزرار مخصصة متعددة [أزرار مخصصة](#custom-buttons)**. يمكنك إضافة أزرار إجراء سريع متعددة إلى شاشة الخريطة. يمكن أيضًا تخصيص هذه الأزرار وإعادة وضعها بشكل فردي باستخدام نفس طريقة السحب والإفلات.
...
![زر مخصص أندرويد](@site/static/img/widgets/custom_button_ios.png)
...
للحصول على إعدادات التخصيص التفصيلية، ارجع إلى مقالة [تكوين الشاشة](../widgets/configure-screen.md#button-appearance)، حيث يمكنك معرفة كيفية ضبط مظهر كل زر ليتناسب مع تفضيلاتك.
...
| إظهار / إخفاء <br/> [**نقاط الاهتمام (POI)**](../map/point-layers-on-map.md#points-of-interest-pois) | تمكين أو تعطيل عرض طبقات نقاط الاهتمام مع الفئات المحددة على الخريطة.<br/>يمكنك تحديد فئات نقاط اهتمام متعددة. يستبدل الإجراء فئات نقاط الاهتمام من تكوين الخريطة المحددة دون استخدام الإجراءات السريعة. |
| تغيير <br/> [**وضع الخريطة**](../map/vector-maps.md#map-mode) | وصول سريع للتبديل بين وضعي النهار والليل. |
| تغيير <br/> [**<Translate ios="true" ids="quick_action_map_source_title"/>**](../map/raster-maps.md) | يسمح لك الزر بتعيين مصدر خريطة واحد أو قائمة مصادر تتغير بشكل دائري عند النقر أو مع مربع حوار مؤقت. <br/> - *إظهار مربع حوار مؤقت*. يعرض مربع حوار بقائمة من الخرائط. <br/> - *عدم إظهار مربع حوار مؤقت*. تتغير مصادر الخريطة بترتيب محدد. <br/> - *الاسم المعروض* - *مصدر الخريطة* >. ">" بعد اسم الخريطة يشير إلى مصدر الخريطة المحدد حاليًا. <br/> - *الاسم المعروض* - > *مصدر الخريطة التالي*. ">" قبل اسم الخريطة يشير إلى مصدر الخريطة التالي الذي سيتم تحديده إذا تم تنفيذ الإجراء. <br/> - *ملاحظة*. لتغيير مصادر الخريطة في OsmAnd، يمكنك إما إعداد إجراء سريع واحد يسمح لك بالتبديل بين مصادر خرائط متعددة، أو إنشاء عدة إجراءات سريعة منفصلة، كل منها لمصدر خريطة معين. |
| إظهار / إخفاء <br /> [**النقل العام**](../map/vector-maps.md#transport) | تمكين أو تعطيل طبقة خريطة النقل العام <br /> - *نوع النقل*. عند النقر الأول، يمكنك تحديد نوع واحد أو أكثر من أنواع النقل، بما في ذلك *محطات النقل*، *مسارات الحافلات، الترولي باص، والحافلات الصغيرة*، *مسارات الترام والقطارات*، *مسارات المترو*. |
| تغيير <br/> [**<Translate ios="true" ids="map_settings_over"/>**](../map/raster-maps.md) | أنشئ قائمة بمصادر الخرائط كتراكب للخريطة وتصفحها. <br /> - *ملاحظة*. لتغيير تراكبات الخريطة في OsmAnd، يمكنك إما إعداد إجراء سريع واحد يسمح لك بالتبديل بين تراكبات خرائط متعددة، أو إنشاء عدة إجراءات سريعة منفصلة، كل منها لتراكب خريطة معين. |
| تغيير <br/> [**<Translate ios="true" ids="map_settings_under"/>**](../map/raster-maps.md) | أنشئ قائمة بمصادر الخرائط كطبقة سفلية للخريطة وتصفحها. <br /> - *ملاحظة*. لتغيير تراكبات الخريطة في OsmAnd، يمكنك إما إعداد إجراء سريع واحد يسمح لك بالتبديل بين تراكبات خرائط متعددة، أو إنشاء عدة إجراءات سريعة منفصلة، كل منها لتراكب خريطة معين. |
| تغيير <br/> [**<Translate android="true" ids="quick_action_map_style"/>**](../map/vector-maps.md#default-map-styles) | أنشئ قائمة بأنماط الخرائط للخرائط المتجهة وتصفحها. <br /> - *ملاحظة*. لتغيير أنماط الخرائط في OsmAnd، يمكنك إما إعداد إجراء سريع واحد يسمح لك بالتبديل بين تراكبات خرائط متعددة، أو إنشاء عدة إجراءات سريعة منفصلة، كل منها لنمط خريطة معين. |
...
| الإجراء | الوصف |
|:-------------|:-------------|
| التنقل <br/> **الشاشة السابقة** | تبديل للتنقل إلى الشاشة السابقة. |
...
| الخريطة <br/> [**تصغير**](../map/interact-with-map.md) | تصغير الخريطة. من الملائم استخدامه مع [أداة المطور - مستوى التكبير](../widgets/info-widgets.md#developer-widgets). |
...
| إضافة <br/> [**مكان وقوف السيارات**](../plugins/parking.md) | يضيف مكان وقوف السيارات إلى موقع خريطة محدد (المركز). يتم حذف موضع وقوف السيارات القديم. |
...
| تشغيل / إيقاف <br/> [**المطالبات الصوتية**](../navigation/guidance/voice-navigation.md) | كتم أو إلغاء كتم التوجيه الصوتي أثناء التنقل. |
| تعيين <br/> [**نقطة البداية**](../navigation/setup/route-navigation.md#set-destinations) | تحديد موقع خريطة محدد (المركز) كنقطة انطلاق. |
| تعيين <br/> [**الوجهة**](../navigation/setup/route-navigation.md#set-destinations) | إضافة الموقع المحدد (المركزي) على الخريطة كوجهة. تصبح الوجهة السابقة هي النقطة الوسيطة الأخيرة. |
...
| إزالة <br/> [**نقطة الوجهة التالية**](../navigation/setup/route-navigation.md#intermediate-destinations) | يزيل النقطة الوسيطة التالية، إذا كانت موجودة، وإلا يزيل الوجهة ويعرض مربع حوار إنهاء التنقل. يكون الإجراء غير نشط إذا لم يكن لديك أي وجهة. |
...
| تغيير <br/> [**<Translate android="true" ids="quick_action_display_position_in_center"/>**](../widgets/configure-screen.md#display-position-location-position-on-screen) <br /> *أندرويد فقط* | يسمح لك بتعيين موضع مؤشر *موقعي* على الخريطة. يمكّن أو يعطل المؤشر ليكون دائمًا في منتصف الشاشة. |
