...
تشير أدوات تسجيل الرحلة إلى [<Translate android="true" ids="record_plugin_name"/> plugin](../plugins/trip-recording.md#widgets). يمكنك استخدام الأدوات لعرض معلومات موجزة حول تسجيل المسار على الشاشة. مثل *المسافة*، *المدة*، *الصعود*، *الهبوط*، *السرعة القصوى*، و*المنحدر المتوسط*.
...
- لإضافة أجهزة استشعار، اختر إحدى الخيارات:
  - اذهب إلى *القائمة → الإضافات → أجهزة الاستشفار الخارجية → الإعدادات → ربط جهاز استشعار جديد*.
...
تنتمي الأدوات إلى [إضافة مقاييس المركبة](../plugins/vehicle-metrics.md#widgets). يمكنك استخدامها لعرض معلومات من ماسح OBD-II المتصل، مثل (*14 مقياساً*): **جهد المحول** (*أندرويد فقط*)،&nbsp; **درجة الحرارة المحيطة**،&nbsp; **جهد البطارية**،&nbsp; **الحمل المحسوب للمحرك**،&nbsp; **درجة حرارة سائل التبريد**،&nbsp; **درجة حرارة زيت المحرك**،&nbsp; **وقت تشغيل المحرك**،&nbsp; **سرعة المحرك** (*مجاني*)،&nbsp; **استهلاك الوقود**،&nbsp; **ضغط الوقود**،&nbsp; **درجة حرارة المدخل**،&nbsp; **الوقود المتبقي**،&nbsp; **موضع الخانق**، و**سرعة المركبة** (*مجاني*).  
