...
اذهب إلى: *<Translate ios="true" ids="shared_string_menu,layer_map_appearance"/> → ⋮ → تخطيط شاشة الخريطة*

يدعم OsmAnd وضعين لتخطيط شاشة الخريطة:
- **التخطيط الفردي** – يستخدم نفس تخطيط الأدوات لجميع اتجاهات الشاشة. يتم اختيار هذا الخيار افتراضيًا.
- **التخطيطات المنفصلة** – يسمح لك بتكوين تخطيطات أدوات مختلفة للاتجاهات العمودية والأفقية.
...
- **نسخ من العمودي** – ينسخ قائمة الأدوات من التخطيط العمودي إلى التخطيط الأفقي.
- **نسخ من الأفقي** – ينسخ قائمة الأدوات من التخطيط الأفقي إلى التخطيط العمودي.
...
- **واسع** – تمتد اللوحتان العلوية والسفلية لعرض الشاشة الكامل.
- **مدمج** – تتناسب اللوحتان العلوية والسفلية بين اللوحات الجانبية وأزرار الخريطة.
