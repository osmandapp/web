...
٣. **رؤية تسمية نص الأداة**

    - تعتمد رؤية تسمية النص على حجم الأداة وموقع اللوحة. في الأحجام المتوسطة والكبيرة، تُعرض التسميات دائمًا.
    - في الحجم الصغير، لا تُعرض التسميات في اللوحات اليسرى واليمنى. في اللوحات العلوية والسفلية، قد تُخفى التسمية تلقائيًا (عند وضعها على الجانب الأيمن) للحفاظ على رؤية القيم الرقمية بالكامل.
...
## تخطيط شاشة الخريطة {#map-screen-layout}

<InfoAndroidOnly/>

![تخطيط شاشة الخريطة](@site/static/img/widgets/map_screen_layout_1.png) ![تخطيط شاشة الخريطة](@site/static/img/widgets/map_screen_layout_2.png)

يسمح إعداد **تخطيط شاشة الخريطة** لك بالتحكم في كيفية ترتيب لوحات الأدوات على شاشة الخريطة. يساعد ذلك في منع تداخل الأدوات والأزرار ويحسن استخدام مساحة الشاشة، خاصة عند التبديل بين الاتجاهات العمودية والأفقية.

يمكنك فتح إعدادات تخطيط شاشة الخريطة من قائمة تهيئة الشاشة، إما مباشرة من إجراءات الشاشة أو عبر قائمة النقاط الثلاث.

### التخطيطات الفردية والمنفصلة {#single-and-separate-layouts}

![تخطيط شاشة الخريطة](@site/static/img/widgets/screen_layout_single.png) ![تخطيط شاشة الخريطة](@site/static/img/widgets/screen_layout_separate.png)

اذهب إلى: *<Translate ios="true" ids="shared_string_menu,layer_map_appearance"/> → ⋮ → <Translate android="true" ids="map_screen_layout"/>*

يدعم OsmAnd وضعين لتخطيط شاشة الخريطة:
- **<Translate android="true" ids="single_layout"/>** – يستخدم نفس تخطيط الأدوات لجميع اتجاهات الشاشة. يتم اختيار هذا الخيار افتراضيًا.
- **<Translate android="true" ids="separate_layouts"/>** – يسمح لك بتكوين تخطيطات أدوات مختلفة للاتجاهات العمودية والأفقية.

عند تمكين التخطيطات المنفصلة، لا تؤثر التغييرات المُجراة في اتجاه واحد على الآخر. هذا مفيد إذا كنت تريد تحسين شاشة الخريطة بشكل مختلف للاستخدام العمودي والأفقي.

### علامتي تبويب العمودي والأفقي {#portrait-and-landscape-tabs}

![تخطيط شاشة الخريطة](@site/static/img/widgets/screen_layout_tabs.png)

عند تمكين التخطيطات المنفصلة، يصبحان متاحين علامتان تبوِيَب في شاشة التهيئة: **العمودي** و**الأفقي**. تمثل كل علامة تبويب تخطيطًا مستقلًا للاتجاه المقابل للشاشة. يمكنك التبديل بين العلامات التبويبية بالنقر عليها.

يمكنك نسخ التخطيط بين الاتجاهات. للوصول إلى هذه الإجراءات، انقر على قائمة النقاط الثلاث للوحة الأداة:
- **<Translate android="true" ids="copy_from_portrait_layout"/>** – ينسخ قائمة الأدوات من التخطيط العمودي إلى التخطيط الأفقي.
- **<Translate android="true" ids="copy_from_landscape_layout"/>** – ينسخ قائمة الأدوات من التخطيط الأفقي إلى التخطيط العمودي.

يتم نسخ قائمة الأدوات فقط، ويتم تطبيق العملية داخل نفس الملف الشخصي.

![تخطيط شاشة الخريطة](@site/static/img/widgets/screen_layout_portrait.png) ![تخطيط شاشة الخريطة](@site/static/img/widgets/screen_layout_landscape.png)

### تخطيط اللوحات {#panels-layout}

![تخطيط شاشة الخريطة](@site/static/img/widgets/screen_layout_wide.png) ![تخطيط شاشة الخريطة](@site/static/img/widgets/screen_layout_compact.png)

يُسيطر إعداد **تخطيط اللوحات** على كيفية عرض لوحات الأدوات العلوية والسفلية. 

**ملاحظة:** هذا الخيار متاح فقط عند تمكين [التخطيطات المنفصلة](#single-and-separate-layouts).

يمكنك الاختيار بين وضعين:
- **<Translate android="true" ids="panels_layout_wide"/>** – تمتد اللوحتان العلوية والسفلية لعرض الشاشة الكامل.
- **<Translate android="true" ids="panels_layout_compact"/>** – تتناسب اللوحتان العلوية والسفلية بين اللوحات الجانبية وأزرار الخريطة.

يمكن تكوين تخطيط اللوحات بشكل مستقل للاتجاهات العمودية والأفقية، مما يسمح بتكييف أفضل مع أحجام الشاشات والاتجاهات المختلفة.
...
![صفحة الأداة](@site/static/img/widgets/conf_screen_buttons_3_andr_new.png)
...
تسمح لك **الأزرار الافتراضية** بتخصيص أي من أزرار الخريطة المعدة مسبقًا تكون مرئية على شاشة الخريطة. يحتوي كل زر في القائمة على مفتاح تشغيل/إيقاف بجانبه. يمكنك اختيار إخفاء أو إظهار الأزرار التالية:
...
تحتوي **قائمة النقاط الثلاث** على شاشة الأزرار الافتراضية على إجراءات مثل:
    ...
    - *المظهر (أندرويد فقط)*. يوفر مجموعة متنوعة من خيارات التخصيص لهذا النوع من الأزرار. لتعديل مظهر الزر، انقر على الزر المطلوب من القائمة وحدد خيار [المظهر](#button-appearance).
...
**اذهب إلى** (للأزرار المخصصة): *<Translate android="true" ids="shared_string_menu,layer_map_appearance,custom_buttons,quick_action_item"/>* → قائمة النقاط الثلاث → *<Translate android="true" ids="shared_string_appearance"/>*  
**اذهب إلى** (لجميع الأزرار الافتراضية): *<Translate android="true" ids="shared_string_menu,layer_map_appearance,shared_string_buttons,default_buttons"/>* → قائمة النقاط الثلاث → *<Translate android="true" ids="shared_string_appearance"/>*  
**اذهب إلى** (لزر افتراضي محدد): *<Translate android="true" ids="shared_string_menu,layer_map_appearance,shared_string_buttons,default_buttons"/>* → حدد زرًا → *<Translate android="true" ids="shared_string_appearance"/>*  

</TabItem>

<TabItem value="ios" label="iOS">  

![مظهر الزر](@site/static/img/widgets/button_appearance_settings_ios.png)

**اذهب إلى** (للأزرار المخصصة): *<Translate ios="true" ids="shared_string_menu,layer_map_appearance,custom_buttons,shared_string_quick_actions"/>* → قائمة النقاط الثلاث → *<Translate ios="true" ids="shared_string_appearance"/>*
**اذهب إلى** (لزر افتراضي محدد): *<Translate ios="true" ids="shared_string_menu,layer_map_appearance,shared_string_buttons,default_buttons"/>* → حدد زرًا → *<Translate ios="true" ids="shared_string_appearance"/>*
...
- **الحجم**. اختر حجم الزر الذي يناسب شاشتك ويبرز حسب الحاجة. 
- **شفافية الخلفية** (أندرويد) / **الخلفية** (iOS). تحكم في رؤية خلفية الزر. يمكنك ضبطها لتكون مرئية بالكامل أو شفافة جزئيًا، أو عرض ظل الإطار والأيقونة فقط.
