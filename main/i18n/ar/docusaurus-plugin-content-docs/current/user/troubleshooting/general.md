...
### لماذا تظهر أزرار الخريطة أو الودجات أو النص كبيرة جدًا؟ (أندرويد) {#why-are-map-buttons-widgets-or-the-map-ruler-too-large}

إذا ظهرت أزرار الخريطة أو الودجات أو مسطرة الخريطة كبيرة الحجم بعد تعديل حجم العرض في إعدادات نظام أندرويد، فقد يكون ذلك مرتبطًا بكيفية تكيف OsmAnd مع واجهة الشاشة الحالية.

على بعض الأجهزة، قد يؤثر تقليل كثافة الشاشة أو تغيير حجم العرض على حجم عناصر الواجهة، خاصة على الأجهزة ذات الشاشات الكبيرة والأجهزة اللوحية.

لم تعد إصدارات OsmAnd الحديثة تطبق تحجيمًا تلقائيًا إضافيًا للأجهزة التي يتم اكتشافها كأجهزة لوحية. أصبحت عناصر الواجهة الآن تتبع إعدادات عرض نظام أندرويد بشكل أقرب.

إذا كنت ترغب في ضبط حجم أزرار الخريطة يدويًا، استخدم إعدادات [المظهر الافتراضي](https://osmand.net/docs/user/widgets/configure-screen#button-appearance): *القائمة ← تكوين الشاشة ← الأزرار ← الأزرار الافتراضية ← قائمة النقاط الثلاث ← المظهر*. يمكنك هناك تعيين حجم مخصص ونصف قطر الزوايا وشفافية الخلفية لجميع الأزرار الافتراضية دفعة واحدة.

إذا كانت الواجهة لا تزال تبدو أكبر مما هو متوقع، تحقق من *إعدادات نظام أندرويد ← العرض ← حجم العرض والنص* واضبط إعدادات العرض حسب الحاجة.
...
7. **إعادة تسجيل الدخول أو استخدام الويب لإدارة الحساب**. إذا كنت لا تزال تواجه مشكلات، فحاول تسجيل الخروج ثم تسجيل الدخول مرة أخرى لتحديث اتصال التطبيق بحسابك الحالي. إذا واجهت أي مشاكل في حذف الحساب القديم داخل التطبيق، فكر في إدارة حسابك من خلال إصدار الويب من OsmAnd.