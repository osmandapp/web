...
![قائمة سياق نقطة الاهتمام](@site/static/img/web/poi_context_menu.png)
...
- **إضافة إلى المفضلة** — يحفظ نقطة الاهتمام في [المفضلة](../web/web-favorites.md#add--edit-favorite).
