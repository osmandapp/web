...
عندما تنشئ أو تستورد مسارًا في تخطيط المسار، تفتح لوحة مسار رأسية. تسمح هذه اللوحة لك بتغيير ملف تعريف التوجيه وإدارة المسار.

انقر على تحكم الملف الشخصي لفتح حوار **تغيير الملف الشخصي**. حدد الملف الشخصي المطلوب (على سبيل المثال، السيارة، الدراجة، أو المشاة)، ثم اختر كيفية تطبيقه: *المقاطع التالية* يطبق الملف الشخصي فقط على الأجزاء الجديدة المضافة من هذه النقطة فصاعدًا، بينما *جميع المقاطع* يعيد حساب المسار بأكمله باستخدام الملف الشخصي المحدد.

من لوحة المسار، يمكنك أيضًا **حذف** المسار من قائمة المحلية الخاصة بك.
...
تشمل قائمة المسار المحلي ثلاث لوحات: **النظرة العامة**، و**المسار**، و**النقاط**. استخدمها لعرض معلومات المسار وإدارة نقاط المسار ونقاط الطريق.

### لوحة النظرة العامة {#overview-panel}

تلخص لوحة النظرة العامة المسار المحدد وتعرض بيانات المسار والارتفاع الرئيسية. وتشمل نظرة عامة سريعة على إحصاءات المسار، بالإضافة إلى الرسوم البيانية وتحليل المسار الإضافي بناءً على بيانات الخريطة المتاحة.
...
- السرعة — رسم بياني للسرعة على طول المسار.

يمكنك تمكين أو تعطيل الخيارات التالية:

- إظهار نقاط المسار — يعرض نقاط المسار على الخريطة.
- إظهار نقاط الطريق — يعرض نقاط الطريق على الخريطة.

للحصول على تفاصيل إضافية للمسار، افتح أقسام التحليل:

- نوع الطريق — يقسم المسار إلى مقاطع حسب تصنيف الطريق.
