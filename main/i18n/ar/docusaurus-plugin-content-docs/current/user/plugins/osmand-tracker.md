...
لقد اخترنا [Telegram](https://telegram.org/) كأكثر منصة اجتماعية مفتوحة لأنها تحتوي على [واجهة برمجة تطبيقات مفتوحة (Open API)](https://core.telegram.org/api)، وحزمة تطوير برمجيات مفتوحة (Open SDK)، وعلاوة على ذلك، ستحتوي في النهاية على تنفيذ خادم مفتوح (Blockchain).
...
إعدادات نقطة الموقع. على سبيل المثال، إذا بقيت في مكان واحد لبعض الوقت دون حركة، فلن يتم إرسال بيانات نقطة موقعك وسيعرض مسار GPX الخاص بك بيانات أكثر دقة ودقة.  
...
يرجى مشاركتنا رأيك حول هذا التطبيق الجديد على [Twitter](https://x.com/osmandapp) والقنوات الاجتماعية الأخرى.
