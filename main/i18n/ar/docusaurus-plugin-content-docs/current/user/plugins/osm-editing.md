...
![ملحق تعديل OpenStreetMap GPX إلى OSM أندرويد](@site/static/img/plugins/osm-editing/osm_plugin_gpx_to_osm_android.webp)

</TabItem>

<TabItem value="ios" label="iOS">

![ملحق تعديل OpenStreetMap GPX إلى OSM iOS](@site/static/img/plugins/osm-editing/osm_plugin_gpx_to_osm_ios.webp)  
