...
![ودجة تسجيل الرحلة](@site/static/img/widgets/tr_rec_wid_conf_scr_new.png) ![ودجة تسجيل الرحلة](@site/static/img/widgets/tr_rec_wid_conf_scr_2_new.png)
...
بالإضافة إلى ودجة *المسافة/بدء-إيقاف*، يتضمن **ملحق تسجيل الرحلة** خمس ودجات أخرى: *المدة* و*الصعود* و*النزول* و*السرعة القصوى* و*متوسط الميل*. توفر هذه معلومات إضافية حول رحلتك، مما يساعدك على تتبع التقدم في الوقت الفعلي.
...
![السرعة القصوى iOS](@site/static/img/widgets/max_speed_ios.png) ![متوسط الميل iOS](@site/static/img/widgets/average_slope_ios.png) 
