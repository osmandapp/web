...
تتيح لك الودجات عرض المعلومات الرئيسية حول تسجيل المسار مباشرة على الشاشة، مثل *المسافة* و*المدة* و*الصعود* و*النزول*. يمكنك أيضًا إضافة ودجات *السرعة القصوى* و*متوسط الميل*.
...
![إضافة ودجة المسافة/بدء-إيقاف في iOS](@site/static/img/plugins/trip-recording/add_recording_widgets_ios_2_new.png)
...
- الصعود / النزول / السرعة القصوى / متوسط الميل — انقر على الودجة على الخريطة للتبديل إلى وضعها.
