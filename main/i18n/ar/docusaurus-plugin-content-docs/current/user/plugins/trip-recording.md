...
تتيح لك الودجات عرض المعلومات الرئيسية حول تسجيل المسار مباشرة على الشاشة، مثل *متوسط الميل*، *المسافة*، *النزول*، *المدة*، *السرعة القصوى*، *وقت الحركة*، و*الصعود*. في أندرويد، يمكنك أيضًا إضافة ودجة *متوسط السرعة*.
...
![إضافة ودجة المسافة/بدء-إيقاف في أندرويد](@site/static/img/plugins/trip-recording/add_new_widg_andr.png)
...
|**متوسط السرعة** *(أندرويد فقط)*. يعرض متوسط السرعة لرحلة التسجيل الحالية، أو متوسط السرعة خلال آخر قسم صاعد أو نازل، اعتمادًا على الوضع المحدد. |
|![ودجات](@site/static/img/widgets/tr_rec_wid_average_speed.png)|
...
|**وقت الحركة**. يعرض وقت الحركة لرحلة التسجيل الحالية، أو الوقت لآخر صعود ونزول، اعتمادًا على الوضع المحدد. |
