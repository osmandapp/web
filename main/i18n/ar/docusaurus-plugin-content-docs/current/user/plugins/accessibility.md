...
## الإعلان التلقائي {#autoannounce}

للتمكين:
*موقعي* (نقرة طويلة) ← *إظهار التفاصيل* ← *بدء/إيقاف الإعلان التلقائي*
...
- مع تمكين **TalkBack**، يتم نطق هذه الإشعارات بصوت عالٍ. إذا **لم يتم تمكين TalkBack** في إعدادات نظام الجهاز، فلن يقدم OsmAnd *إشعارات صوتية* وسيعرض فقط *إشعارات نصية* على الشاشة.  

### الإعلان التلقائي الذكي {#smart-autoannounce}

للتمكين:
*الإضافات* ← *إمكانية الوصول* ← *الإعدادات* ← *الإعلان التلقائي الذكي*

تعمل ميزة **الإعلان التلقائي الذكي** فوق الإعلان التلقائي. ابدأ الإعلان التلقائي أولاً، ثم قم بتمكين الإعلان التلقائي الذكي في إعدادات الإضافة.

عند تمكين الإعلان التلقائي الذكي، يتم تشغيل الإعلانات عندما يتغير قطاع الهدف الحالي للتنقل. يحدث هذا عادةً عندما يغير حركتك الاتجاه إلى المنعطف أو الوجهة التالية. عند تعطيل الإعلان التلقائي الذكي، يعرض OsmAnd إشعارات دورية وفقًا لفترة الإعلان التلقائي.

**ملاحظة:** يمكن تعديل فترة الإعلان التلقائي فقط. لا يمكن تهيئة مشغل "تغيير القطاع" في إعدادات التطبيق. 
