...
[ويكيبيديا](https://en.wikipedia.org/wiki/Wikipedia) هي موسوعة حرة متعددة اللغات على الإنترنت، تم إنشاؤها وصيانتها بواسطة مجتمع من المحررين المتطوعين باستخدام نظام تحرير قائم على الويكي.
...
١. [شراء](../plugins/index.md#purchase) و[تمكين](../plugins/index.md#enable--disable) إضافة ويكيبيديا في قسم الإضافات من *القائمة الرئيسية*.
٢. تنزيل [حزم ويكيبيديا](#download-wikipedia-packages) للمناطق المطلوبة.
٣. عرض [نقاط اهتمام ويكيبيديا](#display-wikipedia-on-the-map) على الخريطة للملف الشخصي المطلوب.
٤. تكوين [اللغات](#set-preferred-language) المفضلة لقراءة المقالات.
...
١. **Android**. اذهب إلى: *<Translate android="true" ids="shared_string_menu,maps_and_resources,regions"/>*
٢. **iOS**. اذهب إلى: *<Translate ios="true" ids="shared_string_menu,res_mapsres,res_worldwide"/>*
٣. حدد المنطقة المطلوبة. بمجرد فتح المنطقة، ستكون بيانات ويكيبيديا من بين الحزم الأخرى.
...
٢. حدد ملفًا شخصيًا، وابحث عن قسم الإعدادات *<Translate android="true" ids="shared_string_show"/>*/*<Translate ios="true" ids="shared_string_show_on_map"/>* في القائمة.
٣. قم بتفعيل *<Translate android="true" ids="poi_osmwiki"/>* **لنظام Android** / *<Translate ios="true" ids="download_wikipedia_maps"/>* **لنظام iOS**.
...
١. قم بتمكين [طبقة نقاط اهتمام ويكيبيديا](../map/point-layers-on-map.md#-wikipedia) لملف شخصي محدد.
٢. انقر على نقطة الاهتمام على الخريطة.
٣. في [القائمة السياقية](../map/map-context-menu.md) لنقطة الاهتمام، انقر على *تفاصيل* (أو ببساطة اسحب *القائمة السياقية* لأعلى) لعرض ملخص لمقالة ويكيبيديا المختارة.
٤. إذا نقرت على هذا النص (لإصدار iOS)، فسيتم إعادة توجيهك إلى مقالة ويكيبيديا غير المتصلة بالإنترنت.
٥. استخدم زر *قراءة المقالة* أو *قراءة المقالة كاملة* لفتح النسخة الكاملة من مقالة ويكيبيديا.
...
![نقطة اهتمام ويكيبيديا الفرنسية باللغة الإنجليزية](@site/static/img/plugins/wikipedia/Andr-french-wikipedia-in-eng1.png)
...
١. *<Translate android="true" ids="shared_string_menu,configure_map"/>*.
٢. حدد الملف الشخصي المطلوب وفي قسم *<Translate android="true" ids="shared_string_show"/>* اختر *<Translate android="true" ids="poi_osmwiki"/>* لنظام Android / *<Translate ios="true" ids="download_wikipedia_maps"/>* لنظام iOS.
٣. عطّل خيار *<Translate android="true" ids="shared_string_all_languages"/>*.
٤. حدد لغة (لغات) معينة في القائمة المفتوحة.
