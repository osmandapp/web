...
- **<Translate android="true" ids="trace_rendering"/>** (*أندرويد* / *iOS*). يعرض أداء العرض والملاحة.
- **<Translate android="true" ids="show_debug_tile"/>** (*أندرويد* / *iOS*). يعرض معلومات تصحيح أخطاء ترميز الطبقات النقطية.
...
- **<Translate ios="true" ids="show_touches"/>** (*iOS*). يبرز لمسات الشاشة بمؤشرات بصرية.
...
- **الوضع الآمن**. يشغّل OsmAnd بدون مكتبة C++ الأصلية، باستخدام تطبيقات Java لعرض الخريطة وحساب المسارات بدلاً من ذلك. ينتقل التطبيق إلى هذا الوضع تلقائيًا إذا فشلت المكتبة الأصلية أثناء بدء التشغيل، مما يسمح له بالبدء والبقاء قابلاً للاستخدام. يصبح عرض الخريطة وحساب المسارات أبطأ بشكل ملحوظ أثناء تفعيل الوضع الآمن.  
...
- **إحصائيات الطاقة (متوسط ١ / ٥ / ١٥ دقيقة)**. يعرض مستوى البطارية في الدقيقة (٪) ومتوسط استهلاك الطاقة (mAh) على فترات ١ و ٥ و ١٥ دقيقة.  
...
بعد تشغيل المحاكاة، سترى على الشاشة الرئيسية للتطبيق أن علامة الملاحة تتحرك وفقًا لمسار GPX. انقر على [زر موقعي](../map/interact-with-map.md#my-position-and-zoom) لمزامنة *موقعي* (الموقع الجغرافي المحاكى للجهاز) مع مركز الخريطة.  
