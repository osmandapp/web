...
تُظهر المباني ثلاثية الأبعاد فقط عند مستويات تقريب أعلى (عرض المدينة/الشارع)، حيث يمكن عرض المباني الفردية. عندما يكون POI أو موقع محدد (مثل دبوس الخريطة أو وجهة الملاحة) داخل مبنى، يبرز OsmAnd المبنى المقابل لتسهيل تحديده على الخريطة.
