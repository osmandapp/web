...
يتم ترتيب نتائج البحث تلقائيًا حسب الصلة والمسافة، لذا تظهر النتائج القريبة والأكثر صلة في أعلى القائمة.
...
عندما قد يشير الاستعلام إلى عنوان ونقطة اهتمام معًا، يقوم OsmAnd تلقائيًا بإعطاء الأولوية للتفسير الأكثر صلة بناءً على السياق والمسافة وأهمية الكائن.
...
ومع ذلك، قد تعيد الاستعلامات القصيرة جدًا أو العامة (على سبيل المثال، “Apple”) مزيجًا من العناوين ونقاط الاهتمام، بما في ذلك علامة تجارية، أو اسم شارع، أو منطقة محلية بنفس الاسم. لتحسين الدقة، جرب إضافة تفاصيل إضافية مثل اسم المدينة، أو الشارع، أو اسم نقطة الاهتمام.
