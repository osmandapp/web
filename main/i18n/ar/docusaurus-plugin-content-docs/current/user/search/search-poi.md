...
<!--
يتيح لك البحث عن فئات نقاط الاهتمام (POI) العثور بسرعة على الأماكن المهمة وتحديدها بناءً على احتياجاتك. إنها أداة مفيدة للسفر، والعثور على الخدمات القريبة أو الأماكن المهمة، وتخطيط المسارات بناءً على فئات نقاط الاهتمام (POI) المحددة.

يبدأ OsmAnd في البحث عن أسماء وفئات نقاط الاهتمام (POI) بالكلمات المدخلة. ستكون النتائج الأولى فئات، والنتائج الثانية ستكون نقاط اهتمام (POI) بمعلومات إضافية، واسم كامل، واسم الفئة، والاتجاه والمسافة إلى نقطة الاهتمام (POI)، ووقت العمل. يؤدي الضغط على الفئة المطلوبة إلى فتح قائمة نقاط الاهتمام (POI) لهذه الفئة.

يؤدي النقر على نقطة اهتمام (POI) مختارة في القائمة إلى فتح [قائمة سياق الخريطة](../map/map-context-menu.md#select-an-object-single-tap) لنقطة الاهتمام (POI).
-->
...
يمكن أن يتكون الفلتر من عدد كبير من العناصر، ويعتمد وجودها على الفئة المحددة. تحتوي كل فئة على عدد من الفلاتر الخاصة بها، منظمة في مجلدات حسب النوع. يوجد إجمالي *22 فئة افتراضية*. بعضها مدرج هنا:
 ...
 5. **<Translate android="true" ids="poi_filter_emergency"/>**. يشمل [الطوارئ](https://wiki.openstreetmap.org/wiki/Key:emergency) المرافق والمواقع المرتبطة بخدمات الطوارئ مثل المستشفيات، مراكز الشرطة، محطات الإطفاء، ومراكز الإسعافات الأولية.
 ...
 18. **مسارات**. يشمل [مسارات OSM](../map/routes.md) لأنواع مختلفة من الأنشطة.
...
<!--
![نقاط اهتمام مخصصة iOS](@site/static/img/search/custom_poi_ios.png) ![أنواع نقاط اهتمام مخصصة iOS](@site/static/img/search/custom_poi_types_ios.png)
-->
...
1. **<Translate android="true" ids="amenity_type_administrative"/>**. يتضمن 25 نوعًا: *مخصصات، جزيرة مرجانية، حي، مدينة، كتلة مدينة، بلد، محكمة، جمارك، مكتب دبلوماسي، مزرعة، حكومة، قرية صغيرة، جزيرة، جزيرة صغيرة، مسكن معزول، منطقة محلية، حي، شرطة، سجن، ربع، منطقة سكنية، ضاحية، بلدة، قاعة مدينة، قرية*.
...
- يتم تقسيم نقاط الاهتمام الدينية بناءً على علامة `amenity=place_of_worship` إلى مواقع دينية محددة مثل الكنائس أو المساجد أو المعابد اليهودية.
