...
عند تشغيل التوجيهات الصوتية، يقوم OsmAnd بضبط الصوت الخلفي حسب نوعه. يمكن إيقاف المحتوى الصوتي المنطوق، مثل البودكاست والكتب الصوتية، تلقائيًا أثناء تعليمات الملاحة. يستمر تشغيل الموسيقى مع خفض مستوى الصوت. يتيح خيار *<Translate ios="true" ids="pause_spoken_audio"/>* التحكم في هذا السلوك.
