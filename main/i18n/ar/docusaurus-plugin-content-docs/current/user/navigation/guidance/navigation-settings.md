...
لنجاح الملاحة، من المهم تكوين الإعدادات المناسبة بشكل صحيح وفقًا لاحتياجاتك وكيفية سفرك - بالسيارة، سيرًا على الأقدام، على ظهر الخيل، أو التزلج. يصف هذا المقال معلمات المسار الأساسية، [التوجيهات الصوتية](#voice-prompts)، [تنبيهات الشاشة](#screen-alerts)، [سلوك الخريطة أثناء الملاحة](#map-during-navigation)، و[مظهر خطوط المسار](#customize-route-line). كما يفصل [إعدادات المركبة](#vehicle-parameters) مثل السرعة الافتراضية، ونوع المحرك لحساب ثاني أكسيد الكربون، وسعة خزان الوقود، وقيود الحجم/الوزن. سيساعدك ضبط هذه الإعدادات على تحقيق أقصى استفادة من استخدام OsmAnd والوصول إلى وجهتك دون تأخير غير ضروري.
