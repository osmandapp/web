...
|:------------|:---------------|:---------------|
| *<Translate android="true" ids="choose_auto_follow_route"/>* |  الوقت الذي تتم فيه مزامنة عرض الخريطة مع الموضع الحالي بعد التحرك.  |  *القيمة:* <br /> أبدًا، ٥ ث، ١٠ ث، ١٥ ث، ٢٠ ث، ٢٥ ث، ٣٠ ث، ٤٥ ث، ٦٠ ث، ٥٠ ث. |
| *<Translate android="true" ids="auto_zoom_map"/>*  |  تغيير مقياس الخريطة تلقائيًا وفقًا لسرعتك، طالما أن الخريطة متزامنة مع موقعك الحالي. | *القيمة:* <br /> *<Translate android="true" ids="auto_zoom_none"/>* - تكبير يدوي. <br /> *<Translate android="true" ids="auto_zoom_farthest"/>* - التكبير ٢٠٠ م.<br /> *<Translate android="true" ids="auto_zoom_far"/>* - التكبير ١٠٠ م. <br /> *<Translate android="true" ids="auto_zoom_close"/>* - التكبير ٥ م. <br /> يمكن أن تكون تغييرات التكبير التلقائي متحركة (ناعمة) أو قائمة على الخطوات (منفصلة)، اعتمادًا على [إعدادات التطوير](navigation-settings.md#development-settings). في وضع النعومة، تستخدم تغييرات التكبير رسومًا متحركة متحكم فيها (حوالي ٠.١ تكبير/ثانية). لا يقوم التكبير التلقائي بتعديل التكبير عند السرعات المنخفضة جدًا (أقل من ~٧ كم/ساعة). إذا كان التغيير المطلوب في التكبير سيستغرق أقل من ~١.٥ ثانية، فلا يتم بدء الرسم المتحرك. <br /> يهدف التكبير التلقائي إلى الحفاظ على المناورة القادمة داخل منطقة تركيز مستقرة على الشاشة، بحيث يظل المسافة المرئية أمامك متسقة أثناء القيادة. |
| *زاوية التكبير التلقائي ثلاثي الأبعاد* | يحدد ميل الخريطة عند التبديل إلى عرض ثلاثي الأبعاد أثناء الملاحة. زاوية أعلى تجعل الأفق يبدو أبعد، مما يعطي رؤية أمامية أكبر. |يتم تطبيقها فقط عند تمكين التكبير التلقائي. القيم: ٢٠°، ٢٥°، ٣٠°، ٣٥°، ٤٠°. الافتراضي: ٢٥°. <br /> عند الاقتراب من مناورة/تقاطع، يمكن للتطبيق تقليل ميل ثلاثي الأبعاد تدريجيًا نحو عرض ثنائي الأبعاد للحفاظ على إمكانية قراءة المنعطف التالي.  |
| *معاينة الانعطاف التالي* | يقوم تلقائيًا بتدوير الخريطة قليلاً مسبقًا لإظهار الانعطاف أو المناورة التالية أثناء الملاحة. يساعد في توقع الإجراءات القادمة.  | مفعلة افتراضيًا. إذا قمت بتصدير وإعادة استيراد ملف تعريف، تأكد من التحقق من هذا الإعداد، حيث كان في بعض الإصدارات السابقة يمكن أن يعاد تعيينه إلى “مفعل”.  <br /> يتم تشغيل التدوير/المعاينة بمجرد أن تدخل نقطة المناورة التالية في منطقة التركيز (حيث تبدأ الخريطة في “النظر” إلى المنعطف عندما يصبح ذا صلة). |
...
:::info Pro feature
تخصيص خط المسار هو ميزة مدفوعة في [**OsmAnd Pro**](../../purchases/index.md) <ProFeature />.
:::
...
**متقدم**: يسمح لك إعداد تخصيص خط المسار بضبط مظهر خط المسار لعرض تغيرات الارتفاع، أو الصعود أو الهبوط الكبير، أو الجليد على الطريق، أو الطرق غير المعبدة، أو الطرق السريعة، وغيرها من العوائق المحتملة. يمكنك أيضًا تحديد أو إنشاء [أنظمة ألوان](../../personal/color-palette-schemes.md#tracks-routes) مخصصة لتطبيقها على خط المسار.
...
- ***<ProFeature/> &nbsp;<Translate android="true" id="routeInfo_winter_ice_road_name" />***. يلون خط المسار أو المسار وفقًا لـ *تصنيف الطرق الشتوية*. يمكن العثور على وصف تفصيلي في مقالة *أنماط الخريطة*، قسم [الطرق الشتوية والجليدية](../../map/map-styles.md#winter-and-ski).  
...
- ***<Translate android="true" id="map_widget_renderer"/>***. يستخدم مع العرض الافتراضي الذي حدده OsmAnd. يمكن العثور على وصف كامل في مقالة *[أنماط الخريطة](../../map/map-styles.md)*.  
    ![نمط الخريطة](@site/static/img/navigation/route/map_st_2.png)
