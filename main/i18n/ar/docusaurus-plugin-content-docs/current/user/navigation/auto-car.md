...
- [موقعي](../widgets/map-buttons.md#my-position-and-zoom). ينقل الجزء المرئي من الخريطة بحيث يكون موقعك الحالي في وسط الشاشة.
- [تكبير/تصغير](../widgets/map-buttons.md#my-position-and-zoom). يسمح لك بتكبير وتصغير الجزء المرئي من الخريطة. إيماءة الضغط بإصبعين متاحة لتكبير الخريطة. إذا لم يدعم الوحدة الرئيسية ذلك، يتم تعديل التكبير بالضغط المزدوج وإيماءة السحب.
...
![أندرويد أوتو](@site/static/img/navigation/auto-car/x_button.png)
...
انقر على زر **X** بجوار أداة معلومات المسار لإيقاف الملاحة.
...
عند اكتمال الملاحة في أندرويد أوتو، يظهر حوار إنهاء الملاحة الخاص على شاشة السيارة. يستخدم نفس خوارزمية كشف الوصول كالتطبيق المحمول ويساعك على إنهاء رحلتك بسرعة أو العثور على مكان وقوف قريب.
...
هذا التحديث يضمن أيضًا إغلاق جلسات أندرويد أوتو بشكل صحيح الآن، مما يمنع استهلاك البطارية غير الضرورية ويوقف إشعارات "رحلة قيد التقدم" بمجرد انتهاء الملاحة.
