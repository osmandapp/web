...
[**Android Auto**](https://www.android.com/auto) هو برنامج طورته جوجل يسمح للمستخدمين بربط أجهزة أندرويد الخاصة بهم بأنظمة الوسائط المتعددة المتوافقة في السيارة. يوفر *Android Auto* نسخة معدلة ومحسّنة من تطبيق OsmAnd للاستخدام الآمن أثناء القيادة، مما يسهل الوصول إلى وظائف الملاحة في التطبيق ويجعلها أكثر أمانًا.

وظيفة **Android Auto** مدعومة فقط عند استخدام تطبيق OsmAnd المتوفر في [متجر Google Play](https://play.google.com/store/apps/dev?id=8483587772816822023).

> **ملاحظة**: *Android Auto ليس نسخة طبق الأصل من تطبيق OsmAnd للهاتف المحمول. إنه يتميز بواجهة مبسطة، تركز على وظائف الملاحة الأساسية لضمان القيادة الآمنة. بعض الميزات المتقدمة غير مدعومة بسبب قيود النظام الأساسي.*
...
- [قائمة OsmAnd](#destination-points). تحتوي على قائمة بالخيارات المتاحة لتعيين نقطة نهاية مسار أو رحلة حرة.
...
- [موقعي](../widgets/map-buttons.md#my-location-and-zoom). يحرك الجزء المرئي من الخريطة بحيث يكون موقعك الحالي في مركز الشاشة.
...
- لا تدعم جميع المركبات إمكانية توصيل الجهاز. تحقق من [قائمة *Android Auto*](https://www.android.com/auto/compatibility/#compatibility-vehicles).
...
- يستخدم *Android Auto* أول [ملف تعريف قيادة OsmAnd](#profile-first) في قائمة الملفات الشخصية للملاحة. قم بتعيين الملف الشخصي المفضل ليكون الأول، باستثناء ملف تعريف *تصفح الخريطة*، لا يتم قراءته بواسطة *Android Auto*. للقيام بذلك، انتقل إلى OsmAnd *القائمة ← الإعدادات ← ملفات تعريف التطبيق ← تحرير قائمة الملفات الشخصية* ← انقل ملف تعريف [**القيادة**](#profile-first) الخاص بك إلى المكان الأول أو بعد ملف تعريف *تصفح الخريطة*.

- من المهم أن تتذكر أن *Android Auto* هو تطبيق كثيف البيانات، بما في ذلك بيانات الهاتف المحمول، وقد تعتمد جودة النظام على جودة اتصالك وسرعة وصولك إلى الإنترنت.

### الملف الشخصي الأول {#profile-first}

لا يمكنك تحديد ملف تعريف مباشرة في *Android Auto* على شاشة السيارة.
إذا كان لديك بالفعل ملف تعريف محدد على جهازك يتوافق مع نوع السيارة، مثل *القيادة*، *الشاحنة*، *السيارة*، *الدراجة النارية*، *الدراجة البخارية*، **سيقوم التطبيق تلقائيًا بتنشيط** الملف الشخصي المناسب عند الاتصال بـ Android Auto. على سبيل المثال، إذا كان لديك ملف تعريف *شاحنة* محددًا وتم توصيل جهازك بـ **Android Auto**، فسيقوم التطبيق بتنشيط هذا الملف الشخصي.

إذا لم يكن لديك أي ملف تعريف *قيادة* محدد على جهازك يتوافق مع نوع سيارتك، فسيقوم OsmAnd بالتبديل تلقائيًا إلى ملف تعريف *القيادة*. يتم ذلك لتوفير الملاحة الأساسية ومنع المشاكل المحتملة الناتجة عن استخدام ملف تعريف خاطئ لنوع سيارة معين.

**لماذا هو مهم:**

1. **سلامة القيادة.** تتطلب أنواع النقل المختلفة معلومات وإعدادات مختلفة عند القيادة. على سبيل المثال، قد يكون سائقو الشاحنات مقيدين بارتفاع ووزن وعرض مركباتهم، لذلك يوفر لهم ملف تعريف *الشاحنة* قيودًا وإرشادات مناسبة. بينما يحتاج راكبو الدراجات والدراجات النارية إلى معلومات حول مسارات الدراجات والطرق، بدون بيانات للشاحنات.

2. **المنفعة والكفاءة.** يجب تخصيص الملاحة لتلبية احتياجات وضع نقل معين. يسمح هذا للمستخدمين بتقليل الوقت المستغرق للعثور على المسارات المثلى وتجنب قيود المرور غير الضرورية.

3. **تجنب الأخطاء.** يوفر لك التبديل إلى ملف تعريف *القيادة* عندما لا يكون هناك ملف تعريف محدد لوضع النقل المحدد وصولاً ثابتًا إلى الحد الأدنى من الإعدادات والمعلومات الضرورية، وبالتالي تجنب الأخطاء وسوء الفهم المحتمل أثناء القيادة.
...
1. إذا كنت تريد موقعًا معينًا على الخريطة كنقطة نهاية، فحدد الفئة المناسبة من النقاط من القائمة، [نقاط الاهتمام](#poi-categories)، [المفضلة](#favorites)، أو [علامات الخريطة](#map-markers).
    ...
    - لا يمكن أن تحتوي جميع الفئات على عدد من عناصر القائمة أكثر مما يوفره نظام الوسائط المتعددة في سيارتك. هذا يعني أن القائمة في *Android Auto* قد تكون غير مكتملة، وجميع المجلدات الأخرى متاحة فقط في تطبيق OsmAnd على جهازك.
    - يحتوي مجلد [آخر تعديل](#folder-last-modified) على قائمة بالوجهات الحديثة، مرتبة حسب تاريخ الإضافة أو التغيير.
    - يتم فرز قائمة جميع المجلدات الأخرى حسب آخر تحديث، المجلدات الجديدة في أعلى القائمة. لا يمكن تغيير ترتيبها يدويًا.
    - يتم فرز قائمة النقاط داخل المجلدات حسب المسافة إليها، بدءًا من الأقرب. تحتوي كل نقطة على اسم أو إحداثيات، وأيقونة على شكل (اللون والأيقونة محددة افتراضيًا أو اخترتها في تطبيق OsmAnd)، والمسافة من نقطة الموقع الحالي إليها.

2. حدد فئة [السجل](#history) للعثور على إحدى الوجهات الحديثة المخزنة في ذاكرة الجهاز.
...
:::note
أثناء القيادة، يمكن [الإعلان](#voice-prompts) عن النقاط المحددة عند الاقتراب منها أو تجاوزها. راجع إعدادات [التوجيهات الصوتية](../navigation/guidance/voice-navigation.md) في المقالة المناسبة لإعداد إشعارات الصوت.
:::
...
نقاط الاهتمام (POIs) هي نوع من النقاط التي تحدد الأماكن أو الكائنات على الخريطة التي تهم المستخدمين أو ذات أهمية لهم. يتم تمييزها بأيقونات خاصة متوفرة في [إعدادات OsmAnd](../map/point-layers-on-map.md#poi-types) ويتم فرزها في مجموعات.

لبناء مسار إلى نقطة اهتمام في *Android Auto*، اتبع هذه الخطوات:

1. حدد نقطة الاهتمام المطلوبة من قائمة الفئات المتاحة، أو أدخل اسم نقطة الاهتمام باستخدام [البحث](#search).
2. يؤدي النقر على فئة إلى فتح الشاشة التالية مع قائمة بنقاط الاهتمام.
3. يؤدي النقر على عنصر في القائمة إلى فتح شاشة الملاحة.
4. يحسب OsmAnd المسار ويعرضه على شاشة *Android Auto*. انقر على زر **ابدأ** لبدء التنقل إلى هذا الموقع.
5. اعتمادًا على [إعدادات](../navigation/guidance/navigation-settings.md) تطبيق OsmAnd الخاص بك وسيارتك، قد تتلقى [توجيهات صوتية](#voice-prompts) لإرشادك إلى وجهة.
...
*المفضلة* هي إحدى وظائف OsmAnd التي تسمح لك بإنشاء نوع من الإشارات المرجعية (الملاحظات) على الخريطة. أثناء استخدام *Android Auto*، لا يمكنك إضافة أو تعديل المفضلة، بل يمكنك فقط استخدام الموجودة. يمكن العثور على قائمة [المفضلة](../personal/favorites.md#manage-favorites) في تطبيق OsmAnd *القائمة ← أماكني ← المفضلة*. إذا كنت ترغب في استخدامها للملاحة، أضف الأماكن الضرورية إلى المفضلة قبل توصيل الجهاز بنظام الوسائط المتعددة في سيارتك.
...
لتحديد وجهتك النهائية كعلامة خريطة، تحتاج أولاً إلى إنشاء العدد المطلوب من العلامات في تطبيق OsmAnd على جهازك قبل توصيله بالنظام. يجب أن تكون العلامات متاحة في قائمة *القائمة ← علامة الخريطة*. يتم وصف هذا بمزيد من التفصيل في مقالة [العلامات](../personal/markers.md).
...
يمكن أيضًا تحديد المسارات مباشرة على شاشة السيارة في *Android Auto*. يتم تنظيمها في مجلدات قمت بإنشائها، وللوصول السهل والسريع إلى المسارات المفتوحة مؤخرًا، يوجد مجلد خاص [آخر تعديل](#folder-last-modified).

### البحث {#search}

![Android Auto](@site/static/img/navigation/auto-car/android_auto_search.png)

يمنحك الانتقال إلى البحث وصولاً سريعًا إلى قائمة [سجل الوجهات](#history) الأخير. وبالمثل مع [قائمة الملاحة](../navigation/setup/route-navigation.md#navigation-menu)، حيث يتم جمع جميع طرق وجهة OsmAnd مثل العنوان أو نقاط الاهتمام أو الإحداثيات.
...
- [نقطة الاهتمام](../search/search-poi.md) و [نقطة الاهتمام المخصصة](../search/search-poi.md) - ستعرض قائمة الأسماء المتشابهة القريبة أيضًا نقاط الاهتمام أو فئاتها.
- [البحث عن الإحداثيات](../search/search-address#coordinates-search) - أدخل الإحداثيات للعثور على النقطة على الخريطة.

### مجلد آخر تعديل {#folder-last-modified}

![Android Auto](@site/static/img/navigation/auto-car/android_auto_last_modified.png)

تحتوي فئات المفضلة والمسارات على مجلد خاص *آخر تعديل*. نظرًا لأن القائمة في هذه الفئات يمكن أن تكون كبيرة جدًا لأنها تحتوي على جميع مفضلاتك أو مساراتك الموجودة، فإن هذا المجلد ضروري للوصول السهل والسريع إلى وجهاتك الأحدث.
...
### الانعطاف التالي ومعلومات المسار {#next-turn--route-info}

![Android Auto](@site/static/img/navigation/auto-car/android_auto_alert_widget.png)

تعرض أداة **الانعطاف التالي** المسافة ونوع [مناورة الانعطاف التالية](../widgets/nav-widgets.md#next-turn) و [اسم الشارع](../widgets/nav-widgets.md#street-name).
...
- في *Android Auto*، لا يمكن تعيين عرض التنبيهات، تحتاج إلى تكوين الأداة في التطبيق قبل بدء الملاحة وتوصيل جهازك بالسيارة.
...
- أداة **عداد السرعة** [*تعتمد على الملف الشخصي*](../personal/profiles.md)، لذلك إذا قمت بتغيير الإعدادات لملف تعريف واحد، فلن يتم تطبيقها على ملف تعريف آخر.
- لا يوجد خيار لتخصيص عرض أداة **عداد السرعة** مباشرة في *Android Auto*، تحتاج إلى تكوينها في تطبيق OsmAnd قبل بدء الملاحة وتوصيل جهازك بالسيارة.
- لمزيد من المعلومات حول كيفية إضافة وتكوين أداة *عداد السرعة* إلى الشاشة، يرجى قراءة مقالة [أدوات المعلومات](../widgets/info-widgets.md#speedometer).
...
- بعد تكوين الإعدادات، سيتم عرض **زر ثلاثي الأبعاد** على شاشة *Android Auto* عند إغلاق قائمة الفئات للوجهات.
...
لتكوين [التوجيهات الصوتية](../navigation/guidance/voice-navigation.md) وفقًا للملف الشخصي المحدد، يجب عليك القيام بذلك قبل بدء مسار في تطبيق OsmAnd على جهازك. في *Android Auto*، يتوفر فقط إعداد إيقاف تشغيل أو تشغيل جميع التوجيهات الصوتية المحددة في نفس الوقت (*زر الإعداد ← التوجيهات الصوتية (تشغيل/إيقاف)*).

### الوقت المقدر للوصول إلى المحطة التالية {#eta-next-stop}

![Android Auto](@site/static/img/navigation/auto-car/android_auto_voice_prompt.png)

في تطبيق OsmAnd، يمكنك تحديد نقطة [أو أكثر من النقاط الوسيطة](../navigation/setup/route-navigation.md#intermediate-destinations) لمسار الملاحة.
...
يوفر *Android Auto* و OsmAnd القدرة على ضبط الخريطة لتتناسب مع ظروف الإضاءة. في *وضع خريطة النهار*، يظل نظام الألوان ساطعًا ومتباينًا، مما يسهل القراءة حتى في ضوء الشمس الساطع. في *وضع الليل*، تصبح الخرائط أغمق، مما يساعد السائق على التنقل بشكل أفضل في الظلام.
...
- حدد وضع النهار أو وضع الليل للحفاظ على عرض الخريطة دون تغيير.
- إذا كنت تريد أن يتحول وضع عرض الخريطة اعتمادًا على الوقت من اليوم، فحدد الوضع التلقائي.
...
يمكن فتح تطبيق OsmAnd واستخدامه للتنقل في *Android Auto* على شاشة نظام الوسائط المتعددة في السيارة في نفس الوقت مع تطبيقات الموسيقى أو الرسائل أو الإشعارات الأخرى. إعداد عرض تقسيم الشاشة على هاتف متصل بـ *Android Auto* أو على الشاشة في نظام سيارتك.
...
- **موضع شريط المهام:**
  انتقل إلى *إعدادات Android Auto ← إظهار عناصر التحكم السريعة للتطبيقات* وقم بتبديل المفتاح إلى وضع الإيقاف. سيؤدي هذا إلى نقل شريط المهام من الأسفل إلى جانب الشاشة.
...
4. أسئلة شائعة حول شاشة الاتصال:
    ...
    - *هل يمكنني تعطيل الشاشة المقفلة واستخدام التطبيق على هاتفي؟*
        لا، يفرض Android Auto هذا القيد لمنع التشتت أثناء القيادة.
    - *ماذا يجب أن أفعل إذا بدا أن هاتفي وشاشة السيارة غير متصلين؟*
