...
2. **<Translate android="true" ids="navigate_point_format_DM"/>**
    ...
    **Graus e Minutos (DM)**. Neste formato, as coordenadas de latitude e longitude são registadas usando graus e minutos. Por exemplo, 37:46.29 de latitude e -122:25.10 de longitude para São Francisco. Este formato pode ser menos preciso e pode levar mais tempo para ser inserido.
