...
<!--
### Tipos de subscrições {#types-of-subscriptions}
...
<!--
:::danger Preços de Saldo de Verão

*Apresse-se! Esta oferta está disponível apenas até* **06 de agosto (23:00 CET)**.

:::

|    | OsmAnd Gratuito   | [OsmAnd+](#install-osmand-ios) /<br/> [Maps+](#install-osmand) Na Aplicação | [Maps+](#install-osmand-ios) Subscrição | [OsmAnd Pro](#install-osmand-ios) |
| :------------- | :------------- | :----------------------- | :------------------- | :----------- |
...
| [Transferências de mapas](../start-with/download-maps.md) |  <details><summary>**5 transferências de mapas** <br /> (a atualização do mapa conta como transferência):</summary> <br /> - A transferência ou atualização do mapa significa apenas a transferência-atualização de um mapa de país (região).<br /> - **Mapa de visão geral do mundo**, **Correção de altitude do mundo**, **Fontes de mapa** e **Avisos de voz** não são contados como 5 possibilidades de transferência.</details> | ✔ | ✔ |
| [Atualizações mensais de mapas](../personal/maps-resources.md#update-maps) |  <details><summary>**Uma vez por mês** <br /> (com 2 dias de atraso):</summary> * limitado a 5 transferências (a atualização do mapa conta como transferência) </details> |  ✔ | ✔ |
...
<!--
## Guias de Ação {#action-guides}

- Restaurar os seus dados após o vencimento das compras.
- Transferir compras do Android para o iOS ou vice-versa
- Uma compra (conta) para Android e iOS
-->
