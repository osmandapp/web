...
A função **Android Auto** é suportada apenas ao usar o aplicativo OsmAnd disponível na [Google Play Store](https://play.android.com/store/apps/dev?id=8483587772816822023).
