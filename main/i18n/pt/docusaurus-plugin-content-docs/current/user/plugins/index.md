...
Os plugins estendem significativamente a funcionalidade do OsmAnd. Cada um foi projetado para atender a uma tarefa ou caso de uso específico, como registrar uma viagem, acessar artigos da Wikipédia offline, visualizar dados de terreno ou fornecer uma visualização em nível de rua.
...
A maioria dos plugins está disponível gratuitamente, apenas os plugins na lista abaixo exigem a compra de uma licença [OsmAnd+ ou OsmAnd Pro](../purchases/index.md) para usar:
...
🤖 - *somente para a versão Android do OsmAnd.*

| Nome do Plugin | Recursos |
|:------------|:-------|
| [Wikipedia](#wikipedia) | [Camada do mapa](../plugins/wikipedia.md#download-wikipedia-packages), [Menu de contexto](../plugins/wikipedia.md#wikipedia-languages) |
| [Mapas online](#online-maps) |[Camada do mapa](../plugins/online-map.md#configure-map-source) |
...
| [Topografia](#topography) | [Camada do mapa](../plugins/topography.md#hillshade-slope-and-altitude-layers) |
| [Relevo 3D](#topography) 🤖 | [Camada do mapa](../plugins/topography.md#3d-relief) |
| [Clima](../plugins/weather.md) | [Camada do mapa](../plugins/weather.md#display-weather-on-the-map), [Widget](../plugins/weather#weather-widgets), [Tela](../plugins/weather.md#configure-screen) |
| [Visualização de mapa náutico](#nautical-map-view) | [Estilo do mapa](../plugins/nautical-charts.md#nautical-map-style), [Perfil](../plugins/nautical-charts.md#nautical-options) |
| [Visualização de mapa de esqui](#ski-map-view) | [Estilo do mapa](../plugins/ski-maps.md#set-winter-style), [Perfil](../plugins/ski-maps.md#skiing-profile) |
|[Notas de áudio/vídeo](#audiovideo-notes) 🤖 | [Camada do mapa](../plugins/audio-video-notes.md#show-all-on-the-map), [Menu de contexto](../plugins/audio-video-notes.md#create), [Widget](../plugins/audio-video-notes.md#recording-widget) |
|[Edição OpenStreetMap](#openstreetmap-editing)| [Camada do mapa](../plugins/osm-editing.md#how-to-use) |
...
|[Mapillary](#mapillary) | [Camada do mapa](../plugins/mapillary.md#map-layer), [Menu de contexto](../plugins/mapillary.md#map-context-menu), [Widget](../plugins/mapillary.md#mapillary-widget)|
...
| [OsmAnd Tracker](#osmand-tracker) 🤖 | [Camada do mapa](../plugins/osmand-tracker.md#active-marker-on-the-osmand-map), [Widget](../plugins/osmand-tracker.md#osmand-tracker-widget), [Menu de contexto](../plugins/osmand-tracker.md#active-marker-on-the-osmand-map) |
...
Para contar uma história de onde você esteve, os dados de GPS, como latitude e longitude de sua localização, podem ser registrados e armazenados em um arquivo, e então reutilizados, aprimorados, enriquecidos com waypoints, fornecidos para navegação, compartilhados com amigos, etc.

### [Topografia](./topography.md) {#topography}

Informações de topografia, como Linhas de Contorno, Relevo Sombreado, Inclinação, Relevo 3D, ajudam a fazer uma avaliação visual do terreno, vendo elevação, relevo, extremos, inclinação, pontos de igual altura, etc.

### [Visualização de Mapa Náutico](./nautical-charts.md) {#nautical-map-view}

A visualização de mapa náutico fornece representação gráfica detalhada de oceanos, mares, áreas costeiras e rios para ajudar você a navegar na água, ver rotas de tráfego populares, obstáculos na via navegável, portos, ancoradouros e outras referências essenciais.
...
O plugin de edição OpenStreetMap permite que você contribua para o OpenStreetMap, uma comunidade global que cria um mapa abrangente do mundo e fornece dados de código aberto atualizados e publicamente disponíveis.

### [Mapillary](./mapillary.md) {#mapillary}

Veja vistas em nível de rua de suas rotas ou pontos de interesse, fornecidas por [Mapillary](https://www.mapillary.com/) (é necessária uma conexão com a internet).
...
Mostra a previsão horária para o dia atual e para 7 dias à frente.
...
O OsmAnd Tracker ajuda você a ver onde seus contatos estão no mapa no OsmAnd. Apenas para Android.
