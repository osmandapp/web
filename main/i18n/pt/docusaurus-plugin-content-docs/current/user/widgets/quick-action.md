...
### Layout de Grade para Botões {#grid-layout-for-buttons}
...
| Mostrar / Ocultar <br/> [**Camadas de clima**](../plugins/weather.md#weather-layers) | Todos os dados meteorológicos são apresentados como camadas de mapa separadas. Com Ação Rápida, você pode ter acesso rápido para alternar a visibilidade dessas camadas no mapa. <br/> - ***Camada de precipitação*** <br/> - ***Camada de nuvens*** <br/> - ***Camada de pressão*** <br/> - ***Camada de vento*** <br/> - ***Camada de animação de vento*** <br/> - ***Camada de temperatura*** <br/> Há também **Camadas de clima** — um alternador mestre para todas as camadas de clima ativas. Desliga todas as camadas de clima atualmente ativadas de uma vez. Quando ligado novamente, restaura exatamente o mesmo conjunto de camadas que estavam ativas antes. |
...
| Alterar <br/> [**<Translate ios="true" ids="map_settings_under"/>**](../map/raster-maps.md) | Crie uma lista de fontes de mapa como uma subcamada de mapa e percorra-as. <br /> - *Nota*. Para alterar as subcamadas de mapa no OsmAnd, você pode configurar uma única ação rápida que permite alternar entre várias subcamadas de mapa, ou criar várias ações rápidas separadas, cada uma para uma subcamada de mapa específica.  |
| Alterar <br/> [**<Translate android="true" ids="quick_action_map_style"/>**](../map/map-styles.md#default-map-styles) | Crie uma lista de estilos de mapa para mapas vetoriais e percorra-os. Você pode mostrar ou ocultar o diálogo de seleção: <br /> - *Se o diálogo for exibido*, você pode escolher qualquer estilo da lista. <br /> - *Se o diálogo for oculto*, a ação funciona como um alternador de um toque (ciclo apenas). <br /> Ao percorrer, o rótulo da ação rápida com uma seta (por exemplo, > Náutico) mostra o próximo estilo de mapa que será aplicado no próximo toque, não o atualmente ativo. <br /> - *Nota*. Para alterar os estilos de mapa no OsmAnd, você pode configurar uma única ação rápida que permite alternar entre vários estilos de mapa, ou criar várias ações rápidas separadas, cada uma para um estilo de mapa específico. |
...
| Ação | Descrição |
|:-------------|:-------------|
| Navegar <br/> **Tela anterior** | Um alternador para navegar para a tela anterior. |
...
| Mover <br/> [**Para Minha localização**](../map/interact-with-map.md#my-position-and-zoom) | Move o mapa para a posição *Minha localização*. |
...
| Alterar <br/> [**Orientação do mapa**](../map/interact-with-map#map-orientation-modes) | Permite alterar o modo de rotação do mapa e alternar entre tipos de orientação selecionados. Você pode escolher quais modos incluir no ciclo. |
