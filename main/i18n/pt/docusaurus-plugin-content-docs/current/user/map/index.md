...
O mapa é um elemento central do OsmAnd. Nesta seção do Guia do Usuário, você pode encontrar informações úteis sobre como interagir com o mapa, como personalizar a visualização do mapa para caminhada, ciclismo ou navegação fora de estrada, como configurar camadas POI adicionais ou habilitar imagens em nível de rua etc.
...
## [Mapas Vetoriais](./vector-maps.md) {#vector-maps}

Os mapas vetoriais são projetados para serem uma fonte padrão de dados de mapa para o OsmAnd, portanto, precisam ser baixados para o dispositivo. Os mapas vetoriais suportam uma vasta gama de estilos de mapa para muitas atividades como ciclismo, caminhada, condução de carro ou motoneve, etc. Cada estilo de mapa pode ser ajustado para destacar ou ocultar objetos específicos e alternar entre o modo diurno e noturno. Os dados vetoriais do mapa podem ser aumentados por dados vetoriais e exibidos com o estilo de mapa padrão, por exemplo, informações de linha de contorno. Você pode criar seu próprio estilo de mapa OsmAnd para exibir as informações necessárias.

## [Estilos de Mapa (Mapas Vetoriais)](./map-styles.md) {#map-styles-vector-maps}

Os estilos de mapa definem como os dados de mapa vetorial são renderizados no OsmAnd. Um estilo controla a aparência visual dos objetos do mapa, como estradas, edifícios, uso do solo, água e pontos de interesse, incluindo cores, padrões de linha e rótulos.
...
## [Rastreios](./tracks) {#tracks}

A funcionalidade de rastreios permite que você crie e salve rotas para que possa retornar a elas facilmente mais tarde ou compartilhá-las com outras pessoas.

### [Menu de Contexto dos Rastreios](./tracks/track-context-menu.md) {#tracks-context-menu}

O menu de contexto dos rastreios é um menu com ações e dados de um rastreio GPX.

### [Aparência do Rastreio](./tracks/appearance.md) {#track-appearance}
