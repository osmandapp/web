...
| GPXLayer (nome do wpt)               | 90 300       | Texto     | Nome dos waypoints                    |
...
| Ícone fixme (OsmBugsLayer)         | 200 000      | Pontos   | Ícones fixme do OSM                   |
| Texto fixme (OsmBugsLayer)         | 200 000      | Texto     | Texto fixme do OSM                    |
...
| Nome do waypoint GPX            | 100 000      | Texto     | Nome dos waypoints GPX          |
| Ícone do waypoint GPX            | 100 003      | Pontos   | Waypoints GPX               |
| Início e fim da trilha GPX      | 120 000      | Pontos   | OAGPXLayer                  |
| Notas OSM (OAOsmBugsLayer)   | 120 000      | Texto     | Notas OSM                   |
| Texto fixme (OAOsmBugsLayer)  | 120 000      | Texto     | Texto fixme do OSM              |
| Ícone fixme (OAOsmBugsLayer)  | 120 000      | Pontos   | Ícone fixme do OSM              |
