...
- Melhorias na seleção de rotas e integração do gráfico de altitude sob o esquema de renderização atualizado.
...
- Abertura mais rápida de menus de contexto ao tocar em POIs, Favoritos, trilhas e edifícios.
