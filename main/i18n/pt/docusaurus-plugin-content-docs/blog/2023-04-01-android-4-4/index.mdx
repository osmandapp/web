...
- _Center_: use center screen position for the cursor (["My location"](https://osmand.net/docs/user/map/interact-with-map.md#my-location-and-zoom)),
- _Bottom_: use bottom screen position for the cursor (["My location"](https://osmand.net/docs/user/map/interact-with-map.md#my-location-and-zoom)),
