...
2. [Overaly/Underlay](http://osmand.net/docs/user/map/raster-maps#select-raster-maps) changes with arrows:
...
New [POIs and objects](http://osmand.net/docs/user/map/point-layers-on-map#points-of-interest-pois) have been added to offline maps in 4.2.
