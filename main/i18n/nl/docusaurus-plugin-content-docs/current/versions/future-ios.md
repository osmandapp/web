...
- Sneller openen van contextmenu's bij tikken op POI's, Favorieten, tracks en gebouwen.
- Correcte behandeling van relatiegebaseerde POI's op multipolygons.
- Gefixeerd “null” dat in plaats van een stadsnaam verscheen in POI-zoekresultaten en verbeterde consistentie van de nachtmodusachtergrond.
- Hersteld tikbaar gedrag voor fitness-, hardloop- en kano routes met shields.