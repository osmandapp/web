...
Wij zijn op zoek naar een ervaren en enthousiaste ontwikkelaar die onze open-source iOS-applicatie naar een hoger niveau kan tillen en deze de beste en krachtigste ter wereld kan maken.
...
- Databases: SQLite,oreData
- Technisch Engels (Intermediate+)
...
- Werken in een spannende en groeiende branche
...
- Je vaardigheden verbeteren door deel te nemen aan trainingen en mentorprogramma's
- Je carrière vooruithelpen door te kiezen uit verschillende carrièrepaden (technisch, management)
