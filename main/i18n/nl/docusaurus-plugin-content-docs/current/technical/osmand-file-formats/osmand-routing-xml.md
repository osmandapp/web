...
Routing.xml is een configuratiebestand dat meerdere routeringsprofielen opslaat. Elk profiel is onafhankelijk en heeft alleen het basis OsmAnd-profiel als referentie, daarom is het niet mogelijk om een hiërarchie van profielen te creëren en moet u alle regelonderdelen kopiëren. Elk is volledig configureerbaar via routing.xml, wat betekent dat er geen constanten in de code zijn en alle straffen worden berekend met behulp van deze configuratie.

In de applicatie kunt u meerdere aangepaste routing.xml-bestanden en profielen gebruiken; u kunt ze selecteren in Instellingen -> Profiel -> Navigatie-instellingen -> Routeringsinstellingen.
...
**Tabel met straffen fietsroutering:**

|                  **Optie**                 |**Helling:**| &lt;1% | &lt;3%  | &lt;7% | &lt;13% | &lt;25% | &gt;=25% |**Daling:**| &lt;17% | &lt;35% | &lt;60% | &gt;=60%      |
|:--------------------------------------------|:-----------|-----|------|-----|------|------|-------|:-----------|------|------|------|------------|
|**_Uitgeschakeld/Elke_** (de kortste maar zwaarste)|            |  -  |   -  |  -  |   -  |   -  |   -   |            |   -  |   -  |   -  |     -      |
...
**Tabel met straffen voetgangersroutering:**
