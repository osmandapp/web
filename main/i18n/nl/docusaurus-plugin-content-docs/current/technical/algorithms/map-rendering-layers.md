...
# Kaartlagen renderen {#map-layers-rendering}
...
## Android-volgordetabellen {#android-order-tables}
...
| GPXLayer (lijnen)                 | -500 000        | Lijnen   | Spoorlijnen                                                         |
...
| GPXLayer (wpt-naam)               | 90 300          | Tekst    | Waypointsnaam                                                       |
...
| POIMapLayer (naam)                | 300 000         | Tekst    | POI-overlaynaam                                                     |
...
## iOS-volgordetabellen {#ios-order-tables}
...
| POI-naam (OAPOILayer)        | 90 000          | Tekst    | POI-overlaynaam                                                                             |
| GPX-tracklijnen (OAGPXLayer) | 100 000         | Lijnen   | Spoorlijnen                                                                                 |
| GPX-waypointnaam             | 100 000         | Tekst    | GPX-waypointsnaam                                                                           |
...
| OAOsmEditsLayer              | 120 000         | Punten   | OSM-plug-in bewerken                                                                        |
