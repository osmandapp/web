...
# Kaartnavigatie-activiteit {#navigate-map-activity}
Er is een kaart en een schakelaar voor OpenGL-rendering, deze heeft een longClickListener op mapView, na de eerste tik wordt het startpunt geselecteerd, na de tweede tik selecteert het de finish en start het de routeberekening.
