...
# Navigeer Kaartactiviteit {#navigate-map-activity}
Er is een kaart en een schakelaar voor OpenGL-rendering, het heeft een longClickListener op mapView, na de eerste tik wordt het startpunt geselecteerd, na de tweede tik selecteert het de finish en start het de routeberekening.
  ...
  public class NavigateMapActivity extends AppCompatActivity  {
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		if (actionBar != null) {
			actionBar.setTitle("Navigeer kaart");
		...
		if (clickListener == null) {
			clickListener = new OnLongClickListener() {
				...
				public boolean onLongPressEvent(PointF point) {
					...
					if (start == null) {
						start = latLon;
						app.showShortToastMessage("Startpunt " + latLon.getLatitude() + " " + latLon.getLongitude());
					} else if (finish == null) {
						finish = latLon;
						app.showShortToastMessage("Eindpunt " + latLon.getLatitude() + " " + latLon.getLongitude());
						startNavigation();
					}
					return true;
				}
	...
	private void startNavigation() {
		...
		app.showShortToastMessage("Startnavigatie van " + start.getLatitude() + " " + start.getLongitude()
				+ " naar " + finish.getLatitude() + " " + finish.getLongitude());
