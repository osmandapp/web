...
U kunt ook alleen git gebruiken en de volgende git-repositories uitchecken naar de juiste mapnamen:
...
* Map **misc** - **[OsmAnd-misc](https://github.com/osmandapp/OsmAnd-misc.git)** (stand-alone hulpprogramma's)
    * ```git clone https://github.com/osmandapp/OsmAnd-misc.git misc```


U hebt mogelijk niet alle repositories nodig om tools / Android of iOS werkend te krijgen. U kunt altijd de corresponderende branches in [repo-configurations](https://github.com/osmandapp/OsmAnd-manifest) controleren.