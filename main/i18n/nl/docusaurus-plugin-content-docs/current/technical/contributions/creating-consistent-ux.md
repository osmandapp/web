...
Gebruik slechts **één uitdrukking** voor een bepaalde functie, mix geen twee mogelijke uitdrukkingen. Voorbeelden:
...
* We gebruiken _"positie"_ voor waar je bent, terwijl _"locatie"_ verwijst naar willekeurige punten
* We gebruiken _"bestemming"_, niet _"doel"_
* We gebruiken _"snelheid"_, niet _"velociteit"_
...
* Controleer de weergave van de bewoording in de app dubbel, met name op apparaten met een lage dichtheid. Te veel regeleinden, afgesneden tekst of opgeblazen menuknoppen kunnen een scherm of dialoog onbruikbaar maken.
* In sommige gevallen zijn er conventies, die het waard zijn om te controleren, in plaats van "iets uit te vinden". Dus als 99% van de commerciële navigatiesystemen in uw taal aankondigen "u heeft uw bestemming bereikt", dan is het gebruik van "u bent aangekomen waar u wilde gaan" misschien niet de beste keuze... :)
* Markeer alle functies die internettoegang vereisen duidelijk met de uitdrukking "online".
* De basistaal voor OsmAnd is Amerikaans Engels. Er is een vertaalmap voor Brits Engels voor alle uitdrukkingen en spelling die afwijkt.

## 3. Rendering {#3-rendering}

* Een opmerking over rendering: Het kaartuiterlijk van onze kaartstijlen is getest op bruikbaarheid en zichtbaarheid op een veelheid aan kaartlocaties, met veel apparaten en schermtechnologieën, en onder verschillende lichtomstandigheden. _"Spontane verbeteringen"_ aan de renderer zijn bijna altijd twijfelachtig, en vereisen op zijn minst meer onderzoek en testen dan u misschien denkt... :)