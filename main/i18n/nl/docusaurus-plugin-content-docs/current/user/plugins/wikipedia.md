...
Om Wikipedia-gegevens op de kaart weer te geven, moet je de volgende instellingen doen:
...
3. Selecteer de gewenste regio. Zodra de regio is geopend, zullen de Wikipedia-gegevens zich tussen andere pakketten bevinden.
...
Wanneer je op de Zoekknop tikt, verschijnt er een extra paneel waarmee je de hele tekst en/of een specifieke categorie kunt [doorzoeken](../search/index.md). In het eerste geval zullen de zoekresultaten Wikipedia POI's met bijbehorende Wikipedia-artikelen tonen, naast andere soorten informatie. In het geval van een [Wikipedia-categoriezoekopdracht](../search/search-poi.md#poi-search) zullen de zoekresultaten alleen Wikipedia-informatie tonen, gesorteerd op de dichtstbijzijnde locatie ten opzichte van het gebied van de kaart dat momenteel op het scherm wordt weergegeven.
...
4. Als je op die tekst tikt (voor de iOS-versie), word je doorgestuurd naar het offline Wikipedia-artikel.
...
Je kunt de [taal instellen](#set-preferred-language) waarin je [artikelen](#wikipedia-article) wilt lezen en ook [afbeeldingsdownloadopties](#download-images) configureren voor elk [profiel](../personal/profiles.md).
...
4. Selecteer specifieke taal (-talen) in de geopende lijst.
...
Als het *Wikipedia-artikel* in verschillende talen beschikbaar is, kun je tijdens het lezen van taal wisselen. Nadat je op het corresponderende pictogram in de rechterbovenhoek van het scherm hebt getikt, krijg je opties om uit te kiezen.
...
Je kunt kiezen of je afbeeldingen van Wikipedia wilt downloaden op je apparaat of niet, binnen het *Wikipedia-artikel*:
