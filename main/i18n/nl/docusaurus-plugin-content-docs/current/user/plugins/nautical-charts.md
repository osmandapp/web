...
De Nautische kaartweergave-plug-in is een [betaalde functie](../purchases/index.md) van de OsmAnd-app.
:::

Nautische kaartweergave is een gedetailleerde grafische weergave van oceanen, zeeën, kustgebieden en rivieren die u helpt bij het navigeren over het water en het kennen van populaire routes, obstakels in uw vaarweg, dichtstbijzijnde havens, ankerplaatsen en andere belangrijke oriëntatiepunten.

Een nautische kaart is een zeer gedetailleerde topografische kaart om schippers te helpen een vaartuig op een geselecteerde koers over het water te navigeren. Het is vergelijkbaar met een wegenkaart voor mensen die met de auto reizen. Vaak een *'kaart'* genoemd om historische redenen, is het een gedetailleerde grafische weergave van de oceanen, zeeën, kustgebieden en rivieren.

Nautische kaarten zijn belangrijk voor professionele zeilers en amateurs die een boot huren om door de grachten van de stad te varen. De kaarten bieden hen diverse informatie zoals vaarroutes, navigatielichten, gevarenzones, zones waar het is toegestaan of verboden om te varen of aan te leggen, enz.
...
Gebruik de [Kaartlegenda](../../user/map-legend/nautical-map.md) voor elke verwijzing naar wat er op de nautische kaart wordt weergegeven. Het verklaart de symbolische elementen op een nautische kaart en dient als referentie om u te helpen navigeren wanneer u twijfelt. Door de Nautische kaartstijl in te stellen, krijgt u de beste weergave van de gedownloade en weergegeven nautische gegevens.

Om de huidige kaartstijl naar Nautisch te wijzigen, moet u de volgende instellingen maken:
...
Voor een optimale presentatie kunnen kaarten worden aangepast aan de huidige behoeften: markeringen en symbolen kunnen worden toegevoegd met dieptepunten en, indien nodig, contouren. Aan de andere kant kunnen standaardkaarten met informatie over binnen-, land- en kustwateren voor een bepaalde regio een goede aanvulling zijn op de informatie over waterwegen op een Nautische kaart.

Wanneer u een nautische kaart [downloadt](../start-with/download-maps.md), verschijnen er meer details met betrekking tot *Boot*-navigatie op de kaart. Sommige soorten [Nautische kaarten](../start-with/download-maps.md#type-of-maps) bevatten details zoals:

- **Nautische markeringen en symbolen.**
Markeringen en symbolen bevatten alle nautische navigatiemarkeringen voor zowel binnenvaart als kustnavigatie. Het kennen van deze markeringen helpt u de locatie van rotsen, obstakels, ankerplaatsen, boeien, stromingen, diep en ondiep water en zijkanten van het kanaal te voorspellen, ongeacht de richting, enz. Markeringen en symbolen worden eenmaal gedownload voor de hele wereld.

- **Dieptepunten.**
Nautische gegevens van de dieptepuntpakketten worden weergegeven door nummers die op het water worden weergegeven en die de ondiepste diepte op een bepaalde locatie aangeven. Dieptepunten zijn beschikbaar voor elk halfrond en sommige regio's.
...
:::info Dieptecijfers
Alle dieptecijfers op de Nautische Kaarten zijn aangegeven in meters.
:::
...
:::info OPMERKING
Het uitschakelen van de Nautische plug-in verwijdert de geladen nautische gegevens niet, dus zelfs als u de weergavemethode van nautisch naar een andere methode wijzigt wanneer nautische gegevens zijn gedownload, blijven deze zichtbaar op de kaart.
:::
...
- Het detailniveau van de zeebodeminformatie instellen: [*Lijnbreedte* en *Lijnkleurenschema*](../map/vector-maps.md#-nautical-depth).

:::info OPMERKING
U kunt de OsmAnd-app helpen de dieptecontouren-database te vergroten door uw informatie toe te voegen via [OpenSeaMap](https://map.openseamap.org/)
:::
...
- **Alles** - toont naast het zeemarkeringssymbool, tag of categorie ook kwalificaties zoals fijn, plakkerig, grof, enz. Voor zeegras en zeewier toont het gegevens gemarkeerd met de *taxon* en *genus* tags.
