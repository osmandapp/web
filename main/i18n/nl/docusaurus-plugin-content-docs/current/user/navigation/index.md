...
In de sectie **[Routeparameters](./routing/osmand-routing.md#routing-types)** kunt u lezen over verschillende routetypes, zowel online als offline. Deze sectie beschrijft ook routeringsregels, die bepalen hoe uw route wordt berekend. Algemene routeparameters worden beschreven in het [indexartikel](./routing/osmand-routing.md#routing-types). Andere artikelen beschrijven de kenmerken van bepaalde routetypes.
- [Auto routering (Vrachtwagen, Motorfiets)](./routing/car-based-routing.md)
- [Fiets routering (MTB)](./routing/bicycle-based-routing.md)
- [Bromfiets routering](./routing/moped-routing.md)
- [Voetganger routering](./routing/pedestrian-routing.md)
- [Openbaar vervoer routering](./routing/public-transport-navigation.md)
- [Paardrijden routering](./routing/horse-routing.md)
- [Ski routering](./routing/ski-routing.md)
- [Trein routering](./routing/train-routing.md)
- [Boot routering](./routing/boat-navigation.md)
