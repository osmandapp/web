...
Er zijn drie manieren om toegang te krijgen tot het *Route Details menu*.

1. Ga naar het hoofd *Menu → Navigatie*, stel de route in en tik op de knop *Details*.
2. Tik op het *Navigatie*-pictogram op het kaartenoverzicht, stel de route in en tik op de knop *Details*.
3. Ga naar het *Mijn Plaatsen*-menu, tik op een beschikbare track in de lijst *Menu → Mijn Plaatsen → Tracks*, selecteer het *Navigatie*-pictogram in het trackcontextmenu in het *Overzicht* en tik op *Details*.
...
**Hoogte-informatie** wordt geleverd in alle offline OsmAnd-routeprofielen, behalve voor profielen die [Rechte lijn navigatie](../routing/straight-line-routing.md) gebruiken. De hoogtegegevens maken deel uit van de OsmAnd Offline Kaarten en worden berekend op basis van [Openbare SRTM-bronnen](https://en.wikipedia.org/wiki/Shuttle_Radar_Topography_Mission).

- *Hoogtebereik*. Geeft de minimale / maximale hoogte op de route weer.
- *Gemiddelde hoogte*. Geeft de gewogen gemiddelde hoogte op de route weer.
- *Omhoog / omlaag*. Geeft de verhouding van het pad tot de horizontaal weer, waarbij nul horizontaliteit aangeeft en het aantal graden een hogere of steilere hellingsgraad aangeeft. De helling toont de maximale weghelling in procenten vanaf uw locatiepunt tot het einde van de zichtbare grafiek, of voor het geselecteerde gedeelte van de route zonder het locatiepunt zichtbaar op het scherm.


***Een licentie voor DEM-gegevens gebruikt door OsmAnd voor terreindetectie***
De hoogtegegevens op de kaart (tussen 70 graden noorderbreedte en 70 graden zuiderbreedte) zijn verkregen uit metingen die zijn uitgevoerd als onderdeel van de *Shuttle Radar Topography Mission (SRTM)*. Er werd gebruik gemaakt van de *Advanced Spaceborne Thermal Emission and Reflection Radiometer (ASTER)*, het primaire beeldvormingsinstrument in *NASA's Earth Observation System*. Voor volledige informatie, zie de [Licentie](https://github.com/osmandapp/OsmAnd/blob/master/LICENSE#L146).
...
De [grafieken](../../map/tracks/track-context-menu.md#altitude--speed-graphs) geven visueel informatie weer over de hoogte en helling van uw navigatieroute en uw huidige positie op deze grafiek met de huidige hoogte en helling. De grafiek is op twee assen uitgezet. De X-as is de afstand op uw route. De eerste Y-as is de hoogte boven zeeniveau, waarvan de waarde afhankelijk is van het terrein, en de tweede Y-as is de benaderde [helling](https://en.wikipedia.org/wiki/Grade_(slope)). U kunt de hoogtegrafiek voor de hele route bekijken of alleen voor een geselecteerd interval door de grafiek te schalen.

- ***In-/uitzoomen***. Standaard toont de grafiek de route vanaf de huidige locatie tot uw bestemming. U kunt [tweevingerbewegingen](../../map/interact-with-map.md#gestures) gebruiken om in en uit te zoomen voor een gedetailleerder beeld. U kunt de grafiek ook naar rechts verplaatsen, vooruit op de route, en terug naar de huidige locatie. *Dergelijke manipulaties verwijzen ook naar het visuele informatieblok in het blok [Wegkenmerken](#road-attributes).*
...
- *Y-as*:
   ...
   - [*Helling*](https://wiki.openstreetmap.org/wiki/Key:incline). De [helling van de landvorm](https://en.wikipedia.org/wiki/Grade_(slope)) betekent de raaklijn van de hellingshoek van het oppervlak tot de horizontaal.
...
- *X-as*:
   ...
   - *Tijdstip van de dag*. U kunt routegegevens bekijken op bepaalde tijden van de dag.


### Soort interacties {#type-of-interactions}
...
- *Schaal*. Schaalgrafiek met [tweevingerbeweging](../../map/interact-with-map.md#gestures).
- *Volg Mijn locatie* (*alleen Android*). U kunt op [Mijn locatie](../../map/interact-with-map.md#my-location-and-zoom) tikken om de kaartweergave en grafiek te synchroniseren met uw locatie. Terwijl u beweegt, verschuift de grafiek van links naar rechts, waarbij informatie voor uw pad wordt weergegeven.
...
- [**Wegtype**](https://wiki.openstreetmap.org/wiki/Key:highway#Roads). Het type weg wordt bepaald op basis van het functionele doel en de kenmerken, zoals het aantal rijstroken, snelheidslimieten, draagvermogen, de aanwezigheid van voet- en fietspaden, bermen en andere parameters. Verschillende wegtypen kunnen verschillende beperkingen en verkeersregels hebben.

   Bijvoorbeeld, hoofdsnelwegen ([highways](https://wiki.openstreetmap.org/wiki/Tag:highway%3Dmotorway)) hebben meestal een hoge snelheidslimiet en kunnen in rijstroken worden verdeeld, en [lokale wegen](https://wiki.openstreetmap.org/wiki/Tag:highway%3Dresidential) kunnen een lage snelheidslimiet en één rijstrook in elke richting hebben.
...
- [**Wegdek**](https://wiki.openstreetmap.org/wiki/Key:surface). Wegdekken zijn de bovenste laag van het wegdek die in contact komt met de wielen van voertuigen. Ze kunnen van verschillende typen zijn, afhankelijk van hun eigenschappen en functionele doel.
   ...
   Bijvoorbeeld, [asfalt](https://wiki.openstreetmap.org/wiki/Tag:surface%3Dasphalt) biedt goede grip en geluidsisolatie, en [beton](https://wiki.openstreetmap.org/wiki/Tag:surface%3Dconcrete) is duurzamer en heeft een groter draagvermogen. Andere materialen zoals grind, steenslag, houten planken en andere kunnen ook worden gebruikt om een wegdek te creëren.

- [**Steilheid**](https://wiki.openstreetmap.org/wiki/Key:incline#Common_&_extreme_inclines). Dit is een meting van de hoek van de helling van de weg, uitgedrukt als een percentage. Het geeft aan hoe steil de weg omhoog of omlaag helt ten opzichte van de horizon, en het wordt berekend door de verticale verandering in weghoogte te meten door de horizontale afstand en de resulterende waarde met 100% te vermenigvuldigen.

   Bijvoorbeeld, als de steilheid van de weg 10% is, betekent dit dat voor elke 100 meter horizontale afstand langs de weg, u 10 meter omhoog of omlaag gaat. De steilheid van de weg kan de snelheid, het remmen, het brandstofverbruik en de rijveiligheid van uw voertuig beïnvloeden, vooral op gladde wegen in de winter.

- [**Oppervlaktehardheid**](https://wiki.openstreetmap.org/wiki/Key:tracktype). Het wegdek kan herstellen van vervorming of belasting. Hoe hoger de oppervlaktehardheid, hoe minder kans op schade aan het voertuig en hoe comfortabeler de weg zal zijn. Oppervlaktehardheid kan ook de voertuigsnelheid en het brandstofverbruik beïnvloeden.

- [**Helling**](https://wiki.openstreetmap.org/wiki/Key:incline). Geeft aan welk percentage hellingen er op uw route zijn.

- [**Gelijkheid**](https://wiki.openstreetmap.org/wiki/Key:smoothness). Van toepassing op alle soorten paden en gebieden, zoals snelwegen, parkeerplaatsen, stranden en paden, en geeft de bruikbaarheid van de route aan. Het geeft u informatie dat u kunt rijden zonder significant risico op schade, zoals voertuigonderstel, of letsel, zoals een val.
...
Turn-by-turn informatie biedt gedetailleerde [instructies](#instructions) over hoe u een route moet navigeren. Naast het *Details*-menu wordt het ook weergegeven in de widgets [*Route maneuvers*](../../widgets/nav-widgets.md#route-maneuvers) en [*Lanes*](../../widgets/nav-widgets.md#lanes). Deze informatie helpt u om uw route beter te navigeren en stelt u in staat om vooruit te plannen.

Tik op een specifiek gedeelte van de route in de lijst om gedetailleerde informatie te bekijken of wijzigingen aan te brengen indien nodig. De kaart vergroot en een [Contextmenu](../../map/map-context-menu.md) opent.
...
In de instructielijst geeft de **wegkantindicator** aan in welke richting vanaf uw huidige locatie en bewegingsrichting naar uw eindpunt uw bestemming is, dit kan links, rechts en rechtdoor zijn.
...
- `-180 °`&nbsp; &nbsp; tot &nbsp; &nbsp;`-60 °`&nbsp; &nbsp; - gemarkeerd als **linker** zijde.
- `60 °`&nbsp; &nbsp; &nbsp; &nbsp; tot &nbsp; &nbsp;`180 °`&nbsp; &nbsp; - gemarkeerd als **rechter** zijde.
...
De mogelijkheid om turn-by-turn informatie **af te drukken** of **op te slaan** **in PDF-formaat** is vooral handig bij lange reizen of op onbekende plaatsen wanneer u een gedetailleerder beeld wilt hebben van de route en de benodigde tijd om er te komen.
...
- **Exporteren/Opslaan**. Hiermee kunt u de route-informatie **opslaan als een nieuwe track** voor later offline gebruik. De geëxporteerde track bevat alle informatie over wegkenmerken en afslaginstructies. Dus, [navigatie met deze track](./gpx-navigation.md) zou alle functies moeten bieden als navigatie met de route.
...
- [Navigatie per track](./gpx-navigation.md)
- [Navigatie per markeringen](./markers-navigation.md)
