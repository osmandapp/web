...
De optie *Navigatie via een track* (GPX) stelt u in staat om een vooraf gedefinieerde route of track op een kaart te volgen. Dit kan bijzonder nuttig zijn voor buitenactiviteiten zoals wandelen, fietsen of off-road rijden, waarbij een geplande route de veiligheid en efficiëntie verbetert. Als u in een georganiseerde groep reist, helpt deze functie u en elk lid van de groep dezelfde route-informatie te hebben als de anderen.

De optie *Navigatie via een track* kan ook in het dagelijks leven worden gebruikt. U kunt een eerder [opgenomen track](../../plugins/trip-recording.md) gebruiken of [een track maken](../../personal/tracks/manage-tracks.md#create-a-track) en deze delen met uw familie of vrienden in plaats van hen de route uit te leggen. U kunt ook de [routes op de OsmAnd-kaart](../../../../blog/routes/) gebruiken voor navigatie. Hoe u deze op de kaart kunt markeren en wat hun kleuren betekenen, wordt beschreven in de sectie [Routes](../../map/vector-maps.md#routes) van het artikel *Vector kaarten*.

<Tabs groupId="operating-systems" queryString="current-os">

<TabItem value="android" label="Android">

![Navigatie via track scherm Android](@site/static/img/navigation/gpx/navigation_gpx_android.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Navigatie via track scherm iOS](@site/static/img/navigation/gpx/navigation_gpx_ios.png)
...
Voordat u de optie *Navigatie via een track* gebruikt, moet u de [track op de kaart weergeven](../../map/tracks/index.md#display-tracks-on-the-map). OsmAnd ondersteunt tracks als een lijn (**Geometrie**) en tracks als een route (**Route**) of een combinatie daarvan (**OsmAnd** door [Route plannen](../../plan-route/create-route.md)). Als u een track heeft als een verzameling **Waypoints**, kunt u [Navigatie via markeringen](./markers-navigation.md) gebruiken.


- **Geometrie**-tracks hebben standaard een zeer eenvoudige navigatie en bieden geen nauwkeurige afslagen, straatnamen en rijstroken. Om ontbrekende informatie te verkrijgen, moet u de tool [Aan wegen koppelen](#attach-to-the-roads) gebruiken.

- **Route**-tracks berekenen de route tussen routepunten volgens het geselecteerde profiel. Kortom, alle routepunten worden beschouwd als tussenpunten. Als uw route uit meer dan 50 punten bestaat, is het zeer waarschijnlijk dat het een verkeerd geconfigureerde **Geometrie**-track is.

- **OsmAnd**-tracks bestaan uit zowel geometrie- als routedeel, en zijn geschikt om exact dezelfde begeleiding te bieden als standaard navigatie. Deze tracks worden geproduceerd door [Route plannen](../../plan-route/create-route.md) of [Webversie](../../web/index.md). Het is mogelijk om deze track opnieuw op te slaan als een **Geometrie**-only track als [**Vereenvoudigd**](../../plan-route/create-route.md#save-route) om te gebruiken in programma's van derden.
...
Navigatie op een track kan worden gestart met de sneltoets in het [track-contextmenu](../../map/tracks/track-context-menu.md#add-waypoint-to-a-track) (geopend door een van de [gemarkeerde tracks](./route-navigation.md#history-of-previous-routes) op de kaart te selecteren, of door op een trackbestand te tikken in de sectie [Mijn plaatsen](../../personal/myplaces.md) van het *Hoofdmenu*) of vanuit het navigatiemenu, dat wordt geopend door te tikken op:

- [*Navigatieknop*](../../widgets/map-buttons.md#directions) op het kaarten scherm.
...
Voor navigatie, als de geselecteerde track uit meerdere segmenten of tracks bestaat, kunt u een specifiek segment of het hele GPX-trackbestand selecteren. Bij het **[importeren](../../personal/tracks/manage-tracks.md#import)** kunt u kiezen of u het in één bestand of in meerdere bestanden wilt opslaan.


### Trackopties volgen {#follow-track-options}
...
![Navigatie via track scherm Android](@site/static/img/navigation/gpx/follow_the_track_5-1_andr.png)
...
![Navigatie via track scherm iOS](@site/static/img/navigation/gpx/follow_the_track_4-1_ios.png)

</TabItem>

</Tabs>

- **Bewerken** (*potloodpictogram* naast de tracknaam) — Opent de track in de tool [*Route plannen*](../../plan-route/create-route.md).
...
- **<Translate android="true" ids="attach_to_the_roads"/>** — Configureert [een track aan de wegen koppelen](#attach-to-the-roads).
- **<Translate android="true" ids="pass_whole_track_descr"/>** (*Android*) / **<Translate ios="true" ids="point_to_navigate"/>** (*iOS*) — U kunt kiezen hoe u van mijn locatie naar de track navigeert:
...
- Voor grote tracks met veel punten kan het koppelingsproces iets langer duren. U ziet een **voortgangsindicator** (*oranje statuslijn*) die de koppelingsstatus weergeeft.
- Nadat de koppeling is voltooid, tikt u op **Toepassen** om de gewijzigde track te gebruiken voor navigatie.

#### Automatische koppeling aan de wegen {#automatic-attachment-to-the-roads}
...
Standaard wordt de functie **Aan wegen koppelen** **automatisch** uitgevoerd wanneer een track wordt geselecteerd voor navigatie. U kunt deze instelling naar behoefte wijzigen. Voor meer details, zie [Gedetailleerde trackbegeleiding](../guidance/navigation-settings.md#detailed-track-guidance) in het artikel *Navigatie-instellingen*.
...
In het menu [Track volgen](#follow-track-options) kunt u kiezen of u vanaf uw huidige locatie naar het startpunt van de track of naar het dichtstbijzijnde punt op de GPX-track wilt navigeren. U kunt ook [<Translate android="true" ids="nav_type_hint"/>](../routing/osmand-routing.md#routing-types) kiezen dat wordt gebruikt voor het start- en eindsegment van uw route.

### Waypoints {#waypoints}

Als de track waypoints heeft, kunt u [Weergeven langs de route](../guidance/map-during-navigation.md#show-points-along-the-route) en [Gesproken begeleiding](../guidance/voice-navigation.md#voice-settings) gebruiken om meldingen te ontvangen over nuttige plaatsen. U kunt **Waypoints** toevoegen aan een bestaande track via [Contextmenu](../../map/map-context-menu.md#-add--edit-track-waypoint--add--edit-track-waypoint), de track moet zichtbaar zijn op de kaart.

### Tussenpunten {#intermediate-points}

Bij het voorbereiden of navigeren van een GPX-track kunt u geen tussenliggende plaatsen toevoegen waar u doorheen wilt rijden binnen die track. U kunt alleen start- en eindpunten toewijzen naast de track of het segment dat u van plan bent te volgen.

## Begeleiding {#guidance}

*Navigatie via GPX-track* bevat dezelfde [gesproken instructies](../guidance/voice-navigation.md) als routenavigatie. Sommige afslagen of rotondes worden echter mogelijk niet correct geïnterpreteerd, omdat er geen informatie over wegkruisingen in GPX is, behalve voor GPX-bestanden die door OsmAnd zijn gemaakt. Om deze problemen te elimineren, moet u de functie [Aan wegen koppelen](#attach-to-the-roads) gebruiken.

Tijdens de navigatie kunt u verschillende opties gebruiken, zoals in- of uitzoomen, de kaart verschuiven of overschakelen naar een andere kaartstijl. Als u van de track afwijkt, berekent OsmAnd de route automatisch opnieuw om u weer op de track te brengen. U kunt ook de snelheid van de track aanpassen en hoorbare waarschuwingen instellen voor naderende punten of afwijkingen van de route.
...
- [Routetdetails](./route-details.md)
