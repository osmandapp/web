...
![Verschil markernavigatie Android](@site/static/img/navigation/marker/markers_ex_andr_2.png) ![Verschil markernavigatie Android](@site/static/img/navigation/marker/markers_ex_andr_1.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Verschil markernavigatie iOS 2](@site/static/img/navigation/marker/markers_ex_ios_2.png) ![Verschil markernavigatie iOS 1](@site/static/img/navigation/marker/markers_ex_ios_1.png)

</TabItem>

</Tabs>

*Kaartmarkeringen* kunnen dienen als [bestemmingen](./route-navigation#set-destinations) bij het maken van een route. Ze zijn vooral handig wanneer u een route met tussenpunten moet instellen.

*Kaartmarkeringen* bieden echter ook verschillende functionaliteiten, zoals [widgets](../../widgets/markers.md), bewegingsrichting, lijnen op de kaart, zodat u deze tools kunt gebruiken voor navigatie zonder een routelijn te bouwen en volledige stembegeleiding te starten.

Als u een eenvoudige punt-naar-punt navigatie wilt die als rechte lijnen wordt weergegeven, kunt u een ***Reisplanlijst*** maken en sorteren die bestaat uit markeringen als tussenpunten en widgets gebruiken voor eenvoudige navigatie.
...
1. Markeringen maken. Zoek het gewenste object(en) op de kaart, tik erop en kies de *[Markeringsknop](../../personal/markers.md#add--edit-markers)* in het *[kaartcontextmenu](../../map/map-context-menu.md#add--edit-marker)*. U kunt ook markeringen maken van [favorieten](#add-group-of-favorite) of [GPX-tracks](#add-group-of-track-waypoints).
2. [*Markeringen sorteren*](#sort-markers) op de gewenste manier waarop u ze wilt passeren
3. Pas de *Kaartmarkeringsweergave* aan als u markeringen wilt gebruiken zonder navigatie te starten. Schakel de opties **Pijlen op de kaart** en **Richtinglijn** in in het gedeelte *[Uiterlijk](../../personal/markers.md#appearance-on-the-map)* van het *[Kaartmarkeringsmenu](../../personal/markers.md#actions)*.
...
De reisplanlijst is een geordende lijst van *passeerbare* markeringen die zichtbaar zijn op de kaart. U kunt punten één voor één toevoegen en verwijderen of dit in bulk doen met behulp van een vooraf voorbereid [GPX-bestand](#add-group-of-track-waypoints) of [Favorietengroep](#add-group-of-favorite). Voor lokale wedstrijden of avonturen kan het handig zijn om een lijst met punten te maken van coördinaten met behulp van de [Coördinateninvoertool](../../plan-route/coordinate-input.md).


### Enkele markeringen toevoegen {#add-single-markers}

*Markeringen* kunnen aan de kaart worden toegevoegd of ervan worden verwijderd door een enkele tik op het scherm op de gewenste locatie. Volg daarna de instructies uit het artikel over het *[kaartcontextmenu](../../map/map-context-menu.md#add--edit-marker)*.
...
- &#128681; pictogram in het Favorieten in-paginamenu *(<Translate android="true" ids="shared_string_menu,shared_string_my_places"/>→Mijn favorieten→&#128681;)*.
- **'+'** (toevoegen) optie in het tabblad *[Groepen](../../personal/markers.md#marker-groups)* in het Kaartmarkeringsmenu *(<Translate android="true" ids="shared_string_menu,map_markers,shared_string_groups"/>→+)*.


### Groep trackwaypoints toevoegen {#add-group-of-track-waypoints}
...
- Gebruik de **'+'** (toevoegen) optie in het tabblad *[Groepen](../../personal/markers.md#marker-groups)* in het Kaartmarkeringsmenu *(<Translate android="true" ids="shared_string_menu,map_markers,shared_string_groups"/>→ +)*.
- Schakel de schakelaar naast de track in het tabblad *[Groepen](../../personal/markers.md#marker-groups)* in het Kaartmarkeringsmenu in *(<Translate android="true" ids="shared_string_menu,map_markers,shared_string_groups"/>→ +)*.

:::note
Alleen tracks met waypoints kunnen worden toegevoegd aan de *Kaartmarkeringslijst*. De track die u wilt toevoegen, moet ook zichtbaar (actief) zijn op de kaart.
:::
...
Door op de linkerbovenhoek (*Android*) of rechterbovenhoek (*iOS*) van een *Kaartmarkeringskaart* in de *[Kaartmarkeringslijst](../../personal/markers.md#itinerary-list)* te drukken en deze omhoog of omlaag te bewegen, kunt u de volgorde ervan in de *Navigatielijst* wijzigen (tijdens het verplaatsen van een markeringskaart ziet u een lijn die aangeeft waar de markering zal worden geplaatst).
...
- **Afstand** (*dichtstbijzijnde of verst weg eerst*) - Deze optie sorteert de markeringen op hun afstand tot uw huidige locatie.
...
Met de functionaliteit van de routeplanning in de markeringenlijsttool kunt u *Markeringen* *Van deur tot deur* sorteren, ze in omgekeerde volgorde plaatsen of een *Rondreis* maken. Als u op een *Navigatie*-optie tikt, worden *Markeringen* gebruikt als [tussenbestemmingen](../setup/route-navigation.md#intermediate-destinations).
...
Een *Markering* kan als gepasseerd (*Android*) of afgewezen (*iOS*) worden gemarkeerd.
