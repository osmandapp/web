...
Hoogtewidgets geven de hoogte boven zeeniveau van de huidige geolocatie en de hoogte van het kaartcentrum weer.
...
U kunt de widget gebruiken om de hoogte van het huidige kaartcentrum boven zeeniveau te achterhalen. Een [Terreinkaart (Hillshade en Helling)](../plugins/topography.md#download-maps) van het vereiste gebied is nodig om informatie weer te geven in de **Hoogte: kaartcentrum widget**.
...
Deze widget geeft de huidige tijd weer, afkomstig van uw apparaat.
...
De **Gemiddelde snelheid** widget berekent en toont uw gemiddelde snelheid over een geselecteerd tijdsinterval zonder dat navigatie of trackopname vereist is. Het is handig voor het controleren van de snelheidsnaleving op snelwegen of het bijhouden van de gemiddelde snelheid over de laatste paar minuten fietsen.

1. ***De widget configureren.***
   Om instellingen aan te passen, tikt u op de knop **Instellingen** (*Android*) of het **widgetveld** (*iOS*). Beschikbare opties zijn:
...
3. ***Stops meenemen in de berekening.***
   ...
   **Uitgeschakeld** — Stops worden meegenomen in de berekening, wat betekent dat lange pauzes de algehele gemiddelde snelheid zullen verminderen.
...
|:--------|:---------|
|![Zweefverhouding](@site/static/img/widgets/glide_ratio_3.png)|![Zweefverhouding](@site/blog/2023-12-22-android-4-6/img/glide_ratio_2.png)|
...
|Widgets| Widgets op het scherm|
|:--------|:---------|
|![Zweefverhouding](@site/static/img/widgets/glide_ratio_1_widget_ios.png)|![Zweefverhouding](@site/static/img/widgets/glide_ratio_widget_ios.png)|
...
De [eenvoudige](../widgets/configure-screen.md#widgets-for-all-panels) *Zweefverhouding* widgets biedt waardevolle informatie over de zweefverhouding om weloverwogen beslissingen te nemen bij het plannen van vliegroutes. De *Zweefverhouding* widget in OsmAnd helpt u de efficiëntie van uw daling of stijging te evalueren bij het navigeren naar een specifieke locatie ([marker](../personal/markers.md) positie op de kaart). Het berekent de zweefverhouding als de verhouding tussen de afstand en het hoogteverschil tussen uw huidige positie en uw beoogde bestemming. U kunt hier meer over lezen [hier](https://en.wikipedia.org/wiki/Lift-to-drag_ratio#Glide_ratio).


**Gebruik van widgets:**

- *Planning van zweefvluchten.* Voor zweefvliegers wordt de *Zweefverhouding naar doel* widget een onmisbaar hulpmiddel bij het plannen en uitvoeren van zweefvluchten. Piloten kunnen inschatten hoe ver ze naar hun doel kunnen vliegen, gegeven de huidige omstandigheden en de vereiste zweefverhouding.
- *Optimaliseren van stijgingen en dalingen.* De gemiddelde zweefverhouding stelt piloten in staat om stijgingen en dalingen te optimaliseren op basis van de huidige omstandigheden. Piloten kunnen de optimale timing voor stijgingen kiezen om de vliegtijd te maximaliseren, of voor dalingen om een doel te bereiken.
- *Reageren op veranderende omstandigheden.* De widget biedt continue updates van de zweefverhouding, waardoor piloten direct kunnen reageren op veranderingen in atmosferische omstandigheden of routes. Ze kunnen hun vliegplan aanpassen om veiligheid en efficiëntie te garanderen.
- *Maximaal gebruik van horizontale afstand.* Het kennen van de zweefverhouding stelt piloten in staat om de horizontale afstand maximaal te benutten om naar het doel te bewegen, wat vooral belangrijk is bij het plannen van lange vluchten.
- *Risicovermindering*. De *Zweefverhouding naar doel* widget helpt piloten situaties te vermijden waarin het bereiken van het doel onmogelijk wordt door onvoldoende zweefverhouding. Dit helpt risico's te verminderen en de vliegveiligheid te verbeteren.
...
### Zweefverhouding naar doel {#glide-ratio-to-target}

- **Zweefverhouding naar doel** toont de exacte zweefverhouding die nodig is om het doel te bereiken.
- **Doelhoogte** toont de hoogte van het doel. De [Kaartmarkering](../personal/markers.md) moet als doel worden gebruikt.

| | |
|:------------|:------------|
| Inschakelen | **Android:** *<Translate android="true" ids="shared_string_menu,map_widget_config"/> → Kies een paneel → Widget toevoegen → Zweefverhouding* |
| | **iOS:** *<Translate ios="true" ids="shared_string_menu,layer_map_appearance"/> → Kies een paneel → Widget toevoegen → Zweefverhouding* |
| Door te tikken | Wijzigt *Zweefverhouding naar doel* of *Doelhoogte* |
| Lang tikken | Opent het [Contextmenu van de widget](../widgets/configure-screen.md#widget-context-menu) |


### Gemiddelde zweefverhouding {#average-glide-ratio}

- **Gemiddelde zweefverhouding** toont de gemiddelde zweefverhouding voor een opgegeven tijdsinterval.
- **Gemiddelde verticale snelheid** geeft de snelheid aan waarmee een object stijgt of daalt gedurende een bepaalde tijd. Alleen de eerste en laatste punten van het tijdsinterval worden in aanmerking genomen voor evaluatie. U kunt het tijdsinterval voor deze widget instellen van 15 seconden tot 60 minuten. U moet de [Kaartmarkering](../personal/markers.md) als doel gebruiken.

| | |
|:------------|:------------|
| Inschakelen | **Android:** *<Translate android="true" ids="shared_string_menu,map_widget_config"/> → Kies een paneel → Widget toevoegen → Zweefverhouding* |
| | **iOS:** *<Translate ios="true" ids="shared_string_menu,layer_map_appearance"/> → Kies een paneel → Widget toevoegen → Zweefverhouding* |
| Door te tikken | Wijzigt *Gemiddelde zweefverhouding* of *Gemiddelde verticale snelheid* |
| Lang tikken | Opent het [Contextmenu van de widget](../widgets/configure-screen.md#widget-context-menu) |
...
De **Batterijniveau** widget geeft het batterijpercentage van uw apparaat direct op het kaartscherm weer en wordt automatisch minstens één keer per minuut bijgewerkt.
...
Zonpositie-widgets tonen de volgende zonsopgang- en zonsondergangtijden voor het midden van de kaart. Wanneer erop wordt getikt, geven ze de resterende tijd tot de verwachte zonsondergang of zonsopgang weer. In beide gevallen is de tijd gebaseerd op de geconfigureerde tijd van uw apparaat.
...
## Straal liniaal {#radius-ruler}

:::note
U kunt hier een meer gedetailleerde beschrijving lezen: **[Straal liniaal en Liniaal](../widgets/radius-ruler)**.
:::
...
![Straal-liniaal scherm](@site/static/img/widgets/radius_ruler_widget.png)
...
<table class="blogimage">
    <tr>
        <td><img src={require('@site/static/img/widgets/radius_ruler_widget_ios.png').default} alt="Straal-liniaal"/></td>
        <td><img src={require('@site/static/img/widgets/radius_ruler_widget_ios_1.png').default} alt="Straal-liniaal"/></td>
        <td><img src={require('@site/static/img/widgets/radius_ruler_widget_ios_2.png').default} alt="Straal-liniaal"/></td>
    </tr>
</table>
...
De Straal Liniaal widget toont de afstand tussen uw locatie en het middelpunt van de Straal Liniaal. De straal van de eerste cirkel is gelijk aan [de kaartschaal](../widgets/radius-ruler.md#ruler).
...
| Door te tikken | Wijzigt de status van de widget tussen zwarte schaal, grijswaarden en onzichtbare modi. |
| Lang tikken | Opent het [Contextmenu van de widget](../widgets/configure-screen.md#widget-context-menu) |
...
### Ritopname-widgets {#trip-recording-widgets}
...
Ritopname-widgets verwijzen naar [<Translate android="true" ids="record_plugin_name"/> plugin](../plugins/trip-recording.md#widgets). U kunt widgets gebruiken om korte informatie over de trackopname op het scherm te bekijken. Zoals *Afstand*, *Duur*, *Omhoog* en *Omlaag*.
...
:::note
Om widgets voor externe sensoren aan het kaartscherm toe te voegen, schakelt u de OsmAnd [Externe sensoren plugin](../plugins/external-sensors.md) in.
:::
...
- Om sensoren toe te voegen, selecteer een van de opties:
...
- Gebruik de [Ritopname plugin](../plugins/trip-recording.md#recording-settings) om sensorgegevens op te nemen.
...
![Voertuigstatistieken widgets Android](@site/static/img/widgets/vehicle_metrics_ios.png)
...
- Alle toegevoegde widgets zijn zichtbaar, ongeacht of een OBD-II scanner is aangesloten of niet.
...
:::note
Om Weerwidgets aan het kaartscherm toe te voegen, schakelt u de OsmAnd [Weerplugin](../plugins/weather.md) in.
:::
...
Weerwidgets tonen de huidige weersinformatie voor een centraal punt op de kaart. Ze worden automatisch ingeschakeld op het scherm wanneer ze met de plugin worden bekeken (*Menu → Weer*), en u kunt kiezen welke u op het startscherm wilt plaatsen voor dagelijks gebruik (*Menu → Scherm aanpassen*). U kunt hier meer over lezen in het artikel [Weerplugin](../plugins/weather.md).
...
- **Wolk**. <Translate android="true" ids="clouds_widget_desc"/>
...
De Parkeerplugin-widget toont de afstand van het midden van het scherm tot de parkeerlocatie. Om een parkeerplek op de kaart in te stellen, zoom in tot het gewenste niveau, tik dan lang op de plek op de kaart om het contextmenu te openen. Volg [deze instellingen](../plugins/parking.md#set-a-spot).
...
- *Op aanvraag*. Standaardtoestand. Elke keer wordt het actieselectiedialoogvenster weergegeven.
- *Audio opnemen* - neemt een audionotitie op.
- *Video opnemen* - stelt u in staat een video op te nemen.
- *Een foto maken* - stelt u in staat een foto te maken.
...
### Ontwikkelaar Widgets {#developer-widgets}

:::note
Om Ontwikkelaar widgets aan het kaartscherm toe te voegen, schakelt u de OsmAnd [OsmAnd ontwikkelingsplugin](../plugins/development.md) in.
:::

**Ontwikkelaar widgets** bieden informatie over de kaart [rendering snelheid](../plugins/development.md#map-rendering-fps-widget) en virtuele camerapositieparameters, inclusief [zoomniveau](../plugins/development.md#zoom-level), [afstand](../plugins/development.md#distance-to-target) tot het kaartcentrum, [camera-elevatie](../plugins/development.md#camera-elevation) en [kantelhoek](../plugins/development.md#camera-tilt).
...
De [Kaartweergave FPS widget](../plugins/development.md#map-rendering-fps-widget) geeft de weergavesnelheid van de kaart en de elementen ervan weer, gemeten in frames per seconde (FPS). Een hogere FPS-waarde duidt op snellere weergave en vloeiendere visuele prestaties.
...
| Door te tikken | Schakelen tussen modi (*Zoomniveau*) / Geen wijzigingen (*Andere*) |
| Lang tikken | Opent het [Contextmenu van de widget](../widgets/configure-screen.md#widget-context-menu) |
...
- **Totaal Applicatie RAM** — Geeft het totale geheugen aan dat is toegewezen aan OsmAnd, inclusief zowel gebruikt als beschikbaar geheugen.
