...
| Wijzigen <br/> [**<Translate android="true" ids="quick_action_map_style"/>**](../map/map-styles.md#default-map-styles) | Maak een lijst van kaartstijlen voor vectorkaarten en doorloop ze. U kunt het selectiedialoogvenster tonen of verbergen: <br /> - *Als het dialoogvenster wordt getoond*, kunt u elke stijl uit de lijst kiezen. <br /> - *Als het dialoogvenster is verborgen*, werkt de actie als een tikschakelaar (alleen cyclus). <br /> Bij het doorlopen toont het label van de snelle actie met een pijl (bijv. > Nautisch) de volgende kaartstijl die bij de volgende tik zal worden toegepast, niet de momenteel actieve. <br /> - *Opmerking*. Om kaartstijlen in OsmAnd te wijzigen, kunt u ofwel één snelle actie instellen waarmee u tussen meerdere kaartoverlays kunt wisselen, ofwel meerdere afzonderlijke snelle acties maken, elk voor een specifieke kaartstijl. |
