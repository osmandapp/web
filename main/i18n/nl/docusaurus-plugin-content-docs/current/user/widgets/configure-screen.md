...
- Righoogte kiezen en widgetpictogrammen in-/uitschakelen.
...
U kunt widgets toevoegen, herordenen, groeperen en verwijderen in de volgende panelen:
...
- **Bovenste en onderste panelen** tonen widgets in rijen. U kunt één of twee widgets per rij plaatsen en meerdere rijen toevoegen indien nodig.
...
***Op plug-ins gebaseerde widgets:***  
...
- [Ritregistratie](../widgets/info-widgets.md#trip-recording-widgets).  
    Start en stopt het opnemen van tracks en toont gegevens van trackopnamen.  
...
- Alleen beschikbaar in de **bovenste en onderste panelen** en moeten in afzonderlijke rijen worden geplaatst: *Coördinatenwidgets, Hoogteprofielwidget, Rijstrokenwidget, Kaartmarkeringsbalk, Straatnaamwidget*.
...
De functie **Rijmodus** stelt u in staat om zoveel rijen als nodig toe te voegen aan de bovenste en onderste panelen. U kunt meerdere widgets per rij weergeven, waardoor de hoeveelheid zichtbare informatie wordt vergroot.
...
- **Widgets herordenen**: Tik op de *Potlood*-knop (Android) of *Bewerken* (iOS) om de widgets te herschikken.
- **Rijen toevoegen**: Tik op de *Rij toevoegen*-knop om nieuwe rijen voor uw widgets te maken.
...
De modus stelt u in staat om **meer dan één widget in een enkele rij** toe te voegen aan de bovenste en onderste panelen om zoveel mogelijk informatie weer te geven.  
...
- Pagina's stellen u in staat om **widgetsets** te maken voor specifieke scenario's, waardoor de workflow wordt verbeterd en de rommel wordt verminderd.
...
1. **Opties voor widgetgrootte** (*voor alle panelen*):  
    U kunt de grootte van **eenvoudige widgets** aanpassen in de **bovenste, onderste, linker- en rechterpanelen**:
...
2. **Widgetpictogrammen verbergen** (*voor bovenste en onderste panelen*):
...
3. **Individuele grootte voor verschillende rijen** (*voor alle panelen*):
    ...
    - Widgets kunnen individueel worden vergroot door de rij- en kolomgrootte aan te passen.
    - **OPMERKING:** Het wijzigen van de grootte van één widget in een rij/kolom zal alle widgets in die rij/kolom vergroten.
...
4. **Om de widgetgrootte en pictogramzichtbaarheid te wijzigen:**
    ...
    - Schakel naar de uit-positie in het veld *Pictogram weergeven*.


## Paneelaanpassing {#panels-customization}
...
Het **widgetcontextmenu** biedt een snelle manier om widgets direct vanuit het kaartscherm te beheren en te configureren. U kunt het openen door ***lang te tikken*** op een willekeurige widget om de lay-out van widgets aan te passen zonder de kaart te verlaten.

**Voor bovenste en onderste panelen**  

- *Widget rechts/links toevoegen:*

    - Selecteer een positie voor de nieuwe widget ten opzichte van de huidige.
    - Kies de widget uit de lijst met [Beschikbare widgets](#widgets-for-all-panels).

**Voor linker- en rechterpanelen**  

- *Widget boven/onder toevoegen:*

    - Selecteer of de nieuwe widget boven of onder de huidige widget moet worden geplaatst.
    - Tik op de gewenste widget in de lijst om deze op de opgegeven positie toe te voegen.
...
- *Gemiddelde snelheid resetten*.
    ...
    - Lang tikken om de snelheidswaarde tijdens een reis direct te resetten.
...
- **De widget toevoegen**. Navigeer naar: *OsmAnd-menu → Scherm configureren → Widgets → Paneel →* **Widget toevoegen**.
- **Dupliceren met het contextmenu**. Tik op de widget en selecteer **Dupliceren** uit de lijst met acties.
- **Alternatieve methode**. Selecteer dezelfde widget uit de lijst met *Beschikbare widgets* en tik op *Toevoegen*.
...
U kunt widgets van het applicatiescherm herschikken of verwijderen met de modus **Bewerken**.  

***Hoe een widget te verplaatsen:***

- Ga naar: *OsmAnd-menu → Scherm configureren → Widgets → Paneel → Bewerken-knop*.
...
2. Het **drie-puntenmenu** op het scherm Standaardknoppen bevat acties zoals:

    - *Terugzetten naar standaard*. Hiermee kunt u de knopinstellingen terugzetten naar hun oorspronkelijke uiterlijk.
    - *Kopiëren van een ander profiel*. Selecteer uit welk profiel uit de aangeboden lijst u knopinstellingen wilt kopiëren.

3. **Het standaardknoppen uiterlijk** (*Alleen Android*) biedt een verscheidenheid aan aanpassingsopties voor dit type knoppen. Om het uiterlijk van een knop te wijzigen, tikt u op de gewenste knop in de lijst en selecteert u de optie [Uiterlijk](#button-appearance).


### Knoppen uiterlijk {#button-appearance}

<InfoAndroidOnly/>

![Button Appearance](@site/static/img/widgets/button_appearance_settings_andr.png)

De functie *Knoppen uiterlijk* stelt u in staat om het uiterlijk van knoppen op uw kaartinterface volledig aan te passen. Deze aanpassingsopties zijn beschikbaar voor zowel *Snelle actie (aangepaste knoppen)* als *Standaardknoppen*, wat uitgebreide controle biedt over het uiterlijk van de kaartinterface en nauwkeurige aanpassingen aan het knopontwerp mogelijk maakt.

***Aanpassingsopties***:

- **Pictogram**. Kies uit een lijst met pictogrammen die acties vertegenwoordigen die u al hebt toegevoegd, waardoor functies in één oogopslag gemakkelijk te identificeren zijn.
- **Hoekradius**. Pas deze instelling aan om de vorm van de knop te wijzigen, variëerend van scherpe, vierkante hoeken tot vloeiende, afgeronde randen.
- **Grootte**. Kies de knopgrootte die het beste bij uw scherm past en opvalt zoals nodig. Voor *Standaardknoppen* zijn de groottes vooraf ingesteld en kunnen ze niet worden aangepast.
- **Achtergronddekking**. Beheer de zichtbaarheid van de achtergrond van de knop. U kunt deze volledig zichtbaar of gedeeltelijk transparant instellen, of alleen de frameschaduw en het pictogram weergeven.
...
- [Snelheidsmeter](../widgets/info-widgets.md#speedometer). Toont de huidige snelheid op basis van GPS-gegevens en de beperkte snelheid op basis van [OpenStreetMap-gegevens](https://wiki.openstreetmap.org/wiki/Key:maxspeed). De weergegeven gegevens zijn ook afhankelijk van de instelling [Snelheidslimiet tolerantie](../navigation/guidance/voice-navigation.md#speed-limit) van OsmAnd.
...
- **<Translate android="true" ids="position_on_map_bottom"/>**. *Mijn locatie* wordt iets onder het midden van het scherm geplaatst. Deze modus stelt u in staat meer kaartinformatie voor uw beweging te zien, wat handig is tijdens navigatie.
- **<Translate android="true" ids="shared_string_automatic"/>**. Plaatst *Mijn locatie* afhankelijk van de *[Kaartoriëntatie](../map/interact-with-map.md#map-orientation-modes)* (*Onder* - voor bewegingsrichting, *Midden* - voor alle andere).
...
- *Android / iOS*. Bevindt zich op de schermen van elk paneel in het *drie-puntenmenu* in de rechterbovenhoek van het scherm.
...
- **Kopiëren van een ander profiel**. Met deze functie kunt u snel instellingen van een ander profiel importeren, de gewenste uit de lijst selecteren en kopiëren.
...
- Voor **Android**-apparaten kunt u profielen wijzigen bovenaan het startscherm van het scherm Configureren met behulp van de beschikbare profielpictogrammen.  
- Als u een **iOS**-apparaat gebruikt, tikt u op het profielpictogram in de bovenhoek van het startscherm van het scherm Configureren en selecteert u het gewenste profiel uit de lijst om het te activeren.  
