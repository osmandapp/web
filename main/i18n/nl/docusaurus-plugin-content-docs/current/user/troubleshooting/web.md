...
2. Klik op ***Extra → Browsertools → Webontwikkelaarstools → Console***, of druk op **Ctrl + Shift + I** (Windows/Linux) of **Cmd + Opt + I** (macOS) om de **Ontwikkelaarsconsole** te openen.
...
2. Druk op **F12** of **Ctrl + Shift + I** om **Ontwikkelaarstools** te openen.
3. Klik op het tabblad **Console** om eventuele fouten of waarschuwingen te bekijken.
4. Indien nodig, klik met de rechtermuisknop in de console, kies **Opslaan als…** en sla de foutlog op voor indiening.
...
- Als het probleem aanhoudt, start u uw browser opnieuw op of probeert u een andere browser te gebruiken.