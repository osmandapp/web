...
sidebar_position: 10
title: Videotutorials en Gidsen
---
...
We hebben een uitgebreide collectie videotutorials en gidsen samengesteld op ons [officiële OsmAnd YouTube-kanaal](https://www.youtube.com/@OsmAndMapsNavigation/playlists), speciaal ontworpen voor onze wereldwijde gebruikers. De afspeellijsten zijn handig georganiseerd per taal, waardoor het eenvoudig is om tutorials, functieoverzichten en door gebruikers gegenereerde inhoud in uw voorkeurstaal te vinden. Of u nu uw begrip van OsmAnd wilt verdiepen, nieuwe functies wilt leren of wilt ontdekken hoe de community OsmAnd gebruikt, u zult iets nuttigs vinden. De volgende secties bieden directe links naar de afspeellijsten die beschikbaar zijn in verschillende talen.
...
We werken deze afspeellijsten regelmatig bij om ervoor te zorgen dat u de meest actuele informatie over de functies en tools van OsmAnd hebt.
...
- **Video**: _Previewing Elevation: OsmAnd for Android & iOS (versions 4.5)_  
...
### Italiaans: Motortourgids {#italian-motorcycle-travel-guide}
...
- Van [Pedro on a Trail Bike](https://www.youtube.com/@pedroenmototrail)  
...
## Ga aan de slag met OsmAnd: delen, voorstellen en verbinden {#engage-with-osmand-share-suggest-and-connect}

Als u suggesties hebt voor inhoud of uw video op ons kanaal wilt laten plaatsen, neem dan gerust contact met ons op. We zijn altijd op zoek naar frisse, hoogwaardige bijdragen om onze OsmAnd-videobibliotheek uit te breiden.  
