...
- Tik op het *Zoek*-pictogram en tik vervolgens op *Filter* in de rij [*Sorteren op*](./manage-tracks.md#sort-by).

- **Kies de vereiste filterinstellingen** om uw trackzoekopdracht te verfijnen.

- Tik op **Toon** in de rechterbenedenhoek om de gefilterde resultaten te zien. Het aantal overeenkomende tracks verschijnt tussen haakjes.
...
- **Tijd in beweging** — Geef het tijdsbereik op dat in beweging is doorgebracht tijdens de opname.
...
- **Type activiteit** — Filter tracks op basis van het type [activiteiten](../../map/tracks/track-context-menu.md#track-information-activity) dat in het GPX-bestand is vastgelegd (bijv. fietsen, wandelen).
...
4. **Regels aanpassen.**
    Maak gepersonaliseerde trackcollecties door aangepaste filterregels te definiëren.
...
1. Tik op het pictogram ***drie-puntjesmenu*** in het tabblad *Tracks* van het menu *Mijn plaatsen*.
...
4. **Sla** de instellingen op.
    - Tik op **Toon** om een voorbeeld van de tracks te bekijken.
    - Selecteer de knop **Opslaan** om de *Slimme map* te voltooien.

De nieuw gemaakte **Slimme map** zal automatisch de inhoud bijwerken met tracks die overeenkomen met de geselecteerde criteria.
...
De **Slimme map** wordt weergegeven met een uniek pictogram in de mappenlijst in het tabblad Tracks. Om de map te beheren, tikt u op het *drie-puntjesmenu* ernaast (*Android*) en *lang tikken* (*iOS*) of opent u de map en gebruikt u het pictogram in de rechterbovenhoek.
...
- **Naam bewerken** (*Android*) / **Hernoemen** (*iOS*) — Wijzig de mapnaam voor eenvoudigere identificatie.
