...
### Decimale coördinaten {#decimal-coordinates}

![Coördinaten zoeken Android](@site/static/img/search/coordinates_search_degrees_andr.png)  

**<Translate android="true" ids="navigate_point_format_D"/>**. In dit formaat worden de breedte- en lengtegraadcoördinaten in decimaal formaat geschreven, bijvoorbeeld 52.37022° breedtegraad en 4.89517° lengtegraad voor Amsterdam. Deze invoermethode is gemakkelijk te gebruiken en is de meest voorkomende. U kunt hier meer lezen over het formaat van decimale coördinaten [hier](https://en.wikipedia.org/wiki/Decimal_degrees).  
...
### Graden en minuten {#degrees-and-minutes}

![Coördinaten zoeken Android](@site/static/img/search/coordinates_search_DM_andr.png)  

**<Translate android="true" ids="navigate_point_format_DM"/>**. In dit formaat worden de breedte- en lengtegraadcoördinaten vastgelegd met behulp van graden en minuten. Bijvoorbeeld, 37:46.29 breedtegraad en -122:25.10 lengtegraad voor San Francisco. Dit formaat kan minder nauwkeurig zijn en het kan langer duren om in te voeren.
...
- [Coördinaatinvoer](../plan-route/coordinate-input.md)
- [Contextmenu van de kaart](../map/map-context-menu.md)
- [Informatieve widgets](../widgets/info-widgets.md)
