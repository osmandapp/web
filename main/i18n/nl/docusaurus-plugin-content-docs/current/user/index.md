...
De kaart is een kernelement van OsmAnd. Dit gedeelte legt uit hoe u met de kaart kunt omgaan, hoe u extra POI-lagen configureert, hoe u de kaart aanpast voor trekking, fietsen of offroad-navigatie, hoe u terreininformatie toevoegt, hoe u straatbeeldweergave inschakelt, enz.
...
OsmAnd maakt het mogelijk om verschillende kaartgegevens, zoals kaarten, punten, tracks, en persoonlijke gegevens, zoals instellingen van het applicatieprofiel, op te slaan en te beheren.
...
Met OsmAnd kunt u uw eigen routes maken en routes van andere gebruikers gebruiken voor reizen.
...
### [Web Routeplanner](./web/index.md) {#web-route-planner}
