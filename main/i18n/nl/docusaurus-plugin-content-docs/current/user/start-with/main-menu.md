...
Het **Hoofdmenu** is een primaire lijst met opties die in de applicatie kunnen worden gebruikt. Het biedt snelle toegang tot de profielconfiguratie, algemene instellingen, zoeken, persoonlijke gegevens, navigatie en andere functies.

Het [Hoofdmenu](../widgets/map-buttons.md#main-menu) icoon '&#8801;' bevindt zich in de linkerbenedenhoek van het Kaartscherm. In de navigatiemodus is deze knop standaard niet zichtbaar. Het verschijnt na een korte tik op de kaart.
...
- [Kaartmarkeringen](../personal/markers.md) is een hulpmiddel waarmee u plaatsen op de kaart kunt markeren.
...
- Met de knop [Routebeschrijving](../widgets/map-buttons.md#directions) kunt u een route maken en de navigatie starten.
...
- [* Ritregistratie](../plugins/trip-recording.md) (*Android*) is een hulpmiddel waarmee u alle bewegingen kunt vastleggen in een track met behulp van de GPS van de telefoon.
...
- Met dit menu kunt u de volgorde wijzigen, items verbergen of weergeven vanuit de [Lade](../personal/profiles.md#drawer), een lijst met items van een ander profiel kopiëren en de standaardinstellingen herstellen.  
