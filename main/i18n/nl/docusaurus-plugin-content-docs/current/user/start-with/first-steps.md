...
Ontdek hoe u kaarten downloadt, hoe u de applicatie configureert, hoe u de kaart gebruikt en een route bouwt, hoe u navigatie start en hoe u interessante plaatsen zoekt. Maak kennis met de belangrijkste punten van het privacybeleid van OsmAnd en de vereiste machtigingen.
...
OsmAnd is een mobiele applicatie voor kaarten en navigatie, beschikbaar voor **Android** en **iOS**. U kunt deze downloaden via de populairste marktplaatsen.

**Android-marktplaatsen**: [Google Play Store](https://play.google.com/store/apps/details?id=net.osmand) en [Huawei AppGallery](https://appgallery.huawei.com/#/app/C101486545).
...
Ons doel is om een volledig functionele, kaartgerichte applicatie te creëren die voor verschillende doeleinden offline en online kan worden gebruikt. De applicatie heeft veel functies, zodat u niet hoeft te schakelen tussen verschillende apps en alles binnen handbereik is.

- Bekijk een wereldwijde kaart met veel details, weergegeven in [verschillende kaartstijlen](../map/vector-maps.md).
- Toon, [zoek](../search/search-poi.md) en bewaar verschillende [Interessante plaatsen](../map/point-layers-on-map.md).
- [Plan een route](../plan-route/create-route.md) met de auto, fiets, te voet en combineer deze tot multimodale routes.
- Start [stemgeleide navigatie](../navigation/guidance/voice-navigation.md) wanneer u het scherm aan- en uitzet.
...
- Alles werkt **offline**.
- En vergeet niet bij te dragen aan [OpenStreetMap](https://www.openstreetmap.org/) met de [OSM Editing Plugin](../plugins/osm-editing.md).
...
We raden u aan OsmAnd toestemming te geven om informatie over de precieze locatie van uw apparaat te ontvangen. Wij verzamelen, gebruiken of delen uw privégegevens niet, dus toegang tot precieze geolocatie is nodig voor een correcte offline werking van zoek-, navigatie- en andere OsmAnd-functies.
...
![Op de kaart tonen](@site/static/img/steps/start_screen_download_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Op de kaart tonen](@site/static/img/steps/start_screen_download_ios.png)
...
OsmAnd kan niet correct werken zonder gedownloade offline kaarten. Hoewel de applicatie [Vector](../map/vector-maps.md) en [Raster](../map/raster-maps.md) kaarten ondersteunt, wordt sterk aanbevolen om te beginnen met vector offline kaarten om alle functies zoals [Zoeken](../search/index.md), [Navigatie](../navigation/index.md) en [Contextmenu](../map/map-context-menu.md) correct te laten werken.
:::
...
Op sommige Android-apparaten (Xiaomi met MIUI 14) is er geen optie om app-talen afzonderlijk in de systeeminstellingen in te stellen, dus de taal van OsmAnd kan alleen worden gewijzigd met de taal van het hele systeem. U kunt de discussie op [GitHub](https://github.com/osmandapp/OsmAnd/issues/16990) bekijken voor aanvullende informatie.
:::
...
![Kaart configureren Android](@site/static/img/settings/configure_map_menu_android.png) ![Kaartvoorbeeld configureren Android](@site/static/img/settings/configure_map_example_android.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Kaart configureren iOS](@site/static/img/settings/configure_map_menu_ios.png) ![Kaartvoorbeeld configureren iOS](@site/static/img/settings/configure_map_example_ios.png)
...
Met [Scherm configureren](../widgets/configure-screen.md) kunt u [Informatieve](../widgets/info-widgets.md) (hoogte, snelheid, huidige tijd, enz.) en [Navigatie](../widgets/nav-widgets.md) (bestemming, koers, aankomsttijd, enz.) widgets, [Snelle actie](../widgets/quick-action.md) en andere elementen inschakelen die over de kaart worden weergegeven.

<Tabs groupId="operating-systems" queryString="current-os">

<TabItem value="android" label="Android">

![Scherm configureren Android](@site/static/img/widgets/configure_screen_android.png) ![Schermvoorbeeld configureren Android](@site/static/img/settings/configure_screen_example_android.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Scherm configureren iOS](@site/static/img/settings/configure_screen_ios.png) ![Schermvoorbeeld configureren iOS](@site/static/img/settings/configure_screen_example_ios.png)
...
[Interessante plaatsen (POI)](../map/point-layers-on-map.md#points-of-interest-pois) zijn voorzieningen die kunnen worden gezocht of gemarkeerd op de kaart. Ze vertegenwoordigen interessante of nuttige plaatsen en worden gedistribueerd als onderdeel van [Vector Kaarten](../map/vector-maps.md). U kunt ze gebruiken om [op de kaart weer te geven](../map/point-layers-on-map.md#points-of-interest-pois), [te navigeren](../navigation/index.md) en [te zoeken](../search/search-poi.md) naar interessante plaatsen op de kaart.
...
OsmAnd biedt veel zoekmogelijkheden, inclusief adres zoeken. Standaard gebruikt het [OpenStreetMap-gegevens](https://nominatim.openstreetmap.org/ui/search.html) en zou het alle adressen moeten kunnen vinden met behulp van de snelle zoekinvoer. U kunt ook [zoeken](../search/search-address.md) op stad, straat, postcode en coördinaten.
...
[Navigatie](../navigation/index.md) biedt u stap-voor-stap begeleiding naar uw bestemming door de route weer te geven, afslag-voor-afslag instructies te geven, extra weginformatie over oppervlak, gladheid, enz., en optionele stembegeleiding.
...
[Reisopname](../plugins/trip-recording.md) is een speciaal hulpmiddel verpakt als een OsmAnd-plugin waarmee u alle bewegingen op de track kunt opnemen met behulp van de GPS van het apparaat.
...
[Applicatiesnelkoppelingen](https://support.google.com/android/answer/9450271) zijn beschikbaar voor het OsmAnd-pictogram. Tik lang op het OsmAnd-pictogram op het scherm van uw apparaat om het menu met applicatiesnelkoppelingen te openen. Hier kunt u kort drukken om de volgende acties te selecteren: *Navigeren naar thuis*, *Navigeren naar werk*, *Opname starten*, *Zoeken*, *Mijn plaatsen*, *Navigeren naar*. Lang tikken op een actie stelt u in staat om een nieuw actiepictogram toe te voegen aan het scherm van uw apparaat.
...
In het *Help-menu* vindt u ook nuttige links naar de sociale netwerken van OsmAnd, versie-informatie over uw applicatie, release-opmerkingen en ondersteuningscontacten. Via Help kunt u ook [logcat- en crashlogs](../troubleshooting/crash-logs.md#crash-and-logcat-logs) verzenden.
...
- **Log verzenden** (*voor iOS*). Voert een vergelijkbare functie uit als de *Crashlog verzenden*-functie voor Android, waardoor gebruikers op iOS-apparaten app-crashes kunnen rapporteren aan ontwikkelaars voor debugging-doeleinden.
- **Buildversie kopiëren**. Hiermee kunnen gebruikers snel en nauwkeurig de huidige versie van de app communiceren aan ontwikkelaars bij het rapporteren van problemen, wat het diagnose- en oplossingsproces vereenvoudigt.
...
Oplossingen en tips voor het oplossen van veelvoorkomende problemen. Als u een specifieke vraag heeft, controleer dan [Probleemoplossing](../troubleshooting/index.md) om deze beantwoord te krijgen.
...
U kunt meer te weten komen over ons team, de huidige versie van de app zien en wat er nieuw is, en de bètaversie van de app downloaden.


## Privacy {#privacy}

Het is een [open source](https://github.com/osmandapp/osmand), advertentievrije / tracker-vrije privacygerichte applicatie. Om maximale privacy te behouden, biedt OsmAnd offline kaarten als eerste optie, zodat er geen interactie of geo-informatie van uw apparaat lekt. We zijn zeer attent op welke gegevens worden verzameld en welke gegevens via het netwerk worden overgedragen. U kunt meer lezen in ons [Privacybeleid](https://osmand.net/help-online/privacy-policy).
...
- **Internet**. Eerste download / update offline kaarten. Het kan ook nodig zijn om toegang te krijgen tot online functies zoals [Street Level Imagery](../map/point-layers-on-map.md#-street-level-imagery), [Online foto's](../map/map-context-menu.md#online-photos) of [Online kaarten](../map/raster-maps.md).
- **GPS** / **GSM-netwerk**. Bepaal uw locatie, volg u in een navigatiemodus en leg uw reis vast (optioneel). Deze toestemming wordt gevraagd wanneer u op de [mijn locatie-knop](../widgets/map-buttons.md#my-location-and-zoom) klikt of wanneer u [navigatie start](../navigation/setup/route-navigation.md#start--stop-navigation).
