...
Het [OsmAnd Kaartportaal](https://osmand.net/map) is een browsergebaseerde dienst van OsmAnd, waarmee gebruikers kaarten kunnen verkennen, hun gegevens kunnen beheren, reizen kunnen plannen en creëren, of simpelweg door de kaart kunnen bladeren.
...
- Totaal gebruikt opslagvolume
- Beschikbare cloudopslagruimte

> 💡 Alleen back-ups die zijn gemaakt op apparaten waar **OsmAnd Cloud** is ingeschakeld, verschijnen hier.
...
3. Registreer uw [Pro- of Start-account](../troubleshooting/setup.md#cross-platform) op de OsmAnd-server binnen de OsmAnd-app.
4. Het geregistreerde e-mailadres zal uw login zijn om OsmAnd Pro op het webplatform te activeren. De eerste keer moet u een wachtwoord kiezen voor toekomstige toegang tot het webportaal (volg de instructies op het webportaal).
