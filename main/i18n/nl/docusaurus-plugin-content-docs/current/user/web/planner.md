...
- **Klik met de rechtermuisknop** op de kaart om waypoints toe te voegen:
  ...
  - *Navigeer via*. Voeg indien nodig tussenpunten toe.
...
Met de [**Route plannen**](../plan-route/create-route.md)-tool van OsmAnd Web kunt u tracks maken en bewerken, vergelijkbaar met de mobiele app. Zo kunt u tracks maken en beheren:


***Een nieuwe route maken:***

- *Klik met de rechtermuisknop* op de kaart en selecteer **Nieuwe route maken**.
- U kunt ook de knop **Track maken** gebruiken in het menu *Lokaal* (rechtsboven met de *Potlood*- en *Upload*-knoppen).
...
- **Routegegevens bekijken**. Krijg toegang tot gedetailleerde trackinformatie, inclusief lengte, duur en terrein.
...
- *Opslaan in de cloud*. Sla uw track op in OsmAnd Cloud voor toegang op meerdere apparaten.
...
- *Wegdetails*. Bekijk gedetailleerde informatie zoals wegtype, ondergrond en steilheid.
...
- Verwijder individuele waypoints indien nodig.

**Bochtenpaneel**:

- Bekijk gedetailleerde informatie over bochten langs de track.
...
- **Aangepaste routeprofielen**. Pas profielen aan verschillende activiteiten aan, zoals fietsen of wandelen.
