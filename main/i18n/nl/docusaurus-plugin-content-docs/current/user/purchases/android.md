...
|------------|------------|------------|------------|
| **OsmAnd Start** | Een **gratis abonnement** dat toegang biedt tot [OsmAnd Cloud](../personal/osmand-cloud.md#osmand-start) voor *Favorieten*, *Instellingen* en *OSM-bewerking/notities*. | Beschikbaar voor alle gebruikers van de gratis OsmAnd-versie. | Beperkt tot basis cloudfuncties en **5MB** opslag. |
...
3. **OsmAnd Pro is een *cross-platform* abonnement**. Dit betekent dat u het in de ene winkel (bijv. *Google Play, Huawei AppGallery, AppStore* en *osmand.net*) kunt kopen en in een andere kunt herstellen door [uw aankoop te koppelen aan uw OsmAnd Cloud-account](../personal/osmand-cloud.md#cross-platform).

4. U kunt **OsmAnd+** toevoegen aan **[Google Play Family Library](https://support.google.com/googleplay/answer/7007852?hl=en)** om de aankoop te delen met familieleden.


## Prijzen {#prices}

In de lijst staat informatie over de prijzen van het OsmAnd-product voor de VS en Europa. Voor andere regio's zijn de prijzen gelijk in lokale valuta.
...
De onderstaande tabel geeft een overzicht van de functies die zijn opgenomen in zowel de gratis als de betaalde pakketten van OsmAnd, samen met hun respectievelijke prijzen.
...
| [Onbeperkt kaarten downloaden](../start-with/download-maps.md) | <details><summary>**7 kaartdownloads**</summary> - Kaartdownload of -update betekent alleen het downloaden/updaten van een land (regio) kaart. <br/> - **Wereldoverzichtskaart**, **Wereldhoogtecorrectie**, **Kaartlettertypen** en **Spraakprompts** worden niet meegeteld als 7 downloadmogelijkheden. </details> | ✔ | ✔ |
| [Maandelijkse kaartupdates](../personal/maps-resources.md#update-maps)<br/>Eén keer per maand (met 2 dagen vertraging) | <details><summary>**7 kaartdownloads**</summary> Kaartupdate telt als download.</details> | ✔ | ✔ |
...
| [Voertuigmetriek-widgets](../plugins/vehicle-metrics.md#widgets) | <details><summary>**2 widgets gratis**</summary><ul><li>*Voertuigsnelheid*</li><li>*Motorsnelheid*</li></ul></details> | <details><summary>**2 widgets gratis**</summary><ul><li>*Voertuigsnelheid*</li><li>*Motorsnelheid*</li></ul></details> | ✔ |
...
| [Audio/afbeelding/video-punten](../plugins/audio-video-notes.md) | ✔ | ✔ | ✔ |
...
| :------------- | :------------- |
| [OsmAnd Cloud](../personal/osmand-cloud.md) | Maak een back-up van uw gegevens en herstel ze, synchroniseer gegevens met de [OsmAnd webportal](https://www.osmand.net/map). |
| [Cross-platform](../personal/osmand-cloud.md#cross-platform) | Mogelijkheid om OsmAnd Pro en OsmAnd Start op alle platforms te gebruiken (Android *↔* iOS *↔* Web). |
| [3D-reliëf](../plugins/topography.md#3d-relief) | Hiermee kunt u een schaalmodel van uw buurt of een heel continent hebben en bekijken. |
...
| [Voertuigmetriek-plugin (OBD-II)](../plugins/vehicle-metrics.md) | Hiermee kunt u een OBD-II-scanner aansluiten om gedetailleerde voertuiggegevens weer te geven in de OsmAnd-app en de informatie op te slaan in trackrecords. Voertuigsnelheid en motorsnelheid zijn beschikbaar voor OsmAnd gratis. |
...
Eenvoudige manier om het gewenste abonnement te kiezen en te kopen via het menu **Aankopen**. Natuurlijk ziet u een voorstelmenu voor betaalde functies.
...
Om de aankoop te herstellen, controleert u welk OsmAnd-abonnement u hebt gekocht.
...
**Om uw *in-app aankoop* of *abonnement* te herstellen ([Maps+, Pro, OsmAnd Live](#difference-between-purchases-android)).**
...
[Gedetailleerde handleiding voor het kopen van Google Play-cadeaubonnen](https://support.google.com/googleplay/answer/3422734?hl=en).
