...
# Actividad de mapa de navegación {#navigate-map-activity}
Hay un mapa y un interruptor para la representación de opengl, tiene un longClickListener en mapView, después del primer toque se selecciona el punto de inicio, después del segundo toque selecciona el final y comienza el cálculo de la ruta.
