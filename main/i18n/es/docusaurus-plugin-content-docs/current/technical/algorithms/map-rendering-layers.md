...
| --------------------------------- | -------------: | ---- | ------------------------------------- |
| MapTileLayer (subyacente)           | -50 000        | Mapa  | Baldosas ráster subyacentes                 |
| MapTileLayer (capa principal)         | 5 000          | Mapa  | Baldosas ráster del mapa                      |
...
| MapTileLayer (superpuesta)            | 70 000         | Mapa  | Superposición de baldosas ráster                  |
...
| GPXLayer (líneas)                  | -500 000     | Líneas    | Líneas de pista             |
...
| ------------------------------- | ----------: | ------------------------------------- |
| OAUnderlayMapLayer              | -5          | Baldosas ráster subyacentes                 |
| Capa ráster (MapRasterLayerProvider) | 0     | Baldosas ráster del mapa                      |
| OATerrainMapLayer                | 4          | [Líneas de contorno, sombreado de relieve y pendiente](/docs/user/plugins/topography) |
| OAOverlayMapLayer                | 5          | Superposición de baldosas ráster                  |
...
| Líneas de pista GPX (OAGPXLayer) | 100 000      | Líneas    | Líneas de pista                 |
