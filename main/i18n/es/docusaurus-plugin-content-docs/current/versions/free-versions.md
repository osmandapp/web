...
Puedes obtener la última versión de OsmAnd gratis en las tiendas de aplicaciones listadas.
...
- Las unidades de temperatura se movieron a la configuración general para un acceso más fácil.
- Añadido indicador de nivel de batería para sensores BLE.
- Nueva interfaz de usuario más intuitiva para la selección de puntos en Navegación.
...
- Añadida la posibilidad de personalizar la apariencia predeterminada de los grupos de favoritos
- Android Auto: ver ETA y distancia al siguiente punto de referencia; los nombres de las ciudades ahora aparecen en los resultados de búsqueda
...
- Añadido TTS en hebreo para la navegación
...
- Introducido un nuevo plugin "Métricas del vehículo" para monitorizar el rendimiento del vehículo usando el protocolo OBD-II.
...
- Introducida la apariencia personalizable del botón del mapa y una cuadrícula precisa.
...
- Corregida la pérdida de datos del sensor para la pista que se está grabando actualmente.
...
- Añadido un icono pulsable para mostrar los atributos de acceso u otros atributos de carretera o sendero.
...
- Clima: Actualización de la interfaz de usuario, añadida animación de viento.
- Mejoras en la pista 3D: nuevas opciones de visualización y coloración.
- Selección ampliada de rutas turísticas en el mapa.
- Añadida opción de tema de la aplicación para seguir el modo de mapa.
- Corregidas las estadísticas de pista, la clasificación y la búsqueda.
- Edición de OSM: eliminado el método de autorización de inicio de sesión/contraseña.
...
- Personalizar "Distancia durante la navegación": elegir entre números precisos o redondeados.
...
- OsmAnd Cloud: Ahora accede a archivos eliminados.
- Coloración de pista mejorada en modo Pendiente con nuevo gradiente simétrico.
- Resueltos problemas con la barra de estado transparente.
- Añadido soporte para widget de temperatura ANT+.
...
- Añadido soporte para "Vía ferrata" para el enrutamiento peatonal.
...
- Accesibilidad: el tamaño del objetivo táctil para los botones cambió a 48 dp; corregido el problema con la interfaz de usuario del mapa visible para los lectores de pantalla.
...
- Corregidos problemas con la visualización de lugares veganos
- Añadida la posibilidad de descargar mosaicos en línea utilizados como mapas de "Superposición" o "Subyacente"
...
- Corregidos los gestos del mapa para la inclinación, el zoom y la rotación
...
- Animación suave de los cambios de ubicación mientras está en movimiento
- Nuevos widgets para coordenadas del centro del mapa y elevación de geolocalizaciones
- "Distancia al toque": añadidas opciones de tamaño de texto
- Widget "Marcador de mapa": añadida opción para cambiar el comportamiento del clic
- Corregida la opción "Posición de visualización"
...
- Añadida opción para deshabilitar la descarga de UUID
...
- Grupos de favoritos: establece la apariencia predeterminada para los nuevos puntos del grupo.
...
- Favoritos: añadida la capacidad de ver los iconos usados recientemente
...
- Diálogo de "Grabación de viaje" actualizado
- La distancia por toque se movió de la regla de radio a una opción separada
- Planificar ruta horizontal: añadidas pestañas para cambiar entre puntos o gráficos
- Planificar ruta: añadida la capacidad de cambiar las opciones de navegación, acceder a configurar mapa y buscar sin salir de planificar ruta
- Nueva pantalla de compra con información detallada sobre la compra
- Añadidos nuevos tipos de PDI, clubes: música, social, scout, masonería
...
- Corregido el problema con las unidades de medida
- Corregido el problema al compartir más de cien puntos favoritos
- Corregidos los bloqueos con el transporte público
...
- Planificar ruta: gráficos para segmentos de pista con ruta, y añadida la capacidad de crear y editar múltiples segmentos de pista.
- Añadido método de autenticación OAuth para OpenStreetMap, interfaz de usuario mejorada de los diálogos de OSM.
- Soporte de colores personalizados para favoritos y puntos de referencia de pista.
...
- Corregidos problemas con la importación/exportación de configuraciones de perfil
...
- Personalización completa de favoritos y puntos de referencia GPX: colores, iconos y formas personalizados
...
- Perfiles: ahora puedes cambiar el orden, establecer un icono para el mapa, cambiar todas las configuraciones para los perfiles base y restaurarlos a los valores predeterminados.
- Añadido número de salida en la navegación.
- Configuraciones de plugins reelaboradas.
- Pantalla de configuración reelaborada para un acceso rápido a todos los perfiles.
- Añadida opción para copiar configuraciones de otro perfil.
...
- Añadidos datos de Puesta/Salida del sol a Configurar mapa.
- Añadidos iconos de Casa/Trabajo en el mapa.
- Añadido soporte para descripción multilínea en Configuración.
...
- Corregidos algunos problemas de enrutamiento en todo el mundo
- Mapa base actualizado con una red de carreteras más detallada
- Corregidas las áreas inundadas en todo el mundo
- Enrutamiento de esquí: añadido perfil de altura y complejidad de la ruta a los detalles de la ruta
...
- Corregida la selección de idioma de Wikipedia
- Corregido el comportamiento del botón de la brújula durante la navegación
- Corrección de errores
...
- Nueva pantalla de Direcciones: Muestra los botones de destino Casa y Trabajo, acceso directo a rutas anteriores, lista de pistas activas, historial de búsqueda
- Información adicional en *Detalles de la ruta*: tipos de carretera, superficie, pendiente, suavidad
- Navegación en transporte público
- Nueva acción rápida para mostrar/ocultar pistas y modos día/noche
- Corregidas las zonas inundadas en Alemania, Sudáfrica, Quebec
- Importación mejorada para KML y KMZ
- Corregidos los bloqueos al abrir algunas paradas de transporte público
- Eliminadas las analíticas de Facebook y Firebase
...
- Corregido el bloqueo al iniciar que ocurría con mapas no latinos
- Mejorada la velocidad de renderizado en dispositivos Android 8.0
...
- Navegación: Corregida la barra de progreso, intercambio rápido del punto de inicio y fin de la ruta
- Marcadores de mapa: corregir la activación/desactivación de grupos, capacidad de ocultar marcadores del mapa
- Edición de OSM: Capacidad de editar etiquetas para objetos y vías no puntuales, corregir comentarios faltantes en notas, copia de seguridad de ediciones
- Mejorar el análisis de Wikipedia y Wikivoyage, los archivos actualizados ya están disponibles
- Menú contextual: corregir el color de los escudos de transporte en el modo nocturno, corregir los tamaños de menú adicionales
- Navegación en barco: soporte para la vía navegable
...
- Nuevo menú Viajes: ver artículos de WikiVoyage sin usar internet
- Wikipedia: nueva apariencia, enlaces activos, imágenes
- Abrir interfaz de usuario de pista: mostrar grupos de puntos de referencia
...
- Menú contextual actualizado: muestra cuándo abre/cierra el PDI
- Menú de transporte: todas las rutas disponibles ahora están en la parte superior
- Wikipedia: añadido el botón para abrir el artículo original, actualizada la apariencia de los artículos
- Ruta: añadida la posibilidad de intercambiar puntos de inicio y fin con un solo toque
- Notas: añadida la clasificación por tipo y fecha
...
- Marcadores de mapa completamente reelaborados con guías y planificación de rutas
- Herramienta de medición de distancia, que ofrece la función de ajuste a la carretera y el guardado de puntos como pista
...
- Perfiles de elevación y pendiente para rutas. Consulta los detalles de elevación de cada ruta
- Líneas de contorno de profundidades náuticas
- Configuración del estilo de conducción para ciclistas
...
- Iconos clicables en el mapa. Obtén información sin la capa PDI
- Búsqueda de PDI muy detallada. Encuentra ubicaciones por múltiples características
- Ocultar brújula. Ve la brújula solo cuando la necesites
...
- Búsqueda rápida. Todos los tipos de consultas en un solo campo de búsqueda
- Integración del sistema de audio del coche. Utiliza el sistema de audio de tu coche para la navegación por voz
- Mejor información de transporte público. Consulta rutas completas de transporte público vinculadas a paradas
...
- Beta de OSM Live. Un nuevo sistema que fomenta a los cartógrafos y proporciona actualizaciones constantes
- Interfaz de marcadores de mapa completamente nueva
- Menú de preparación de rutas reelaborado
- Escudos de autopistas diseñados por país
...
- Mejor recálculo de ruta (después de repetidos intentos, el motor ahora sugiere una ruta diferente)
- La búsqueda de PDI ahora admite consultas más específicas
- Estructura e interfaz de descarga de datos de mapas reelaboradas
...
- Mejor recálculo de ruta (después de varios intentos, el motor sugiere una ruta diferente)
...
Fecha de lanzamiento 04/2015:

- Diseño de materiales
- Nueva pantalla de mapa
- Panel con diferentes tarjetas
- Mis lugares y pistas rediseñados
- Ediciones de OSM y notas de OSM simplificadas para uso sin conexión
...
- Notificaciones visuales y de audio opcionales al acercarse a los puntos de referencia
...
- Añadido aviso de voz para cuando se vuelve a la ruta
...
- Estilos de mapa nuevos y actualizados, incluidos OsmAnd, LightRS, UniRS
- Más detalles y parámetros de configuración para los estilos de mapa
...
- OsmAnd ahora habilita automáticamente el servicio de modo de suspensión GPS si se ha activado la navegación o la grabación de viajes, para que esto continúe funcionando mientras la pantalla del dispositivo está apagada. Solo si se desea, el servicio de modo de suspensión GPS aún puede interrumpirse o configurarse manualmente tocando el widget "Estado del GPS".
...
- Más configuración para la navegación (ocultar botones automáticamente, hablar con antelación)
- Iniciar navegación automáticamente después de un retraso
...
- Nuevo mapa base mundial con carreteras principales, ferrocarriles y características de área importantes como bosques.
...
- Corrección de errores con el enrutamiento y la renderización
...
- Más capacidades de aviso de voz (nombres de calles anunciados)
- Iconos de mapa de alta densidad
- Corrección de errores en la visualización de distancias, analizador GPX, manejo de puntos de referencia, widget de planificación, carga de OSM, https.
...
- Ordenar los puntos de referencia de forma óptima para visitarlos todos (Vendedor viajero, puerta a puerta)
...
- Reimplementar soporte para tabletas y pantallas grandes
- Tema Holo (personalización)
- Configuraciones adicionales para estabilizar la brújula
...
- Introducidos mapas solo de carreteras.
...
- Soporte para idiomas árabe, kannada y RTL
...
- Detección de dirección: se indica y anuncia 'Hacer un giro en U' cuando se dirige en dirección opuesta o después de perder un giro
...
- Administrador de datos sin conexión (descargar, eliminar, activar/desactivar datos sin conexión directamente en OsmAnd)
- Puntos y grupos favoritos (categorizar, eliminar, administrar favoritos)
- Información de altitud
- Explorador GPX en la aplicación (ver detalles de la pista, distancia, velocidad media, elevación, etc.)
- Navegación GPX (más opciones, continuar navegación después de un bloqueo, soporte de rotondas)
- Función para guardar la ruta como pista GPX para uso sin conexión
- Mejorar el monitoreo GPX (filtrar algunas posiciones imprecisas y guardar precisión/elevación/velocidad)
- [Subir GPX](https://download.osmand.net/gpx/) a la comunidad OSM
- Motor de texto a voz para navegación por voz
