...
El enrutamiento para bicicletas tiene en cuenta factores como la disponibilidad de carriles bici, senderos y carreteras que son seguras y legales para los ciclistas. OsmAnd siempre utiliza datos de elevación al calcular la hora estimada de llegada (tiempo para cubrir la distancia) según la [regla de Naismith](https://en.wikipedia.org/wiki/Naismith%27s_rule#Scarf's_equivalence_between_distance_and_climb). Por defecto se proporciona la ruta más rápida. El enrutamiento para bicicletas también tiene en cuenta factores adicionales como el [ancho](../guidance/vehicle-parameters.md#limits) de su bicicleta para ayudar a evitar carriles bici estrechos.  
...
![Ajustes de enrutamiento para bicicleta](@site/static/img/navigation/routing/cycling_routing_andr.webp)
