...
Se puede encontrar información adicional sobre la ruta creada, como altitud, instrucciones paso a paso, herramienta de análisis y otros, en la sección [**Detalles**](../setup/route-details.md).
:::
