...
- **Para usar la función Buscar dirección,** primero debe [descargar un mapa](../start-with/download-maps.md) del área requerida.
...
- La información de dirección en OsmAnd contiene todas las [claves de etiquetas OSM](https://wiki.openstreetmap.org/w/index.php?title=Key:addr).
...
OsmAnd admite búsquedas de direcciones utilizando datos de OpenStreetMap, pero en los Estados Unidos, los resultados de la búsqueda de direcciones pueden ser incompletos debido al uso de [datos TIGER](https://wiki.openstreetmap.org/wiki/TIGER).

- **Los datos TIGER proporcionan rangos de direcciones, no ubicaciones exactas**, lo que significa que algunos números de casa pueden no ser reconocidos.
...
Esta forma de búsqueda facilita la búsqueda de ubicaciones específicas dentro de una localidad seleccionada, proporcionando una forma conveniente de encontrar direcciones de forma precisa y rápida. Puede comenzar a buscar la dirección necesaria determinando la localidad.
...
- *Precisión.* Puede seleccionar una ciudad y una calle de las opciones disponibles, evitando errores al ingresar manualmente una dirección.
...
La búsqueda de calles se realiza en la localidad donde se encuentra, o donde buscó antes, o que está en el centro del mapa visible en la pantalla de la aplicación.
...
:::note
Para obtener más información, lea los **[datos de códigos postales del Reino Unido](https://github.com/hvdwolf/OsmAnd-UKpostcodes/releases)**.
:::
