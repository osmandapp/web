...
| ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) **Maps+** | Una **compra dentro de la aplicación** o **suscripción** que desbloquea funciones avanzadas para la aplicación gratuita de OsmAnd. | Disponible en [App Store](https://apps.apple.com/us/app/osmand-maps-travel-navigate/id934850257). | Se puede añadir a la [Compartir en familia de Apple](https://support.apple.com/en-us/HT201088). |
| ![Pro](@site/static/img/svg/pro_icon.svg) **OsmAnd Pro** | Un **plan de suscripción** que desbloquea funciones avanzadas y [pro](#pro-features) adicionales. | Disponible en [App Store](https://apps.apple.com/us/app/osmand-maps-travel-navigate/id934850257). | Admite acceso **multiplataforma** (ver nota a continuación). |

### Notas importantes {#important-notes}

1. **Maps+** es una *actualización* para la versión gratuita de OsmAnd, que desbloquea la mayoría de las funciones.

2. **OsmAnd Pro es una suscripción *multiplataforma***. Esto significa que puedes comprarla en una tienda (por ejemplo, *AppStore, Google Play y osmand.net*) y restaurarla en otra [vinculando tu compra con la cuenta de OsmAnd Cloud](../personal/osmand-cloud.md#cross-platform).
...
|    | OsmAnd Free   | [Maps+](#install-osmand-ios) Dentro de la aplicación | [Maps+](#install-osmand-ios) Suscripción | [OsmAnd Pro](#install-osmand-ios) |
| :------------- | :------------- | :----------------------- | :------------------- | :----------- |
|  | ![Maps+](@site/static/img/svg/osmand_maps.svg) | ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) | ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) | ![Pro](@site/static/img/svg/pro_icon.svg) |
...
|  | OsmAnd Gratis | [OsmAnd Maps+](#install-osmand-ios)<br/>(dentro de la aplicación y suscripción) | [OsmAnd Pro](#install-osmand-ios) |
| :------ | :------------- | :------------------ | :------------------ |
...
| [Descargas de mapas](../start-with/download-maps.md) |  <details><summary>**5 descargas de mapas** <br /> (la actualización del mapa cuenta como descarga):</summary> <br /> - La descarga o actualización del mapa se refiere únicamente a la descarga-actualización de un mapa de país (región).<br /> - El **mapa de visión general del mundo**, la **corrección de altitud del mundo**, las **fuentes del mapa** y las **indicaciones de voz** no se cuentan como 5 posibilidades de descarga.</details> | ✔ | ✔ |
| [Actualizaciones mensuales de mapas](../personal/maps-resources.md#update-maps) |  <details><summary>**Una vez al mes** <br /> (con 2 días de retraso):</summary> * limitado a 5 descargas (la actualización del mapa cuenta como descarga) </details> |  ✔ | ✔ |
...
| [Herramienta de planificación de rutas](../plan-route/create-route.md) | ✔ | ✔ | ✔ |
...
| [Rastreador GPS online de OsmAnd](../plugins/osmand-tracker.md) | ✔ | ✔ | ✔ |
...
| [Plugin del tiempo](../plugins/weather.md) | Pronóstico horario de 24 horas con 7 días de antelación en el mapa. |
...
La forma más fácil de elegir y comprar el plan necesario es a través del menú **Compras**. Por supuesto, verás un menú de propuestas para las funciones de pago.
...
![Maps+](@site/static/img/svg/osmand_maps_plus.svg) Plan de suscripción / compra dentro de la aplicación *Maps+*. Aquí puedes elegir [suscripción anual](#prices) o [pago único](#prices):
...
Las nuevas suscripciones se activaron a partir de OsmAnd 4.3 (diciembre de 2022). Todas las suscripciones anteriores son heredadas y técnicamente equivalentes a la "suscripción de mapas", aunque las suscripciones heredadas tienen derecho a actualizaciones de mapas por hora. Los usuarios no pueden comprar suscripciones heredadas, pero las suscripciones antiguas se renuevan automáticamente hasta que el usuario se da de baja (el precio de estas podría cambiar en el futuro).
...
Usa el mismo ID de Apple para restaurar tus compras.

- Inicia sesión en la misma cuenta de Apple App Store que usaste para comprar las compras dentro de la aplicación (suscripciones) de OsmAnd Maps.
...
- [Guía detallada sobre cómo comprar tarjetas de regalo de la App Store](https://www.apple.com/shop/gift-cards).
