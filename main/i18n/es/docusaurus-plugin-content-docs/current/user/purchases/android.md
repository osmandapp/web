...
| Aplicación | Google Play | Huawei AppGallery | Gratis / De pago |
| :------------- | :------------- | :------------- | :------------- |
| ![Maps+](@site/static/img/svg/osmand_maps.svg) OsmAnd | ✔ &nbsp;&nbsp;[Instalar](https://play.google.com/store/apps/details?id=net.osmand) | ✔ &nbsp;&nbsp;[Instalar](https://appgallery.huawei.com/#/app/C101486545) | Gratis |
...
| :------------- | :------------- | :------------- | :------------- |
| ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) Maps+ en la aplicación | ✔ | ✔ | OsmAnd |
| ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) Suscripción Maps+ | ✔ | ✔ | OsmAnd |
...
|------------|------------|------------|------------|
| **OsmAnd Start** | Un **plan gratuito** que proporciona acceso a [OsmAnd Cloud](../personal/osmand-cloud.md#osmand-start) para *Favoritos*, *Ajustes* y *edición/notas de OSM*. | Disponible para todos los usuarios de la versión gratuita de OsmAnd. | Limitado a funciones básicas de la nube y **5 MB** de almacenamiento. |
...
1. **OsmAnd+** y **Maps+** ofrecen las mismas funciones. La única diferencia es que OsmAnd+ es una **aplicación de pago independiente**, mientras que Maps+ es una **suscripción o compra en la aplicación**.
...
| | OsmAnd Free | [OsmAnd+](#install-osmand-android) /<br/> [Maps+](#install-osmand-android) en la aplicación | [Maps+](#install-osmand-android) Suscripción | [OsmAnd Pro](#install-osmand-android) |
| :------------- | :------------- | :----------------------- | :------------------- | :----------- |
| | ![Maps+](@site/static/img/svg/osmand_maps.svg) | ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) | ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) | ![Pro](@site/static/img/svg/pro_icon.svg) |
...
| | OsmAnd Free | [OsmAnd+](#install-osmand-android) <br/> [Maps+](#install-osmand-android) (en la aplicación y suscripción) | [OsmAnd Pro](#install-osmand-android) |
| :------ | :------------- | :------------------ | :------------------ |
...
| [Descargas ilimitadas de mapas](../start-with/download-maps.md) | <details><summary>**7 descargas de mapas**</summary> - La descarga o actualización de mapas solo significa la descarga o actualización de un mapa de país (región). <br/> - El **mapa de vista general del mundo**, la **corrección de altitud del mundo**, las **fuentes de mapa** y las **indicaciones de voz** no se cuentan como 7 posibilidades de descarga. </details> | ✔ | ✔ |
| [Actualizaciones mensuales de mapas](../personal/maps-resources.md#update-maps)<br/>Una vez al mes (con 2 días de retraso) | <details><summary>**7 descargas de mapas**</summary> La actualización de mapas cuenta como descarga.</details> | ✔ | ✔ |
...
| [Wikiviajes sin conexión - Guías de viaje](../plan-route/travel-guides.md)| **-** | ✔ | ✔ |
...
| [Widgets de métricas del vehículo](../plugins/vehicle-metrics.md#widgets) | <details><summary>**2 widgets gratis**</summary><ul><li>*Velocidad del vehículo*</li><li>*Revoluciones del motor*</li></ul></details> | <details><summary>**2 widgets gratis**</summary><ul><li>*Velocidad del vehículo*</li><li>*Revoluciones del motor*</li></ul></details> | ✔ |
...
La función [Android Auto](https://www.android.com/auto/) solo funciona para las aplicaciones OsmAnd de [Google Play](https://play.google.com/store/apps/dev?id=8483587772816822023).
...
| :------------- | :------------- |
| [OsmAnd Cloud](../personal/osmand-cloud.md) | Haz copias de seguridad y restaura tus datos, sincroniza datos con el [portal web de OsmAnd](https://www.osmand.net/map). |
...
| [Plugin de Clima](../plugins/weather.md) | Pronóstico horario de 24h con 7 días de antelación en el mapa. |
| [Plugin de Métricas del Vehículo (OBD-II)](../plugins/vehicle-metrics.md) | Te permite conectar un escáner OBD-II para mostrar datos detallados del vehículo en la aplicación OsmAnd y almacenar la información en los registros de seguimiento. La información de velocidad del vehículo y revoluciones del motor está disponible para OsmAnd gratuito. |
...
| [Corrección de elevación (sin conexión)](../map/tracks/track-context-menu.md#calculate-missing-elevation) | Te permite calcular un gráfico de altitud para tu pista (se requiere [mapa de terreno](../plugins/topography.md#download-maps) para la región elegida). |
...
![Pro](@site/static/img/svg/pro_icon.svg) Plan de suscripción *OsmAnd Pro*. Aquí puedes elegir la suscripción mensual o anual:
...
![Maps+](@site/static/img/svg/osmand_maps_plus.svg) Plan de suscripción / en la aplicación *Maps+*. Aquí puedes elegir la suscripción anual o el pago único:

*<Translate android="true" ids="shared_string_menu,shared_string_settings,purchases,shared_string_learn_more"/> → Toca la lista de funciones de Maps+ → Continuar con Maps+*
...
Las nuevas suscripciones comienzan con la versión 4.0 de OsmAnd (agosto de 2021). Todas las suscripciones anteriores son obsoletas y técnicamente equivalen a una *Suscripción de mapa*, aunque las suscripciones más antiguas son elegibles para actualizaciones de mapas cada hora. Los usuarios no pueden comprar suscripciones antiguas, pero las suscripciones antiguas se renuevan automáticamente hasta que te desuscribes (el precio puede cambiar en el futuro).


## Restaurar compras {#restore-purchases}

### Encuentra tu compra {#find-your-purchase}
...
**Para restaurar tu *compra en la aplicación* o *suscripción* ([Maps+, Pro, OsmAnd Live](#difference-between-purchases-android)).**

- *Actualiza la aplicación del Mercado* (Google Play, Huawei AppGallery).
- *Inicia sesión* con **la misma cuenta** en el Mercado (Google Play, Huawei AppGallery) con la que tienes una compra de OsmAnd.
- *Abre OsmAnd* con una conexión a Internet activa.
- *Para abrir Restaurar compras*, sigue estos pasos: *<Translate android="true" ids="shared_string_menu,shared_string_settings,purchases,restore_purchases"/>* y en la parte superior de la pantalla debería aparecer que Maps+(Pro) está activado.
...
[Guía detallada sobre la compra de tarjetas regalo de Google Play](https://support.google.com/googleplay/answer/3422734?hl=en).

Puedes comprar OsmAnd utilizando tarjetas regalo de Google Play, lo que proporciona una alternativa segura para compartir información de tarjetas de crédito en línea. Simplemente compra una tarjeta regalo en un minorista de tu elección y canjea el código en Google Play.
