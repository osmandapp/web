...
Debes tener una cuenta de [OsmAnd Cloud](../personal/osmand-cloud.md#login) para usar la *Copia de seguridad gratuita de la configuración*. Si tienes una suscripción a *OsmAnd Pro* o una cuenta activa de *OsmAnd Cloud*, el banner de promoción no se mostrará.
...
![Perfiles Ajustes generales Apariencia Android](@site/static/img/personal/profiles/profiles_appearance_2_andr.png)
...
![Perfiles Ajustes generales Apariencia iOS](@site/static/img/personal/profiles/profiles_appearance_3_ios.png)
...
![Perfiles Ajustes generales Unidades y formatos Android](@site/static/img/personal/profiles/profiles_units_formats_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Perfiles Ajustes generales Unidades y formatos iOS](@site/static/img/personal/profiles/profile_unitsformats_3_ios.png)
...
|          | <Translate android="true" ids="shared_string_milliradians"/> | Todos los valores angulares tienen [valor de milirradián](https://es.wikipedia.org/wiki/Milirradi%C3%A1n).  |
|  |  |  |
...
|          | <Translate android="true" ids="round_up"/> | *Para una mejor legibilidad*, los números que se muestran en los widgets de navegación (distancia a un punto, siguiente giro o carril) se redondearán hacia abajo para tener menos dígitos. <br/> Por ejemplo: 3672 m *→* 3.6 km,&nbsp; 462 m *→* 400 m,&nbsp; 184 m *→* 150 m,&nbsp; 47 m *→* 40 m,&nbsp; 18 m *→* 15 m. |
...
![Perfiles Ajustes generales Otros Android](@site/static/img/personal/profiles/profile_general_settings_other_2_andr.png)
...
![Perfiles Ajustes generales Otros iOS](@site/static/img/personal/profiles/profile_general_settings_other_ios.png)  
...
- [<Translate android="true" ids="use_kalman_filter_compass"/>](../map/interact-with-map.md#extra-compass-settings) (*Solo Android*) – Suaviza la rotación del mapa con un [movimiento gradual](https://es.wikipedia.org/wiki/Filtro_de_Kalman), reduciendo los cambios de posición repentinos. Esto introduce un pequeño retraso (*menos de 1 segundo*).
...
- [Mensajes de voz](../navigation/guidance/navigation-settings.md#voice-prompts) - Habilita la guía de audio para recibir instrucciones de navegación habladas mientras conduces o caminas por una ruta seleccionada.
...
- [Guía detallada de la pista](../navigation/guidance/navigation-settings.md) – Mejora la navegación paso a paso alineando tu ruta con las carreteras mapeadas. Ajustes disponibles: *Preguntar siempre* o *Siempre*.
...
![Perfiles Configurar ajustes del mapa Android](@site/static/img/personal/profiles/profile_configure_map_1_andr.png)
...
![Perfiles Configurar ajustes del mapa iOS](@site/static/img/personal/profiles/profile_configure_map_ios.png)
...
- **Superponer capas de mapa adicionales**, como [información de terreno](../plugins/topography.md), **imágenes satelitales** u otros [mapas ráster](../map/raster-maps.md) disponibles.
...
2. **Integra el modelo en OsmAnd:**
   ...
   - Alternativamente, copia los **archivos MTL y OBJ** directamente en la carpeta OsmAnd utilizando la misma estructura de directorio.
...
![Personalización de la interfaz de usuario del perfil Android](@site/static/img/personal/profiles/profile_ui_customization_android.png)  
...
![Cajón del perfil Android](@site/static/img/personal/profiles/profile_drawer_moving_android.png)  ![Restablecer perfil Android](@site/static/img/personal/profiles/profile_drawer_reset_item_android.png)  
...
- **Menú Configurar mapa** - En la sección *Personalizar interfaz de usuario*, puedes *reordenar u ocultar elementos* del [Configurar mapa](../map/configure-map-menu.md), lo que permite un acceso rápido a la configuración utilizada con frecuencia.
...
- **Menú contextual del mapa** - En la sección Personalizar interfaz de usuario, puedes reordenar u ocultar elementos en el [menú contextual del mapa](../map/map-context-menu.md) para optimizar el acceso a las funciones utilizadas con frecuencia.
...
:::caution Acceso a la configuración de complementos
...
![Complementos de ajustes de perfil Android](@site/static/img/personal/profiles/profile_plugins_1_andr.png)
...
![Complementos de ajustes de perfil iOS](@site/static/img/personal/profiles/profile_plugins_1_ios.png)

</TabItem>

</Tabs>

Los complementos desbloquean funciones adicionales de la aplicación y pueden ser [de pago o gratuitos](../plugins/index.md#purchase). Algunos complementos tienen su propia [configuración](../plugins/index.md#plugin-settings), otros no. OsmAnd te ofrece la posibilidad de configurar los complementos para cada perfil por separado.
...
- **Clima**. Las capas interactivas del mapa de [Clima](../plugins/weather.md#weather-settings) te permiten monitorear la temperatura, la presión del aire, la cobertura de nubes, la velocidad del viento y la precipitación en tu ciudad o en cualquier otra ubicación en un mapa global.
...
- **Sensores externos**. Cuando tocas un elemento en la sección *Configuración de complementos*, se abre la [configuración de sensores externos](../plugins/external-sensors.md#sensors-settings) para el perfil seleccionado. El complemento Sensores externos te permite leer y registrar datos de sensores externos inalámbricos y mostrarlos usando widgets en la aplicación OsmAnd.
...
- **Wikipedia** (Solo iOS). Este menú abre la *[configuración del complemento de Wikipedia](../plugins/wikipedia.md#wikipedia-settings)*. Puedes seleccionar el idioma en el que se mostrarán los artículos y elegir si deseas descargar imágenes de Wikipedia. Tener Wikipedia en tu viaje mejora tu experiencia al proporcionar información sobre los lugares que visitas. Funciona sin conexión y muestra artículos relevantes de Wikipedia directamente en el mapa relacionados con puntos de interés.

- **Métricas del vehículo**. Este menú abre la *[configuración del complemento de métricas del vehículo](../plugins/vehicle-metrics.md#scanner-settings)*. Te permite conectar un escáner OBD-II a OsmAnd.

- **Rastreador de embarcaciones AIS** (Solo Android). Este menú abre la *[configuración del complemento de rastreador de embarcaciones AIS](../plugins/ais-tracker.md#plugin-settings)*. Este complemento te permite conectar un rastreador AIS a OsmAnd.
...
- **Restablecer a valores predeterminados** - Restaura todos los ajustes al estado inicial.
