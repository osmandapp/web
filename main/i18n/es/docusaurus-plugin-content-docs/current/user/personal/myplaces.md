...
2. ***Menú de tres puntos*** (*Android*) y ***pulsación larga*** (*iOS*). Utilice el menú de *tres puntos* junto a cada carpeta o *pulse prolongadamente* la carpeta para gestionar grupos de favoritos. Consulte [Acciones de grupo de favoritos](../personal/favorites.md#favorite-group-actions) para obtener detalles.  
...
1. ***Botones de acción***. Puede utilizar los *botones de acción* de la pantalla Mis lugares para gestionar su lista de notas:  
    ...
    - **Exportar** (*Solo Android*) — Guarde sus notas y POI como archivos para uso externo o copia de seguridad, con opciones para exportar como notas OSM, POI o todos los datos combinados.

    - **Eliminar** — Elimine permanentemente los elementos seleccionados de su lista.


2. ***Menú de tres puntos***. Puede gestionar POI o notas específicas utilizando el *menú de tres puntos* situado junto a cada nota:  
    ...
    - **Mostrar en el mapa** — Muestra la ubicación específica del POI o de la nota en el mapa.

    - **Modificar cambio/nota OSM** — Realice más ediciones en el POI o en la nota que ya se han añadido a OpenStreetMap.

    - **Eliminar** — Elimine el POI o la nota seleccionados de su lista.
