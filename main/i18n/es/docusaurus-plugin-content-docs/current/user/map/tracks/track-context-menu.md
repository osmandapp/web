...
**Nota:** Puedes conectar un monitor de frecuencia cardíaca BLE a través de *<Translate android="true" ids="shared_string_plugin,external_sensors_plugin_name"/>* para grabar datos de FC directamente en OsmAnd.
