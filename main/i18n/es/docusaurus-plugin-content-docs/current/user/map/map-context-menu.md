...
El menú contextual del mapa proporciona información sobre el objeto seleccionado en el mapa. También puede utilizarlo para crear una ruta a la ubicación seleccionada. Para abrir el menú contextual, primero, busque la ubicación requerida en el mapa, luego seleccione el objeto con un toque corto o un toque largo al seleccionar cualquier punto preciso en el mapa.
...
El **menú contextual** aparece cuando **toca una vez** un objeto marcado en el mapa. Este menú contextual muestra información esencial sobre el objeto seleccionado, incluyendo su *nombre, icono* (tal como se representa en el mapa), *dirección, distancia* y *dirección* desde su posición actual.

Puede seleccionar varios tipos de objetos de mapa, como *PDI*, *favoritos*, *paradas de transporte*, *marcadores*, *picos de montaña* u otros *objetos de mapa*.
...
> *La altura de los picos de montaña se muestra en metros o pies, según las [unidades de longitud](../personal/profiles.md#units--formats) seleccionadas en la configuración del perfil.*
...
Cuando **toca prolongadamente** en cualquier lugar del mapa, aparece un **menú contextual** que proporciona información sobre la ubicación seleccionada. Esto incluye la dirección, la distancia y la dirección desde su posición actual.

> **NOTA**. *Un toque prolongado en un **número de edificio** resalta su contorno y abre el menú contextual del mapa.*
...
![Menú de seguimiento contextual Android](@site/static/img/map/context_track_menu_Android.png)
...
Al tocar una [pista GPX](../map/tracks/index.md) en el mapa, se abre el [menú contextual de la pista](../map/tracks/track-context-menu.md), donde puede acceder a opciones adicionales relacionadas con la pista.
...
El panel de **Información del objeto** proporciona detalles adicionales sobre el objeto seleccionado. Puede tocar cualquier entrada para copiar la información al portapapeles.
...
- [Enlace OpenStreetMap](../map/map-context-menu.md#openstreetmap-link)
...
- [Horario de trabajo](https://wiki.openstreetmap.org/wiki/Key:opening_hours)
- [Tarifa](https://wiki.openstreetmap.org/wiki/Key:fee)
- [Accesibilidad](https://wiki.openstreetmap.org/wiki/Key:wheelchair)
- [Ancho](https://wiki.openstreetmap.org/wiki/Key:width) / [Altura](https://wiki.openstreetmap.org/wiki/Key:height)
...
- Si una traducción específica *no está disponible*, OsmAnd recurre al nombre **local** para garantizar la precisión y la coherencia en las regiones multilingües.


### Información de polígonos {#polygon-information}

<Tabs groupId="operating-systems" queryString="current-os">

<TabItem value="android" label="Android">

![Información de polígonos Android](@site/static/img/map/polygon_information_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Información de polígonos Android](@site/static/img/map/polygon_information_ios.png)

</TabItem>

</Tabs>

La función de **información de polígonos** proporciona datos detallados sobre los **polígonos** cercanos que se muestran en el mapa. Esto incluye características geográficas, límites administrativos y otras áreas mapeadas.
...
- Al seleccionar un punto en el mapa o un PDI, el panel de **información de polígonos** muestra una lista de todos los polígonos que contienen la ubicación seleccionada.

- Las entradas en la lista incluyen **divisiones administrativas, áreas de uso del suelo, características naturales y otras regiones categorizadas**.

- El panel permite a los usuarios **copiar el nombre y los detalles del polígono** como referencia.

- Para ver esta información, vaya a *Menú contextual del mapa → Detalles → Dentro*.

Esta función le ayuda a comprender su *ubicación actual* en relación con las divisiones administrativas mapeadas, las áreas naturales u otras características geográficas importantes.
...
|:------|:------|
| <ul><li>DDD.DDDDD (grados decimales simples)</li><li>DDD.DDDDD (N/S, E/O coma)</li><li>DDD MM.MMM</li><li> DDD MM SS.S</li><li>[UTM Estándar](https://es.wikipedia.org/wiki/Sistema_de_coordenadas_universal_transversal_de_Mercator)</li><li>[Código de ubicación abierto](https://es.wikipedia.org/wiki/Open_Location_Code)</li><li>[MGRS](https://es.wikipedia.org/wiki/Sistema_de_referencia_de_cuadr%C3%ADcula_militar)</li><li>[Swiss Grid CH1903 y CH1903+](https://es.wikipedia.org/wiki/Sistema_de_coordenadas_suizo)</li><li>[Enlace web de OsmAnd](https://osmand.net/map)</li><li>[Enlace web de OpenStreetMap](../map/map-context-menu.md#openstreetmap-link)</li></ul> | ![Coordenadas](@site/static/img/map/map_context_menu_Coordinates.png) |

En el menú contextual, puede encontrar [coordenadas geográficas](../search/search-coordinates.md#coordinate-format) de un punto en varios formatos y también enlaces compartibles de OsmAnd y [OpenStreetMap](../map/map-context-menu.md#openstreetmap-link) (la última opción solo está disponible cuando el [complemento de edición de OpenStreetMap](../plugins/osm-editing.md) está habilitado). Si expande la sección de coordenadas y toca prolongadamente cualquier línea de la lista, sus valores se copiarán automáticamente al portapapeles (**Android**) o la opción *Copiar* estará disponible en el mensaje emergente (**iOS**).

El enlace web de OsmAnd puede ser reconocido automáticamente por OsmAnd (ejemplo: `https://osmand.net/map?pin=52.51628,13.37771#15/52.51628/13.37771`). Tanto los enlaces de OsmAnd como los de [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Browsing#Adding_a_Marker) se abren en los sitios correspondientes con una marca de pin en el lugar de interés.


### PDI cercanos / Wikipedia {#nearby-pois--wikipedia}

![Artículos de Wikipedia cercanos](@site/static/img/map/map_context_menu_nearby_wikipedia.png) ![Artículos de Wikipedia cercanos](@site/static/img/map/map_context_menu_nearby_wikipedia_1.png)

Estas secciones muestran [artículos de Wikipedia](../plugins/wikipedia.md) o [Puntos de Interés](../map/point-layers-on-map.md#points-of-interest-pois) cercanos con *<Translate android="true" ids="shared_string_show_on_map"/>* y *<Translate android="true" ids="search_more"/>* para mostrar y [buscar](../search/search-poi.md) todos los demás PDI y artículos de Wikipedia.

Tocar *PDI cercanos / Artículos de Wikipedia* abre una lista de puntos (PDI o Wikipedia). Al tocar uno de estos puntos de una lista de puntos, el mapa se mueve a este punto (PDI o Wikipedia) con la apertura del menú contextual del mapa del punto.

> **NOTA**. *[<Translate android="true" ids="wiki_around"/>](../plugins/wikipedia.md) solo aparecerá si previamente descargó mapas especiales con [artículos de Wikipedia para esta área](../plugins/wikipedia.md#download-wikipedia-packages-download-wikipedia-packages)*.
...
Información mostrada sobre rutas de transporte público para la parada de transporte elegida. Información sobre el menú contextual del transporte público y las acciones con él, lea en el [artículo](../map/public-transport.md#transport-routes-context-menu).
...
Esta es una lista de todos los puntos de un grupo para un Favorito o un Punto de referencia. Al tocar, se expande toda la lista de puntos de un grupo, al tocar un punto de la lista, el mapa se mueve al punto seleccionado.
...
### Área de escalada y detalles del peñasco {#climbing-area-and-crag-details}

![Lista de favoritos](@site/static/img/map/climbing_andr.png)

Al seleccionar un [área de escalada o peñasco](../map/routes.md#climbing-routes), OsmAnd proporciona un resumen detallado de la ubicación de escalada, que incluye: nombre y ubicación, clasificación de dificultad de escalada (UIAA, francés, YDS, etc.), tipo de roca, altura y longitud de la ruta, calidad de escalada y condiciones de la superficie.
...
Esta parte contiene una parte de la descripción del [artículo de Wikipedia](../plugins/wikipedia.md), [Favorito](../personal/favorites.md) o descripción del punto de referencia, al tocar puede abrir la descripción completa.


### Enlace OpenStreetMap {#openstreetmap-link}
...
- Navegar por hasta 100 imágenes por lugar
- Ver metadatos de la imagen (*autor*, *licencia*, *fuente*)
- Realizar acciones: **Compartir**, **Abrir en el navegador**, **Descargar**

> *En iOS, al tocar prolongadamente una imagen, se abre un menú contextual con acciones rápidas.*
...
OsmAnd admite la integración con [Mapillary](https://www.mapillary.com/), una plataforma global de imágenes a nivel de calle de origen colectivo. Esta función le permite ver y explorar secuencias de fotos del mundo real directamente en el mapa.
...
- Utilizar el botón **Explorar** para abrir el visor de Mapillary y navegar por las imágenes a nivel de calle cercanas.
- Tocar el botón **Añadir fotos** para contribuir con sus propias fotos a la plataforma Mapillary.

> *Obtenga más información sobre cómo activar y utilizar esta función en la [guía del complemento Mapillary](../plugins/mapillary.md).*
...
La información de [notas de audio/vídeo](../plugins/audio-video-notes.md) como la fecha, las coordenadas, la vista previa y otros detalles están disponibles en el menú **Detalles**. Puede abrir las notas en un software secundario tocando el botón **Reproducir/Mostrar** en el menú contextual de la nota.
...
Es un conjunto de manipulaciones específicas que se pueden realizar en un punto u objeto. Este menú se divide en dos partes: la sección visible consta de un máximo de 3 acciones y otras acciones son accesibles mediante el botón *Acciones*. Puede personalizar (*Android*) el orden de las acciones en [Configuración general](#customize).
...
![Añadir acción de favorito Android](@site/static/img/map/add_favorite_android.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Añadir acción de favorito iOS](@site/static/img/map/add_favorite_ios.png)
...
- Para **editar** la información sobre un punto favorito, debe activar *Mostrar en el mapa* (*Menú → Mis lugares → Favoritos*) y luego tocarlo. En el menú contextual, en lugar del icono de *estrella*, aparecerá un *icono de lápiz* (con la firma Editar).
...
![Añadir acción de marcador Android](@site/static/img/map/add_marker_android.png) ![Acción de pasar marcador Android](@site/static/img/map/action_pass_marker_android.png)
</TabItem>

<TabItem value="ios" label="iOS">

![Añadir acción de marcador iOS](@site/static/img/map/add_marker_ios.png) ![Restaurar acción de marcador Android](@site/static/img/map/action_restore_marker_android.png)

</TabItem>

</Tabs>

Es posible marcar un punto o un objeto para facilitar la planificación de la navegación. Solo tiene que tocar el icono de la **bandera** en el menú (*Android*), **flecha** (*iOS*) - muestra la dirección y la distancia al punto seleccionado desde su ubicación actual.
...
- ***Enviar***. Envía texto a través de las aplicaciones disponibles en su dispositivo. Incluye toda la información sobre la ubicación: nombre de Mi ubicación o el nombre del PDI seleccionado, dirección, coordenadas y geolocalización como enlace.
- ***Copiar***. Copia toda la información de la ubicación (nombre de Mi ubicación o nombre del PDI seleccionado, dirección, coordenadas y geolocalización como enlace) al portapapeles.
...
- ***geo***. Abre una lista de aplicaciones disponibles que admiten geolocalizaciones. <!-- (información sobre [geo urls Android](https://developers.google.com/maps/documentation/urls/android-intents)). -->
...
- ***Guardar en archivos*** (*iOS*) - guarda la captura de pantalla del mapa en iCloud Drive o en el almacenamiento de su dispositivo. -->
...
Para iniciar la navegación o la planificación de rutas, primero debe seleccionar el destino con [<Translate android="true" ids="get_directions"/>](../widgets/map-buttons.md#directions). En caso de que ya tenga un punto de destino, el menú le sugerirá que reemplace el punto de destino o que lo inserte como otro punto intermedio o de inicio.
...
Si toca **Iniciar navegación**, el punto *Desde* se descartará a medida que la aplicación entre en modo de navegación. Para conservar una ruta, no toque *Iniciar navegación* y [**deslice hacia abajo**](#hide-context-menu) el menú *Preparación de ruta*.
:::
...
Utilizando el menú contextual del mapa, puede añadir una carretera específica a la lista de carreteras no utilizadas para el enrutamiento. Esto afectará a la [preparación de la ruta](../navigation/setup/route-navigation.md).
Para eliminar carreteras previamente seleccionadas de la *[lista de carreteras a evitar](../navigation/routing/osmand-routing.md#avoid-roads-menu)*, toque un signo, elija *Eliminar* (**Android**) o *Descartar* (**iOS**).
...
Casi todos los objetos creados por el usuario son móviles, es decir, Marcador, Favorito, PDI creado, Nota de audio/vídeo o Punto de ruta de seguimiento. Primero seleccione un objeto en el mapa y luego use *<Translate android="true" ids="change_markers_position"/>* el menú para moverlo a una nueva ubicación.
...
Para actualizar o descargar mapas en línea (mosaicos) en una ubicación específica, puede usar el menú contextual del objeto:
...
Lea las [instrucciones completas](../map/raster-maps.md#download--update-tiles).
...
En caso de que no haya un mapa sin conexión presente en la ubicación seleccionada, por ejemplo, el menú de objetos del mapa se abrió a través de Búsqueda o a través de un Favorito específico, se sugerirá la descarga del mapa sin conexión más pequeño posible para [descargar](../start-with/download-maps.md#select-on-the-map).

**iOS**. Si ya ha [descargado](../map/map-context-menu.md) mapas de OsmAnd (vectoriales o de terreno), es posible actualizarlos a través del menú contextual. Deberá seleccionar la región en el mapa primero; toque cualquier ubicación en el zoom mundial 3-7.

> **NOTA**. *Si ha abierto el menú contextual para la región del mapa (la región está resaltada), podrá ver ***<Translate android="true" ids="rendering_category_details"/>*** sobre ella: tipo y tamaño de un mapa disponible, enlace a una página de Wikipedia, idioma, población y otros.*


### * Añadir / Eliminar punto de estacionamiento {#-add--delete-parking-point}

:::note
Para añadir/eliminar puntos de estacionamiento, habilite el [**complemento de posición de estacionamiento**](../plugins/parking.md) de OsmAnd.
:::
...
![Acción Estacionamiento Android](@site/static/img/map/action_parking_android.png)
...
![Acción Estacionamiento iOS](@site/static/img/map/action_parking_ios.png)
...
Cualquier ubicación seleccionada en el mapa podría marcarse como [una posición de estacionamiento](../plugins/parking.md). Para eliminar una posición de estacionamiento, puede abrir el menú contextual asociado con la ubicación de estacionamiento.


### * Añadir / Editar punto de ruta de seguimiento {#-add--edit-track-waypoint}

:::note
Para añadir/editar puntos de seguimiento, habilite el [**complemento de grabación de viajes**](../plugins/trip-recording.md) de OsmAnd.
:::
...
![Acción Punto de ruta Android](@site/static/img/map/action_waypoint_android.png)
...
![Acción Punto de ruta iOS](@site/static/img/map/action_waypoint_ios.png)
...
Puede añadir puntos de ruta a una pista grabada o a la grabación de la pista actual utilizando el menú contextual del mapa.

- Seleccione una ubicación en el mapa con un [toque prolongado](../map/map-context-menu.md#select-any-point-long-tap).
- En el *menú contextual del mapa* que se abre, elija *Acciones → Añadir punto de ruta de seguimiento*.
- La lista muestra las [pistas](../map/tracks/index.md#display-tracks-on-the-map) grabadas y mostradas en el mapa, así como la [grabación de la pista actual](../plugins/trip-recording.md), a la que puede añadir el punto de ruta seleccionado.
- Puede añadir puntos de ruta a una pista que aún no está activa para la grabación, en cuyo caso la pista inactiva cambia del *estado de inicio* al *estado de reanudación*.
- [Rellene](../map/tracks/track-context-menu.md#add-waypoint-to-a-track) los datos requeridos y guarde el punto de ruta.
- Puede configurar las [Acciones rápidas](../widgets/quick-action.md) añadiendo un punto de ruta a *Añadir punto de ruta de seguimiento*.


### * Crear / Modificar PDI {#-create--modify-poi}

:::note
Para añadir, crear/modificar PDI, habilite el [**complemento de edición de OSM**](../plugins/osm-editing.md) de OsmAnd.
:::
...
Con el complemento de edición de OSM, puede crear y modificar la mayoría de los PDI presentes en [OpenStreetMap](https://www.openstreetmap.org/).
...
:::note
Para añadir una nota de OSM, habilite el [**complemento de edición de OSM**](../plugins/osm-editing.md) de OsmAnd.
:::
...
Puede **informar** errores en los datos del mapa en una ubicación específica a la [comunidad de OpenStreetMap](https://wiki.openstreetmap.org/wiki/Join_the_community). Siga las [directrices](https://wiki.openstreetmap.org/wiki/Notes#Adding_notes) y añada comentarios adecuados a un problema.


### * Comentar / Cerrar nota de OSM {#-comment--close-osm-note}

:::note
Para comentar/cerrar una nota de OSM, habilite el [**complemento de edición de OSM**](../plugins/osm-editing.md) de OsmAnd.
:::
...
:::note
Para subir PDI / nota de OSM, habilite el [**complemento de edición de OSM**](../plugins/osm-editing.md) de OsmAnd.
:::
...
En caso de que utilice el *modo sin conexión* para añadir/editar PDI o notas de OSM, deberá subir los cambios a OpenStreetMap. Por defecto, el *modo sin conexión* está activado para evitar cambios accidentales en la base de datos pública. Puede subir o eliminar cambios a través del menú contextual del objeto creado.
...
:::note
Para grabar notas de audio/vídeo, habilite el [**complemento de notas de audio/vídeo**](../plugins/audio-video-notes.md) de OsmAnd.
:::
