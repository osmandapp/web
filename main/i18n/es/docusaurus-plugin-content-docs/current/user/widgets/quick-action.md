...
| Mostrar / Ocultar <br/> [**Capas meteorológicas**](../plugins/weather.md#weather-layers) | Todos los datos meteorológicos se presentan como capas de mapa separadas. Con Acción Rápida, puede obtener acceso rápido para cambiar la visibilidad de estas capas en el mapa. <br/> - ***Capa de precipitación*** <br/> - ***Capa de nubes*** <br/> - ***Capa de presión*** <br/> - ***Capa de viento*** <br/> - ***Capa de animación de viento*** <br/> - ***Capa de temperatura*** <br/> En Android, también hay **Capas meteorológicas** — un interruptor maestro para todas las capas meteorológicas activas. Apaga todas las capas meteorológicas habilitadas actualmente de una vez. Cuando se enciende de nuevo, restaura exactamente el mismo conjunto de capas que estaban activas antes. |
...
| Cambiar <br/> [**<Translate ios="true" ids="map_settings_under"/>**](../map/raster-maps.md) | Crear una lista de fuentes de mapa como subyacente de mapa y alternar entre ellas. <br /> - *Nota*. Para cambiar las superposiciones de mapa en OsmAnd, puede configurar una única acción rápida que le permita cambiar entre múltiples subyacentes de mapa, o crear varias acciones rápidas separadas, cada una para un subyacente de mapa específico.  |
| Cambiar <br/> [**<Translate android="true" ids="quick_action_map_style"/>**](../map/vector-maps.md#default-map-styles) | Crear una lista de estilos de mapa para mapas vectoriales y alternar entre ellos. Puede mostrar u ocultar el diálogo de selección: <br /> - *Si se muestra el diálogo*, puede seleccionar cualquier estilo de la lista. <br /> - *Si se oculta el diálogo*, la acción funciona como un interruptor de un solo toque (ciclo únicamente). <br /> Al ciclar, la etiqueta de acción rápida con una flecha (por ejemplo, > Náutico) muestra el siguiente estilo de mapa que se aplicará en el siguiente toque, no el actualmente activo. <br /> - *Nota*. Para cambiar los estilos de mapa en OsmAnd, puede configurar una única acción rápida que le permita cambiar entre múltiples superposiciones de mapa, o crear varias acciones rápidas separadas, cada una para un estilo de mapa específico. |
