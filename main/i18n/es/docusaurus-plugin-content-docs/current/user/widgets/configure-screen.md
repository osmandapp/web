...
El menú **Configurar pantalla** en OsmAnd te permite personalizar la interfaz del mapa añadiendo y organizando widgets, botones y acciones rápidas en varios paneles.
...
- Crear varias **páginas** dentro de los paneles laterales.
...
- Los **paneles superior e inferior** muestran los widgets en filas. Puedes colocar uno o dos widgets por fila y añadir varias filas si es necesario.
- Los **paneles izquierdo y derecho** admiten varias páginas. Puedes agrupar los widgets en páginas separadas y alternar entre ellas.
...
- [Rumbo](../widgets/nav-widgets.md#bearing).
...
- [Notas de audio/video](../widgets/info-widgets.md#audiovideo-notes-widget).
    ...
    Se incluyen 4 widgets: *Bajo demanda*, *Grabar audio*, *Grabar video*, *Tomar una foto*.
...
- **Añadir filas.** Utiliza el botón *Añadir fila* para crear nuevas filas para los widgets.
...
![Página de widgets](@site/static/img/widgets/widget_page_1_andr.png) ![Página de widgets](@site/static/img/widgets/widget_page_2_andr.png)
...
![Página de widgets](@site/static/img/widgets/widget_page_1_ios.png) ![Página de widgets](@site/static/img/widgets/widget_page_2_ios.png)  
...
2. **Ocultar iconos de widgets** (*para paneles superior e inferior*):
    ...
    - Especialmente útil cuando se muestran muchos widgets en la misma **fila**.

3. **Tamaño individual para diferentes filas** (*para paneles superior e inferior*):

    - Los widgets se pueden dimensionar individualmente ajustando el tamaño de la fila.
    - **NOTA:** Cambiar el tamaño de un widget en una fila redimensionará todos los widgets de esa fila.
...
4. **Para cambiar el tamaño del widget y la visibilidad del icono:**
    ...
    - Cambia a la posición de Apagado, en el campo *Mostrar icono*.
...
El **menú contextual del widget** proporciona una forma rápida de gestionar y configurar los widgets directamente desde la pantalla del mapa. Puedes acceder a él ***manteniendo pulsado*** cualquier widget para personalizar el diseño de los widgets sin salir del mapa.
...
- *Restablecer velocidad media*.
    ...
    - Mantén pulsado para restablecer instantáneamente el valor de velocidad durante un viaje.

- *Eliminar*.
    - Elimina el widget del panel.
    - Una solicitud de confirmación asegura que la acción es intencional.
...
OsmAnd te permite añadir varias instancias del mismo widget a diferentes paneles o páginas. Esta función es particularmente útil cuando necesitas información consistente en diferentes vistas o perfiles.  
...
![Página de widgets](@site/static/img/widgets/conf_screen_buttons_andr.png)
...
![Página de widgets](@site/static/img/widgets/conf_screen_buttons_2_ios.png)
...
![Página de widgets](@site/static/img/widgets/conf_screen_buttons_3_andr.png)
...
![Página de widgets](@site/static/img/widgets/conf_screen_buttons_3_ios.png)
...
2. El **menú de tres puntos** en la pantalla de botones predeterminados contiene acciones como:
    ...
    - *Restablecer a valores predeterminados*. Te permite devolver la configuración de los botones a su apariencia original.
    - *Copiar de otro perfil*. Selecciona de qué perfil de la lista ofrecida deseas copiar la configuración de los botones.

3. La **apariencia del botón predeterminado** (*Solo Android*) ofrece una variedad de opciones de personalización para este tipo de botones. Para modificar la apariencia de un botón, toca el botón requerido de la lista y selecciona la opción [Apariencia](#button-appearance).
...
La función *Apariencia del botón* te permite personalizar completamente el aspecto de los botones en la interfaz de tu mapa. Estas opciones de personalización están disponibles tanto para *Acción rápida (Botones personalizados)* como para *Botones predeterminados*, lo que proporciona un control integral sobre la apariencia de la interfaz del mapa y permite ajustes precisos en el diseño de los botones.

***Opciones de personalización***:

- **Icono**. Selecciona de una lista de iconos que representan acciones que ya has añadido, lo que facilita la identificación de funciones de un vistazo.
...
- **Tamaño**. Elige el tamaño del botón que mejor se adapte a tu pantalla y destaque según sea necesario. Para los *botones predeterminados*, los tamaños están preestablecidos y no se pueden ajustar.
- **Opacidad del fondo**. Controla la visibilidad del fondo del botón. Puedes configurarlo para que sea completamente visible o parcialmente transparente, o mostrar solo la sombra del marco y el icono.
...
![Página de widgets](@site/static/img/widgets/conf_screen_other_andr.png)  
...
![Página de widgets](@site/static/img/widgets/conf_screen_other_ios.png)
...
- [Distancia por toque](../widgets/radius-ruler.md#distance-by-tap). Permite medir la distancia desde tu posición hasta el punto seleccionado.
...
![Página de widgets](@site/static/img/widgets/conf_screen_display_position_andr.png)  

</TabItem>

<TabItem value="ios" label="iOS">  

![Página de widgets](@site/static/img/widgets/conf_screen_display_position_ios.png)
...
- **<Translate android="true" ids="shared_string_automatic"/>**. Coloca *Mi ubicación* dependiendo de la *[Orientación del mapa](../map/interact-with-map.md#map-orientation-modes)* (*Abajo* - para la dirección del movimiento, *Centro* - para todas las demás).
...
![Página de widgets](@site/static/img/widgets/widget_actions_andr.png)
...
![Página de widgets](@site/static/img/widgets/widget_actions_ios.png)  

</TabItem>

</Tabs>

El acceso a acciones adicionales en la pantalla de Configuración son:

- *Android*. Ubicado en la pantalla de Configuración en la parte inferior de la pantalla en la sección *Acciones*: *Menú → Configurar pantalla → Acciones*.
...
- **Copiar de otro perfil**. Esta función te permite importar rápidamente configuraciones de otro perfil, seleccionar las requeridas de la lista y copiar.
...
**Ten en cuenta**. La opción *Cambiar perfil* no muestra todos los perfiles existentes, sino solo aquellos que se han *activado* en el menú de Configuración.
