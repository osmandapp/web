...
Widgets on the [Left & Right panels](https://osmand.net/docs/user/widgets/configure-screen#panels-customization)lude a height option, allowing you to customize the size of the widgets to better fit your preferences and screen layout. This change improves the usability of the widgets and makes them more adaptable to different screen sizes.
