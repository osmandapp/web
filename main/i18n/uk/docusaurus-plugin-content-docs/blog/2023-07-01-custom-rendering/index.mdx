...
By our vision, it's [the most advanced project](https://osmand-rendering.github.io/index_EN.html) with map styles for OsmAnd from the free authors' team. Here you can find styles for motorcycle, cycling, and hiking activities, and a manual for rendering creation. 
...
[Here](https://github.com/cmoffroad/osmand-dirtbike-plugin) you can download Custom plugin and use new map styles.
