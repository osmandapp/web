...
- _Analyze_ launches [_Analyse on map_](https://osmand.net/docs/user/navigation/setup/route-details#analyze-on-map).
...
A special coefficient for [3D relief](https://osmand.net/docs/user/plugins/topography#3d-relief) has been added in this release. Now, you can adjust the Vertical Exaggeration:
