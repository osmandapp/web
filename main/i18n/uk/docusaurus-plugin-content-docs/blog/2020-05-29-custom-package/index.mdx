...
In the earlier versions, we have added customization of your navigation profiles. In the last version of [OsmAnd (3.7)](/blog/osmand-android-3-7-released) you can customize the Configure map menu, Drawer, etc. In general, you can send your <a href="https://osmand.net/docs/user/personal/profiles">navigation profile</a> to your friends with all your settings anytime.
