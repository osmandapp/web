...
![Пошук POI Android](@site/static/img/search/poi_overlay_android_new.png)

</TabItem>

<TabItem value="ios" label="iOS">  

![Пошук POI iOS](@site/static/img/search/poi_overlay_ios_new.png)
...
![Пошук Дослідити](@site/static/img/search/explore_search_android.png)

Вкладка **Дослідити** в інструменті Пошук допомагає швидко відкривати місця поблизу вашого поточного місцезнаходження та отримувати доступ до нещодавно відкритих елементів. Вона містить дві основні секції:  
- Популярні місця поблизу – прокручуваний список відомих орієнтирів та атракцій поблизу вашого місцезнаходження. Кожен елемент може включати назву місця, його категорію, відстань і напрямок, а також попередній перегляд зображення, якщо воно доступне. Торкніться *Показати все*, щоб відкрити повний список, або *Показати на мапі*, щоб відобразити ці місця на мапі.
- Нещодавно відвідувані – список місць, треків або інших об'єктів, які ви нещодавно відкрили. Це дозволяє швидко повернутися до раніше переглянутих локацій.

Для отримання додаткових деталей дивіться [тут](../map/popular_places.md#explore-in-search).

## Історія пошуку (iOS) {#search-history-ios}
