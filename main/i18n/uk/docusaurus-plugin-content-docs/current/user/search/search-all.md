---
source-hash: 99f051b820c6b586fd39bf93160bf08106b2a37ec83962250f6eb850cf904eed
sidebar_position: 1
title:  Пошук
---
...
- Пошук за Обраними та Точками.
- Пошук значків за назвами підкатегорій POI.
- Пошук за треками.
...
- У випадках, коли результати пошуку занадто широкі, OsmAnd може **обмежити відображувані результати** до тих, що мають найвищу точність відповідності слів.
...
OsmAnd інтегрував [**дані TIGER**](../../technical/algorithms/trace-address-search-issues.md#trace-address-search-issues#us-address-search-and-tiger-data) у карти США, щоб надавати інформацію про адреси США. Набір даних TIGER **базується на діапазонах** і не містить точних номерів будинків, тому деякі адреси можуть бути відсутніми або неточними.
:::
...
**Пошук адреси** використовує дані OpenStreetMap. Цей тип пошуку дозволяє знайти місцезнаходження та напрямок до певної адреси зі вже відсортованого списку. Докладніше читайте у статті [Пошук адреси](./search-address.md).
