...
- У випадках, коли результати пошуку занадто широкі, OsmAnd може **обмежити відображувані результати** тими, що мають найвищу точність відповідності слів.
...
Ви можете використовувати пошук в околицях певного місця. Для цього виберіть потрібну точку [зі списку в меню пошуку](#full-text-search) або виберіть її безпосередньо на карті. У [контекстному меню карти](../map/map-context-menu.md#actions) виберіть *Дії → Пошук поблизу*.
...
- OsmAnd надає [Онлайн-пошук](./search-poi.md#online-search), який працює в режимі реального часу, надаючи швидкий доступ до результатів пошуку.  
Його зручно використовувати, коли карти регіону недоступні, але потрібне постійне та стабільне підключення до Інтернету.

- Додаткову інформацію читайте у статті [Пошук POI](./search-poi.md).
...
Пошук за координатами забезпечує точне місцезнаходження. Ви можете ввести точні координати, отримані, наприклад, з інших джерел, таких як карта, GPS-пристрій або онлайн-сервіси, що особливо корисно, коли йдеться про місця, які не мають точної адреси. Додаткову інформацію дивіться у статті [Пошук за координатами](./search-coordinates.md).
