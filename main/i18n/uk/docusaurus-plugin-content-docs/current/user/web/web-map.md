...
- **Відкрити погоду** – Доступ до [меню погоди](#weather-on-the-web) для перегляду деталей погоди.
...
- **Додати до обраного** – Дозволяє створити та зберегти [обране місце](../web/web-userdata.mdx#add--edit-favorite) в будь-якій точці на карті для легкого доступу.
...
## Погода на вебсайті {#weather-on-the-web}
...
- Оновлення прогнозів надаються з **кроком 3 години** для детального аналізу.

Щоб отримати доступ до цих функцій або налаштувати їх, використовуйте меню зліва або справа інтерфейсу.
...
Меню Налаштування карти дозволяє керувати параметрами відображення даних карти, таких як шари POI, Обрані місця, треки та рельєф. Будь ласка, увійдіть до свого облікового запису OsmAnd, щоб використовувати цей розділ меню.
...
Одним клацанням миші ви можете вмикати або вимикати відображення обраних місць на карті. Однак відображатимуться лише обрані місця з увімкненою опцією [**Показати на карті**](../web/web-userdata.mdx##favorites-on-the-web).
...
- Вмикати або вимикати треки зі списку **Нещодавно видимі**.
