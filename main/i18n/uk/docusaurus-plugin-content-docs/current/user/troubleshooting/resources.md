...
| :-- | :-- | :-- | :-- |
| Facebook | Спільнота користувачів OsmAnd (*English*)  |  Це група, де користувачі OsmAnd можуть допомагати іншим користувачам.  |  [Facebook](https://www.facebook.com/groups/osmandusers/) |
...
|  Facebook | Група користувачів LC8 Rally OsmAnd (*English*)  |  Для обміну досвідом використання OsmAnd. |  [Facebook](https://www.facebook.com/groups/1848734328597008) |
|  Facebook | Друзі Osmand в Італії (*Italian*)  |  Для обміну досвідом використання OsmAnd. |  [Facebook](https://www.facebook.com/groups/231397842534959/) |
|  Google Groups | Osmand (*English*)  | Група, де користувачі діляться порадами, відповідають на запитання та обговорюють можливості OsmAnd. | [Google Groups](https://groups.google.com/g/osmand)  |
...
|  Telegram | Канал новин OsmAnd (*English*)  | Офіційна група OsmAnd для оголошень та оновлень безпосередньо від розробників. |  [Telegram OsmAnd](https://t.me/OsmAnd_News) |
...
| Gh0stz0x | Користувацькі ресурси проєкту OsmAnd для точного налаштування поведінки OsmAnd. Тут визначено: стилі рендерингу карт, що використовуються в OsmAnd, записані та TTS-голоси, конфігурація генерації офлайн-карт, параметри маршрутизації, репозиторій іконок  |[Stormchasing rendering style](https://github.com/Gh0stz0x/OsmAnd-resources)|
