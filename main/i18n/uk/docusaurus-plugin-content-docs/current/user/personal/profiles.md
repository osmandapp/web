...
Використовуйте **Розмір іконки**, щоб налаштувати розмір іконки позиції "Моє місцезнаходження" незалежно від розміру тексту застосунку. Ви можете встановити різні розміри для режимів Resting та Navigation. Розмір можна налаштувати від 50% до 300% (50, 75, 100, 125, 150, 200, 250, 300%). Значення за замовчуванням — 100%. Торкніться Розмір іконки, щоб відкрити налаштування розміру, потім використовуйте слайдер або кнопки кроку + / – для зміни значення. Використовуйте **Скинути до стандартних**, щоб повернутися до 100%.
