...
OsmAnd пропонує різноманітні профілі за замовчуванням, розроблені для різних видів діяльності, включаючи водіння, їзду на велосипеді, піші прогулянки та більш спеціалізовані види діяльності, такі як катання на лижах та плавання на човні. Ці профілі розроблені для покращення вашого досвіду навігації відповідно до виду діяльності, якою ви займаєтеся. Кожен профіль включає настроювані параметри, що дозволяють налаштовувати параметри та інтегрувати додаткові плагіни відповідно до ваших уподобань.

- Деякі профілі, такі як *Лижі* та *Човен*, мають **додаткові функції**, які стають доступними лише тоді, коли увімкнено відповідні плагіни.

     - Плагіни можна активувати, перейшовши до *Меню → Плагіни → Вигляд лижної карти* або *Вигляд морської карти*.
     - Увімкнення плагінів надає профілям основні функції для задоволення специфічних вимог цих видів діяльності.
...
- Важливо зазначити, що деякі профілі, такі як **Вантажівка**, **Мотоцикл**, **Мопед**, **Поїзд**, **Літак**, **Човен** та **Верхова їзда**, не активовані за замовчуванням.
     ...
     - Цей метод допомагає підтримувати впорядкований та релевантний список профілів, активуючи лише ті, що потрібні для конкретних видів діяльності.

<Tabs groupId="operating-systems" queryString="current-os">

<TabItem value="android" label="Android">

- *<Translate android="true" ids="shared_string_menu,configure_profile"/>* (Перегляд карти або будь-який інший профіль)
...
Перейти до: *<Translate ios="true" ids="shared_string_menu,shared_string_settings,application_profiles"/>*
...
Перейти до: *<Translate android="true" ids="shared_string_menu,configure_profile"/>*
...
OsmAnd дозволяє [створювати резервні копії](../personal/osmand-cloud.md#osmand-start) налаштувань профілю вашої програми в OsmAnd Cloud, забезпечуючи безпечне зберігання та легке відновлення ваших конфігурацій на Android, iOS та веб-версіях. Ця функція резервного копіювання захищає ваші налаштування у випадку збою пристрою або перевстановлення програми. Ви можете скористатися цим спеціальним планом за допомогою [OsmAnd Start](../personal/osmand-cloud.md#osmand-start).  
...
Цей розділ містить налаштування для теми програми та кнопки компаса, одиниць вимірювання та форматів даних карти та профілю, зовнішніх пристроїв введення та багато інших налаштувань для створення оптимальної конфігурації для вибраного профілю.
...
Перейти до: *<Translate android="true" ids="shared_string_menu,configure_profile,general_settings_2,shared_string_appearance"/>*
...
Перейти до: *<Translate ios="true" ids="shared_string_menu,shared_string_settings,application_profiles,general_settings_2,shared_string_appearance"/>*
...
- **<Translate android="true" ids="choose_osmand_theme"/>**. Дозволяє встановити денну та нічну тему для програми, яку можна застосувати до одного профілю або до всіх одразу. Ця опція не змінює налаштування [режиму карти](../map/vector-maps.md#map-mode).
...
- **<Translate android="true" ids="map_screen_orientation"/>**. Встановлює та блокує положення екрана в програмі OsmAnd. Ця функція не підтримується на iPad.
...
- **[<Translate android="true" ids="screen_control"/>](../navigation/guidance/voice-navigation.md#screen-control)** (*Тільки Android*). Відкриває меню керування екраном, де можна вибрати параметри для екрана пристрою під час навігації, щоб заощадити заряд батареї пристрою.  
...
|  |  |  |
|:------------|:---------------|:---------------|
| **<Translate android="true" ids="driving_region"/>** | <Translate android="true" ids="shared_string_automatic"/> | <ul><li>Відповідно до розташування пристрою</li></ul> |
...
|          | <Translate android="true" ids="si_nm_ft"/>, <Translate android="true" ids="si_nm_mt"/> | 0.54 морських миль / 3280.84 футів / 1000 м |
|  |  |  |
...
|          | <Translate android="true" ids="navigate_point_format_olc"/> | Приклад:  9F2X4WFJ+7W ([Відкритий код розташування](https://en.wikipedia.org/wiki/Open_Location_Code) представляє площу 9м x 14м)  |
|          | <Translate android="true" ids="navigate_point_format_swiss_grid"/> (Тільки версія Android) | Приклад: 2 215 227.87, 830 915.9 ([Швейцарська система координат](https://en.wikipedia.org/wiki/Swiss_coordinate_system#:~:text=The%20Swiss%20coordinate%20system%20(or,Office%20of%20Topography%20(Swisstopo).)))  |
|          | <Translate android="true" ids="navigate_point_format_swiss_grid_plus"/> (Тільки версія Android) | Приклад: 4 215 227.87, 1 830 915.9 ([Швейцарська система координат](https://en.wikipedia.org/wiki/Swiss_coordinate_system#:~:text=The%20Swiss%20coordinate%20system%20(or,Office%20of%20Topography%20(Swisstopo).))) |
|  |  |  |
...
|          | <Translate android="true" ids="shared_string_milliradians"/> | Усі кутові значення мають [значення мілірадіана](https://en.wikipedia.org/wiki/Milliradian).  |
|  |  |  |
...
|  | <Translate android="true" ids="imperial_gallons"/> | Велика Британія та подібні |
|  | <Translate android="true" ids="us_gallons"/> | Сполучені Штати |
|  |  |  |
| **<Translate android="true" ids="shared_string_temperature"/>** (*Тільки Android*)| <Translate android="true" ids="system_default_theme"/> |  |
|  | <Translate android="true" ids="weather_temperature_celsius"/> |  |
|  | <Translate android="true" ids="weather_temperature_fahrenheit"/> |  |
|  |  |  |
| **<Translate android="true" ids="distance_during_navigation"/>** | <Translate android="true" ids="precise"/> | *Для точних вимірювань* виберіть, як відображається інформація про відстань у навігаційних віджетах, наприклад, відстань до точки, наступний поворот або конкретна смуга. |
|          | <Translate android="true" ids="round_up"/> | *Для кращої читабельності* числа, що відображаються в навігаційних віджетах (відстань до точки, наступний поворот або смуга), будуть округлені до меншої кількості цифр. <br/> Наприклад: 3672 м *→* 3.6 км,&nbsp; 462 м *→* 400 м,&nbsp; 184 м *→* 150 м,&nbsp; 47 м *→* 40 м,&nbsp; 18 м *→* 15 м. |
...
Перейти до: *<Translate android="true" ids="shared_string_menu,configure_profile,general_settings_2,shared_string_other"/>*
...
Перейти до: *<Translate ios="true" ids="shared_string_menu,shared_string_settings,application_profiles,general_settings_2,shared_string_others"/>*
...
Розділ **Інше** надає додаткові налаштування профілю для налаштування інтерфейсу OsmAnd та елементів керування введенням. Ці налаштування дозволяють налаштовувати зовнішні пристрої, коригувати параметри анімації та перемикати повноекранний режим.
...
- **<Translate android="true" ids="use_volume_buttons_as_zoom"/>** (*Тільки Android*) – Увімкніть або вимкніть можливість використовувати кнопки гучності вашого пристрою для [збільшення та зменшення масштабу](../map/interact-with-map.md#my-location-and-zoom) на карті.

- [<Translate android="true" ids="use_kalman_filter_compass"/>](../map/interact-with-map.md#extra-compass-settings) (*Тільки Android*) – Згладжує обертання карти за допомогою [плавного руху](https://en.wikipedia.org/wiki/Kalman_filter), зменшуючи раптові зміни положення. Це призводить до невеликої затримки (*менше 1 секунди*).

- [<Translate android="true" ids="use_magnetic_sensor"/>](../map/interact-with-map.md#extra-compass-settings) (*Тільки Android*) – Використовує [магнітний датчик](https://en.wikipedia.org/wiki/Kalman_filter) вашого пристрою для стабілізації обертання карти, зменшуючи різкі зміни. Це також призводить до невеликої затримки.

- **<Translate android="true" ids="tap_on_map_to_hide_interface"/>** (*Тільки Android*) – Торкніться порожнього місця на карті, щоб приховати кнопки керування та віджети, максимально збільшуючи видимість карти.

- [<Translate android="true" ids="do_not_use_animations"/>](../map/interact-with-map.md#no-animations) (*Тільки Android*) – Вимкніть анімації в режимі навігації для швидших переходів екрана.

- **<Translate android="true" ids="position_animation"/>** (*Тільки Android*) – Піктограма [позиції](../map/interact-with-map.md#my-location-and-zoom) анімується з кожною отриманою точкою GPS (раз на секунду). Може бути помітна невелика затримка в її русі, особливо під час швидкого руху або коливань сигналу GPS. Ви можете налаштувати цей ефект за допомогою параметра *Час передбачення*: вищі значення збільшують плавність, але додають затримку, нижчі значення зменшують затримку, але можуть зробити рух менш плавним.
...
- [Тип навігації](../navigation/guidance/navigation-settings.md#navigation-type) - Виберіть відповідний режим навігації на основі вашого способу пересування та наявності Інтернету.
...
- [Голосові підказки](../navigation/guidance/navigation-settings.md#voice-prompts) - Увімкніть звукові підказки, щоб отримувати голосові навігаційні інструкції під час руху або прогулянки за вибраним маршрутом.
...
- [Налаштувати лінію маршруту](../navigation/guidance/navigation-settings.md#customize-route-line) – Налаштуйте колір, ширину та стиль лінії маршруту, що відображається на карті, для кращої видимості під час навігації.

- [Карта під час навігації](../navigation/guidence/navigation-settings.md#map-during-navigation) – Переглядайте позиціонування в реальному часі на карті, відстежуйте прогрес за маршрутом та покращуйте орієнтацію за допомогою орієнтирів.

- [Детальне керівництво по треку](../navigation/guidance/navigation-settings.md) – Покращуйте покрокову навігацію, вирівнюючи свій маршрут з нанесеними на карту дорогами. Доступні налаштування: *Запитувати щоразу* або *Завжди*.
...
- *<Translate android="true" ids="shared_string_menu,shared_string_settings,application_profiles"/>* *→ Налаштувати карту*
...
Перейти до: *<Translate ios="true" ids="shared_string_menu,shared_string_settings,application_profiles,configure_map"/>*  
...
Меню [<Translate android="true" ids="configure_map"/>](../map/configure-map-menu.md) дозволяє налаштовувати параметри відображення карти для вибраного профілю, забезпечуючи кращу візуалізацію ключових елементів карти.  

За допомогою цього меню ви можете:

- **Виділити важливі елементи карти**, включаючи [Вибрані точки](../personal/favorites.md), [Навігаційні маркери](../personal/markers.md) або спеціальні [Точки інтересу](../map/point-layers-on-map.md#points-of-interest-pois) на карті.

- **Відображати певні маршрути та файли GPX**, включаючи сторонні треки для навігації або аналізу.

- **Накладати додаткові шари карти**, такі як [інформація про рельєф](../plugins/topography.md), **супутникові знімки** або інші доступні [растрові карти](../map/raster-maps.md).
...
- **Налаштувати вигляд карти**, вибравши інший [стиль карти](../map/vector-maps.md#default-map-styles) відповідно до ваших потреб.
...
- Перейти до: *Меню → Налаштування → Профіль програми → Налаштувати екран*
...
[<Translate android="true" ids="map_widget_config"/>](../widgets/configure-screen.md) – це меню, яке дозволяє налаштовувати віджети для вибраного профілю, що відображатимуться на карті. На цьому екрані можна увімкнути та налаштувати [Інформаційні](../widgets/info-widgets.md) та [Навігаційні](../widgets/nav-widgets.md) віджети, а також інші елементи.
...
Перейти до: *<Translate android="true" ids="shared_string_menu,configure_profile,profile_appearance"/>*
...
Перейти до: *<Translate ios="true" ids="shared_string_menu,shared_string_settings,application_profiles,profile_appearance"/>*  
...
Налаштування **Зовнішній вигляд профілю** дозволяють налаштувати ім'я та візуальне представлення вашого профілю. Тут також можна змінити вигляд [Моє місцезнаходження](#my-location-appearance). Хоча *ім'я профілю* має бути унікальним, *іконки* та *кольори* можуть бути однаковими для різних профілів. Ці зміни будуть застосовані в різних частинах програми, наприклад, у меню [Підготовка маршруту](../navigation/setup/route-navigation.md).
...
Налаштування **Зовнішній вигляд мого місцезнаходження** дозволяють налаштувати відображення вашого місцезнаходження на карті, як у стаціонарному положенні, так і в русі. Рух виявляється операційною системою, коли швидкість пристрою **більша за нуль**.

#### 1. Кут огляду та радіус місцезнаходження {#1-view-angle-and-location-radius}

Ви можете налаштувати візуальні елементи, пов'язані з вашим місцезнаходженням, та застосувати їх окремо або разом для позицій **Відпочинок** та **Навігація**. Для обох режимів 2D та 3D, *Кут огляду* та *Радіус місцезнаходження* відображаються тим самим кольором, вибраним для [профілю навігації](#profile-appearance), безпосередньо під піктограмою [Моє місцезнаходження](../map/interact-with-map.md#my-location-and-zoom).

- **<Translate android="true" ids="view_angle"/>** – Відображає **конусоподібну** область, що вказує напрямок, у якому ви зараз дивитеся.  
- **<Translate android="true" ids="location_radius"/>** – Показує **кругову область** навколо вашої піктограми, що представляє точність вашого поточного місцезнаходження.
...
1. **Створіть 3D-модель**. Розробіть свою іконку у [форматах MTL та OBJ](https://en.wikipedia.org/wiki/Wavefront_.obj_file).

2. **Інтегруйте модель в OsmAnd:**  
   - Розробіть [користувацький плагін](../plugins/custom.md) за допомогою наданого [прикладу плагіна](https://osmand.net/uploads/plugins/model.plugin/1/model.plugin-1.osf).  
   - Розмістіть файли 3D-іконок за такими шляхами:  
...
Ви можете керувати поведінкою піктограми **Моє місцезнаходження** за допомогою різних [режимів орієнтації карти](../widgets/map-buttons.md#compass).  

- Якщо піктограма місцезнаходження **дрижить або обертається** в стаціонарному положенні, перейдіть з **Режиму напрямку руху** ([Обертати карту за напрямком](../map/interact-with-map.md#rotate-map-by-bearing)) на інший режим.  
- Налаштуйте додаткові параметри в *Меню → Налаштування → Профілі програми → Зовнішній вигляд профілю → Параметри*.
- Дізнайтеся більше про відстеження напрямку та курсу в розділі [Віджет напрямку](../widgets/nav-widgets#bearing-widget).  
...
:::note Для невикористаних плагінів
Щоб приховати всі параметри керування невикористаних [плагінів](../plugins/index.md#configure-plugin), вимкніть їх.
:::
...
- **Основні видимі елементи** - У розділі *Налаштувати інтерфейс користувача* ви можете *змінювати порядок, приховувати та відновлювати* елементи з [Висувної панелі](../start-with/main-menu.md#customize-advanced-use-of-android) відповідно до ваших уподобань.
...
- **<Translate android="true" ids="copy_from_other_profile"/>** - Дозволяє скопіювати *макет висувної панелі* з іншого профілю OsmAnd для підтримки послідовних налаштувань у всіх профілях.
...
- **Налаштувати меню карти** - У розділі *Налаштувати інтерфейс користувача* ви можете *змінювати порядок або приховувати елементи* з [Налаштувати карту](../map/configure-map-menu.md), що дозволяє швидко отримати доступ до часто використовуваних налаштувань.

- **<Translate android="true" ids="reset_to_default"/>** - Відновлює *оригінальний список елементів* у меню Налаштувати карту, видаляючи будь-які зміни.

- **<Translate android="true" ids="copy_from_other_profile"/>** - Копіює *макет меню Налаштувати карту* з іншого профілю OsmAnd.
...
- **Контекстне меню карти** - У розділі "Налаштування інтерфейсу користувача" ви можете змінювати порядок або приховувати елементи в [контекстному меню карти](../map/map-context-menu.md) для оптимізації доступу до часто використовуваних функцій.
...
Перейти до: *<Translate android="true" ids="shared_string_menu,shared_string_settings,application_profiles,plugin_settings"/>*  
...
Перейти до: *<Translate ios="true" ids="shared_string_menu,shared_string_settings,application_profiles,plugins_menu_group"/>*
...
Плагіни розблоковують додаткові функції програми та можуть бути [платними або безкоштовними](../plugins/index.md#purchase). Деякі плагіни мають власні [налаштування](../plugins/index.md#plugin-settings), інші — ні. OsmAnd дає вам можливість налаштовувати плагіни для кожного профілю окремо.
...
- **Погода**. Інтерактивні [Погодні](../plugins/weather.md#weather-settings) шари карти дозволяють відстежувати температуру, атмосферний тиск, хмарність, швидкість вітру та опади у вашому місті або будь-якому іншому місці на глобальній карті.

- **Аудіо/Відео нотатки** (*Тільки Android*). Цей пункт відкриває [налаштування плагіна аудіо-відео](../plugins/audio-video-notes.md#plugin-settings) для вибраного профілю. Плагін *Аудіо/Відео нотатки* розширює функціональність OsmAnd, дозволяючи створювати нотатки в різних форматах, таких як фото, відео або аудіо, та пов'язувати їх з географічним розташуванням або поточним місцезнаходженням.  
...
- **Зовнішні датчики**. Коли ви торкаєтеся елемента в розділі *Налаштування плагіна*, відкриваються [налаштування зовнішніх датчиків](../plugins/external-sensors.md#sensors-settings) для вибраного профілю. Плагін "Зовнішні датчики" дозволяє зчитувати та записувати дані з бездротових зовнішніх датчиків та відображати їх за допомогою віджетів у програмі OsmAnd.

- **Доступність** (*Тільки Android*). Цей пункт відкриває [налаштування плагіна Доступність](../plugins/accessibility.md#plugin-settings) для вибраного профілю. Налаштування плагіна Доступність дозволяють налаштувати програму відповідно до ваших потреб. Усі налаштування стосуються процесу навігації та встановлюються індивідуально для кожного профілю.

- **Розробка OsmAnd**. Це меню відкриває [налаштування плагіна розробки OsmAnd](../plugins/development.md#plugin-settings), де ви можете налаштувати програму OsmAnd для тестування або дослідити майбутні функції. Ці налаштування призначені для розробників і не потрібні для звичайного використання програми.  

  > ***Зміна налаштувань плагіна розробки OsmAnd впливає на всі профілі.***

- **Вікіпедія** (Тільки iOS). Це меню відкриває *[налаштування плагіна Вікіпедія](../plugins/wikipedia.md#wikipedia-settings)*. Ви можете вибрати мову, якою відображатимуться статті, та вибрати, чи завантажувати зображення з Вікіпедії. Наявність Вікіпедії під час подорожі покращує ваш досвід, надаючи інформацію про місця, які ви відвідуєте. Вона працює в автономному режимі та відображає відповідні статті Вікіпедії безпосередньо на карті, пов'язані з точками інтересу.

- **Метрики транспортного засобу**. Це меню відкриває *[налаштування плагіна метрик транспортного засобу](../plugins/vehicle-metrics.md#scanner-settings)*. Воно дозволяє підключити сканер OBD-II до OsmAnd.

- **Відстеження суден AIS** (Тільки Android). Це меню відкриває *[налаштування плагіна відстеження суден AIS](../plugins/ais-tracker.md#plugin-settings)*. Цей плагін дозволяє підключити трекер AIS до OsmAnd.
...
- **Скинути до початкових** - Повертає всі налаштування до початкового стану.

- **Видалити профіль**:
    - Ця дія доступна лише для *Android* і лише для *Користувацького профілю*.
    - Профілі за замовчуванням не можуть бути видалені.
