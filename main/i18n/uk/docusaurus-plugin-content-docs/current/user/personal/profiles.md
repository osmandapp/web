...
Налаштування **Зовнішній вигляд "Моє місцезнаходження"** дозволяють вам налаштувати, як ваше місцезнаходження відображається на мапі, як у стані спокою (Resting), так і в русі (Navigation). Рух виявляється операційною системою, коли швидкість пристрою **більша за нуль**.
...
![Зовнішній вигляд "Моє місцезнаходження"](@site/static/img/personal/profiles/location_appearance_2_ios_new.png)

Налаштування **Зовнішній вигляд "Моє місцезнаходження"** дозволяють вам налаштувати, як ваше місцезнаходження відображається на мапі, як у стані спокою (Resting), так і в русі (Navigation). Рух виявляється операційною системою, коли швидкість пристрою **більша за нуль**.

Використовуйте **<Translate ios="true" ids="icon_size"/>**, щоб налаштувати розмір іконки позиції "Моє місцезнаходження" незалежно від розміру тексту застосунку. Ви можете встановити різні розміри для режимів Resting та Navigation. Розмір можна налаштувати від 50% до 300% (50, 75, 100, 125, 150, 200, 250, 300%). Значення за замовчуванням — 100%. Торкніться Розмір іконки, щоб відкрити налаштування розміру, потім використовуйте слайдер або кнопки кроку + / – для зміни значення. Використовуйте **<Translate ios="true" ids="reset_to_default"/>**, щоб повернутися до 100%.
...
2. **Інтегруйте модель в OsmAnd:**  
   ...
   - Або скопіюйте файли **MTL та OBJ** безпосередньо в папку OsmAnd, використовуючи ту саму структуру каталогів.  
...
![Меню налаштування мапи профілю Android](@site/static/img/personal/profiles/profile_configure_map_visible_andr.png) ![Меню налаштування мапи профілю Android](@site/static/img/personal/profiles/profile_configure_map_show_andr.png)
...
Плагіни розблоковують додаткові функції застосунку і можуть бути як [платними, так і безплатними](../plugins/index.md#purchase). Деякі плагіни мають власні [налаштування](../plugins/index.md#plugin-settings), інші — ні. OsmAnd дає вам можливість налаштовувати плагіни для кожного профілю окремо.
