...
Ви повинні мати обліковий запис [OsmAnd Cloud](../personal/osmand-cloud.md#login), щоб використовувати *Безкоштовне резервне копіювання налаштувань*. Якщо у вас є підписка *OsmAnd Pro* або активний обліковий запис *OsmAnd Cloud*, банер акції не відображатиметься.
...
|          | <Translate android="true" ids="navigate_point_format_utm"/> | 34N 5552876 423678 (Зона Північне Східне) . [<Translate android="true" ids="utm_format_descr"/>](https://en.wikipedia.org/wiki/Universal_Transverse_Mercator_coordinate_system) |
...
|  |  |  |
| **<Translate android="true" ids="distance_during_navigation"/>** | <Translate android="true" ids="precise"/> | *Для точних вимірювань* виберіть, як відображається інформація про відстань у навігаційних віджетах, наприклад, відстань до точки, наступного повороту або певної смуги. |
|          | <Translate android="true" ids="round_up"/> | *Для кращої читабельності* числа, що відображаються у навігаційних віджетах (відстань до точки, наступного повороту або смуги), будуть округлені до меншої кількості цифр. <br/> Наприклад: 3672 м *→* 3.6 км,&nbsp; 462 м *→* 400 м,&nbsp; 184 м *→* 150 м,&nbsp; 47 м *→* 40 м,&nbsp; 18 м *→* 15 м. |
...
Розділ **Інше** надає додаткові налаштування профілю для налаштування інтерфейсу та елементів керування введенням OsmAnd. Ці налаштування дозволяють налаштовувати зовнішні пристрої, регулювати параметри анімації та перемикати повноекранний режим.
...
- **<Translate android="true" ids="use_volume_buttons_as_zoom"/>** (*Тільки Android*) – Увімкніть або вимкніть можливість використання кнопок гучності вашого пристрою для [масштабування](../map/interact-with-map.md#my-location-and-zoom) карти.
...
- [<Translate android="true" ids="do_not_use_animations"/>](../map/interact-with-map.md#no-animations) (*Тільки Android*) – Вимкніть анімацію в режимі навігації для швидшого переходу між екранами.
...
- [Тип навігації](../navigation/guidance/navigation-settings.md#navigation-type) - Виберіть відповідний режим навігації на основі вашого способу пересування та доступності інтернету.
...
- [Голосові підказки](../navigation/guidance/navigation-settings.md#voice-prompts) - Увімкніть звукові підказки для отримання голосових навігаційних інструкцій під час руху або прогулянки за вибраним маршрутом.
...
- **Виділити важливі елементи карти**, включаючи [Вибрані точки](../personal/favorites.md), [Навігаційні маркери](../personal/markers.md) або спеціальні [Точки інтересу (POI)](../map/point-layers-on-map.md#points-of-interest-pois) на карті.
...
- Перейдіть до: *Меню → Налаштування → Профіль програми → Налаштувати екран*
...
#### 2. Користувацькі 3D-піктограми {#2-custom-3d-icons}

Для більш персоналізованого досвіду ви можете створювати та додавати **користувацькі 3D-піктограми** до OsmAnd.  

***Як додати користувацьку 3D-піктограму місцезнаходження:***

1. **Створіть 3D-модель**. Створіть свою піктограму у [форматах MTL та OBJ](https://en.wikipedia.org/wiki/Wavefront_.obj_file).
...
2. **Інтегруйте модель в OsmAnd:**  
   ...
   - Розмістіть файли 3D-піктограм за такими шляхами:  
...
Ви можете керувати поведінкою піктограми **Моє місцезнаходження**, використовуючи різні [режими орієнтації карти](../widgets/map-buttons.md#compass).  

- Якщо піктограма місцезнаходження **тремтить або обертається** у стаціонарному стані, переключіться з **Режиму напрямку руху** ([Обертати карту за напрямком](../map/interact-with-map.md#rotate-map-by-bearing)) на інший режим.  
- Налаштуйте додаткові параметри в *Меню → Налаштування → Профілі програми → Вигляд профілю → Параметри*.
- Дізнайтеся більше про відстеження напрямку та курсу в розділі [Віджет курсу](../widgets/nav-widgets#bearing-widget).  
...
- **<Translate android="true" ids="copy_from_other_profile"/>** - Дозволяє скопіювати *макет висувної панелі* з іншого профілю OsmAnd для підтримки послідовних налаштувань між профілями.
...
- **<Translate android="true" ids="reset_to_default"/>** - Відновлює *оригінальний список елементів* у меню Налаштування карти, скасовуючи будь-які зміни.
...
- **Контекстне меню карти** - У розділі "Налаштувати інтерфейс користувача" ви можете змінювати порядок або приховувати елементи в [контекстному меню карти](../map/map-context-menu.md), щоб оптимізувати доступ до часто використовуваних функцій.
...
- **Погода**. Інтерактивні [погодні](../plugins/weather.md#weather-settings) шари карти дозволяють відстежувати температуру, тиск повітря, хмарність, швидкість вітру та опади у вашому місті або будь-якому іншому місці на глобальній карті.
...
- **Зовнішні датчики**. При натисканні на пункт у розділі *Налаштування плагінів* відкриваються [налаштування зовнішніх датчиків](../plugins/external-sensors.md#sensors-settings) для вибраного профілю. Плагін "Зовнішні датчики" дозволяє зчитувати та записувати дані з бездротових зовнішніх датчиків та відображати їх за допомогою віджетів у програмі OsmAnd.
...
- **Розробка OsmAnd**. Це меню відкриває [налаштування плагіна розробки OsmAnd](../plugins/development.md#plugin-settings), де ви можете налаштувати програму OsmAnd для тестування або вивчити майбутні функції. Ці налаштування призначені для розробників і не потрібні для звичайного використання програми.  
