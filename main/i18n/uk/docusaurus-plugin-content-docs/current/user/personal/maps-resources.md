...
- [Контурні лінії](../plugins/topography.md#contour-lines). Карта, що містить контурні лінії висот для візуалізації рельєфу.
...
- [Морські глибини та контури](../plugins/nautical-charts.md). Морські карти, що показують узбережжя, глибини, навігаційні засоби, гавані та небезпеки для безпечного плавання та вітрильного спорту.
...
- **Тип**. Тип елемента даних, наприклад **Стандартна карта**, **Wikipedia**, **Контурні лінії** тощо.
...
Коли карта деактивована, вона може тимчасово зникнути з вкладки Локальні. Якщо оновлення стає доступним для деактивованої карти, вона все одно з'явиться у списку Оновлень і буде позначена сірою іконкою. Оновлення такої карти автоматично активує її знову.
