...
- [Додаткові карти](#extra-maps). Відображає дані карт для [Користувацького пакету](../plugins/custom).
...
![Меню Карти Оновлення карт Android](@site/static/img/personal/maps/maps_update_andr.png) ![Вкладка Оновлення карт Android](@site/static/img/personal/maps/maps_update_tab_andr.png)
