...
- **Форма** — Виберіть форму мітки (коло, квадрат, октагон).
...
Така гнучкість дозволяє стандартизувати вигляд папки або зберегти унікальні налаштування, одночасно встановлюючи значення за замовчуванням для нових точок.
