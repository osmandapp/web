...
1. [Натисніть](../map/map-context-menu.md#select-an-object-single-tap) на вибране на карті або перейдіть до [Мої вибрані](#manage-favorites).
...
Широкий спектр іконок для POI та маршрутних точок доступний в OsmAnd. Ви можете:
...
### Спеціальні вибрані (Особисті) {#special-favorites-personal}
...
Перейти до: *Довге натискання на папку → Стандартний вигляд*
...
- **<Translate android="true" ids="shared_string_rename"/>** — Використовуйте цю опцію для зміни назви вибраної папки.
...
- **<Translate android="true" ids="shared_string_add_to_map_markers"/>** або **Видалити з маркерів карти** (*тільки Android*) — Додайте всі точки вибраного з папки до *Списку маркерів карти* або видаліть їх за потреби для легкого доступу.

- **<Translate android="true" ids="shared_string_share"/>** — Поділіться точками вибраного в папці, експортувавши їх як файл *Favorites.gpx*, що дозволяє легко передавати або створювати резервні копії ваших даних.

- **<Translate android="true" ids="shared_string_delete"/>** — Безповоротно видаліть вибрану папку вибраного та всі точки в ній.

Детальніше в статті [Мої місця](../personal/myplaces.md#favorites).
...
- **Місця резервного копіювання** — Локальне сховище, [OsmAnd Cloud](../personal/osmand-cloud.md) (тільки з підпискою [OsmAnd Pro або OsmAnd Start](../purchases/index.md)), або програми для обміну миттєвими повідомленнями.
...
- **Збереження вибраних точок**. Регулярно зберігайте свої вибрані точки в OsmAnd, щоб уникнути їх втрати, якщо ваш пристрій вийде з ладу або програму буде видалено.
...
Ви можете експортувати та імпортувати свої вибрані за допомогою спеціальних кнопок внизу екрана "Вибране". Файл [.gpx](../../technical/osmand-file-formats/osmand-gpx.md) (*favorites.gpx*) можна надіслати в Dropbox, електронною поштою, месенджерами та іншими програмами, встановленими на вашому пристрої, які підтримують цю функцію.

- Кнопка **Імпорт** (*Android*) / **Імпортувати вибране** (*iOS*). Дозволяє імпортувати вибрані точки (*favorites.gpx*) як маршрутні точки з файлу *GPX* (поширений формат GPS-даних) зі сховища вашого пристрою.
- Кнопка **Поділитися** (*Android*) / **Експортувати вибране** (*iOS*). Дозволяє експортувати (поділитися) усі ваші вибрані як файл *favorites.gpx*.
...
- **iOS**: Файли розташовані в *Files → On my iPhone → OsmAnd Maps → favourites_backup*.
