---
source-hash: 7cc058afef65a7c9da795155721ef0d40937676268f6a5746cb1496d03a9d790
sidebar_position: 7
title:  Вибране
---
...
Функція **Вибране** в OsmAnd дозволяє створювати закладки (нотатки) на карті. Ці вибрані точки за замовчуванням відображаються як жовті зірочки, але ви можете повністю налаштувати їх за допомогою різних кольорів, форм та іконок. Вибране групується в спеціальний шар карти, який стає видимим з *6-го рівня масштабування*.
...
При додаванні точки з даних OSM відповідна інформація POI автоматично включається. Ви також можете створити вибране, [довго натиснувши](../map/map-context-menu.md#select-any-point-long-tap) будь-яке місце на карті.
...
- **Видалити** — Видалити вибране за допомогою опції видалення, доступної через меню редагування або за допомогою кнопки видалення на Android.
...
В OsmAnd доступний широкий спектр іконок для POI та маршрутних точок. Ви можете:
...
- **Сортування** — Папки та точки вибраного сортуються за алфавітом, з [особистою папкою](../personal/favorites.md#special-favorites-personal) нагорі.
...
Перейти до: *Меню з трьома крапками → Змінити вигляд за замовчуванням*
...
Перейти до: *Довге натискання папки → Вигляд за замовчуванням*
...
- **<Translate android="true" ids="change_default_appearance"/>** — Налаштуйте, як точки вибраного в папці відображаються на карті, змінюючи їхні іконки, кольори або мітки.
...
- **<Translate android="true" ids="shared_string_add_to_map_markers"/>** або **Видалити з маркерів карти** (*лише Android*) — Додайте всі точки вибраного з папки до *Списку маркерів карти* або видаліть їх за потреби для легкого доступу.
...
- **Збереження вибраних точок**. Регулярно зберігайте свої вибрані точки в OsmAnd, щоб уникнути їх втрати, якщо ваш пристрій вийде з ладу або програма буде видалена.
...
Ви можете експортувати та імпортувати вибране за допомогою спеціальних кнопок у нижній частині екрана Вибраного. Файл [.gpx](../../technical/osmand-file-formats/osmand-gpx.md) (*favorites.gpx*) можна надіслати в Dropbox, електронну пошту, месенджери та інші програми, встановлені на вашому пристрої, які підтримують цю функцію.
...
- Кнопка **Поділитися** (*Android*) / **Експортувати вибране** (*iOS*). Дозволяє експортувати (ділитися) всіма вашими вибраними як файл *favorites.gpx*.
...
- Натисніть **Меню з трьома крапками** (*Android*) або кнопку **Редагувати** (*іконка олівця на iOS*) або **довго натисніть** папку (*iOS*) вибраної папки вибраного.
