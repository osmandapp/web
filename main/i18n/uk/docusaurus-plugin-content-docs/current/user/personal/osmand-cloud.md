---
source-hash: 37d58885701eb58e62a63f2e95d9ffad9fc9c11574d0e6b42dc39ee0fcb91ee0
sidebar_position: 11
title:  OsmAnd Cloud
---
...
:::note cross-platform  
OsmAnd Cloud — це незалежний хмарний сервіс зберігання даних, який *не прив'язаний* до конкретної версії платформи Android, iOS чи веб.  
:::  

OsmAnd Cloud дозволяє **зберігати та синхронізувати особисті налаштування та дані застосунків** на кількох пристроях. Ви можете отримати доступ до цих даних на будь-якому пристрої, де встановлено OsmAnd, включно з настільним застосунком. Усі зміни, внесені в застосунку, можуть бути **синхронізовані між платформами**, забезпечуючи безперешкодний доступ до збережених даних.
...
- Для реєстрації або входу вам потрібна активна підписка [OsmAnd Pro](#cross-platform) або [OsmAnd Start](#osmand-start). Ви можете перевірити статус своєї підписки в застосунку OsmAnd:  
  *Меню → Налаштування → Покупки*.

- Ваш обліковий запис Cloud **має бути зареєстрований на пристрої, де була здійснена покупка**.
...
- Переконайтеся, що ви реєструєтеся на **тому ж пристрої**, де була здійснена покупка.  
- Перевірте своє **інтернет-з'єднання** перед повторною спробою.
...
- [Безкоштовне резервне копіювання вибраного](../personal/favorites.md#free-cloud-backup) – Зберігайте важливі місця та маршрути у вибраному та отримуйте до них доступ з будь-якого пристрою, підключеного до OsmAnd Cloud.  
- [Безкоштовне резервне копіювання налаштувань](../personal/profiles.md#free-cloud-backup) – Зберігайте налаштування застосунку OsmAnd в OsmAnd Cloud та відновлюйте їх на інших пристроях для безперебійної роботи.  
- [Редагування/нотатки OSM](../plugins/osm-editing.md) – Додавайте до OpenStreetMap, створюючи та редагуючи дані мапи, додаючи нотатки та зберігаючи зміни безпосередньо в OsmAnd Cloud.
...
Функція **Кошик** дозволяє переглядати та керувати файлами, які були видалені з OsmAnd Cloud. Вона розроблена для запобігання випадковому видаленню файлів та незворотній втраті ваших даних.
...
Усі [мапи](../start-with/download-maps.md) зберігаються на пристрої, на якому вони були завантажені раніше. OsmAnd Cloud зберігає лише інформацію про те, які мапи у вас є, та дату їх останньої зміни.
...
Дії, які ви можете виконати в розділі **Небезпечна зона** меню Налаштування, є незворотними, тому вимагають особливої уваги.
...
У розділі [Остання синхронізація](#last-sync) спадного меню торкніться будь-якого елемента, щоб відкрити розділ Зміни. Цей розділ містить три вкладки, що відображають усі доступні зміни для редагування. Якщо список порожній, з моменту останньої синхронізації змін не відбулося.
...
- У кожній вкладці дані **сортуються за типом та за алфавітом**, щоб допомогти вам швидко знайти потрібні елементи, особливо при керуванні кількома файлами в OsmAnd Cloud.
...
- **Локальні** - Ви можете синхронізувати всі локальні зміни, яких ще немає в хмарі, натиснувши **Вивантажити все**. Крім того, ви можете завантажити певні зміни, вибравши їх зі списку та обравши **Вивантажити локальну версію**.  
...
- Натискання на файл у папці **Конфлікти** відображає деталі про **Локальну** та **Хмарну** версії, включаючи час останньої модифікації та завантаження.
