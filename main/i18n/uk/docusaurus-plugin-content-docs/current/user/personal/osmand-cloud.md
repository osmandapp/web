...
- Автоматичне резервне копіювання запускається приблизно щогодини, доки OsmAnd працює на передньому плані.
- Резервне копіювання також починається, коли ви повертаєтеся до екрана карти.
