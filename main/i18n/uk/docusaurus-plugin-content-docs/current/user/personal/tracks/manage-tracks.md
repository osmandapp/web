...
- **Показати/Приховати на мапі** — Відображає або приховує вибрані треки на мапі, візуально представляючи їхнє розташування.

- [Відкрити](../../map/tracks/index.md#configure-map) (*iOS*) — Ця опція доступна в меню "Налаштувати мапу". Розташована в *<Translate ios="true" ids="shared_string_menu,configure_map,shared_string_gpx_tracks"/>*, вона дозволяє отримати доступ до [контекстного меню вибраного треку](../../map/tracks/track-context-menu.md) при натисканні.
...
- **Завантажити зміни в OSM** (*iOS*) — [Завантажити зміни](../../plugins/osm-editing.md#gps-track), які ви внесли до треку, безпосередньо в *OpenStreetMap*.
...
- **Експорт** (*Android*) — Перейдіть до *Меню → Налаштування → Вкладка "Дії"* для експорту всіх треків з папки.
...
- [Фільтр](./smart-folder.md#search-filter) (*тільки Android*), якщо вам потрібні специфічні характеристики треку.
...
- **Показати на мапі** — За допомогою цієї функції ви можете відобразити вибрані треки на мапі, щоб краще зрозуміти їхнє розташування та взаємозв'язок.
...
- [Змінити вигляд](../../map/tracks/appearance.md#change-appearance-for-multiple-tracks) — Ця опція дозволяє налаштувати вигляд вибраних треків, зробивши їх більш помітними та впізнаваними на мапі.
...
- **Найновіші спочатку** — Перераховує треки за датою створення, найновіші зверху.

- **Найстаріші спочатку** — Перераховує треки за датою створення, найстаріші зверху.

- **Найдовша відстань спочатку** — Відображає треки, відсортовані за довжиною, найдовші зверху.

- **Найкоротша відстань спочатку** — Відображає треки, відсортовані за довжиною, найкоротші зверху.
...
- **Показати всі треки на мапі** (*тільки Android*) — Відображає всі треки в папці на мапі —  
...
У нижній частині списку на вкладці *Треки*, а також під списком треків **у кожній з ваших папок**, є інформаційний розділ, який дозволяє переглядати загальну зведену статистику для треків у вибраній папці. Усі значення відображаються в обраних вами [одиницях](../../personal/profiles.md#units--formats).

- *Кількість **треків** у папці* — Відображає кількість треків, що містяться у вибраній папці.

- *Загальна сума* **Відстаней** — Відображається загальна довжина всіх треків у вибраній папці, виміряна в обраних вами одиницях.
...
Як відкрити дії з папкою:

- Відкрийте вкладку "Треки" в "Моїх місцях".
- Перейдіть до папки, якою ви хочете керувати.
- Торкніться *меню з трьома крапками* у верхньому правому куті, щоб відкрити меню дій з папкою.

***Дії в меню папки:***

- [Вибрати](#selection-mode) — Торкніться потрібних папок і треків, щоб застосувати дії з меню в *режимі вибору*.

- [Сортувати підпапки](#sort-by) — Застосувати порядок сортування (наприклад, за назвою, датою) до всіх підпапок і треків на кожному рівні.
...
- [Імпорт](#import) — Завантажувати файли GPX або інші файли треків з вашого пристрою в OsmAnd для використання в автономному режимі.

- **Додати нову папку** — Щоб організувати ваші маршрути та треки в логічні категорії, помістіть їх у різні папки. Це допомагає структурувати вашу навігаційну інформацію.
...
1. **Прямий імпорт файлів:**
    ...
    - Виберіть "Відкрити в OsmAnd" за запитом.
...
Є кілька способів експортувати один або кілька файлів треків до будь-якого месенджера, електронної пошти, файлового менеджера або програми.  
