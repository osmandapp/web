...
5. Ви також можете додати **Маршрутні точки** до нового треку за допомогою **[Контекстного меню](../../map/map-context-menu.md#-add--edit-track-waypoint--add--edit-track-waypoint)**.
...
Усі треки, які коли-небудь були записані, створені або імпортовані, автоматично відображаються у папці [Мої місця](../../personal/myplaces.md) на вкладці *Треки*. Вони організовані за папками або відображаються у списку під ними.
...
Кожен трек, як і папки, має меню, що дозволяє ефективно керувати треками. Ось як до нього отримати доступ:
...
- [Змінити активність](../../map/tracks/track-context-menu.md#track-information-activity) — Ця дія дозволяє змінити тип активності, наприклад, на *Автомобіль*, *Пригодницький мотоспорт*, *Піший туризм* або інші, для вибраного треку.
...
- **Видалити** — Якщо вибрані треки або папки більше не потрібні, функція Видалити дозволяє видалити їх, при цьому застосунок надає параметри підтвердження, щоб уникнути випадкового видалення.
...
- **Новіші дати спочатку** — Перераховує треки за датою створення, з новішими зверху.

- **Старіші дати спочатку** — Перераховує треки за датою створення, зі старішими зверху.
...
Вибраний параметр сортування застосовується не тільки до поточної підпапки, але й до всіх вкладених папок та треків на всіх рівнях. Це забезпечує послідовну структуру збережених даних.
...
- [Експорт](../../personal/import-export.md) — Відкриває вкладку *Меню → Налаштування → Дії*, щоб експортувати всі треки в папці як [файл .osf](../../personal/import-export.md#export).
...
У нижній частині списку на вкладці *Треки* та під списком треків **у кожній з ваших папок** є інформаційний розділ, який дозволяє переглядати загальну зведену статистику для треків у вибраній папці. Усі значення відображаються у вибраних вами [одиницях](../../personal/profiles.md#units--formats).
...
- *Сума* **Спусків** — Цей параметр є сумою вертикальних спусків по всіх треках у вибраній папці.
...
- [Імпорт](#import) — Завантажуйте файли GPX або інші файли треків з вашого пристрою в OsmAnd для використання в автономному режимі.
...
- Торкніться *меню з трьома крапками* у полі папки, щоб видалити.
...
1. **Прямий імпорт файлу:**
    ...
    - Імпортований трек зберігається у папці **Імпорт** у *Моїх місцях*.
