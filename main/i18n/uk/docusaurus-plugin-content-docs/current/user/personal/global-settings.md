...
![Загальні налаштування Профіль CarPlay iOS](@site/static/img/personal/profiles/CarPlay_ios.png)  
...
| [3D-рельєф](../plugins/topography.md#3d-relief) | Не підтримується. | Ця функція візуалізує рельєф на мапі, додаючи інформацію про висоту до звичайної 2D-мапи, що створює ефект 3D та глибини. |
...
| [Перегляд у режимі глобуса](../map/interact-with-map.md#globe-view) | Не підтримується. | Дозволяє відображати мапу як сферичну Землю (глобус) замість плоскої проекції. |   
...
![Джерело місцезнаходження](@site/static/img/personal/profiles/location_source_andr.png)
...
![Загальні налаштування Камери iOS](@site/static/img/personal/profiles/uninstall_speed_camera_1_ios.png)   ![Загальні налаштування Камери iOS](@site/static/img/personal/profiles/uninstall_speed_camera_2_ios.png)
