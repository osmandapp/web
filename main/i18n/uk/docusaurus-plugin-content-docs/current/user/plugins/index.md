---
source-hash: c7f132f957ce65348870f07883fbe8f52b8af62db4497b222199dce339513a30
sidebar_position: 18
title:  Плагіни
---
...
Плагіни значно розширюють функціональність OsmAnd. Кожен з них розроблений для вирішення конкретного завдання або випадку використання, наприклад, запису поїздки, доступу до статей Вікіпедії в автономному режимі, візуалізації даних про рельєф або надання виду на рівні вулиці.
...
Щоб отримати доступ до функціональності плагіна, його необхідно спочатку [увімкнути](#enable--disable), а деякі плагіни вимагають [придбання](#purchase) перед використанням. Потім, у деяких випадках, необхідно активувати певний шар карти або [налаштувати](#plugin-settings) профіль користувача.
...
- [Перегляд морської карти](../plugins/nautical-charts.md)
...
Плагіни OsmAnd можуть розширювати такі групи функцій: **Шари**, **Віджети**, **Дії контекстного меню**, **Дії панелі навігації**, **Стиль карти**, **Джерело карти**, **Профіль**.

🤖 - *лише для версії OsmAnd для Android.*
...
| [Перегляд морської карти](#nautical-map-view) | [Стиль карти](../plugins/nautical-charts.md#nautical-map-style), [Профіль](../plugins/nautical-charts.md#nautical-options)  |
| [Перегляд лижної карти](#ski-map-view) | [Стиль карти](../plugins/ski-maps.md#set-winter-style), [Профіль](../plugins/ski-maps.md#skiing-profile) |
...
| [Відстеження суден AIS](#ais-vessel-tracker) 🤖  |  [Користувацькі налаштування](../plugins/ais-tracker.md#plugin-settings) |
...
![Налаштування плагіна Android 1](@site/static/img/plugins/development/access_plugin_settings_andr_2.png) ![Налаштування плагіна Android 2](@site/static/img/plugins/development/access_plugin_settings_andr_1.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Налаштування плагіна iOS 1](@site/static/img/plugins/development/access_plugin_settings_ios_2.png) ![Налаштування плагіна iOS 2](@site/static/img/plugins/development/access_plugin_settings_ios_1.png)
...
| [Відстеження суден AIS](#ais-vessel-tracker) | [Налаштування плагіна](../plugins/ais-tracker.md#plugin-settings) дозволяють увімкнути спеціальні налаштування |
...
Наявність Вікіпедії під час подорожі допомагає дізнатися більше про місця, які ви відвідуєте. Вона доступна в автономному режимі та показує статті Вікіпедії, пов'язані з цікавими місцями, прямо на карті.
...
Щоб розповісти історію про те, де ви були, дані GPS, такі як широта та довгота вашого місцезнаходження, можуть бути записані та збережені у файлі, а потім повторно використані, покращені, доповнені маршрутними точками, надані для навігації, передані друзям тощо.

### [Топографія](./topography.md) {#topography}

Топографічна інформація, така як горизонталі, тіньовий рельєф, схил, 3D-рельєф, допомагає візуально оцінити рельєф місцевості, бачачи висоту, рельєф, екстремуми, крутизну, точки однакової висоти тощо.

### [Перегляд морської карти](./nautical-charts.md) {#nautical-map-view}

Перегляд морської карти надає детальне графічне представлення океанів, морів, прибережних районів та річок, щоб допомогти вам орієнтуватися на воді, бачити популярні маршрути руху, перешкоди на водному шляху, гавані, якірні стоянки та інші важливі орієнтири.

### [Перегляд лижної карти](./ski-maps.md) {#ski-map-view}

Перегляд лижної карти показує зимові кольори та траси для спуску або бігових лиж, а також канатні дороги, крісельні підйомники, об'єкти та послуги поблизу, що корисно для навігації в таких місцях, як зони відпочинку, гірськолижні курорти та сноупарки.

### [Аудіо/відео нотатки](./audio-video-notes.md) {#audiovideo-notes}

Створюйте аудіо/відео нотатки для майбутнього використання, наприклад, щоб запам'ятати подію, сцену або взаємодію. Створені аудіо/відео нотатки доступні з *Моїх місць*, а також на карті як окремий шар створених користувачем історій та думок, прив'язаних до геолокації. Лише для Android.

### [Позиція паркування](./parking.md) {#parking-position}

Встановіть точку на карті, де ваш автомобіль залишений на вулиці, та повідомте свій календар, коли закінчиться час паркування. Це полегшить вам відстеження часу та місця розташування вашого автомобіля.
...
Плагін доступності робить функції доступності пристрою безпосередньо доступними в OsmAnd. Лише для Android.
...
OsmAnd Tracker допомагає вам бачити, де знаходяться ваші контакти на карті в OsmAnd. Лише для Android.

### [Відстеження суден AIS](./ais-tracker.md) {#ais-vessel-tracker}
