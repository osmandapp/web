...
Модуль Вікіпедія — це окрема функція, яку можна вмикати/вимикати за потреби. Після ввімкнення він дозволяє завантажувати дані Вікіпедії, [завантажені](../personal/maps-resources#maps--resources) для кожного географічного регіону. На мапі є два види завантажених знань з Вікіпедії: коротка інформація та повна стаття.  
...
Щоб завантажити дані Вікіпедії для регіону, перейдіть до [доступних для завантаження пакетів у *Головному меню*](../start-with/download-maps.md#download), знайдіть потрібний регіон і відкрийте його. Дані Вікіпедії будуть серед інших пакетів.
