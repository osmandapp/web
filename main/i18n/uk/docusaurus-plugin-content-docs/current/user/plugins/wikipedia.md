...
З завантаженими даними Вікіпедії, незалежно від режиму видимості [POI Вікіпедії](../map/point-layers-on-map.md#-wikipedia) на мапі, можна [шукати](../search/search-poi.md) будь-яку інформацію з Вікіпедії.
...
3. У [контекстному меню](../map/map-context-menu.md) POI торкніться [Деталі](../map/map-context-menu.md#details) (або просто потягніть *контекстне меню* вгору), щоб переглянути анотацію обраної [статті Вікіпедії](../map/map-context-menu.md#article-description).
4. Використовуйте кнопку *Читати повну статтю*, щоб відкрити повну версію статті Вікіпедії.
5. Якщо дані Вікіпедії не завантажено, з'являється кнопка *Читати у Вікіпедії*.
6. Натиснення цієї кнопки відкриває діалог з такими опціями: 
- Завантажити Вікіпедію та Відкрити в Браузері (платна версія).
- Читати Вікіпедію офлайн та Відкрити в Браузері (безкоштовна версія).

![POI французької Вікіпедії англійською](@site/static/img/plugins/wikipedia/wikipedia_article_android.png)
...
2. Торкніться POI на мапі.
3. У [контекстному меню](../map/map-context-menu.md) POI торкніться [Деталі](../map/map-context-menu.md#details) (або просто потягніть *контекстне меню* вгору), щоб переглянути анотацію обраної [статті Вікіпедії](../map/map-context-menu.md#article-description).
4. Якщо ви торкнетеся цього тексту, ви будете перенаправлені до офлайн-статті Вікіпедії.
5. Використовуйте кнопку *Читати статтю*, щоб відкрити повну версію статті Вікіпедії.
