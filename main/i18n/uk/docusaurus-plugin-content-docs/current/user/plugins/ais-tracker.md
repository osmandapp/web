...
При правильному налаштуванні позиції суден з'являться на карті. Основні особливості:

- Судна рухаються відповідно до швидкості та курсу в реальному часі.
- Нові судна динамічно входять та виходять з видимої зони.
...
1. Статична інформація (незмінні дані).  
    *Надсилається кожні **6 хвилин** або за запитом.*
    ...
    - **MMSI (Ідентифікатор морської рухомої служби)** (*Унікальний 9-значний ідентифікатор судна*)
...
2. Динамічна інформація (дані в реальному часі).  
    *Надсилається з різними інтервалами залежно від швидкості та маневрування.*
    ...
    - **Курс** (*Напрямок носа*)
    - **Статус судна** (*У русі, На якорі, Маневрування тощо*)  
...
| *Символ якоря*           | Зона стоянки на якорі |
...
| *Червоний миготливий значок* | Аварійне сповіщення |
...
| *Значок годинника*      | Орієнтовний час прибуття (ETA) |
| *Значок хвилі*       | Швидкість над водою |
...
| Таймаут для видимості судна | Значки суден змінять стан, якщо сигнал не надходить | `2 - 15 хв / Вимкнено` |
| | | |
...
3. **Перегляд суден AIS на карті**  
Значки суден з'являться на основі симульованих даних. Натисніть на значок судна, щоб переглянути детальну інформацію.
