...
Діалогове вікно запуску відкривається, якщо опція **<Translate android="true" ids="show_start_dialog"/>** увімкнена в розділі налаштувань діалогового вікна запуску.
...
Віджети дозволяють відображати ключову інформацію про запис треку безпосередньо на екрані, таку як *Середній нахил*, *Відстань*, *Спуск*, *Тривалість*, *Макс. швидкість*, *Час у русі* та *Набір висоти*. На Android ви також можете додати віджет *Середня швидкість*.
...
| **Віджет** | **Доступні режими**  |
|-------|-------------|
| Середній нахил | <Translate android="true" ids="shared_string_last_downhill"/>; <Translate android="true" ids="shared_string_last_uphill"/> |
| Середня швидкість *(лише для Android)* | Середня поїздки (за замовчуванням); <Translate android="true" ids="shared_string_last_downhill"/>; <Translate android="true" ids="shared_string_last_uphill"/> |
| Відстань (Старт-Стоп) | Середня поїздки (за замовчуванням); <Translate android="true" ids="shared_string_last_downhill"/>; <Translate android="true" ids="shared_string_last_uphill"/> |
| Спуск | Загальний (за замовчуванням); <Translate android="true" ids="shared_string_last_downhill"/> |
| Макс. швидкість | Загальний (за замовчуванням); <Translate android="true" ids="shared_string_last_downhill"/>; <Translate android="true" ids="shared_string_last_uphill"/> |
| Час у русі | Загальний (за замовчуванням); <Translate android="true" ids="shared_string_last_downhill"/>; <Translate android="true" ids="shared_string_last_uphill"/> |
| Набір висоти | Загальний (за замовчуванням); <Translate android="true" ids="shared_string_last_uphill"/> |

Перемикання режимів залежить від віджета:
- Набір висоти / Спуск / Макс. швидкість / Середній нахил / Час у русі / Середня швидкість — натисніть віджет на мапі, щоб переключити його режим.
...
|**Середня швидкість** *(лише для Android)*. Показує середню швидкість для поточно записаної поїздки або середню швидкість під час останнього підйому або спуску, залежно від вибраного режиму. |
...
|**Час у русі**. Показує час у русі для поточно записаної поїздки або час для останнього підйому та спуску, залежно від вибраного режиму. |
