...
- або з [сервера OsmAnd](https://download.osmand.net/latest-night-build/OsmAnd-tracker.apk) (APK-файл)
...
**Час завершення терміну дії буфера** - дозволяє вибрати час збереження точок у буфері.
...
1. Перший — *Старт*.  
   Коли ви натискаєте *Старт*, ви переходите до [**OsmAnd Online GPS Tracker**](https://play.google.com/store/apps/details?id=net.osmand.telegram), де ви можете вибрати будь-які контакти або натиснути Запропоновані контакти.
...
Будь ласка, поділіться з нами своїми думками про цей новий додаток у [Twitter](https://x.com/osmandapp) та інших соціальних каналах.
