...
3. [Завантажте](#download-maps): карти "Лінії контуру", "Відтінення пагорбів", "Ухил" або карти рельєфу (3D).
...
Вам потрібно завантажити карти **рельєфу (3D)** для відображення "Відтінення пагорбів", "Ухилу" та "3D-рельєфу". Після завантаження карт ви можете відобразити **лінії контуру** та **рельєф** за допомогою розділу [Налаштувати карту](../map/configure-map-menu.md) *Головного меню*.
...
Растрові карти **відтінення пагорбів**, **ухилу** та **висоти** створюються на основі растрових даних рельєфу, таких як цифрові моделі висот (DEM).
...
2. Якщо ви використовуєте **рушій візуалізації карти версії 2 (OpenGL)**:
    ...
    - Альтернативно, ви можете використовувати завантаження [карт рельєфу (3D)](../personal/maps-resources.md#paid-map-content). Це економить місце в пам'яті вашого пристрою, а ефекти "Відтінення пагорбів", "Ухил" та "3D-рельєф" будуть генеруватися з них за допомогою вашого пристрою.
...
Ви можете використовувати кнопки *Швидкої дії* на екрані карти для перемикання видимості шарів [ліній контуру](#contour-lines), [рельєфу](#terrain) та [колірної схеми рельєфу](#default-color-scheme). Залежно від шару, вибраного в меню "Налаштувати карту", призначення дії *Рельєф* кнопці відобразить *відтінення пагорбів*, *ухил* або *висоту*.  
