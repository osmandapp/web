---
source-hash: 85327d702d7bee3a23785f2b5d7e85929242daeeee0ec984ec85478e309c4ad4
sidebar_position: 16
title: Топографія
---
...
**Вигляд** контролює, як виглядають 3D-будівлі на карті. Воно включає два налаштування: Колір та Видимість. 

**Колір** дозволяє змінювати колір будівель. Коли ви торкаєтеся Кольору, OsmAnd відкриває окремий екран попереднього перегляду, де ви можете бачити карту під час налаштування. Екран попереднього перегляду показує живу карту, щоб ви могли негайно побачити, як вибраний колір впливає на будівлі.
...
**Продуктивність** контролює, як рендериться 3D-будівлі. Воно включає два налаштування: Рівень деталізації та Відстань огляду.

**Рівень деталізації** визначає складність геометрії 3D-будівель:
- Низький (за замовчуванням) — простіша геометрія.
- Високий — детальніша геометрія.

**Відстань огляду** контролює, наскільки далеко від камери рендеряться 3D-будівлі:
