...
Спеціальні машини готують траси для відповідних видів діяльності, таких як класичне ковзання, катання на ковзанах та інші. Одна і та ж траса може бути підготовлена по-різному на різних ділянках.
...
З увімкненим профілем "Лижі", навігацією для лижників та стилем карти [Зима та лижі](../map/map-styles.md#winter-and-ski), [лижні схили та маршрути](../map/routes.md#ski-slopes-and-routes) показують усі типи трас, які навігація для лижників може використовувати для побудови маршрутів. Такі маршрути лижних схилів, якщо вони увімкнені, виділяються фіолетовим кольором переважно за межами гірськолижних курортів.  
При увімкненні опції [Лижні схили та маршрути](../map/routes.md#ski-slopes-and-routes) для стилю карти, відмінного від "Зима та лижі", відображаються лише схили. Інші функції, пов'язані з лижами, можуть не відображатися в цьому шарі стилізації.  
