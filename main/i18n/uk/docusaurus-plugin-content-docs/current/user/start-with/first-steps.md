...
Опція *Мова відображення* використовується для зміни мови всього застосунку, включаючи спливаючі підказки, внутрішній текст, повідомлення тощо. 

На пристроях Android OsmAnd дозволяє налаштовувати мову відображення безпосередньо в застосунку на всіх підтримуваних версіях. За замовчуванням застосунок використовує системну мову, але ви можете вручну вибрати іншу мову, якщо потрібно.

На Android 13 та пізніших версіях ви можете змінити мову застосунку як у налаштуваннях OsmAnd, так і в системних налаштуваннях пристрою. Вибрана мова синхронізується між застосунком і системою. Деякі зміни можуть вимагати перезапуску застосунку для повного застосування вибраної мови.

На пристроях iOS мову відображення можна змінити лише в системних налаштуваннях (дивіться, як змінити мовні налаштування для окремих застосунків в [iOS](https://developer.apple.com/news/?id=u2cfuj88)).  
...
На деяких пристроях Android або версіях системи опція встановлення мов для застосунків окремо в системних налаштуваннях може бути недоступною або обмеженою (ви можете переглянути обговорення на [GitHub](https://github.com/osmandapp/OsmAnd/issues/16990) для отримання додаткової інформації). У таких випадках ви все одно можете змінити мову застосунку безпосередньо в OsmAnd за допомогою налаштування Мова відображення. Навіть якщо мова не підтримується системою Android, OsmAnd все одно застосує та збереже вибрану мову в межах застосунку.
:::
...
**ПРИМІТКА:** На пристроях iOS у країнах ЄС ви можете встановити OsmAnd як застосунок навігації за замовчуванням у системних налаштуваннях.  
Перейдіть до: *Налаштування → Програми → За замовчуванням → Навігація*  
Після встановлення OsmAnd автоматично відкриватиметься для запитів на навігацію від системи.
