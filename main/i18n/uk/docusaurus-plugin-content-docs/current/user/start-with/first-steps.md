...
OsmAnd — це мобільний додаток для карт та навігації, доступний для **Android** та **iOS**. Ви можете завантажити його з найпопулярніших магазинів.
...
- **Обмеження пам'яті.** Переконайтеся, що на вашому пристрої достатньо місця перед завантаженням кількох регіонів.
...
:::note Немає можливості встановити мови додатків
На деяких пристроях Android (Xiaomi з Muiu 14) немає можливості встановлювати мови додатків окремо в системних налаштуваннях, тому мову OsmAnd можна змінити лише разом з мовою всієї системи. Ви можете ознайомитися з обговоренням на [GitHub discussion](https://github.com/osmandapp/OsmAnd/issues/16990) для отримання додаткової інформації.
:::
...
:::note
Вам потрібно завантажити карту, перш ніж шукати там адресу. Також, якщо ваше поточне місцезнаходження занадто далеко від адреси, яку ви шукаєте, можливо, вам доведеться збільшити радіус пошуку.
:::
...
Існує два доступних варіанти закриття OsmAnd.
...
[Ярлики додатків](https://support.google.com/android/answer/9450271) доступні для іконки OsmAnd. Просто довго натисніть іконку OsmAnd на екрані вашого пристрою, щоб відкрити меню ярликів додатків. Тут ви можете коротко натиснути, щоб вибрати наступні дії: *Навігація до дому*, *Навігація до роботи*, *Почати запис*, *Пошук*, *Мої місця*, *Навігація до*. Довге натискання на дію дозволяє додати нову іконку дії на екран вашого пристрою.

Натисніть іконку дії, щоб негайно запустити додаток з вибраною дією.
...
У *Меню допомоги* ви також можете знайти корисні посилання на соціальні мережі OsmAnd, інформацію про версію вашого додатка, примітки до випуску та контакти підтримки. Через Допомогу ви також можете надсилати [журнали logcat та збоїв](../troubleshooting/crash-logs.md#crash-and-logcat-logs).
...
- **Надіслати журнал збоїв** (*для Android*). Дозволяє користувачам надсилати звіти про збої програми розробникам, допомагаючи виявляти та вирішувати проблеми.
- **Надіслати журнал logcat** (*для Android*). Надає користувачам можливість надсилати детальні журнали збоїв програми розробникам, сприяючи глибшому аналізу та усуненню несправностей.
- **Надіслати журнал** (*для iOS*). Виконує подібну функцію до функції *Надіслати журнал збоїв* для Android, дозволяючи користувачам на пристроях iOS повідомляти про збої програми розробникам для налагодження.
- **Копіювати версію збірки**. Дозволяє користувачам швидко та точно повідомляти поточну версію програми розробникам при повідомленні про проблеми, спрощуючи процес діагностики та вирішення.
...
Найпопулярніші статті серед наших користувачів стосуються статей у додатку або на сайті, які набрали найбільшу кількість переглядів або взаємодій з користувачами. Цей показник допомагає визначити контент, який особливо цікавий або корисний для ваших користувачів. Він може надати цінну інформацію про вподобання та інтереси користувачів, дозволяючи розробникам та творцям контенту адаптувати майбутній контент, щоб краще відповідати потребам аудиторії. Крім того, виділення популярних статей може допомогти новим користувачам знайти цінні ресурси в додатку.
...
Розділ **Посібник користувача** в меню Допомоги — це повний посібник, який відповідає структурі вебсайту OsmAnd, забезпечуючи узгодженість інформації та легкість навігації між платформами. За допомогою Допомоги ви можете легко переходити з додатка на вебсайт, знаходячи той самий контент, організований звичним чином. Ця узгодженість покращує зручність використання, надаючи єдиний ресурс підтримки для швидкого пошуку відповідей на запитання та усунення несправностей.
...
Рішення та поради для вирішення поширених проблем. Якщо у вас є конкретне запитання, перегляньте розділ [Вирішення проблем](../troubleshooting/index.md), щоб отримати відповідь.
...
- **Відкрити проблему на GitHub**. [Версія Android GitHub](https://github.com/osmandapp/OsmAnd-Issues/issues), [Версія iOS GitHub](https://github.com/osmandapp/OsmAnd-iOS/issues): задавайте запитання, пишіть про помилки та пропонуйте функції.
...
- **GPS** / **Мережа GSM**. Визначення вашого місцезнаходження, відстеження вас у режимі навігації та запис вашої поїздки (опціонально). Цей дозвіл запитується, коли ви натискаєте [кнопку мого місцезнаходження](../widgets/map-buttons.md#my-location-and-zoom) або коли ви [починаєте навігацію](../navigation/setup/route-navigation.md#start--stop-navigation).
