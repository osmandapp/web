...
Перейдіть до: *<Translate ios="true" ids="shared_string_menu,layer_map_appearance"/> → ⋮ → Map Screen Layout*

OsmAnd підтримує два режими макету для екрана мапи:
- **Одиночний макет** – використовує той самий макет віджетів для всіх орієнтацій екрана. Ця опція вибрана за замовчуванням.
- **Окремі макети** – дозволяє налаштувати різні макети віджетів для портретної та альбомної орієнтацій.
...
- **Копіювати з портретної** – копіює список віджетів з портретного макету до альбомного макету.
- **Копіювати з альбомної** – копіює список віджетів з альбомного макету до портретного макету.
...
- **Широкий** – верхня та нижня панелі займають повну ширину екрана.
- **Компактний** – верхня та нижня панелі вміщуються між бічними панелями та кнопками мапи.
