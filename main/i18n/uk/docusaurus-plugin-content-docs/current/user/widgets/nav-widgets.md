...
Навігаційні віджети **Наступний поворот**, **Наступний поворот (малий)**, **Другий наступний поворот** можуть бути розміщені на будь-якій панелі для зручності користувача. Однак, відображувана інформація відрізняється залежно від типу віджета та його розміщення. У таблиці нижче підсумовано поведінку:
