...
![Позиція відображення Android](@site/static/img/widgets/radius_ruler_display_position_3_ios.png) ![Радіусна лінійка вниз](@site/static/img/widgets/radius_ruler_downward_ios.png)
...
- Торкніться [кнопки місцезнаходження](../map/interact-with-map.md#my-location-and-zoom), щоб сфокусуватися на вашій позиції.
