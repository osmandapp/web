...
| ![Pro](@site/static/img/svg/pro_icon.svg) **OsmAnd Pro** | **План підписки**, що розблоковує всі [функції Pro](#pro-features), включно з CarPlay та 3D-рельєфом. | Підтримує **кросплатформний** доступ |
...
Нижче наведено ціни на продукти OsmAnd у США та ЄС. Ціни в інших регіонах автоматично конвертуються в місцеву валюту платіжною платформою.
...
3. Перейдіть до:  
   **Меню → Налаштування → OsmAnd Cloud → Я вже маю обліковий запис**  
   [Додаткова інформація тут](../personal/osmand-cloud.md#login)
