...
|  Додаток  | Google Play | Huawei AppGallery | Free / Paid |
| :------------- | :------------- | :------------- | :------------- |
...
| Покупка  | Google Play  | Huawei AppGallery | App |
| :------------- | :------------- | :------------- | :------------- |
...
|------------|------------|------------|------------|
| **OsmAnd Start** | **Безкоштовний план**, що надає доступ до [OsmAnd Cloud](../personal/osmand-cloud.md#osmand-start) для *Обраного*, *Налаштувань* та *редагування/нотаток OSM*. | Доступний для всіх користувачів безкоштовної версії OsmAnd. | Обмежено базовими функціями хмари та сховищем на **5MB**. |
...
| [Віджети показників транспортного засобу](../plugins/vehicle-metrics.md#widgets) | <details><summary>**2 віджети безкоштовно**</summary><ul><li>*Швидкість транспортного засобу*</li><li>*Оберти двигуна*</li></ul></details> | <details><summary>**2 віджети безкоштовно**</summary><ul><li>*Швидкість транспортного засобу*</li><li>*Оберти двигуна*</li></ul></details> | ✔ |
...
| :------------- | :------------- |
| [OsmAnd Cloud](../personal/osmand-cloud.md) | Резервне копіювання та відновлення ваших даних, синхронізація даних з [OsmAnd web portal](https://www.osmand.net/map). |
| [3D Relief](../plugins/topography.md#3d-relief) | Дозволяє мати та спостерігати масштабну модель вашого району або цілого континенту. |
| [Live updates](../personal/maps-resources.md#live-updates) | Мапи OsmAnd оновлюються кожні 15 хвилин після покращень в [OpenStreetMap](https://www.openstreetmap.org/). |
| [Weather Plugin](../plugins/weather.md) | Погодинний прогноз на 24 години на 7 днів вперед на мапі. |
| [Vehicle Metrics Plugin (OBD-II)](../plugins/vehicle-metrics.md) | Дозволяє під'єднати сканер OBD-II для відображення детальних даних про транспортний засіб у додатку OsmAnd та зберігання інформації в записах треків. Інформація про швидкість транспортного засобу та оберти двигуна доступна для безкоштовної версії OsmAnd.  |
| [Customise Route line](../navigation/guidance/map-during-navigation.md#route-line-appearance) | Зміна кольору та ширини лінії маршруту під час навігації. |
| [Elevation widget](../widgets/nav-widgets.md#elevation-widget) | Показує ваше місцезнаходження на графіку висот навігаційного маршруту з додатковою інформацією.  |
| [Altitude Widgets - Elevation: Map Center](../widgets/info-widgets.md#elevation-map-center) | Дозволяє дізнатися висоту поточного центру мапи над рівнем моря.  |
| [Elevation correction (offline)](../map/tracks/track-context-menu.md#calculate-missing-elevation) | Дозволяє розрахувати графік висот для вашого треку ([Terrain map](../plugins/topography.md#download-maps) required for chosen region). |
...
![Maps+](@site/static/img/svg/osmand_maps_plus.svg)  *Maps+* subscription / in-app plan. Тут ви можете обрати річну підписку або одноразовий платіж:
...
**Щоб відновити *внутрішню покупку* або *підписку* ([Maps+, Pro, Live updates](#difference-between-purchases-android)).**
