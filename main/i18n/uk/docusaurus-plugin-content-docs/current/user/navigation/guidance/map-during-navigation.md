...
Під час навігації карта є візуальним інструментом для визначення вашого місцезнаходження, ідентифікації пункту призначення, планування вашого маршруту та перегляду навігаційних вказівок. Для цього ви можете використовувати масштабування, а також перетягувати та повертати карту за потреби. Карта також може відображати інформацію про дороги, назви вулиць, будівлі та інші об'єкти, щоб допомогти вам легко визначити свій маршрут.  
...
:::info note
Опція **Показувати вздовж маршруту** впливає лише на списки POI та Моїх улюблених місць, а не на саму карту. Іконки POI та Улюблених місць відображаються скрізь на карті незалежно від їхньої відстані від маршруту.
:::
...
Список містить усі раніше додані [Улюблені точки](../../personal/favorites.md#favorite-point) поблизу створеного вами маршруту. Як і у випадку з POI, ви можете вибрати відстань, на якій знаходяться ці точки.  
...
- Кожна точка містить назву або координати, групу, відстань від поточної точки місцезнаходження до *Улюбленої точки* безпосередньо на лінії маршруту, інформацію про те, наскільки далеко праворуч або ліворуч від лінії знаходиться точка, і напрямок маршруту.
...
:::info Pro feature
Налаштування лінії маршруту є платною функцією [**OsmAnd Pro**](../../purchases/index.md) <ProFeature />.
:::
