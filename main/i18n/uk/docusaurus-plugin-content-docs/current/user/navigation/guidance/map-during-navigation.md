...
Під час навігації карта є візуальним інструментом для визначення вашого місцезнаходження, ідентифікації пункту призначення, планування маршруту та перегляду навігаційних вказівок. Для цього ви можете використовувати масштабування, а також перетягувати та повертати карту за потреби. Карта також може відображати інформацію про дороги, назви вулиць, будівлі та інші об'єкти, щоб допомогти вам легко визначити свій маршрут.  
