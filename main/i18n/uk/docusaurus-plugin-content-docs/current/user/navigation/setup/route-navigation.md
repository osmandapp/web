...
- **Офлайн-навігація** увімкнена за замовчуванням. Однак ви також можете використовувати [онлайн-механізми маршрутизації](./../routing/online-routing.md).
...
1. Відкрийте [*Меню навігації*](#navigation-menu):
    ...
    - Зачекайте, поки маршрут буде розраховано. Після цього ви зможете отримати додаткову інформацію про свій маршрут у розділі *[Деталі](./route-details.md#overview)*.
...
3. [Розпочніть](#start--stop-navigation) навігацію або спочатку [симулюйте навігацію](#simulated-navigation) (за допомогою цієї функції ви можете протестувати свій маршрут перед фактичною поїздкою по ньому).
...
- Розділ Навігація у [*Головному меню*](../../start-with/main-menu.md)  *(<Translate android="true" ids="shared_string_menu,shared_string_navigation"/>)*.
...
- **Поміняти місцями** &nbsp;&#8595;&#8593; - Змінити місцями точки *Початку* та *Кінця*.
...
- [Кнопка Почати](#start--stop-navigation) розпочинає навігацію після завершення розрахунку маршруту.
...
- **Поміняти місцями початкову точку та пункт призначення** &nbsp;&#8595;&#8593; - Дозволяє поміняти місцями точки *Початку* та *Кінця*.
...
![Проміжні пункти навігації Android 1](@site/static/img/navigation/route/navigation_interpoints_1_andr.png) ![Проміжні пункти навігації Android 2](@site/static/img/navigation/route/navigation_interpoints_2_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Проміжні пункти навігації iOS 1](@site/static/img/navigation/route/navigation_by_route_intermediate_ios_1.png) ![Проміжні пункти навігації iOS 2](@site/static/img/navigation/route/navigation_by_route_intermediate_ios_2.png)
...
- **&nbsp;&#8592;** - повертає до екрана Меню навігації.
...
![Проміжні пункти навігації Android 3](@site/static/img/navigation/route/navigation_interpoints_android_3.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Проміжні пункти навігації iOS 2](@site/static/img/navigation/route/navigation_by_route_intermediate_ios_3.png)
...
### Використовувати точки Дому або Роботи {#use-home-or-work-points}
...
![Екран навігації початок Android](@site/static/img/navigation/route/navigation_start_andr.png)  
...
Після вибору початкової та кінцевої точок програма створить маршрут між ними, використовуючи активний профіль. [Профіль програми](../../personal/profiles.md) та набір [віджетів](../../widgets/index.md) зміняться лише після того, як ви торкнетеся кнопки *Почати* навігації.
...
Якщо ви хочете зупинитися на перерву та на короткий час відхилитися від маршруту, ви можете скористатися функцією *Призупинити/Відновити* навігацію, щоб призупинити голосові підказки та зупинити перерахунок маршруту.
Ця опція доступна у версії програми для Android у *[Списку сповіщень](../guidance/voice-navigation.md#text-notifications)* або з *[Меню швидких дій](../../widgets/quick-action.md)*.
...
![Відновити навігацію Android](@site/static/img/navigation/route/navigation_menu_start_pause_andr_1.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Відновити навігацію ios](@site/static/img/navigation/route/navigation_menu_start_pause_ios_1.png)
...
![Симулювати навігацію Android](@site/static/img/navigation/route/simulate_navigation_andr_1.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Симулювати навігацію ios](@site/static/img/navigation/route/simulate_navigation_ios_1.png)
...
Перейти до: *<Translate android="true" ids="shared_string_navigation,shared_string_settings,simulate_navigation"/>  →*  &#x2699

![Симулювати навігацію Android](@site/static/img/navigation/route/simulate_navigation_andr_2.png)
...
![Симулювати навігацію ios](@site/static/img/navigation/route/simulate_navigation_ios_2.png)
...
- **<Translate android="true" ids="simulation_real_mode_title"/>**:
    - **На прямих ділянках** дороги швидкість буде близькою до максимально дозволеної швидкості.
...
Щоб побудувати маршрут, всі **необхідні мапи** мають бути завантажені та мати однакову дату випуску. Зверніть увагу, що в деяких ситуаціях повідомлення про відсутні мапи може бути приховано в меню підготовки маршруту. Якщо ви піднімете меню навігації вгору, ви побачите можливі причини, чому ваш маршрут не вдалося розрахувати.

<Tabs groupId="operating-systems">

<TabItem value="android" label="Android">

![Повідомлення про відсутність мап під час побудови навігації Android 5](@site/static/img/navigation/route/navigation_by_route_no_maps_5.png)  

</TabItem>

<TabItem value="ios" label="iOS">

![Повідомлення про відсутність мап під час побудови навігації iOS](@site/static/img/navigation/route/navigation_by_route_no_maps_1_ios.png)
</TabItem>
...
У діалоговому вікні необхідних мап ви побачите пропозиції мап для завантаження або оновлення. Список використаних мап може бути неточним, оскільки він розраховує дуже простий маршрут; щоб отримати точний список мап, ви можете натиснути **Розрахувати онлайн**. Якщо ви виберете **Використовувати завантажені мапи**, тоді розрахунок маршруту спробує використовувати вже завантажені мапи та пропустити попереджувальне повідомлення.

<Tabs groupId="operating-systems">

<TabItem value="android" label="Android">

![Повідомлення про відсутність мап під час побудови навігації Android](@site/static/img/navigation/route/navigation_by_route_no_maps_1.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Повідомлення про відсутність мап під час побудови навігації iOS](@site/static/img/navigation/route/navigation_by_route_no_maps_2_ios.png)
