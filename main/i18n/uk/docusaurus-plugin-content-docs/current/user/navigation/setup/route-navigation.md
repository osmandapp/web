---
source-hash: 5e4e6adbda3c300f15e46032144003e796b4a66ec2a0bf0751792913285d59c6
sidebar_position: 1
...
Функція **Підготовка маршруту** в OsmAnd забезпечує покрокові навігаційні вказівки для різних [типів маршрутизації](./../routing/osmand-routing.md#routing-types), включаючи [водіння](./../routing/car-based-routing.md), [ходьбу](./../routing/pedestrian-routing.md), їзду на велосипеді, [верхову їзду](./../routing/horse-routing.md) та [лижний спорт](./../routing/ski-routing.md). Користувачі можуть налаштовувати параметри навігації, додавати пункти призначення та оптимізувати маршрути для ефективності.
...
Перед використанням офлайн-навігації переконайтеся, що необхідні [карти завантажені](../../start-with/download-maps.md). Перейдіть до *Меню → Карти та ресурси → Завантажити карти*, щоб встановити карти для вашого регіону.
...
1. Відкрийте [*Меню навігації*](#navigation-menu):
    ...
    - Дочекайтеся розрахунку маршруту. Після цього ви зможете отримати додаткову інформацію про ваш маршрут у розділі *[Деталі](./route-details.md#overview)*.
...
3. [Почніть](#start--stop-navigation) навігацію або спочатку [симулюйте навігацію](#simulated-navigation) (за допомогою цієї функції ви можете протестувати свій маршрут, перш ніж фактично подорожувати ним).
...
Є 3 способи дістатися до меню навігації:
...
- **Поміняти місцями** &nbsp;&#8595;&#8593; - Змінити порядок точок *Початок* та *Кінець*.
...
Щодо початкової точки, ви можете вибрати своє поточне місцезнаходження, місцезнаходження [Улюбленої точки](../../map/point-layers-on-map.md#favorites), вибрати точку на карті або скористатися [Пошуком](../../search/index.md). Ви також можете встановити початкову точку в [контекстному меню карти](../../map/map-context-menu.md), вибравши функцію [Напрямки від](../../map/map-context-menu.md#directions-to--from).  
...
- **<Translate android="true" ids="shared_string_favorites"/>** - Дозволяє використовувати [Вибране](../../personal/favorites.md) як пункт призначення.
...
Вкладки **Дім** та **Робота** (або [Спеціальні точки](../../personal/favorites.md#special-favorites-personal) для Вибраного) можуть бути використані для швидкого встановлення пунктів призначення в меню навігації. Якщо ви не ввели адреси Спеціальних вибраних, ці поля залишаться порожніми. Якщо ви торкнетеся цього поля, вам буде запропоновано створити ці POI.  
...
Після вибору початкової та кінцевої точок програма створить маршрут між ними, використовуючи активний профіль. [Профіль програми](../../personal/profiles.md) та набір [віджетів](../../widgets/index.md) переключаться лише після того, як ви натиснете кнопку *Пуск* навігації.

- **Натисніть Пуск**, щоб розпочати навігацію.
...
Якщо ви хочете зупинитися на перерву та ненадовго відхилитися від маршруту, ви можете скористатися функцією *Призупинити/Відновити* навігацію, щоб призупинити голосові підказки та припинити перерахунок маршруту.  
...
- Використовуйте *Меню швидких дій* або діалогове вікно, яке з'являється, коли ви торкаєтеся *[Кнопки навігації](../../widgets/map-buttons.md#directions)* (див. знімок екрана).
...
:::note
Коли ви **натискаєте кнопку навігації** під час маршруту, навігація **не зупиняється, і голосові підказки продовжують озвучуватися**, хоча запропоновані варіанти Відновити або Почати можуть бути заплутаними.
:::
...
## Карти відсутні або не синхронізовані {#maps-missing-or-not-synchronized}

Для побудови маршруту всі **необхідні карти** повинні бути завантажені та мати однакову дату випуску. Зверніть увагу, що в деяких ситуаціях повідомлення про відсутність карт може бути приховано в меню підготовки маршруту. Якщо ви підтягнете меню навігації вгору, ви побачите можливі причини, чому ваш маршрут не вдалося розрахувати.
...
Щоб отримати додаткові кроки з усунення несправностей, див. [проблеми з навігацією](../../troubleshooting/navigation.md).
