...
| *Allow ferries* | Увімкнення маршрутизації через поромні маршрути. | Зазвичай [маршрути поромів](https://wiki.openstreetmap.org/wiki/Tag:route%3Dferry) недоступні для малих човнів на основі визначення OSM. |
...
3. Якщо в OSM не нанесено відповідних водних шляхів або поромних маршрутів, механізм маршрутизації може не зможе побудувати правильний маршрут. У таких випадках ви можете використовувати інструмент [Планування маршруту](../../plan-route/create-route.md) та розставляти проміжні точки вручну.
...
Важливо зазначити, що типи маршрутизації *Direct-to-point* та *Straight line* слід використовувати лише у відкритій воді, де немає перешкод або небезпек для навігації. Якщо ви рухаєтеся водним шляхом з певним каналом або маршрутом, вам слід використовувати тип маршрутизації для човнів в OsmAnd, який проведе вас правильними навігаційними каналами та допоможе уникнути мілководдя чи інших небезпек. Деякі нанесені небезпеки на основі тегів OSM hazard=* можуть відображатися на карті як іконки POI небезпек або текстові мітки. 
