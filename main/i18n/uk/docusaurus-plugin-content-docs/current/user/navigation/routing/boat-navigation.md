...
| *Дозволити пороми* | Дозволяє маршрутизацію по поромних маршрутах. | Використовує `route=ferry` там, де він присутній в OSM. Нові карти не потрібні. |
...
2. Профіль "Човен" також підтримує **поромні маршрути (`route=ferry`)**, коли увімкнено опцію **Дозволити пороми**. Це означає, що якщо поромні маршрути присутні на карті, вони будуть використовуватися при розрахунку маршрутів для човнів.

3. Якщо в OSM не нанесено відповідних водних шляхів або поромних маршрутів, механізм маршрутизації може не змогти побудувати правильний маршрут. У таких випадках ви можете скористатися інструментом "Планування маршруту" та розставити проміжні точки вручну.
