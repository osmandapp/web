...
- **Знайти паркування**. Відкриває екран Пошуку з попередньо вибраною категорією Паркування, щоб допомогти вам знайти неподалік варіанти паркування.
- **Перерахувати маршрут**. Будує новий маршрут до початкового пункту призначення, якщо ви хочете продовжити навігацію.
- **Завершити навігацію**. Завершує поточний маршрут і повертає OsmAnd до стандартного стану карти.
