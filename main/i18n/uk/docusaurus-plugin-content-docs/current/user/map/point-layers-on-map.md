---
source-hash: 65ce94a26799a454b5f96c2cd5c824c9ed366977536067467dd0ee6e0c4f0cfb
sidebar_position: 7
...
:::info
В Android-версії OsmAnd ви можете відображати на карті та під час пошуку лише певні групи вибраного. Перейдіть до *Меню → Мої місця → Вибране*, торкніться &#8942; та виберіть *Показати на карті* або ні.
:::
...
**Android**. Торкніться кнопки внизу ліворуч, щоб перемикатися між вибором однієї або кількох цікавих точок.
...
Кожному типу POI в OsmAnd призначено певну піктограму та колір. [Рівень масштабування](../map/vector-maps.md#details) та дизайн POI можуть відрізнятися в деяких [стилях карти](../map/vector-maps.md#default-map-styles).  
...
Ви можете прочитати більше про вигляд маркерів у цій [статті](../personal/markers#appearance-on-the-map).
...
[Зображення на рівні вулиці (Mapillary)](../plugins/mapillary.md) відображаються на карті зеленими крапками. До цих крапок прикріплені фотографії виду вулиці. Ви можете створити [фільтр](../plugins/mapillary.md#data-filtering) та вибрати фотографії, які ви хочете відобразити на карті. Щоб відкрити фотографію виду вулиці, торкніться зеленої крапки.  
...
OsmAnd має спеціальні цікаві місця, позначені логотипом «W» та пов'язані зі статтями Вікіпедії. Ці точки можуть відображатися так само, як і будь-який інший тип POI, через пошук або перейшовши до <Translate android="true" ids="configure_map"/> → <Translate android="true" ids="layer_poi"/>. Однак існує спеціальний спосіб фільтрування статей Вікіпедії за **доступними мовами**.  
