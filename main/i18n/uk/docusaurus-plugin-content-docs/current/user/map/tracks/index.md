...
- **Дані графіка (вісь Y)** відображають: *Висоту*, *Нахил*, *Швидкість*, [*Дані зовнішніх датчиків*](../../plugins/external-sensors.md) та комбінації до двох опцій, якщо вони містяться в даних треку. ***Тільки для Android:*** для автомобільних треків, записаних з даними OBD-II, вісь Y додатково надає метрики транспортного засобу, такі як оберти двигуна, температура охолоджуючої рідини та інше.
...
Натисніть кнопку [Моє місцезнаходження](../../map/interact-with-map.md#my-position-and-zoom), щоб синхронізувати вигляд мапи та графік з вашим місцезнаходженням.
