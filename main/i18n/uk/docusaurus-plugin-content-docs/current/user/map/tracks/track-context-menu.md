...
- [Теги активності для GPX-треків](#description-and-info). [Записані треки](../../plugins/trip-recording.md#recording-settings) та треки, збережені за допомогою [Планування маршруту](../../plan-route/create-route.md), автоматично отримують тип активності на основі профілю, який використовувався для їх створення. Це допомагає класифікувати та фільтрувати їх пізніше. Ви можете вручну змінити активність, якщо потрібно.
...
- [Керування типами активності](../../personal/tracks/manage-tracks.md#selection-mode). Ви можете змінити тип активності для вибраних папок або треків, використовуючи режим вибору на вкладі "Треки" меню "Мої місця".
...
Ця опція розділяє трек на сегменти на основі змін висоти. Кожен інтервал класифікується як ***підйом***, ***спуск*** або ***рівнина***. Інтервали відображаються в порядку їх появи вздовж треку, і кожному підйому, спуску або рівнинній ділянці присвоюється власний порядковий номер. Список інтервалів надає ті самі основні статистичні дані, що й у розділі [Розділення за відстанню](#split-by-distance).
...
Торкніться мітки, щоб відкрити панель деталей для вибраного сегмента підйому, спуску або рівнинної ділянки. Панель деталей відображає статистику для вибраного сегмента, таку як відстань, тривалість, підйом і спуск, висота, швидкість та дані, пов'язані з часом.
