...
Опція **Розділити за часом** ділить трек на інтервали однакової тривалості. Ви можете вибрати між ***1 хв***, ***2 хв***, ***2.5 хв***, ***5 хв***, ***10 хв***, ***15 хв***, ***30 хв*** та ***60 хв***. Спосіб відображення інтервалів, статистика, що надається для кожного сегмента, та їх вигляд на мапі такі ж, як у розділі [Розділити за відстанню](#split-by-distance).
...
Ця опція ділить трек на сегменти на основі змін висоти. Кожен інтервал класифікується як ***підйом***, ***спуск*** або ***рівнина***. Спосіб відображення інтервалів, статистика, що надається для кожного сегмента, та їх вигляд на мапі також такі ж, як у розділі [Розділити за відстанню](#split-by-distance).
