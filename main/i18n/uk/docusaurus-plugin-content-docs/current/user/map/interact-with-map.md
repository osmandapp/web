...
| Дія на карті | Жест |
|:------------|:-------------|
| **Переміщення** | Натисніть і утримуйте карту **одним** пальцем, потім перетягніть, щоб перемістити. |
...
| **Обертання** | Торкніться карти **двома** пальцями, потім обертайте пальці по колу. |
| **Нахил (3D)** | Торкніться **двома** пальцями і рухайте їх вгору або вниз. <br/> Доступно лише з [двигуном візуалізації карти](../personal/global-settings.md#map-rendering-engine) версії 2 (OpenGL). |
...
*Кнопки масштабування* завжди видимі поруч з *Моє місцезнаходження* і дозволяють контролювати рівень масштабування карти.
...
- Пам'ятайте, що під час навігації масштабування може автоматично контролюватися налаштуванням **Автоматичне масштабування**:
...
*Лупа карти* — це інструмент, який покращує видимість карти, подібно до збільшувального скла, що використовується з паперовими картами. Він дозволяє збільшити карту, щоб чіткіше бачити текст і деталі, або налаштувати рівень деталізації, зберігаючи той самий масштаб. Для отримання додаткової інформації перейдіть до статті [Векторні карти](../map/vector-maps.md#map-magnifier).
...
Ви можете активувати цю функцію через *Меню → Налаштування → Профілі → Загальні налаштування → Вигляд → Орієнтація карти* або подвійним натисканням на [кнопку Компас](../widgets/map-buttons.md#compass-tapping-behavior). Для отримання додаткової інформації про напрямок руху дивіться [тут](../widgets/nav-widgets.md#bearing-widget).
...
Ви не можете змінити нахил камери, коли увімкнено старий [двигун візуалізації карти](../personal/global-settings.md#map-rendering-engine) (версія 1).
:::
...
- Виберіть пристрій зі списку підтримуваних OsmAnd, натиснувши на пункт *Тип* у списку:
...
- Для кожного типу зовнішнього пристрою введення існує різне **визначене призначення дії-клавіші**. Натисніть *<Translate android="true" ids="key_assignments"/>*, щоб побачити список дій та клавіш. Таблиця клавіш показана нижче.
...
|**D**| *Клавіатура*   | Зміна - [Орієнтація карти](#map-orientation-modes) |
|**N**| *Клавіатура*   | Показати / Приховати - Вигляд навігації |
|**S**| *Клавіатура*   | Показати / Приховати - [Вигляд пошуку](../search/index.md) |
|**P**| *Клавіатура*   | Зміна - Профіль програми на наступний |
|**O**| *Клавіатура*   | Зміна - Профіль програми на попередній |
...
|**&#43;** **=**| *Клавіатура*  | Карта - [Збільшення](#my-location-and-zoom) |
|**&#8722;**| *Клавіатура*  | Карта - [Зменшення](#my-location-and-zoom) |
|**Натиснути назад**| *Клавіатура*   | Навігація – Попередній екран  |
|**&#8595;**| *Wunderlinq*  | Карта - [Зменшення](#my-location-and-zoom) |
|**&#8593;**| *Wunderlinq*  | Карта - [Збільшення](#my-location-and-zoom) |
...
| **&#8592;** <br/> (*лише Android*)| *Parrot*  | Карта - [Зменшення](#my-location-and-zoom) |
| **&#8594;** <br/> (*лише Android*) | *Parrot*  | Карта - [Збільшення](#my-location-and-zoom) |
...
Якщо ви хочете призначити клавіші для зовнішнього пристрою введення (наприклад, клавіатури, джойстика або контролера), вам потрібно створити тип пристрою: перейдіть до налаштування [Зовнішні пристрої введення](#external-input-devices), виберіть **Тип** зі списку, натисніть&nbsp;  "**＋**"  &nbsp; та введіть назву. Кожен тип має меню з такими опціями: ***Перейменувати, Дублювати*** та ***Видалити***.
...
- Виберіть необхідну дію, потім натисніть на поле ***Додати клавішу*** та натисніть кнопку на своєму пристрої, щоб призначити її дії.
...
- ***Видалити всі призначення клавіш*** для вибраного типу, натиснувши кнопку у верхньому правому куті екрана поруч з *Редагувати назву*.
