...
- **Колір сітки:** доступний окремо для денного/нічного режиму. Налаштування кольору сітки — це [платна функція](https://osmand.net/docs/user/purchases/), доступна в Maps+ (покупка в додатку або підписка) та OsmAnd+.
