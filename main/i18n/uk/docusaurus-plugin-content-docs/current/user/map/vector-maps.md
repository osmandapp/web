...
Функція **Сітка координат** накладає на карту опорну сітку, що дозволяє візуалізувати лінії широти та довготи на основі різних систем координат. Ця функція корисна для точного визначення місцезнаходження та геопросторової навігації. Ви можете вибрати ***Налаштування рівня масштабування:*** для відображення між 2 - 22, ***Позиція міток*** - **Краї**/**Центр** та ***Колір сітки*** окремо для денного/нічного режиму.
