...
- **Рівні масштабування:** встановіть мінімальний та максимальний рівні масштабування (2 - 22), на яких сітка буде видимою.
- **Позиція міток:** виберіть між *Краї* (за замовчуванням) або *Центр* для міток сітки.
- **Колір сітки:** доступний окремо для денного/нічного режиму. Налаштування кольору сітки є платною функцією.
- **Формат координат:** виберіть один з кількох доступних форматів (див. список нижче).
