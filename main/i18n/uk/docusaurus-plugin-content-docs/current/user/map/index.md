...
## [Векторні карти](./vector-maps.md) {#vector-maps}
...
## [Стилі карти (Векторні карти)](./map-styles.md) {#map-styles-vector-maps}

Стилі карти визначають, як векторні дані карти відображаються в OsmAnd. Стиль контролює візуальний вигляд об'єктів карти, таких як дороги, будівлі, використання земель, вода та точки інтересу, включаючи кольори, шаблони ліній та мітки.
...
## [Маршрути](./routes/index.md) {#routes}

OsmAnd має багато потужних функцій для відображення різних маршрутів на карті.

### [Типи маршрутів](./routes/types-of-routes.md) {#type-of-routes}

Уся інформація про типи маршрутів, доступні в OsmAnd.