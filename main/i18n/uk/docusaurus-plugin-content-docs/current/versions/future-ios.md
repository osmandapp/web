...
- Режим **[Віджети запису поїздки](https://osmand.net/docs/user/plugins/trip-recording#widgets)** для останнього підйому / останнього спуску з перемиканням між загальним і останнім набором/спуском висоти.
- Оновлений **[Віджет відстані](https://osmand.net/docs/user/plugins/trip-recording#distance-start-stop)** з режимами для загальної відстані, останньої відстані підйому та останньої відстані спуску.
...
- **[Віджет середнього нахилу](https://osmand.net/docs/user/plugins/trip-recording#max-speed--average-slope)**, що показує середній нахил останнього набору або спуску висоти.
...
- Новий розділ «Дослідити» у пошуку з «Популярні місця поблизу» та покращеними станами офлайн/без даних.
- Покращені результати пошуку POI з послідовним відображенням міста, вдосконаленим макетом, необов'язковими ескізами та чіткішими альтернативними назвами.
