...
### Версія 5.3 {#version-53}

Дата випуску 04/2026:

- Плагін "Астрономія" з астрономічним накладенням, що показує шляхи Сонця, планет і зірок на карті.
- Гнучкіше розташування віджетів та кнопок карти.
- 3D-будівлі.
- Глобальний вигляд.
- Нові віджети запису поїздки: Середня швидкість та Час у русі.
- Віджет спідометра з візуальною індикацією перевищення швидкості, попередженням про допуск та станами перевищення ліміту.
...
- Нова швидка дія для показ/приховування треків та режимів день/ніч.
