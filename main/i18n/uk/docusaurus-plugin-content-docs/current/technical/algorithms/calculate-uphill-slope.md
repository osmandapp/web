...
- Замінює значення висоти даними з завантажених карт рельєфу (DEM/SRTM або 3D файли GeoTIFF).
- Працює локально на пристрої, якщо встановлені тайли висоти.
- Цей метод зберігає початкову геометрію треку.

2. Використовувати найближчі дороги (Прив'язати до доріг)
