...
Список API досить довгий, і ви можете ознайомитися з ним у [Демо-застосунку](https://download.osmand.net/latest-night-build/OsmAnd-api-sample.apk). Наприклад, зовнішні застосунки можуть додавати віджети окремо або групами, а також призначати їм власні іконки через URI замість того, щоб покладатися лише на вбудований набір іконок OsmAnd.
