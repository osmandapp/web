...
Fälle von falschen Stadtzuweisungen wurden in den folgenden GitHub-Issues gemeldet:
...
Siehe GitHub-Issue [10036](https://github.com/osmandapp/OsmAnd/issues/10036) für ein Beispiel.
...
1. **Kaputte oder fehlende Stadtgrenzen.**
   ...
   - **Lösung:** Befolgen Sie die [Anleitung zur Korrektur von OSM-Grenzen](https://help.openstreetmap.org/questions/1053/how-do-i-fix-inconsistent-boundaries).
...
3. **Fehlende erforderliche Tags in der Grenzrelation.**
   ...
   - Beispiele:
     - Issue [10921](https://github.com/osmandapp/OsmAnd/issues/10921) (fehlende Tags).
     - Issue [12548](https://github.com/osmandapp/OsmAnd/issues/12548) (Problem mit der Grenze von *Erfstadt*).
