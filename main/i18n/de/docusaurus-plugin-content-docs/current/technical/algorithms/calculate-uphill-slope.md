...
Das Hauptziel der Berechnung von **bergauf** ist es, relevante Informationen darüber zu liefern, wie viel **zusätzliche Energie** für den Aufstieg aufgewendet wird, offensichtlich hängt es
...
Tool "Route planen", dem Navigationstool oder nach der SRTM-Korrektur erstellt wurden, sollte die Filterung keinen Einfluss haben.
...
## Höhenkorrektur {#elevation-correction}
