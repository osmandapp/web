...
[Favoriten](../personal/favorites.md) sind spezielle Punkte, die von Benutzern markiert wurden. Standardmäßig erscheinen sie als gelbe Sterne auf der Karte, können aber mit beliebigen Farben, Formen und Symbolen angepasst werden. Sie werden auf der Karte ab Zoomstufe 6 sichtbar.
...
Jedem POI-Typ in OsmAnd ist ein spezifisches Symbol und eine Farbe zugewiesen. Die [Zoomstufe](../map/vector-maps.md#details) und das Design von POIs können in einigen [Kartenstilen](../map/map-styles.md) unterschiedlich sein.  
