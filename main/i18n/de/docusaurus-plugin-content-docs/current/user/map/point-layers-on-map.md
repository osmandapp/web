...
Die Karte kann Punkte wie [Favoriten](#favorites), [Points of Interest](#points-of-interest-pois), [Marker](#markers), [Wikipedia](#-wikipedia--wikipedia), [Suchergebnisse](#search-results-poi), [Audio- und Video-Notizen](#-audio--video-points-android--audio--video-points-android) und [OSM-Bearbeitungen](#-osm-edit-points--osm-edit-points) anzeigen.
...
[Favoriten](../personal/favorites.md) sind spezielle Punkte, die von Benutzern markiert wurden. Standardmäßig erscheinen sie als gelbe Sterne auf der Karte, obwohl sie mit jeder Farbe, Form und jedem Symbol angepasst werden können. Sie werden ab Zoomstufe 6 auf der Karte sichtbar.
...
Die wichtigsten POIs werden automatisch auf der Karte angezeigt. Sie können jedoch einen bestimmten POI-Typ auswählen (z. B. *Restaurants*), und alle werden auf der Karte mit einem **orangefarbenen Kreis** hervorgehoben (ab Zoomstufe 9).  
...
Sie können einen oder mehrere aus den Standard-OsmAnd-POI-Typen auswählen oder Ihren eigenen [POI-Filter](../search/search-poi.md) erstellen und auswählen, um POIs auf der Karte anzuzeigen.
...
Jedem POI-Typ in OsmAnd ist ein bestimmtes Symbol und eine bestimmte Farbe zugewiesen. Die [Zoomstufe](../map/vector-maps.md#details) und das Design von POIs können in einigen [Kartenstilen](../map/vector-maps.md#default-map-styles) unterschiedlich sein.  
...
[Kartenmarker](../personal/markers.md) sind temporäre Punkte, die auf der Karte als Flaggen markiert sind. Ihr Aussehen kann mit **Pfeilen** (Pfeile auf der Karte) und **Entfernungsanzeige** (Richtungslinien) angepasst werden.  

Mehr über das Aussehen der Marker können Sie in diesem [Artikel](../personal/markers#appearance-on-the-map) lesen.
...
Track-Punkte (Wegpunkte) sind Teil von Track- (GPX-) Dateien. Diese Punkte werden automatisch angezeigt, wenn der Track auf der Karte liegt. Sie sehen ähnlich aus wie [Favoriten](#favorites) und können ähnlich konfiguriert werden - Symbol, Namen, Farbe, Form. Wie Sie einen Wegpunkt erstellen und hinzufügen, lesen Sie im [Artikel](../map/tracks/track-context-menu.md#add-waypoint-to-a-track).  
...
Mehr über die [Suche](../search/index.md) lesen.
...
Ein [Parkplatz](../plugins/parking.md) ist ein von Benutzern auf der Karte markierter Punkt, um Informationen über den genauen Standort des Fahrzeugs zu speichern. Er kann in unbegrenzte und begrenzte Parkzonen unterteilt werden.  
...
OsmAnd verfügt über spezielle Points of Interest, die mit einem "W"-Logo gekennzeichnet und mit Wikipedia-Artikeln verknüpft sind. Diese Punkte können wie jeder andere POI-Typ angezeigt werden, über die Suche oder über <Translate android="true" ids="configure_map"/> → <Translate android="true" ids="layer_poi"/>. Es gibt jedoch eine spezielle Möglichkeit, Wikipedia-Artikel nach **verfügbaren Sprachen** zu filtern.  

[Mehr lesen](../plugins/wikipedia.md), wie Sie die Wikipedia-Funktion in OsmAnd herunterladen und verwenden.
...
Erfordert das [Audio-/Video-Notiz-Plugin](../plugins/audio-video-notes.md).
...
OSM-Bearbeitungspunkte sind POIs, die von Benutzern erstellt wurden, um dem [OpenStreetMap-Projekt](https://www.openstreetmap.org/) hinzugefügt zu werden.  
...
Wegpunkte, POIs, Favoritenpunkte und Audio-/Video-Notizen beziehen sich alle auf das Konzept des Speicherns von Orten und Routen im [GPX-Format (GPS Exchange Format)](https://en.wikipedia.org/wiki/GPS_Exchange_Format). Sie können [dieselben Tags](../map/tracks/track-context-menu.md#display-custom-gpx-tags) verwenden, um sie zu beschreiben und zu bearbeiten.  

[Wegpunkte](#track-waypoints) sind einzelne Punkte auf einer Karte oder Route. Sie können verwendet werden, um bestimmte Orte zu markieren, die für die Navigation oder Aufzeichnung Ihrer Reisen wichtig sein können. Sie können beispielsweise einen Wegpunkt auf der Karte erstellen, um eine wichtige Kreuzung oder Richtungsänderung anzuzeigen.  
...
[Favoritenpunkte](#favorites) sind Orte, die Benutzer als besonders wichtig oder interessant empfinden und in ihrer Liste der Lieblingsorte speichern. Orte können jeden beliebigen Ort umfassen, den Sie später wiederfinden und besuchen möchten.
