...
- **Bezahlte Versionen** *(Maps+ und OsmAnd Pro)*
  Aktivieren Sie die visuelle Überlagerung im Menü [Karte konfigurieren](#enable-layer).
...
![Erkunden-Modus](@site/static/img/map/popular_places/popular_places_search.png)
![Erkunden-Modus](@site/static/img/map/popular_places/popular_places_search_2.png)

</TabItem>

</Tabs>

Der Abschnitt **<Translate android="true" ids="popular_places_nearby"/>** zeigt eine scrollbare Liste der am besten bewerteten Sehenswürdigkeiten in der Nähe Ihres aktuellen Standorts. Jeder Eintrag enthält:

- Name des Ortes.
- Kurze Beschreibung.
- POI-Kategorie-Tag.
- Entfernung und Richtung.
- Miniaturansicht (falls verfügbar).
...
- **Teilen**
  Teilen Sie das ausgewählte Bild mit einer beliebigen kompatiblen App, die auf Ihrem Gerät installiert ist (z. B. Messaging, E-Mail oder soziale Medien). Der geteilte Inhalt enthält das Bild und seinen Quelllink (falls verfügbar).

- **Details**
  Öffnen Sie eine Detailansicht, die Metadaten zum Bild anzeigt, einschließlich: *Name*, *Hinzugefügt am*, *Autor*, *Lizenz*, *Quelle* und *Direkter Link*

- **Im Browser öffnen**
  Starten Sie die Quellseite des Bildes (normalerweise auf [Wikimedia Commons](https://commons.wikimedia.org/)) in Ihrem Standardbrowser. Dadurch können Sie das vollständige Bild, Lizenzinformationen und verwandte Inhalte anzeigen.
