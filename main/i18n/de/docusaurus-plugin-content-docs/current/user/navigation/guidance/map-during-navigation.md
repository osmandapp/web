...
| *Auto-Zoom-3D-Winkel* | Legt die Neigung der Karte fest, wenn während der Navigation auf die 3D-Ansicht umgeschaltet wird. Ein höherer Winkel lässt den Horizont weiter entfernt erscheinen und bietet mehr Sicht nach vorn. | Es wird nur angewendet, wenn Auto-Zoom aktiviert ist. Werte: 20°, 25°, 30°, 35°, 40°. Standard: 25°.  |
