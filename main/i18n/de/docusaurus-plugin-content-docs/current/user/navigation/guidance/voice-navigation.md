...
- Textbenachrichtigungen spiegeln die Auslösezeit und die Nachrichten der Sprachansagen-Nachrichten vollständig wider.
...
- *Abbiegeanweisungen, Straßennamen (TTS), Ausfahrtsnummern, Verkehrswarnungen, Fußgängerüberwege* und *Tunnel.*
...
- Öffnen Sie [Sprachansagen testen](../../plugins/development.md#application-testing): *Menü → Einstellungen → Plugins → OsmAnd Entwicklung → Test Voice Prompts*.
