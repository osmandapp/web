...
- Tippen Sie auf *Bearbeiten* (Stiftsymbol), dann *Halten & Ziehen* am Symbol mit den drei vertikalen Linien, um Aktionen neu anzuordnen.

:::info note
Einige Aktionen wie *Kartenquelle*, *Kartenstil*, *Overlay*, *Underlay*, *Geländefarbschema* und *Profil hinzufügen* können als Schleife zugewiesen werden. Jeder Tipp auf die Schaltfläche wechselt zyklisch durch die ausgewählten Ebenen. Ein Zwischendialog kann angezeigt werden, um manuell aus der Liste auszuwählen, oder ausgeblendet, um in der festgelegten Reihenfolge zu wechseln.
:::
...
![Gitter für Schaltflächen_v_Android](@site/static/img/widgets/grid_buttons_v_and.png) ![Gitter für Schaltflächen_h_Android](@site/static/img/widgets/grid_buttons_h_and.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Gitter für Schaltflächen_v_iOS](@site/static/img/widgets/grid_buttons_v_ios.png) ![Gitter für Schaltflächen_h_iOS](@site/static/img/widgets/grid_buttons_h_ios.png)
...
Dieses Layout hilft, die Schaltflächen visuell konsistent zu halten und Überlappungen zu vermeiden. Zum Beispiel werden auf einem Querformatbildschirm die Schaltflächen in der rechten Ecke horizontal am unteren Bildschirmrand ausgerichtet, während sie auf einem Hochformatbildschirm vertikal nach oben oder unten erweitert werden, je nach Bedarf.
...
| Ändern <br/> [**<Translate android="true" ids="quick_action_map_style"/>**](../map/vector-maps.md#default-map-styles) | Erstellen Sie eine Liste von Kartenstilen für Vektorkarten und wechseln Sie zyklisch durch sie. <br /> - *Hinweis*. Um Kartenstile in OsmAnd zu ändern, können Sie entweder eine einzelne Schnellaktion einrichten, mit der Sie zwischen mehreren Kartenstilen wechseln können, oder mehrere separate Schnellaktionen erstellen, jede für einen bestimmten Kartenstil. |
