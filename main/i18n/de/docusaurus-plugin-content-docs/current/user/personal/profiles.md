...
OsmAnd bietet eine Vielzahl von Standardprofilen, die auf verschiedene Aktivitäten zugeschnitten sind, darunter Autofahren, Radfahren, Wandern und spezialisiertere Aktivitäten wie Skifahren und Bootfahren. Diese Profile wurden entwickelt, um Ihr Navigationserlebnis an die jeweilige Aktivität anzupassen. Jedes Profil enthält konfigurierbare Optionen, mit denen Sie Einstellungen anpassen und zusätzliche Plugins integrieren können, um Ihren Präferenzen zu entsprechen.
...
- Bestimmte Profile, wie *Skifahren* und *Boot*, verfügen über **zusätzliche Funktionen**, die erst verfügbar werden, wenn die entsprechenden Plugins aktiviert sind.
     ...
     - Plugins können aktiviert werden, indem Sie zu *Menü → Plugins → Ski-Kartenansicht* oder *Nautische Kartenansicht* navigieren.
     - Durch die Aktivierung der Plugins erhalten die Profile die wesentlichen Funktionen, um die spezifischen Anforderungen dieser Aktivitäten zu erfüllen.
...
- Es ist wichtig zu beachten, dass einige Profile, wie **LKW**, **Motorrad**, **Moped**, **Zug**, **Flugzeug**, **Boot** und **Reiten**, nicht standardmäßig aktiviert sind.
     ...
     - Diese Methode hilft, eine organisierte und relevante Liste von Profilen zu erhalten, indem nur die für bestimmte Aktivitäten benötigten Profile aktiviert werden.
...
:::caution Einstellungen nur für ein bestimmtes Profil anwenden
...
Dieser Abschnitt enthält alle Einstellungen in Bezug auf Aussehen, Navigationsoptionen, Kartenanzeige, Einstellungsmenü und Profilbildschirm.
...
OsmAnd ermöglicht es Ihnen, Ihre Anwendungsprofileinstellungen [in der OsmAnd Cloud zu sichern](../personal/osmand-cloud.md#osmand-start), um sicherzustellen, dass Ihre Konfigurationen sicher gespeichert und einfach über Android-, iOS- und Webversionen wiederhergestellt werden können. Diese Backup-Funktion schützt Ihre Einstellungen im Falle eines Gerätefehlers oder einer Neuinstallation der App. Sie können von diesem speziellen Plan mit [OsmAnd Start](../personal/osmand-cloud.md#osmand-start) profitieren.  

Sie müssen über ein [OsmAnd Cloud](../personal/osmand-cloud.md#login)-Konto verfügen, um das *Kostenlose Einstellungen-Backup* nutzen zu können. Wenn Sie ein *OsmAnd Pro*-Abonnement oder ein aktives *OsmAnd Cloud*-Konto haben, wird das Werbebanner nicht angezeigt.


## Allgemeine Einstellungen {#general-settings}

Dieser Abschnitt enthält Einstellungen für das Anwendungsthema und die Kompass-Schaltfläche, Karten- und Profildateneinheiten und -formate, externe Eingabegeräte und viele andere Einstellungen, um die optimale Konfiguration für Ihr ausgewähltes Profil zu erstellen.
...
- **<Translate android="true" ids="choose_osmand_theme"/>**. Ermöglicht das Festlegen eines Tag- und Nachtthemas für die App, das für ein Profil oder für alle gleichzeitig angewendet werden kann. Diese Option ändert nicht die Einstellungen des [Kartenmodus](../map/vector-maps.md#map-mode).
  ...
  - *<Translate android="true" ids="system_default_theme"/>*  
      Übernimmt das Systemthema. Standardmäßig und für alle neuen Benutzer entspricht der Kartenstil dem hellen oder dunklen Thema, das in den Systemeinstellungen Ihres Geräts ausgewählt ist.
...
|  |  |  |
| **<Translate android="true" ids="coordinates_format"/>** | <Translate android="true" ids="dd_mm_mmmm_format"/> | Beispiel: 50.12333° 19.93233° (Lat Long) |
|          | <Translate android="true" ids="dd_mm_mmm_format"/> | Beispiel: 50°7.393′ 19°55.941′ (Lat Long)  |
|          | <Translate android="true" ids="dd_mm_ss_format"/> | Beispiel: 50°7′23.6″ 19°55′56.4″ (Lat Long) 23°27′30″ |
...
|          | <Translate android="true" ids="navigate_point_format_olc"/> | Beispiel:  9F2X4WFJ+7W ([Open Location Code](https://en.wikipedia.org/wiki/Open_Location_Code) repräsentiert Fläche 9m x 14m)  |
...
|  |  |  |
| **<Translate android="true" ids="angular_measeurement"/>** (*Android*) / **<Translate ios="true" ids="angular_units"/>** (iOS)| Grad 180° | Alle Winkelwerte werden von 0° bis 180° und von 0° bis -180° angezeigt.  |
|          | Grad 360° | Alle Winkelwerte werden von 0° bis 360° angezeigt.  |
|          | <Translate android="true" ids="shared_string_milliradians"/> | Alle Winkelwerte haben einen [Milliradiantwert](https://en.wikipedia.org/wiki/Milliradian).  |
|  |  |  |
...
| **<Translate android="true" ids="distance_during_navigation"/>** | <Translate android="true" ids="precise"/> | *Für präzise Messungen* wählen Sie, wie Distanzinformationen in den Navigations-Widgets angezeigt werden, z. B. die Entfernung zu einem Punkt, der nächsten Abbiegung oder einer bestimmten Fahrspur. |
|          | <Translate android="true" ids="round_up"/> | *Zur besseren Lesbarkeit* werden die Zahlen in den Navigations-Widgets (Entfernung zu einem Punkt, nächste Abbiegung oder Fahrspur) abgerundet, um weniger Ziffern zu haben. <br/> Zum Beispiel: 3672 m *→* 3,6 km,&nbsp; 462 m *→* 400 m,&nbsp; 184 m *→* 150 m,&nbsp; 47 m *→* 40 m,&nbsp; 18 m *→* 15 m. |
...
Der Abschnitt **Sonstiges** bietet zusätzliche Profileinstellungen zur Anpassung der OsmAnd-Oberfläche und der Eingabesteuerungen. Diese Einstellungen ermöglichen Ihnen die Konfiguration externer Geräte, die Anpassung von Animationspräferenzen und das Umschalten des Vollbildmodus.

- [<Translate android="true" ids="external_input_device"/>](../map/interact-with-map.md#external-input-devices) – Schließen Sie externe Controller wie *<Translate ios="true" ids="sett_wunderlinq_ext_input"/>*, *<Translate ios="true" ids="sett_generic_ext_input"/>* oder *<Translate android="true" ids="sett_parrot_ext_input"/>* an, um OsmAnd über physische Tasten zu bedienen.
...
- [<Translate android="true" ids="use_kalman_filter_compass"/>](../map/interact-with-map.md#extra-compass-settings) (*nur Android*) – Glättet die Kartenrotation mit [gradueller Bewegung](https://en.wikipedia.org/wiki/Kalman_filter) und reduziert plötzliche Positionsverschiebungen. Dies führt zu einer kleinen Verzögerung (*weniger als 1 Sekunde*).
...
- **<Translate android="true" ids="tap_on_map_to_hide_interface"/>** (*nur Android*) – Tippen Sie auf einen leeren Bereich auf der Karte, um Steuerelemente und Widgets auszublenden und die Sichtbarkeit der Karte zu maximieren.
...
- **<Translate android="true" ids="position_animation"/>** (*nur Android*) – Das [Positions](../map/interact-with-map.md#my-location-and-zoom)-Symbol animiert mit jedem empfangenen GPS-Punkt (einmal pro Sekunde). Eine leichte Verzögerung in seiner Bewegung kann wahrnehmbar sein, insbesondere bei schneller Bewegung oder GPS-Signal-Schwankungen. Sie können diesen Effekt mit der Einstellung *Vorhersagezeit* anpassen: Höhere Werte erhöhen die Glätte, fügen aber Verzögerung hinzu, niedrigere Werte reduzieren die Verzögerung, können aber die Bewegung weniger glatt machen.
...
Einen detaillierten Überblick über die Navigationsoptionen finden Sie im Artikel [Navigationseinstellungen](../navigation/guidance/navigation-settings.md), der erklärt, wie Sie OsmAnd für ein optimales Navigationserlebnis konfigurieren.
...
- [Routenparameter](../navigation/guidance/navigation-settings.md#route-parameters) - Definieren Sie, wie OsmAnd Routen berechnet, einschließlich Präferenzen für die Vermeidung bestimmter Straßen oder die Auswahl von Routentypen.

- [Bildschirmhinweise](../navigation/guidance/navigation-settings.md#screen-alerts) - Aktivieren Sie das *Hinweis-Widget*, um Echtzeit-Benachrichtigungen für Geschwindigkeitsbegrenzungen, Abbiegungen und andere wichtige Straßenbedingungen anzuzeigen.

- [Sprachansagen](../navigation/guidance/navigation-settings.md#voice-prompts) - Aktivieren Sie die Sprachführung, um gesprochene Navigationsanweisungen während der Fahrt oder des Gehens entlang einer ausgewählten Route zu erhalten.
...
- [Karte während der Navigation](../navigation/guidance/navigation-settings.md#map-during-navigation) – Zeigen Sie die Echtzeitpositionierung auf der Karte an, verfolgen Sie den Fortschritt entlang der Route und verbessern Sie die Orientierung anhand von Orientierungspunkten.

- [Detaillierte Track-Führung](../navigation/guidance/navigation-settings.md) – Verbessern Sie die Turn-by-Turn-Navigation, indem Sie Ihre Route an kartierte Straßen anpassen. Verfügbare Einstellungen: *Jedes Mal fragen* oder *Immer*.
...
Das Menü [<Translate android="true" ids="configure_map"/>](../map/configure-map-menu.md) ermöglicht es Ihnen, die Kartenanzeigeeinstellungen für das ausgewählte Profil anzupassen und so eine bessere Visualisierung wichtiger Kartenelemente zu ermöglichen.  

Mit diesem Menü können Sie:

- Wichtige Kartenelemente hervorheben, einschließlich [Favoritenpunkte](../personal/favorites.md), [Navigationsmarkierungen](../personal/markers.md) oder spezielle [Points of Interests (POIs)](../map/point-layers-on-map.md#points-of-interest-pois) auf der Karte.
...
- Die Visualisierung des öffentlichen Nahverkehrs aktivieren und [Routen und Haltestellen](../map/public-transport.md) für eine bessere Reiseplanung anzeigen.

- Das Kartenbild anpassen, indem Sie einen anderen [Kartenstil](../map/vector-maps.md#default-map-styles) auswählen, der Ihren Anforderungen entspricht.
...
Das [<Translate android="true" ids="map_widget_config"/>](../widgets/configure-screen.md) ist ein Menü, mit dem Sie die Widgets für das ausgewählte Profil konfigurieren können, die auf der Karte angezeigt werden sollen. Auf diesem Bildschirm können Sie [Informations](../widgets/info-widgets.md)- und [Navigations](../widgets/nav-widgets.md)-Widgets sowie andere Elemente aktivieren und konfigurieren.
...
Die Einstellungen für das **Profil-Erscheinungsbild** ermöglichen es Ihnen, den Namen und die visuelle Darstellung Ihres Profils anzupassen. Hier können Sie auch das Erscheinungsbild von [Mein Standort](#my-location-appearance) ändern. Während der *Profilname* eindeutig sein muss, können *Symbole* und *Farben* über verschiedene Profile hinweg gleich sein. Diese Änderungen werden in verschiedenen Teilen der Anwendung angewendet, z. B. im Menü [Routenvorbereitung](../navigation/setup/route-navigation.md).


### Erscheinungsbild von Mein Standort {#my-location-appearance}
...
Die Einstellungen für das **Erscheinungsbild von Mein Standort** ermöglichen es Ihnen, anzupassen, wie Ihr Standort auf der Karte angezeigt wird, sowohl im Stillstand als auch in Bewegung. Bewegung wird vom Betriebssystem erkannt, wenn die Gerätegeschwindigkeit **größer als Null** ist.

#### 1. Blickwinkel und Standortradius {#1-view-angle-and-location-radius}

Sie können die visuellen Elemente in Bezug auf Ihren Standort anpassen und diese separat oder zusammen für **Ruhe**- und **Navigations**positionen anwenden. Für 2D- und 3D-Modi werden *Blickwinkel* und *Standortradius* in derselben Farbe angezeigt, die für das [Navigationsprofil](#profile-appearance) ausgewählt wurde, direkt unter dem Symbol [Mein Standort](../map/interact-with-map.md#my-location-and-zoom).
...
Für ein personalisierteres Erlebnis können Sie **benutzerdefinierte 3D-Symbole** erstellen und zu OsmAnd hinzufügen.  

***So fügen Sie ein benutzerdefiniertes 3D-Standortsymbol hinzu:***

1. **Erstellen Sie ein 3D-Modell**. Entwerfen Sie Ihr Symbol in [MTL- und OBJ-Formaten](https://en.wikipedia.org/wiki/Wavefront_.obj_file).
...
- Wenn das Standortsymbol im Stillstand **wackelt oder sich dreht**, wechseln Sie vom **Bewegungsrichtungsmodus** ([Karte nach Richtung drehen](../map/interact-with-map.md#rotate-map-by-bearing)) zu einem anderen Modus.  
- Passen Sie zusätzliche Einstellungen unter *Menü → Einstellungen → App-Profile → Profil-Erscheinungsbild → Optionen* an.
- Erfahren Sie mehr über Richtung und Richtungserfassung im Abschnitt [Richtung-Widget](../widgets/nav-widgets#bearing-widget).  


## Benutzeroberfläche anpassen {#ui-customization}

<InfoAndroidOnly />

:::note Für unbenutzte Plugins
Um alle Steuerparameter unbenutzter [Plugins](../plugins/index.md#configure-plugin) auszublenden, deaktivieren Sie diese.
:::
...
- **Hauptsichtbare Elemente** - Im Abschnitt *UI anpassen* können Sie Elemente aus der [Schublade](../start-with/main-menu.md#customize-advanced-use-of-android) *neu anordnen, ausblenden und wiederherstellen*, um sie Ihren Präferenzen anzupassen.
...
- **Karte konfigurieren Menü** - Im Abschnitt *UI anpassen* können Sie Elemente aus dem Menü [Karte konfigurieren](../map/configure-map-menu.md) *neu anordnen oder ausblenden*, um schnell auf häufig verwendete Einstellungen zugreifen zu können.
...
- **Aufzeichnung von Touren**. Dieser Punkt öffnet die [Einstellungen für die Tourenaufzeichnung](../plugins/trip-recording.md#recording-settings) für das ausgewählte Profil, in denen Sie beliebige Parameter für die Aufzeichnung Ihrer Reisen auswählen können.

- **Wetter**. Interaktive [Wetter](../plugins/weather.md#weather-settings)-Kartenebenen ermöglichen es Ihnen, Temperatur, Luftdruck, Wolkenbedeckung, Windgeschwindigkeit und Niederschlag in Ihrer Stadt oder an einem beliebigen anderen Ort auf einer globalen Karte zu überwachen.

- **Audio-/Video-Notizen** (*nur Android*). Dieser Punkt öffnet die [Einstellungen für das Audio-Video-Plugin](../plugins/audio-video-notes.md#plugin-settings) für das ausgewählte Profil. Das *Audio/Video-Notizen*-Plugin erweitert die Funktionalität von OsmAnd, indem es Ihnen ermöglicht, Ihre Notizen in verschiedenen Formaten wie Foto, Video oder Audio zu erstellen und sie mit einem geografischen Standort oder dem aktuellen Standort zu verknüpfen.  
...
- **Externe Sensoren**. Wenn Sie im Abschnitt *Plugin-Einstellungen* auf ein Element tippen, werden die [Einstellungen für externe Sensoren](../plugins/external-sensors.md#sensors-settings) für das ausgewählte Profil geöffnet. Das Plugin "Externe Sensoren" ermöglicht das Auslesen und Aufzeichnen von Daten von drahtlosen externen Sensoren und deren Anzeige mithilfe von Widgets in der OsmAnd-Anwendung.

- **Barrierefreiheit** (*nur Android*). Dieser Punkt öffnet die [Einstellungen des Barrierefreiheits-Plugins](../plugins/accessibility.md#plugin-settings) für das ausgewählte Profil. Die Einstellungen des Barrierefreiheits-Plugins ermöglichen es Ihnen, die Anwendung an Ihre Bedürfnisse anzupassen. Alle Einstellungen beziehen sich auf den Navigationsprozess und werden individuell für jedes Profil festgelegt.

- **OsmAnd-Entwicklung**. Dieses Menü öffnet die [Einstellungen des OsmAnd-Entwicklungsplugins](../plugins/development.md#plugin-settings), in denen Sie die OsmAnd-Anwendung für Testzwecke konfigurieren oder kommende Funktionen erkunden können. Diese Einstellungen sind für Entwickler gedacht und für den normalen Gebrauch der Anwendung nicht erforderlich.  

  > ***Das Ändern der Einstellungen des OsmAnd-Entwicklungsplugins wirkt sich auf alle Profile aus.***

- **Wikipedia**. Dieses Menü öffnet die *[Wikipedia-Plugin-Einstellungen](../plugins/wikipedia.md#wikipedia-settings)*. Sie können die Sprache auswählen, in der Artikel angezeigt werden, und entscheiden, ob Bilder von Wikipedia heruntergeladen werden sollen. Wikipedia auf Ihrer Reise verbessert Ihr Erlebnis, indem es Informationen über die Orte liefert, die Sie besuchen. Es funktioniert offline und zeigt relevante Wikipedia-Artikel direkt auf der Karte zu Points of Interest an.
