...
Sie können die App über diesen Link herunterladen - [OsmAnd Maps im Apple App Store](https://apps.apple.com/us/app/osmand-maps-travel-navigate/id934850257).
...
|------------|------------|------------|------------|
| **OsmAnd Start** | Ein **kostenloser Plan**, der Zugriff auf [OsmAnd Cloud](../personal/osmand-cloud.md#osmand-start) für *Favoriten*, *Einstellungen* und *OSM-Bearbeitung/Notizen* bietet. | Verfügbar für alle Benutzer der kostenlosen Version von OsmAnd. | Beschränkt auf grundlegende Cloud-Funktionen und **5 MB** Speicherplatz. |
...
| ![Pro](@site/static/img/svg/pro_icon.svg) **OsmAnd Pro** | Ein **Abonnement-Plan**, der zusätzliche erweiterte und [Pro-Funktionen](#pro-features) freischaltet. | Verfügbar im [App Store](https://apps.apple.com/us/app/osmand-maps-travel-navigate/id934850257). | Unterstützt **plattformübergreifenden** Zugriff (siehe Hinweis unten). |

### Wichtige Hinweise {#important-notes}

1. **Maps+** ist ein *Upgrade* für die kostenlose Version von OsmAnd, das die meisten Funktionen freischaltet.

2. **OsmAnd Pro ist ein *plattformübergreifendes* Abonnement**. Das bedeutet, dass Sie es in einem Store (z.B. *AppStore, Google Play und osmand.net*) kaufen und in einem anderen wiederherstellen können, indem Sie [Ihren Kauf mit dem OsmAnd Cloud-Konto verknüpfen](../personal/osmand-cloud.md#cross-platform).
...
In der Liste finden Sie Informationen zu den Preisen der OsmAnd-Produkte für die Regionen USA und Europa. Für andere Regionen sind die Preise in lokaler Währung äquivalent.
...
|  | OsmAnd Free | [OsmAnd Maps+](#install-osmand-ios)<br/>(In&#8209;App & Abonnement) | [OsmAnd Pro](#install-osmand-ios) |
| :------ | :------------- | :------------------ | :------------------ |
...
| [Karten-Downloads](../start-with/download-maps.md) |  <details><summary>**5 Karten-Downloads** <br /> (Karten-Update zählt als Download):</summary> <br /> - Karten-Download oder -Update bedeutet nur den Download/das Update einer Länderkarte (Region).<br /> - **Weltübersichtskarte**, **Welt-Höhenkorrektur**, **Karten-Schriftarten** und **Sprachansagen** werden nicht als 5 Download-Möglichkeiten gezählt.</details> | ✔ | ✔ |
| [Monatliche Karten-Updates](../personal/maps-resources.md#update-maps) |  <details><summary>**Einmal im Monat** <br /> (mit 2 Tagen Verzögerung):</summary> * auf 5 Downloads beschränkt (Karten-Update zählt als Download) </details> |  ✔ | ✔ |
...
| [Topografie-Daten](../plugins/topography.md#setup)<br/>(Höhenlinien und Gelände) | **-** | ✔ | ✔ |
...
| [Unterstützung für SQLitedb/mbtiles Karten](../map/raster-maps.md#manage-raster-maps) | ✔ | ✔ | ✔ |
...
![Pro](@site/static/img/svg/pro_icon.svg) *Pro-Funktionen* sind für das [OsmAnd Pro-Abonnement](#prices) verfügbar. Das bedeutet, Sie benötigen ein [OsmAnd Pro-Abonnement](#install-osmand-ios).

Derzeit bietet das Pro-Abonnement die folgenden Funktionen:
...
| [3D-Relief](../plugins/topography.md#3d-relief) | Ermöglicht es Ihnen, ein maßstabsgetreues Modell Ihrer Umgebung oder eines ganzen Kontinents zu sehen und zu beobachten. |
| [Höhen-Widgets - Elevation: Map Center](../widgets/info-widgets.md#elevation-map-center) | Ermöglicht es Ihnen, die Höhe des aktuellen Kartenzentrums über dem Meeresspiegel herauszufinden.  |
| [OsmAnd Live](../personal/maps-resources.md#osmand-live) | OsmAnd-Karten werden alle 15 Minuten nach Verbesserungen in [OpenStreetMap](https://www.openstreetmap.org/) aktualisiert. |
| [Wetter-Plugin](../plugins/weather.md) | 24-Stunden-Stundenprognose für 7 Tage im Voraus auf der Karte. |
| [Anpassen der Routenlinie](../navigation/guidance/map-during-navigation.md#route-line-appearance) | Ändern der Farbe und Breite der Routenlinie während der Navigation. |
...
![Pro](@site/static/img/svg/pro_icon.svg) *OsmAnd Pro* Abonnement-Plan. Hier können Sie [monatliches oder jährliches Abonnement](#prices) wählen:
...
![Maps+](@site/static/img/svg/osmand_maps_plus.svg) *Maps+* Abonnement / In-App-Plan. Hier können Sie [jährliches Abonnement](#prices) oder [Einmalzahlung](#prices) wählen:
...
Neue Abonnements wurden ab OsmAnd 4.3 (Dezember 2022) aktiv. Alle früheren Abonnements sind ältere Abonnements und technisch gleichwertig mit dem "Maps-Abonnement", obwohl ältere Abonnements Anspruch auf stündliche Karten-Updates haben. Benutzer können keine älteren Abonnements kaufen, aber alte Abonnements werden automatisch verlängert, bis Sie kündigen (der Preis dafür kann sich in Zukunft ändern).
...
- Melden Sie sich mit demselben Apple App Store-Konto an, das Sie zum Kauf von In-Apps (Abonnements) von OsmAnd Maps verwendet haben.
...
3. Starten Sie das Gerät neu und versuchen Sie erneut, die Käufe wiederherzustellen.
...
Sie können OsmAnd mit einer App Store-Geschenkkarte kaufen. Diese Methode ermöglicht es Ihnen, die direkte Weitergabe von Kreditkarteninformationen an den Dienst zu vermeiden. Kaufen Sie einfach eine Geschenkkarte bei einem Händler Ihrer Wahl und lösen Sie den Code im App Store ein.

- [Detaillierte Anleitung zum Kauf von App Store-Geschenkkarten](https://www.apple.com/shop/gift-cards).
- [Anleitung zum Einlösen Ihrer App Store-Geschenkkarte](https://support.apple.com/en-gb/HT201209).
