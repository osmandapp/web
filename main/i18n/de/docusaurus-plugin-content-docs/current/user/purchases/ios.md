...
| [Karten-Downloads](../start-with/download-maps.md) |  <details><summary>**5 Karten-Downloads** <br /> (Karten-Update zählt als Download):</summary> <br /> - Karten-Download oder -Update bezieht sich nur auf den Download/das Update einer Länder- (Regionen-) Karte.<br /> - **Weltübersichtskarte**, **Welt-Höhenkorrektur**, **Karten-Schriftarten** und **Sprachansagen** werden nicht als 5 Download-Möglichkeiten gezählt.</details> | ✔ | ✔ |
| [Monatliche Karten-Updates](../personal/maps-resources.md#update-maps) |  <details><summary>**Einmal im Monat** <br /> (mit 2 Tagen Verzögerung):</summary> * begrenzt auf 5 Downloads (Karten-Update zählt als Download) </details> |  ✔ | ✔ |
