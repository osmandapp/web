...
- Google Play — <a href="https://play.google.com/store/apps/details?id=net.osmand">**Holen**</a>
- Huawei AppGallery — <a href="https://appgallery.huawei.com/#/app/C101486545">**Holen**</a>
...
- Alle OSM-Routen, jetzt durchsuchbar! Wandern, Radfahren, MTB und mehr
- Neues Navigations-Widget kombiniert Abbiegepfeil und Navigationsanweisungen
- Aktuelles Routeninfo-Widget: zeigt ETA, Ankunftszeit und Entfernung an
- Wählen Sie Skipisten und MTB-Trails auf der Karte für detaillierte Informationen aus
- Möglichkeit zur Auswahl der Widget-Größe für linke und rechte Panels
- "Koordinatengitter" mit geografischen Koordinaten hinzugefügt
- Möglichkeit zur Anpassung des Standardaussehens von Favoritengruppen hinzugefügt
- Android Auto: ETA und Entfernung zum nächsten Wegpunkt anzeigen; Städtenamen erscheinen jetzt in den Suchergebnissen
- Markante Gipfel sind jetzt über Karte und Suche auffindbar
- Berghöhen in Fuß
- Hinzugefügt: Klettergebiete und Kletterwände auf der Karte
- Die Adresssuche in den USA wurde verbessert
...
- Eine Vollbild-Galerieansicht für Wikimedia-Bilder wurde hinzugefügt.
- Ein neues Plugin "Fahrzeugmetriken" zur Überwachung der Fahrzeugleistung über das OBD-II-Protokoll wurde eingeführt.
- Die Möglichkeit, Aktivitäten Tracks zuzuweisen und diese entsprechend zu filtern, wurde hinzugefügt.
- Neue Schnellaktionen für die Aufzeichnung von Fahrten und die Sperrung des Touchscreens wurden implementiert.
- Anpassbares Aussehen der Kartenschaltflächen und ein präzises Gitter wurden eingeführt.
- Ein Kontextmenü und eine Aktion "Durchschnittsgeschwindigkeit zurücksetzen" wurden zu Widgets hinzugefügt.
- Neue Routenschicht "Dirt Bike Trails" wurde hinzugefügt.
- "Automatische Trackaufzeichnung während der Navigation" wurde behoben.
- Problem mit vertauschten Koordinaten in RTL wurde behoben.
- Fehlende Sensordaten für den aktuell aufgezeichneten Track wurden behoben.
- Informationen über umliegende Gebiete für den ausgewählten Punkt wurden hinzugefügt.
- Schnellaktion zur Steuerung der Sichtbarkeit von OSM-Bearbeitungen wurde hinzugefügt.
- Sichtbarkeitsparameter für die Optionen zur Geländefärbung wurden getrennt.
- Ein antippbares Symbol zur Anzeige von Zugangs- oder anderen Straßen- oder Pfadattributen wurde hinzugefügt.
...
- 3D-Variante für Standortpositionsymbole.
...
- Einheitliche Benutzeroberfläche für die Trackauswahl.
...
- Verbesserte obere und untere Widget-Panels zur Aufnahme aller Widgets.
...
- Verbesserte Track-Färbung im Slope-Modus mit neuem symmetrischem Gradienten.
- Probleme mit transparenter Statusleiste behoben.
- Unterstützung für ANT+-Temperatur-Widget hinzugefügt.
- Widget "Verfügbarer RAM" eingeführt.
...
- Kostenloses Backup für Favoriten und Einstellungen in OsmAnd Cloud.
- Neues Format für Geländekarten mit 3D-Relief-Unterstützung.
- Track-Verwaltung: Aktualisierte Benutzeroberfläche, Sortierung hinzugefügt, Unterstützung verschachtelter Ordner.
...
- Neues Profil "Zug", ermöglicht die Berechnung von Eisenbahnrouten.
...
- Option zum "Ansagen der Abweichung von der Route" hinzugefügt.
- Startbildschirm: Option zum Wiederherstellen des OsmAnd-Zustands aus einer Datei hinzugefügt.
- Klassen für "Gefahrstoffe" für die LKW-Navigation in Nordamerika hinzugefügt.
- Unterstützung für "Via Ferrata" für die Fußgänger-Navigation hinzugefügt.
- "CAI"-Skala zur Klassifizierung der Schwierigkeit von Routen hinzugefügt.
- Auswahl der Sprache pro App behoben.
- Unterstützung für thematische Symbole hinzugefügt.
- OsmAnd Cloud: Option zum Löschen des Kontos hinzugefügt.
- Barrierefreiheit: Größe des Berührungsziels für Schaltflächen auf 48 dp geändert; Problem mit für Screenreader sichtbarer Karten-UI behoben.
...
- Verbessertes Menü "Tracks" in "Karte konfigurieren"
- Kontextmenü zeigt jetzt lokalisierte Namen für POI an
- Option zum Teilen der Route per Link hinzugefügt
- Längeneinheit "Seemeilen/Fuß" hinzugefügt
- Kartenorientierung hat neuen festen Modus hinzugefügt
- Vereinfachter Startbildschirm
- Behobene Standortposition im Split-Screen-Modus in Android Auto
...
- Widget "Kartenmarkierung": Option zum Ändern des Klickverhaltens hinzugefügt
- Option "Position anzeigen" behoben
- GPX: Unterstützung für "link", "cmt", "desc" Tags und für beliebige benutzerdefinierte Erweiterungen hinzugefügt
- Liste der "Nautischen Karten" neu organisiert
...
- Mapillary-Ebene behoben, das Plugin ist jetzt standardmäßig deaktiviert
- Bildschirm zur Verwaltung des gesamten Verlaufs in der App hinzugefügt
- Die Kartenorientierung wird nach dem Neustart der App nicht zurückgesetzt
- Verbessertes Rendering von SRTM-Höhenmarkierungen
...
- Option zum Ändern des Aussehens der Routenlinie hinzugefügt.
- Dialog "Fahrt aufzeichnen" aktualisiert
- Entfernung per Tippen vom Radiuslineal in eine separate Option verschoben
- Routenplanung Querformat: Registerkarten zum Wechseln zwischen Punkten oder Diagrammen hinzugefügt
- Routenplanung: Möglichkeit hinzugefügt, Navigationsoptionen zu ändern, auf "Karte konfigurieren" und "Suchen" zuzugreifen, ohne die Routenplanung zu verlassen
- Neuer Kaufbildschirm mit detaillierten Informationen zum Kauf
- Neue POI-Typen, Clubs hinzugefügt: Musik, Soziales, Pfadfinder, Freimaurerei
- Dialog zur Auswahl der Sprache für Navigationsanweisungen neu gestaltet
- Meine Orte: Die zuletzt geöffnete Registerkarte wird jetzt gespeichert und beim nächsten Mal geöffnet
- Verschiedene Fehlerbehebungen für RTL
...
- Option zum Exportieren und Importieren aller Daten einschließlich Einstellungen, Ressourcen, meiner Orte hinzugefügt.
- Routenplanung: Diagramme für Tracksegmente mit Route und Möglichkeit zum Erstellen und Bearbeiten mehrerer Tracksegmente hinzugefügt.
- OAuth-Authentifizierungsmethode für OpenStreetMap hinzugefügt, Benutzeroberfläche der OSM-Dialoge verbessert.
- Unterstützung benutzerdefinierter Farben für Favoriten und Track-Wegpunkte.
...
- Neues Menü "Aussehen" für Tracks: Farbe, Dicke, Anzeige von Richtungspfeilen, Start-/Zielsymbolen auswählen
...
- Anpassen der Reihenfolge von Elementen im Kontextmenü, Karte konfigurieren, Schublade
- Wikipedia als separate Ebene in Karte konfigurieren, nur benötigte Sprachen auswählen
- Erstellen Sie Ihren eigenen POI-Filter/Karten mit voller Flexibilität
- Optionen zum Wiederherstellen von Einstellungen für benutzerdefinierte Profile hinzugefügt
- Vollständige GPX-Routen von der Navigation unterstützen Fahrspuren und vollständige Abbiegeanweisungen
...
- Sonnenuntergangs-/Sonnenaufgangsdaten zu Karte konfigurieren hinzugefügt
...
- Neuer Bildschirm "Wegbeschreibung": Zeigt Schaltflächen für die Ziele "Zuhause" und "Arbeit", Verknüpfung zur vorherigen Route, Liste der aktiven Tracks, Suchverlauf
...
- Neue Schnellaktion zum Anzeigen/Ausblenden von Tracks und Tag-/Nachtmodi
- Überflutete Gebiete in Deutschland, Südafrika, Quebec behoben
- Verbesserter Import für KML- und KMZ-Import
- Abstürze beim Öffnen einiger Haltestellen öffentlicher Verkehrsmittel behoben
...
- Absturz beim Start behoben, der bei nicht-lateinischen Karten auftrat
- Rendering-Geschwindigkeitsprobleme auf Android 8.0-Geräten verbessert
- Unterstützung für die Bearbeitung von Polygon-Objekten (nicht-Amenity)
- Entfernung messen: Schaltfläche "Messen" zu Aktionen im Kontextmenü hinzugefügt
...
- Navigation: Fortschrittsbalken korrigiert, schnelles Vertauschen von Start- und Endpunkt der Route
- Kartenmarkierungen: Ein-/Ausschalten von Gruppen korrigiert, Möglichkeit, Markierungen von der Karte auszublenden
- OSM-Bearbeitung: Möglichkeit, Tags für Nicht-Punkt-Objekte und Wege zu bearbeiten, fehlende Kommentare zu Notizen korrigiert, Backup von Bearbeitungen
- Wikipedia- und Wikivoyage-Parsing verbessert, aktualisierte Dateien sind bereits verfügbar
- Kontextmenü: Farbe der Verkehrsschilder im Nachtmodus korrigiert, Größen zusätzlicher Menüs korrigiert
- Bootsnavigation: Unterstützung für Wasserstraßen-Fahrwasser
...
- Wikipedia: Schaltfläche zum Öffnen des Originalartikels hinzugefügt, Aussehen der Artikel aktualisiert
- Route: Möglichkeit hinzugefügt, Start- und Endpunkte mit einem Tippen zu tauschen
...
- Neuer Bildschirm zur schnellen Koordinateneingabe für schnelle Markierungserstellung
...
- Vollständig überarbeitete Kartenmarkierungen mit Richtlinien und Routenplanung
- Werkzeug zum Messen von Entfernungen, bietet Funktion zum Einrasten an Straßen und Speichern von Punkten als Track
- OsmAnd Live: Fehlerbehebungen, frische Daten auf dem Server alle 15 Minuten, Updates in die Navigation implementiert
...
- GPX-Split-Intervall zeigt Details von Track-Abschnitten
...
- Schnellaktionsschaltfläche. Fügen Sie ausgewählte Funktionen zu einer einzigen Symbolleiste hinzu
- Verbessertes Suchmenü. Traditionelle Schritt-für-Schritt-Suche kombiniert mit der modernen
- Höhen- und Steigungsprofile für Routen. Zeigen Sie Höhendetails jeder Route an
...
- Anklickbare Symbole auf der Karte. Informationen erhalten ohne die POI-Ebene
...
- Integration von Auto-Audiosystemen. Verwenden Sie Ihr Auto-Audiosystem für die Sprachnavigation
- Bessere Informationen zu öffentlichen Verkehrsmitteln. Vollständige Routen öffentlicher Verkehrsmittel anzeigen, die mit Haltestellen verknüpft sind
- Weitere Verbesserungen. Bessere Sprachführung, neue Anzeige von Fahrspuren und Speicherfehlerbehebungen
...
- Völlig neue Benutzeroberfläche für Kartenmarkierungen
...
- Viele Fehlerbehebungen in verschiedenen Bereichen
...
- Sprachansage hinzugefügt, wenn Sie auf die Route zurückkehren
...
- Kartentextgröße unabhängig vom Kartenzoom anpassen

Benutzeroberfläche und Sonstiges:

- Bessere Benutzeroberfläche zum Herunterladen und Aktualisieren von Karten
- Bessere Benutzeroberfläche zum Konfigurieren von Karten- und Bildschirmanzeige
- Unterstützung für Android Wear
- Reiseroute und Abbiegeinformationen drucken

Vereinfachung der Hintergrund-Fahrtenaufzeichnung und Hintergrund-Navigation:

- OsmAnd aktiviert jetzt automatisch den GPS-Schlafmodus-Dienst, wenn die Navigation oder die Fahrtenaufzeichnung aktiviert wurde, damit dies auch bei ausgeschaltetem Gerätebildschirm weiterhin funktioniert. Nur wenn gewünscht, kann der GPS-Schlafmodus-Dienst weiterhin manuell unterbrochen oder über das Tippen auf das Widget "GPS-Status" konfiguriert werden.

- OsMo-Plugin
- Anmelde-/Abmeldefunktion
- Automatische Gruppen- und Geräte-Downloads für registrierte Benutzer
...
- Teilen Sie Ihren Standort mit Ihren Freunden und sehen Sie deren Standort auf der Karte
- Erstellen und beitreten Sie aktiven Gruppen
...
- Schnellere Sucheingabe für Adressen
- Fehlerbehebungen beim Routing und Rendering
...
- Sprachwarnungen über Geschwindigkeitsbegrenzungen und Kameras
- Mehr Sprachansagefunktionen (Straßennamen werden angesagt)
- Kartensymbole mit hoher Dichte
- Fehlerbehebungen bei der Entfernungsanzeige, GPX-Analyse, Wegpunktverwaltung, Planungs-Widget, OSM-Upload, https.
...
- Tablets und Großbildschirm-Unterstützung neu implementieren
- Holo Theme (Anpassung)
- Zusätzliche Einstellungen zur Stabilisierung des Kompasses
- Die obere linke Schaltfläche auf dem Kartenbildschirm ersetzt die Menü-Schaltfläche
...
- Hillshade pro Land herunterladbar
...
- Usability-Fixes und neu strukturiertes Höhenlinien-Plugin
- Hillshade-Pakete für das Höhenlinien-Plugin
- Fehlerbehebungen (suboptimales Routing)
- Entfernungsrechner-Plugin
- Audio-/Video-Notizen-Plugin
- Höhenlinien-Plugin
- Fehlerbehebungen
- Kartenstil-Option 'Touring View' mit mehr Kartendetails, neuen Straßenstilen, mehr Kontrast und Option für alpines Wandern (SAC-Skala)
...
- Verbessertes Routing: schneller, präziser, bis zu 250 km.
- Einführung von Karten nur mit Straßen.
...
- Einstellung zur Vermeidung von Autobahnen während der Navigation
- Dynamische Karten-Widgets
- Sperrbildschirm-Schaltfläche mit Protokollierungsdiensten
- Unterstützung für arabische, kannadische Schrift und RTL-Sprachen
- Intelligente Routenneuberechnung
- Richtung nach Fahrspuren
- Informationen über Geschwindigkeitsbegrenzungen, Radarkameras und Bodenschwellen
- Widget zur Aktivierung/Deaktivierung der Protokollierung
...
- Online-Tracking-Option - Koordinaten periodisch an Webdienst senden
...
- GPX-Überwachung verbessern (einige ungenaue Positionen filtern und Genauigkeit/Höhe/Geschwindigkeit speichern)
- [GPX hochladen](https://download.osmand.net/gpx/) an die OSM-Community
- Text-to-Speech-Engine für die Sprachnavigation
- Basiskarte für die ganze Welt, gebündelt mit einer App
- Offline-Navigation optimieren (noch experimentell)
