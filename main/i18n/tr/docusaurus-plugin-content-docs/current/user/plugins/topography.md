...
3B Rölyef özelliği, yükseltilmiş bir rölyef üretir ve manzalanın üç boyutlu bir temsilini sağlar. 3B Rölyef çevrimdışı çalışır ve [OsmAnd vektör haritaları](../map/vector-maps.md) veya herhangi bir [raster harita](../map/raster-maps.md#layers) ile [Harita Kaynağı](../map/raster-maps.md#main) veya [Alt Katman/Üst Katman](../map/raster-maps.md#overlay) olarak kullanılabilir.
