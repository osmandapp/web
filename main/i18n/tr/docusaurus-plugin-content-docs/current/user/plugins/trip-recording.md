...
Widget'lar, *Ortalama Eğim*, *Mesafe*, *Yokuş aşağı*, *Süre*, *Maksimum Hız*, *Hareket Süresi* ve *Yokuş yukarı* gibi parkur kaydıyla ilgili temel bilgileri doğrudan ekranda görüntülemenizi sağlar. Android'de ayrıca *Ortalama Hız* widget'ını ekleyebilirsiniz.
...
![Android'de Mesafe/Başlat-Durdur widget'ı ekleme](@site/static/img/plugins/trip-recording/add_new_widg_andr.png)
...
| **Widget** | **Mevcut modlar**  |
|-------|-------------|
| Ortalama Eğim | Son yokuş aşağı; Son yokuş yukarı |
| Ortalama Hız (*Yalnızca Android*) | Gezi ortalaması (varsayılan); Son yokuş aşağı; Son yokuş yukarı |
| Mesafe (Başlat-Durdur) | Gezi ortalaması (varsayılan); Son yokuş aşağı; Son yokuş yukarı |
| Yokuş aşağı | Toplam (varsayılan); Son yokuş aşağı |
| Maksimum Hız | Toplam (varsayılan); Son yokuş aşağı; Son yokuş yukarı |
| Hareket Süresi | Toplam (varsayılan); Son yokuş aşağı; Son yokuş yukarı |
| Yokuş yukarı | Toplam (varsayılan); Son yokuş yukarı |

Mod değiştirme widget'a bağlıdır:
- Yokuş yukarı / Yokuş aşağı / Maksimum Hız / Ortalama Eğim / Hareket Süresi / Ortalama Hız — Haritada widget'a dokunarak modunu değiştirin.
...
|**Ortalama Hız** (*Yalnızca Android*). Seçilen moda bağlı olarak şu anda kaydedilen gezi için ortalama hızı veya son yokuş yukarı veya yokuş aşağı bölümündeki ortalama hızı gösterir. |
|![widget'lar](@site/static/img/widgets/tr_rec_wid_average_speed.png)|
...
|**Hareket Süresi**. Seçilen moda bağlı olarak mevcut gezi kaydının hareket süresini veya son yokuş yukarı ve yokuş aşağı sürelerini gösterir. |
