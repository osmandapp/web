...
| :-- | :-- | :-- |
| İspanyolca  |  ¿Qué es OsmAnd y para qué sirve?  |  [Goiena](https://www.goiena.org/osmand) |
| İspanyolca  |  Este manual tiene el fin de explicar detalladamente todas las funciones que tiene esta app, entre ellas explicar de qué manera funciona el waypoint, los tracks y el Go to. Todo ello con la intención de obtener más herramientas para la navegación virtual y que sirva como herramienta para los trabajos geodésicos. |  [Geodesia](https://www.studocu.com/pe/document/universidad-nacional-de-ingenieria/geodesia/manual-de-uso-aplicativo-osmand-gps-trabajo-de-campo/18722995) |
| İspanyolca  |  OSMAnd, alternativa libre a Google Maps con muchas funciones.  |  [Mapcolabora](https://mapcolabora.org/post/2024/2024-05-21-intro_osmand/) |
| Çekçe   | OsmAnd CZ je český web podporující navigaci OsmAnd. Najdete zde návody, testy, tipy, aktuality a recenze.   | [OsmAnd CZ](https://osmand.cz/) |
| Fransızca  | Ces tutoriels sont désormais disponible sur cette chaîne YouTube.  | [RandoVélo](https://randovelo.touteslatitudes.fr/osmand/)  |
| İtalyanca | Guida non ufficiale a OsmAnd, l'app di cartografia e navigazione per Android e iOS -- In Italiano!  | [GuidaOsmAnd](https://github.com/Max1234-Ita/GuidaOsmand)   |
| Hollandaca | OsmAnd Handleiding 2021. | [OsmAnd Handleiding 2021](https://compostelagenootschap.be/wp-content/uploads/2021/09/OsmAnd_handleiding_v2.pdf)   |
| Hollandaca | OsmAnd Nederlandse instructie. | [Nederlandse instructie](https://docs.google.com/document/d/1JdyVswTcfrpVmflLZ_WBKEhmndlJBl57qPuAWFv5Pqg/edit?usp=drivesdk)   |
| Hollandaca | Filmpjes zijn door mij gemaakt met korte en duidelijke uitleg over de werking van Osmand. | [Janiek.de](https://www.janiek.be/?fbclid=IwZXh0bgNhZW0CMTAAAR2zi1q2NqTAc14Y_7W129qapWYQLVxW1e8CuY19_KtplyV6z613q3W6nWo_aem_xWMmPwTXqmVA43tIxhB-VA)   |
| Almanca | Osmand Anleitung: Kostenlose Karten- und Navigations App  |  [Rudis Smartphone Tipps](https://www.smartphone-tipp.de/apps/anleitung-osmand/) |
| Rusça  | Навигация для бездорожья, экспедиций, воды (и не только)! OsmAnd! – пора сменить олдскульный Ozi-к, не теряя генштаба, спутника, openstreetmap, и прочих прелестей! Инструкция, Руководство и Фишки!  |  [Drive2](https://www.drive2.ru/l/533880791202005393/) |
...
|--|--|--|
| Gelişmiş Profiller ve Haritalar  | [OsmAnd Rendering Github](https://github.com/OsmAnd-Rendering) verilerinden. Eklenti, Enduro, CycloRoute ve Yürüyüş harita stillerini (daha fazla bilgi [burada](../map/map-styles.md#default-map-styles)) ve 5 yeni [profil](https://osmand.net/docs/user/personal/profiles) (Yaya, Bisiklet ve üç Motosiklet profili) ekler. Ayrıca, *Gelişmiş Çevrimiçi Haritalar* klasöründeki [Haritalar ve Kaynaklar](../personal/maps-resources.md#extra-maps) menüsü aracılığıyla İspanya, Fransa, Norveç, İsviçre, Avusturya, Belçika ve Arjantin için çevrimiçi haritalar sağlar. | [Gelişmiş Profiller ve Haritalar](https://osmand.net/uploads/plugins/osmand.rendering.plugin/1/osmand.rendering.plugin-1.osf)  |
| 🇸🇦 Rahal Team tarafından Suudi Arabistan Çöl Haritaları  | Suudi Arabistan Krallığı'nın profesyonel bir çevrimdışı haritası; topografik özellikler, yollar, şehirler, köyler ve su kaynakları dahil. Çöl gezileri için mükemmel. Daha fazla bilgi için [Rahal Haritalar](https://rahalteam.com) adresini ziyaret edin. | [🇸🇦 Rahal Team tarafından Suudi Arabistan Çöl Haritaları](https://osmand.net/uploads/plugins/desert.saudi.plugin/1/desert.saudi.plugin-1.osf)  |
| 3D Konum Simgeleri  | Bu paket, profiller için bir 3D model seçeneği ekler (Kendi 3D simgesini OsmAnd'e eklemenin bir örneğidir). Görünümü menüden özelleştirin: [*OsmAnd menüsü → Ayarlar → Profil → Profil görünümü → Konum simgesinin 4-5. simgelerini seçin*](../personal/profiles.md#profile-appearance). | [3D Konum Simgeleri](https://osmand.net/uploads/plugins/model.plugin/1/model.plugin-1.osf)  |
| AnyGIS Çevrimiçi Haritalar Koleksiyonu | [AnyGIS web sayfası](https://anygis.ru/index_en) verilerinden. Uydu, turistik ve tarihi haritalar dahil olmak üzere çeşitli çevrimiçi harita kaynaklarının bir koleksiyonu.  | [AnyGIS Çevrimiçi Haritalar Koleksiyonu](https://osmand.net/uploads/plugins/ru.anygis.plugin/2/ru.anygis.plugin-2.osf)  |
| Çevrimdışı Harita Lejantı | Bu paket, *Menü → Yerlerim → Favoriler → Harita lejantı* aracılığıyla erişilebilen bir çevrimdışı harita lejantı (sürüm 1.01; 03-04-2024) ekler. Harita lejantı ayrıca [bu konumda](https://osmand.net/map/?pin=45.738777,36.493324#12/45.7340/36.5059) mevcuttur  | [Çevrimdışı Harita Lejantı](https://osmand.net/uploads/plugins/legend.plugin/1/legend.plugin-1.osf)  |
| 🇺🇸ABD Arazileri ve Patikaları | OsmAnd OBF formatına dönüştürülmüş özel ABD haritaları koleksiyonu, şu özellikleri içerir:<ul><li>[USGS Kamu arazileri ve korunan alanlar (PAD-US 3.0), eyalete göre](https://www.usgs.gov/programs/gap-analysis-project/science/pad-us-data-overview),</li><li>[USFS Patikaları ve Yolları, ülke çapında](https://www.fs.usda.gov/visit/maps),</li><li>[BLM Yolları ve Patikaları, ülke çapında](https://www.blm.gov/maps),</li><li>[BLM Rekreasyon Aktivite POI'leri, ülke çapında](https://www.blm.gov/maps),</li><li>[Bazı eyaletler için özel araziler (parsel verileri)](https://www.usgs.gov/core-science-systems/ngp/tnm-corps/authoritative-source-parcel-viewer)</li></ul>Daha fazla bilgi için [Reddit](https://www.reddit.com/r/OsmAnd/comments/19erp5z/padus_usgs_topo_usgs_national_map_arcgis_world/). | [🇺🇸ABD Arazileri ve Patikaları](https://osmand.net/uploads/plugins/us.maps/2/us.maps-2.osf)  |
...
| -- | -- | --|
| Gravel Roads Seeker | Yol yüzeyinin daha iyi görselleştirilmesini sağlayan harita stili; asfaltlanmış ve stabilize edilmemiş yollar arasında ayrım yapar (*Fransızca* web sayfası). | [Gravel Roads Seeker](https://sites.google.com/view/gravel-roads-seeker/planification-navigation/osmand) |
| OsmAnd Rendering GitHUB | Çevrimiçi haritalara, topografik haritalara, ortofotolara ve farklı ülkelerdeki bazı ana coğrafi kurumlardan elde edilebilen diğer coğrafi kaynaklara erişim koleksiyonu. Güncellemeler devam etmektedir, ancak herhangi bir dosya güncel değilse, kullanıcıların bildirmesi teşvik edilir. | [Online Maps: ARG, AT, BE, CH, ES, FR, NO](https://github.com/OsmAnd-Rendering/Online-Maps) |
...
| Highlighted Admin Boundaries | Harita oluşturma stili, daha iyi görünürlük için daha fazla vurgulanmış Yönetim Sınırları ile OsmAnd varsayılanına dayanmaktadır. |[Highlighted Admin Boundaries](https://github.com/Max1234-Ita/GuidaOsmand/blob/main/risorse/rendering/en_highlighted_boundaries.md)|
...
| OsmAnd Rendering GitHUB | Topo, ortofoto ve diğerlerini içeren çevrimiçi haritaların bir koleksiyonu, farklı ülkelerin bazı ana coğrafi enstitülerinden temin edilebilir. | [OsmAnd Rendering GitHub](https://osmand-rendering.github.io/Online-Maps/index_EN.html) |
