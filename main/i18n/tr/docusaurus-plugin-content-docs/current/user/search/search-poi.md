...
- *Özellik Filtreleri* - Bir kategori seçtikten sonra, uygulama aramayı iyileştirmek için kullanılabilecek ek özellikleri gösterir. Örneğin, Restoranlar kategorisi için mutfak türü (İtalyan, Çin vb.), fiyat aralığı, derecelendirme ve park yeri mevcudiyeti gibi filtreleri seçebilirsiniz.
...
![POI Ara Android](@site/static/img/search/search_poi_filter_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![POI Ara iOS](@site/static/img/search/search_poi_filter_ios.png)
...
![POI Ara Android](@site/static/img/search/search_poi_rearrange_andr.png)

</TabItem>

<TabItem value="ios" label="iOS">

![POI Ara iOS](@site/static/img/search/search_poi_rearrange_ios.png)

</TabItem>

</Tabs>

Kategorileri Yeniden Düzenle özelliği, yalnızca ihtiyacınız olan kategorileri listelemenize ve bunları kullanmak için en rahat ettiğiniz sıraya göre düzenlemenize olanak tanır.
...
1. **Konuma göre arama** - Bir şehir, cadde, mahalle veya başka bir konumun adını girebilirsiniz ve OsmAnd sorguya uyan sonuçları sağlayacaktır.
2. **Coğrafi kodlama** - Çevrimiçi arama, metin sorgularınızı coğrafi koordinatlara dönüştürerek hassas konumlandırma sağlar.
3. **Ters coğrafi kodlama** - Coğrafi koordinatları girebilirsiniz ve Arama, karşılık gelen konumu bir şehir adı, cadde adı veya haritadaki yer olarak döndürecektir.
...
- `amenity=place_of_worship` etiketine dayalı dini POI'ler, kiliseler, camiler veya sinagoglar gibi dine özgü konumlara ayrılmıştır.
