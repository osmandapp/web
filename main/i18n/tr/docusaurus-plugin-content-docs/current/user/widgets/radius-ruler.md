...
- **Cetvel** aracı, metre veya fit gibi birimlerde dinamik bir harita ölçeği göstererek ekrandaki nesneler arasındaki mesafeleri görsel olarak değerlendirmenize yardımcı olur.
...
- **Dokunarak Mesafe** aracı, haritaya dokunarak mesafeleri ölçmenizi sağlar — ister bulunduğunuz konumdan ister herhangi iki konum arasında.
...
**Cetvel**, ekranın altında, gerçek dünya uzunluğu (örn. 100 m veya 500 ft) ile etiketlenmiş bir çizgi parçası olarak mevcut harita ölçeğini gösterir. Özellikleri:

- Ölçek, yakınlaştırma veya uzaklaştırma sırasında dinamik olarak uyum sağlar.
- Haritadaki nesneler arasındaki gerçek dünya mesafelerini tahmin etmek için görsel bir referans sağlar.
- Sezgisel kullanım için segment uzunluğu uygun birimlere (örn. 100 m) yuvarlanır ve kabaca bir başparmağın genişliğine eşittir.
...
[Yarıçap Cetveli Pencere Öğesi](../widgets/info-widgets.md#radius-ruler), mevcut konumunuz (*Konumum*) ile haritanın merkezi arasındaki mesafeyi gösterir. Ayrıca herhangi bir özel merkez noktası ayarlamak için haritayı taşıyabilirsiniz. Özellikleri:
...
İlgi çekici noktalara yakınlığı tahmin etmek veya tanımlanmış bir alan etrafında plan yapmak için bu pencere öğesini kullanın.
...
**Yarıçap Cetveli** etkin olduğunda, harita uzayda kendinizi yönlendirmenize yardımcı olmak için bir pusula katmanı gösterir. Katman, haritanın gerçek Kuzey'e göre nasıl hizalandığını gösterir ve cihazın mevcut yönünü gösteren mavi bir üçgen içerebilir.
...
- **Mavi üçgen** ve **kırmızı ok** (Kuzey) her ikisi de yukarıyı gösteriyorsa, cihaz gerçek Kuzey'e hizalanmıştır.
...
Şuraya gidin: *<Translate ios="true" ids="shared_string_menu,layer_map_appearance"/>* *→ Diğer → Ekranda konum konumu*
...
Konumunuzun etrafındaki görünür yarıçapı artırmak için, *Merkez* veya *Alt* seçeneğini belirleyerek Yarıçap Cetveli'nin konumunu değiştirebilirsiniz.
...
![Yarıçap cetveli 3D biçimi](@site/static/img/widgets/radius_ruler_2_5D_android.png)

</TabItem>

<TabItem value="ios" label="iOS">

![Yarıçap cetveli 3D biçimi](@site/static/img/widgets/radius_ruler_2_5D_ios.png)
...
Yarıçap daireleri derinlikle görünecek, bu da özellikle engebeli alanlarda veya dikey bağlamın önemli olduğu kentsel ortamlarda rota planlaması için kullanışlıdır.


## Dokunarak Mesafe {#distance-by-tap}

![Haritadaki iki rastgele nokta arasındaki mesafe](@site/static/img/widgets/distance_between_two_random_points.png)
...
- **Konumunuzdan bir noktaya olan mesafe**
  Haritada herhangi bir yere dokunun ve mevcut konumunuzdan dokunulan noktaya düz bir çizgi ve bir mesafe etiketi görünecektir. Başka bir yere dokunsanız bile çizgi ekranda kalır.

- **Herhangi iki nokta arasındaki mesafe**
  Haritada aynı anda iki noktaya dokunun (çoklu dokunuş). İki noktayı bir çizgi bağlar ve ölçülen mesafe görüntülenir.
