...
- **<Translate android="true" ids="shared_string_details"/>** — Klasörde bulunan parkurların tam listesini görüntüleyin.
- **<Translate android="true" ids="show_all_tracks_on_the_map"/>** — Tüm klasör parkurlarını haritada görüntüleyin.  
    *NOT: Çok sayıda parkur yüklemek performansı etkileyebilir.*
- **<Translate android="true" ids="shared_string_rename"/>** — Daha kolay tanımlama için klasör adını değiştirin.
- **<Translate android="true" ids="shared_string_refresh"/>** — En son parkurları içerdiğinden emin olmak için klasörün içeriğini manuel olarak güncelleyin.
- **<Translate android="true" ids="edit_filter"/>** — Geçerli Akıllı Klasör için parkur filtre ayarlarını değiştirin. Ayrıntılar için [Arama Filtresi](#search-filter) bölümüne bakın.
- **<Translate android="true" ids="shared_string_export"/>** — Akıllı Klasördeki tüm parkurları [İçe/Dışa Aktar](../../personal/import-export.md) özelliği aracılığıyla dışa aktarın. *Menü → Ayarlar → Eylemler sekmesine* yönlendirileceksiniz.
- **<Translate android="true" ids="delete_folder"/>** — Parkurlarını silmeden Akıllı Klasörü kaldırın.  
...
- **<Translate ios="true" ids="shared_string_rename"/>** — Daha kolay tanımlama için klasör adını değiştirin.
- **<Translate ios="true" ids="shared_string_export"/>** — Akıllı Klasördeki tüm parkurları [İçe/Dışa Aktar](../../personal/import-export.md) özelliği aracılığıyla dışa aktarın. *Menü → Ayarlar → Eylemler sekmesine* yönlendirileceksiniz.
- **<Translate ios="true" ids="shared_string_move"/>** — Klasörü başka bir mevcut klasöre taşımanıza veya yeni bir klasör oluşturmanıza olanak tanır.
- **<Translate ios="true" ids="shared_string_delete"/>** — Parkurlarını silmeden Akıllı Klasörü kaldırın.  
    *UYARI: Bu eylem geri alınamaz ve bir onay mesajı isteyecektir.*
