...
- Kişisel verilerinizle birlikte yedeklenir.
...
1. *Menü → Yerlerim → İzler* aracılığıyla bir koleksiyon oluşturun veya izleri bir koleksiyona atayın.
2. *Menü → Ayarlar → OsmAnd Cloud → Verileri yedekle* bölümüne gidin ve senkronizasyonu etkinleştirin.
3. Başka bir cihazda, aynı OsmAnd Cloud hesabıyla oturum açın ve verileri geri yükleyin.
-->
