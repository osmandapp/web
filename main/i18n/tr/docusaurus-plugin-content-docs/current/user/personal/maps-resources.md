...
Standart haritalar için bazı öğeler bölgeye göre gruplanmış olabilir. Bu tür durumlarda, her harita girişi alt bölgeyi ve ana bölgeyi görüntüler. Bu isimlerin sırası seçilen sıralama yöntemine bağlıdır: ada göre sıralandığında alt bölge önce gösterilir, ardından bölge; ülkeye göre sıralandığında bölge önce gösterilir, ardından alt bölge.
...
![Haritalar menüsü OsmAnd canlı  iOS](@site/static/img/personal/maps/maps_menu_live_updates_ios.png) ![Haritalar menüsü OsmAnd canlı düzenle iOS](@site/static/img/personal/maps/maps_menu_live_updates_edit_ios.png)
