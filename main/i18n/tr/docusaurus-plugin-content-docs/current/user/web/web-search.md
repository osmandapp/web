...
- **★ Düğmesi (*Favorilere Ekle*)**. Seçilen İÇN'yi [favori](../web/web-favorites.md#add--edit-favorite) olarak kaydetmenizi sağlar.  
...
Haritada veya sonuçlar listesinde seçilen İÇN'ye tıklamak **İÇN Bağlam Menüsünü** açar. Bu menü aşağıdaki verileri ve bağlantıları sağlar:
...
Arama menüsündeki **Keşfet** bölümü, yerleri bulmayı ve ilgi çekici noktaları (İÇN'ler) fotoğraflarıyla ([Wikidata kaynağı](https://www.wikidata.org/)) doğrudan harita üzerinde görüntülemeyi kolaylaştırır.
...
3. Keşfet bölümünde **"Tümünü Göster"**'i seçerek üstteki ***Filtre*** düğmesiyle tam kategoriler listesini açın.  
