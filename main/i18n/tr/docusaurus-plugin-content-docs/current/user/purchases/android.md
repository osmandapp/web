...
<!--
### Abonelik Türleri {#types-of-subscriptions}
...
*Acele edin! Bu teklif sadece* **6 Ağustos (23:00 CET)** *tarihine kadar geçerlidir*.
...
| [Sınırsız harita indirme](../start-with/download-maps.md) | <details><summary>**7 harita indirme**</summary> - Harita indirme veya güncelleme, yalnızca bir ülke (bölge) haritasının indirilmesi-güncellenmesi anlamına gelir. <br/> - **Dünya genel bakış haritası**, **Dünya yükseklik düzeltmesi**, **Harita yazı tipleri** ve **Sesli komutlar** 7 indirme imkanı olarak sayılmaz. </details> | ✔ | ✔ |
| [Aylık harita güncellemeleri](../personal/maps-resources.md#update-maps)<br/>Ayda bir kez (2 gün gecikmeyle) | <details><summary>**7 harita indirme**</summary> Harita güncellemesi indirme olarak sayılır.</details> | ✔ | ✔ |
...
- Satın almaların süresi dolduktan sonra verilerinizi geri yükleyin.
- Satın almaları Android'den iOS'a veya tam tersi yönde aktarın
- Android ve iOS için tek satın alma (hesap)
-->
