...
- Amazon artık mevcut değil. Ayrıntılı bilgiye [buradan](https://osmand.net/docs/user/troubleshooting/purchases_payments#amazon-store-is-closing--what-to-do) ulaşabilirsiniz.
...
| ![Maps+](@site/static/img/svg/osmand_maps_plus.svg) **Maps+** | Ücretsiz OsmAnd uygulaması için, OsmAnd+ ile aynı özellikleri açan **uygulama içi satın alma** veya **abonelik**. | [Google Play](https://play.google.com/store/apps/details?id=net.osmand) ve [Huawei AppGallery'de](https://appgallery.huawei.com/#/app/C101486545) mevcuttur. | OsmAnd+ ile özellikler ve fiyatlandırma açısından aynıdır. |
| ![Pro](@site/static/img/svg/pro_icon.svg) **OsmAnd Pro** | Ek gelişmiş ve [pro özellikleri](#pro-features) açan **bir abonelik planı**. | [Google Play](https://play.google.com/store/apps/dev?id=8483587772816822023) ve [Huawei AppGallery'de](https://appgallery.huawei.com/#/app/C101486545) mevcuttur. | OsmAnd Cloud özelliklerine tam erişim sağlar. |

### Önemli Notlar {#important-notes}

1. **OsmAnd+** ve **Maps+** aynı özellikleri sunar. Tek fark, OsmAnd+'ın **ayrı bir ücretli uygulama** olması, Maps+'ın ise **abonelik veya uygulama içi satın alma** olmasıdır.
...
Listede, ABD ve Avrupa bölgesi için OsmAnd ürününün fiyatları hakkında bilgi bulunmaktadır. Diğer bölgeler için fiyatlar yerel para birimlerinde eşdeğerdir.
...
| [GPX izlerini dışa aktar](../personal/tracks/manage-tracks.md) | ✔ | ✔ | ✔ |
...
[Ücretsiz](../personal/maps-resources.md#free-for-osm-mappers). Canlı güncellemeler ve sınırsız harita indirme OSM Haritacıları için mevcuttur.

#### *** Android Auto {#-android-auto}

[Android Auto](https://www.android.com/auto/) özelliği yalnızca [Google Play'deki](https://play.google.com/store/apps/dev?id=8483587772816822023) OsmAnd uygulamaları için çalışır.
...
- Market uygulamasını güncelleyin (Google Play, Huawei AppGallery).
...
**Uygulama içi satın alımınızı veya aboneliğinizi ([Maps+, Pro, Canlı güncellemeler](#difference-between-purchases-android)) geri yüklemek için.**

- *Market uygulamasını güncelleyin* (Google Play, Huawei AppGallery).
- OsmAnd satın alımınızın olduğu Market'e (Google Play, Huawei AppGallery) **aynı hesapla** *giriş yapın*.
- Aktif bir İnternet bağlantısıyla *OsmAnd'ı açın*.
- *Satın almaları geri yüklemek için* şu adımları izleyin: *<Translate android="true" ids="shared_string_menu,shared_string_settings,purchases,restore_purchases"/>* ve ekranın üst kısmında Maps+(Pro) etkinleştirildi yazısı görünmelidir.
- Tüm platformlar (Android ve iOS) için OsmAnd Pro aboneliği ile *Pro özelliklerini kaydedin*. OsmAnd Pro hesabınız varsa, cihazınız için [OsmAnd Pro'yu etkinleştirmek için](../personal/osmand-cloud.md) kullanmanız gerekir.
...
[Google Play hediye kartı satın alma hakkında ayrıntılı rehber](https://support.google.com/googleplay/answer/3422734?hl=en).

OsmAnd'ı, kredi kartı bilgilerini çevrimiçi paylaşmaya güvenli bir alternatif sunan Google Play hediye kartlarını kullanarak satın alabilirsiniz. Seçtiğiniz bir perakendeciden bir hediye kartı satın alın ve kodu Google Play'de kullanın.