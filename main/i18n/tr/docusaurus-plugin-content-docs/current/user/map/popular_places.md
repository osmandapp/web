...
- **Ücretsiz sürüm**  
  ...
  *<Translate android="true" ids="android_button_seq"/> only*. Şuraya gidin: *<Translate android="true" ids="map_widget_search,shared_string_explore,popular_places_nearby"/>*
...
- **Ücretli sürümler** *(Maps+ ve OsmAnd Pro)*  
  ...
  *<Translate android="true" ids="android_button_seq"/> & IOS*. Şuraya gidin: *<Translate android="true" ids="shared_string_menu,configure_map,poi_osmwiki"/>*  
...
Şuraya gidin: *<Translate android="true" ids="shared_string_menu,configure_map,poi_osmwiki"/>*
...
Şuraya gidin: *<Translate ios="true" ids="shared_string_menu,configure_map"/> → Popular places (Wikipedia)*
...
**Galeri Menüsü**, seçilen ilgi çekici noktayla ilgili **100 adede kadar görüntü** görüntüleyebilir. Bu görüntüleri görüntülemek için **Tümünü Göster** (Android) / **Tümünü Görüntüle** (iOS) düğmesine dokunun. Mevcut tüm fotoğraflar arasında gezinebilirsiniz. Bir fotoğrafa kısa dokunmak, *Açıklama (Android'de en fazla iki satır)*, *Ad*, *Eklenme tarihi*, *Yazar*, *Lisans* gösteren ayrıntılı bir görünüm açar.
...
- **Ayrıntılar**  
  Görüntü hakkında meta verileri gösteren ayrıntılı bir görünüm açın: *Açıklama (Android'de tam metin)*, *Ad*, *Eklenme tarihi*, *Yazar*, *Lisans*, *Kaynak* ve *Doğrudan bağlantı*

  **Not:** Açıklama dili, uygulamanın görüntüleme diline bağlıdır. Seçili dilde açıklama mevcut değilse, OsmAnd İngilizce sürümü veya ilk mevcut çeviriyi gösterir.
