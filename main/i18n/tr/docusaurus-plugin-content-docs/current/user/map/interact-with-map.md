...
Bu makale, çeşitli düğmeler ve hareketler kullanarak haritayı nasıl özelleştireceğinizi ve haritayla nasıl etkileşim kuracağınızı açıklar. Haritayı döndürme, yakınlaştırma, görüş açısını ayarlama ve haritanın görüş açısını değiştirme, pusulayı kullanarak manuel veya otomatik olarak döndürme veya yönüne göre döndürme konularını kapsar.


## Hareketler {#gestures}

Hareketler, haritada kolay ve sezgisel gezinmek için gereklidir.

| Harita Eylemi | Hareket |
|:------------|:-------------|
| **Taşı** | Haritaya **tek** parmağınızla dokunun ve basılı tutun, ardından etrafta gezinmek için sürükleyin. |
| **Kaydır** | Haritayı **tek** parmağınızla kaydırın. |
| **Yakınlaştır** | Haritaya **tek** parmağınızla çift dokunun. <br/> **Tek** parmağınızla çift dokunun ve aşağı kaydırın. <br/> Yakınlaştırmak için **iki** parmağınızla sıkıştırın. |
| **Uzaklaştır**| **İki** parmağınızla çift dokunun. <br/> **Tek** parmağınızla çift dokunun ve yukarı kaydırın. <br/> Uzaklaştırmak için **iki** parmağınızla sıkıştırın. |
...
![Ekran menüsünü yapılandırın](@site/static/img/widgets/location_zoom_buttons.png)

**Konumum**.
*Konumum* düğmesi, haritanın merkezinin cihazınızın mevcut coğrafi konumuyla senkronize olup olmadığını gösteren dairesel bir simgedir. Genellikle "Neredeyim?" düğmesi olarak adlandırılır, harita üzerindeki konumunuzu hızlı bir şekilde bulmanıza yardımcı olur. Navigasyon sırasında, harita genellikle cihazın konumuyla senkronize kalır, bu nedenle düğme gizli kalır. Ancak, kullanıcı etkileşimi nedeniyle harita ve konumunuz senkronizasyondan çıkarsa görünür hale gelir. Düğmeye dokunmak, haritayı mevcut konumunuza yeniden ortalar ve çift dokunma görünümü 3D moduna geçirir.
...
- *Konumum* düğmesine **uzun dokunma** (*Android*) [harita bağlam menüsünü](../map/map-context-menu.md) açar ve konumunuzu paylaşmanıza olanak tanır.

<br/>

**Yakınlaştırma düğmeleri**.
*Yakınlaştırma düğmeleri* her zaman *Konumum*'un yanında görünür ve haritanın yakınlaştırma düzeyini kontrol etmenizi sağlar.

- Yakınlaştırma düzeyini değiştirmek, haritanın konumunuzla senkronizasyonunu etkilemez.
- *Yakınlaştırma düğmelerine* **uzun dokunma**, harita detay düzeylerini ayarlamanıza olanak tanıyan *Harita Büyüteci* iletişim kutusunu açar.
...
**Konumum** düğme simgelerini Profil görünüm ayarlarını kullanarak özelleştirebilirsiniz. Bunu nasıl yapacağınız hakkında daha fazla bilgi [burada](../personal/profiles.md#profile-appearance) bulabilirsiniz.


## Harita Büyüteci {#map-magnifier}

*Harita Büyüteci*, kağıt haritalarla kullanılan bir büyüteç gibi haritanın görünürlüğünü artıran bir araçtır. Metin ve detayları daha net görmek veya aynı ölçeği korurken detay düzeyini ayarlamak için haritayı yakınlaştırmanıza olanak tanır. Daha fazla bilgi için [Vektör Haritalar](../map/vector-maps.md#map-magnifier) makalesine gidin.
...
Şuraya gidin: *<Translate android="true" ids="shared_string_menu,shared_string_settings,shared_string_profiles,general_settings_2,shared_string_appearance,rotate_map_to"/>*
...
Şuraya gidin: *<Translate ios="true" ids="shared_string_menu,shared_string_settings,shared_string_profiles,general_settings_2,shared_string_appearance,rotate_map_to"/>*
...
*Harita yönlendirme modları*, haritanın cihaz ekranında nasıl görüntüleneceğini seçmenize olanak tanır. OsmAnd, **Manuel Olarak Döndürülmüş**, **Hareket Yönü**, **Pusula Yönü** ve **Kuzey Yukarıda** gibi modlar sunar. Her modun etkinleştirilmesi, haritanın seçilen seçeneğe göre yönlendirilme şeklini değiştirir. Tam ayrıntılar için [Harita Düğmeleri](../widgets/map-buttons.md#compass) makalesine bakın.
...
Pusula düğmesi, [haritanın nasıl yönlendirildiğini](#map-orientation-modes) gösterir. Simgelerdeki *kırmızı ok* veya *Hareket yönü* modundaki okun yönü Kuzey'i gösterir. [Pusula düğmesindeki simge](../widgets/map-buttons.md#compass) mevcut harita yönlendirme modunu gösterir. Pusula düğmesi widget'ı üç [etkileşim seçeneği](../widgets/map-buttons.md#compass-tapping-behavior) sunar: *Tek Dokunuş* haritayı Kuzey'e döndürür, *Çift Dokunuş* tüm harita yönlendirme modları arasında geçiş yapar ve *Uzun Dokunuş* mod listesini açar.


## Haritayı Yöne Göre Döndür {#rotate-map-by-bearing}

**Yöne göre haritayı döndür** modunda ([Hareket yönü](../widgets/map-buttons.md#compass)), harita otomatik olarak hareket yönünüzle hizalanır, böylece önünüzdeki alan ekranın üstünde görüntülenir. Bu mod, harita merkezini hafifçe aşağı kaydırarak, ilerideki rotanın daha fazlasını göstererek navigasyonu geliştirir. Sabit duruyorsanız, harita sabit kalır.

Bu özelliği *Menü → Ayarlar → Profiller → Genel ayarlar → Görünüm → Harita yönlendirme* veya [Pusula düğmesine](../widgets/map-buttons.md#compass-tapping-behavior) çift dokunarak etkinleştirebilirsiniz. Yön hakkında daha fazla ayrıntı için [buraya](../widgets/nav-widgets.md#bearing-widget) bakın.
...
Yeni harita [oluşturma motoru](../personal/global-settings.md#map-rendering-engine) ile [kamera eğimini](../plugins/development.md#camera-tilt) 90 (eğimsiz) ila 10 derece arasında değiştirebilirsiniz. Yaklaşık olarak 20-22 dereceden daha az bir harita eğiminde (bu parametre yakınlaştırma düzeyine bağlıdır), hayali ufuk çizgisi görünür hale gelir. Gerçek olandan farklı olarak, program ufku her zaman düzdür.
...
Sis kullanımı gereklidir, çünkü haritadaki uzak nesnelerin gösterimi önemli hesaplama kaynakları gerektirir ve küçük görüş açılarında harita [bozulmaları](../plugins/development.md#comparison-with-a-satellite-imagery) nedeniyle her zaman haklı değildir. Bu nedenle OsmAnd haritasındaki görünür mesafe şu anda 35 karoyla sınırlıdır.

:::bilgi
Harita eğimi, iki parmakla ekrana uzun dokunup yukarı/aşağı hareket ettirilerek değiştirilebilir. Ayrıca ekranın sağ alt köşesindeki [Konumum](#my-location-and-zoom) simgesine dokunarak eğimi değiştirebilirsiniz (yalnızca 45 ve 90 derecelik konumlar mevcuttur).
...
Navigasyon sırasında kazara dokunmaları önlemek için **Dokunmatik Ekran Kilidi** özelliğini kullanın. Bu, bisiklet sürme veya yürüyüş gibi aktiviteler için özellikle yararlıdır, çünkü istenmeyen dokunuşlar rotanızı bozabilir.
...
- *Menü → Ekranı Yapılandır → Özel düğmeler*'e gidin.
- *+ → Eylem Ekle → Arayüz → Dokunmatik Ekran Kilidi*'ni seçin.
...
Harita etkileşimleri sırasında, hareketler ve düğmeler dahil olmak üzere tüm harita animasyonlarını devre dışı bırakabilirsiniz.
...
Şuraya gidin: *<Translate android="true" ids="shared_string_menu,shared_string_settings,shared_string_profiles,general_settings_2,other_menu_group,external_input_device"/>*
...
Şuraya gidin: *<Translate ios="true" ids="shared_string_menu,shared_string_settings,shared_string_profiles,general_settings_2,external_input_device"/>*
...
- Ana *Menü → Ayarlar →* *Profil → Genel ayarlar → Diğer → Harici giriş cihazları*'nı seçin ve *Etkinleştirildi*'ye geçin.

- Listeden OsmAnd tarafından desteklenen bir cihaz seçin:
...
- Her harici giriş cihazı türü için farklı bir **tanımlanmış eylem-tuş paketi** ataması vardır. Eylemlerin ve tuşların listesini görmek için *<Translate android="true" ids="key_assignments"/>*'a dokunun. Tuş tablosu aşağıda gösterilmiştir.
...
|**D**| *Klavye* | Değiştir - [Harita yönü](#map-orientation-modes) |
...
|**&#8593;**| *Klavye* | Taşı - Harita yukarı |
|**&#8595;**| *Klavye* | Taşı - Harita aşağı |
|**&#8592;**| *Klavye* | Taşı - Harita sola |
|**&#8594;**| *Klavye* | Taşı - Harita sağa |
...
| **Joystick tuşuna bas** <br/> (*eski Android*) | *Klavye* | Taşı - [Konumuma](#my-location-and-zoom) |
...
Harici bir giriş cihazı (klavye, joystick veya kontrolör gibi) için tuş atamak istiyorsanız, bir cihaz türü oluşturmanız gerekir: [Harici Giriş Cihazı](#external-input-devices) ayarına gidin, listeden **Tür**'ü seçin, &nbsp;"**＋**"&nbsp; düğmesine dokunun ve bir ad girin. Her türün aşağıdaki seçenekleri içeren bir menüsü vardır: ***Yeniden Adlandır, Çoğalt*** ve ***Kaldır***.
...
- Gerekli eylemi seçin, ardından ***Tuş ekle*** alanına dokunun ve cihazınızdaki düğmeye dokunarak eyleme atayın.
...
- Daha sonra, zaten oluşturulmuş eylemler için eylemleri ve tuş atamalarını değiştirebilir veya başkalarını ekleyebilirsiniz, sadece Tuş atamaları listesinden bir öğe seçin.
...
- Seçilen tür için ***tüm tuş atamalarını kaldırın***, ekranın sağ üst köşesindeki *Adı düzenle*'nin yanındaki düğmeye dokunarak.
