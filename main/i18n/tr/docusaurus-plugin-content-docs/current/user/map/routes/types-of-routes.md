...
Daha fazla bilgiyi [Harita Göstergesi](../../map-legend/osmand.md#cycling) makalesinde bulabilirsiniz.
...
- ***<Translate android="true" ids="mtb_scale"/>***.  Patikaları MTB ölçeğine göre gösterir. Daha fazla bilgi [Harita Göstergesi](../../map-legend/osmand.md#mtb) makalesindedir.  
![Map routes - MTB trails](@site/static/img/map/map-routes-mtb-trails.png)  

- ***<Translate android="true" ids="mtb_imba"/>***.  MTB patikalarını Uluslararası Dağ Bisikleti Derneği'ne göre gösterir, [MTB IMBA](https://www.imba.com/). Daha fazla bilgi [Harita göstergesi](../../map-legend/osmand.md#mtb) makalesindedir.  
...
**Kir Bisiklet Patikaları** özelliği, `dirtbike:scale` etiketine dayalı olarak haritada kir bisikletine özgü rotaları görüntülemenizi sağlar. Bu ölçek, zorluk seviyelerini gösteren renkli bir kaplama ile kir bisikleti için uygun patikaları vurgular ([Harita Göstergesi](../../map-legend/osmand.md#dirtbike-scale)).  
...
- Bu konumlar aşağıdaki **ayrıntılı öznitelikleri** içerir:
    ...
    - *Tırmanış kalitesi* (sağlam, gevşok, karışık).
