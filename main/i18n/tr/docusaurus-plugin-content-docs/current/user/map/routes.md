...
![Harita Rotalar bölümünü yapılandır](@site/static/img/map/configure_map_routes_android.png)
...
Haritada, [yürüyüş, bisiklet, seyahat ve daha fazlası](#type-of-routes) için rotaları seçebilirsiniz, bunlar uygun olduğunda [OSMC sembolleriyle](https://wiki.openstreetmap.org/wiki/Key:osmc:symbol) işaretlenir.
