...
Vektör haritalar, OsmAnd için varsayılan harita veri kaynağı olarak kullanılmak üzere tasarlanmıştır, bu nedenle **bunları cihazınıza indirmeniz gerekir**. Vektör haritalar, bisiklet, yürüyüş, araba veya kar motosikleti ile sürüş ve diğerleri gibi farklı etkinlikler için çok sayıda harita stilini destekler.
...
OsmAnd'ın standart harita oluşturma stili, detay ve sadeliği dengeler, bu da onu kentsel ve dış mekan keşifleri için ideal kılar. Haritaları daha net hale getirerek görsel dağınıklığı basitleştirirken, sokaklar, binalar ve ulaşım durakları gibi şehir özelliklerini detaylandırır.
...
Yüksek kontrastlı ve maksimum detaylı Touring stili. Varsayılan OsmAnd stilinin tüm seçeneklerini içerirken, özellikle yollar, patikalar ve diğer seyahat yolları olmak üzere mümkün olduğunca fazla detay gösterir. Bir *tur atlasında* yol tiplerinin net ayrımı. Gündüz, gece ve dış mekan kullanımı için uygundur.
...
- **LightRS stili**. Bu, nazik bir gece moduna sahip basit bir sürüş stilidir. Yolları zıt turuncu renkte vurgular, ikincil harita nesnelerini karartır ve kontur çizgileri gibi topografik özellikleri gösterir.
...
Bu, şamandıralar, deniz fenerleri, nehir rotaları, deniz yolları, işaretler, limanlar, denizcilik işaretleri ve derinlik konturlarını içeren bir denizcilik navigasyon stilidir. Daha fazla bilgiyi [Deniz Haritası Görünümü](../plugins/nautical-charts.md) makalesinde okuyun.
...
Kayak pistlerini ve pistlerin zorluğu ve asansör işaretleri gibi diğer detayları görebilirsiniz. Temel faydaları arasında pistlerin, asansörlerin ve diğer kayak özelliklerinin rahat gösterimi bulunur. Haritanın dikkat dağıtıcı ikincil nesneleri daha azdır. Daha fazla bilgiyi [Kayak Haritaları](../plugins/ski-maps.md) makalesinde okuyun.

### Topo {#topo}

![Topo harita stili](@site/static/img/map/map-style-topo.png)

Bu stil, doğada yürüyüş, kamp ve bisiklet sürmek için tasarlanmıştır. Zıt yollar ve doğal özellikler, farklı türde patikalar, genişletilmiş kontur çizgisi seçenekleri ve ek detaylar içerir. Dış mekanlarda okunabilir. *Yüzey Bütünlüğü* ayarı, yolun kalitesini ayırt etmenizi sağlar.
...
Çöller ve diğer seyrek nüfuslu bölgeler için tasarlanmış, daha detaylı harita bilgisi sunar.

### Offroad {#offroad}

![Offroad harita stili](@site/static/img/map/map-style-offroad.png)

Off-road navigasyon için tasarlanan bu stil, [Topo](#topo) harita düzenine dayanır ve uydu görüntüleriyle alt katman olarak iyi çalışır. Patikaları, izleri, bisiklet rotalarını ve diğer off-road yollarını vurgulamak için daha ince ana yollara sahiptir, bu da kırsal veya uzak bölgelerdeki asfaltsız rotaları keşfetmek için idealdir.

### Kar Motosikleti {#snowmobile}

![Kar motosikleti harita stili](@site/static/img/map/map-style-snowmobile.png)

Kar motosikleti navigasyonu için özel olarak tasarlanan bu stil, kar motosikleti dostu patikaları, yolları ve izleri vurgular. Karlı bölgelerdeki özel yolları vurgular, standart yolların bulunmadığı karla kaplı arazilerde net navigasyon sunar.
...
Basitleştirilmiş/geleneksel Çince, Japonca ve Korece haritalar için, cihazınızda gerekli yazı tipleri yoksa yanlış karakterler veya semboller (kareler gibi) görünebilir. Bu sorun, yerel adların işlenmesi sırasında ortaya çıkar ve OsmAnd aracılığıyla gerekli yazı tiplerini indirerek çözülebilir.
...
Git: *<Translate android="true" ids="shared_string_menu,configure_map,srtm_plugin_name"/>*

</TabItem>

<TabItem value="ios" label="iOS">

Git: *<Translate ios="true" ids="shared_string_menu,configure_map,srtm_plugin_name"/>*
...
Git: *<Translate android="true" ids="shared_string_menu,configure_map,srtm_plugin_name,nautical_depth"/>*
...
Git: *<Translate ios="true" ids="shared_string_menu,configure_map,srtm_plugin_name,nautical_depth"/>*
...
Deniz derinliği kontur çizgileri, eşit derinlikteki alanları temsil ederek su altı topografya değişikliklerini görselleştirmeye yardımcı olur. Bu özellik, tüm harita stillerinde ve modlarında mevcuttur ve Deniz haritası görünümü eklentisi etkin olsun veya olmasın ayarlanabilir.
...
Git: *<Translate android="true" ids="shared_string_menu,configure_map,show_borders_of_downloaded_maps"/>*
...
Git: *<Translate ios="true" ids="shared_string_menu,configure_map,show_borders_of_downloaded_maps"/>*
...
Bu özellik, indirilen haritaların sınırlarının görünürlüğünü, mevcut haritalar listesinden açıp kapatmanızı sağlar. Ana amacı, özellikle çok sayıda harita yüklüyse, indirilen haritaların ana hatlarını gizleyerek ana haritayı düzenlemeye yardımcı olmaktır.
...
Git: *Menü → Haritayı Yapılandır → Göster → Koordinat Izgarası*
...
**Koordinat Izgarası** özelliği, harita üzerine bir referans ızgarası yerleştirerek, farklı koordinat sistemlerine dayalı enlem ve boylam çizgilerini görselleştirmenizi sağlar. Bu özellik, hassas konum referansı ve coğrafi navigasyon için kullanışlıdır.

***1. Mevcut koordinat biçimleri:***

- **DD°MM′SS″** (Derece, Dakika, Saniye)
- **DD.DDDDD°** (Ondalık Derece - WGS84 varsayılan biçimi)
...
1. *UTM ızgara sınırlamaları:*
    ...
    - Bölgeler her 6° meridyenle ayrıldığından, aynı anda yalnızca bir UTM bölgesi görüntülenir.

2. *WGS84 ızgarası üç farklı modu destekler:* ondalık dereceler, dereceler+dakikalar ve dereceler+dakikalar+saniyeler.
...
**Varsayılan olarak, uygulama,** [Genel ayarlar](../personal/profiles.md#units--formats) **bölümünde seçilen koordinat biçimini kullanır.**


***3. Etiketlerin konumu:***
- Kenarlar
- Merkez
...
Git: *<Translate android="true" ids="shared_string_menu,configure_map,map_widget_map_rendering,map_mode"/>*
...
Git: *<Translate ios="true" ids="shared_string_menu,configure_map,map_widget_renderer,map_mode"/>*
...
Git: *<Translate android="true" ids="shared_string_menu,configure_map,map_widget_map_rendering,rendering_category_details"/>*
...
- **<Translate ios="true" ids="rendering_attr_moreDetailed_name"/>**. Düşük yakınlaştırmada harita üzerinde çokgenleri, patikaları, noktaları ve işaretleri gösterir. Bu, düşük büyütmede harita üzerinde daha fazla ayrıntı görebileceğiniz anlamına gelir. Cihazınızda oluşturmanın hızlı olmayabileceğini unutmayın.
...
- **<Translate ios="true" ids="rendering_attr_OSMMapperAssistant_name"/>**. Haritacılar için tasarlanan bu özellik, harita üzerindeki diğer kullanıcıların referanslarını, açıklamalarını ve yorumlarını gösterir.
...
- **<Translate android="true" ids="rendering_attr_natureReserves_name"/>**. [Doğa koruma alanı](https://wiki.openstreetmap.org/wiki/Tag:leisure%3Dnature_reserve) için yeşil tahta ve "NR" etiketleri gösterir. Yaban hayatı koruma bölgeleri için yeşil bir sınır ve "NR" etiketi ile korunan alanları vurgular.
...
Git: *<Translate android="true" ids="shared_string_menu,configure_map,rendering_category_routes"/>*

</TabItem>

<TabItem value="ios" label="iOS">

Git: *<Translate ios="true" ids="shared_string_menu,configure_map,rendering_category_routes"/>*
...
Git: *<Translate android="true" ids="shared_string_menu,configure_map,shared_string_show,icon_group_transport"/>*

</TabItem>

<TabItem value="ios" label="iOS">

Git: *<Translate ios="true" ids="shared_string_menu,configure_map,map_widget_renderer,rendering_category_transport"/>*
...
Git: *<Translate android="true" ids="shared_string_menu,configure_map,map_widget_map_rendering,shared_string_hide"/>*

</TabItem>

<TabItem value="ios" label="iOS">

Git: *<Translate ios="true" ids="shared_string_menu,configure_map,map_widget_renderer,rendering_category_hide"/>*

</TabItem>

</Tabs>

Harita görünürlüğünü artırmak için belirli nesneleri gizlemeniz gerekebilir. Örneğin, [Alt Katman/Üst Katman katmanıyla](../map/raster-maps.md#select-raster-maps) çevrimiçi uydu haritalarını kullanırken suyu gizleyebilirsiniz.

- **<Translate android="true" ids="rendering_attr_noAdminboundaries_name"/>**. Ülkeler içindeki bölgesel sınırları gizler, ancak eyalet sınırları görünürdür.
...
- **<Translate android="true" ids="rendering_attr_hideWaterPolygons_name"/>**. Suyun (denizler, göller, rezervuarlar vb.) tüm çokgenlerini gizler.
- **<Translate android="true" ids="rendering_attr_hideHouseNumbers_name"/>**. Haritadaki ev numaralarını gizler.
- **<Translate android="true" ids="rendering_attr_showProposed_name"/>**. Önerilen nesneleri gizler - inşaat için planlanan ancak yalnızca bir projesi olan nesneler (planlanan yollar, kavşaklar, binalar ve diğerleri).
- **<Translate android="true" ids="rendering_attr_hideIcons_name"/>**. Haritadaki POI simgelerini gizler. Ancak, bu POI'lerin etiketleri haritada hala görünecektir.
- **<Translate android="true" ids="rendering_attr_hidePOILabels_name"/>**. Haritadaki POI etiketlerini gizler. Ancak, POI simgeleri haritada hala görünecektir.
...
- **<Translate android="true" ids="rendering_attr_hideOverground_name"/>**. Tüm yer üstü nesnelerini gizler. Sadece tüneller, geçitler vb. gibi yeraltı nesnelerini görmek için özel.
...
Git: *<Translate android="true" ids="shared_string_menu,configure_map,map_widget_map_rendering,rendering_attr_roadStyle_name"/>*

</TabItem>

<TabItem value="ios" label="iOS">

Git: *<Translate ios="true" ids="shared_string_menu,configure_map,map_widget_renderer,rendering_attr_roadStyle_name"/>*

</TabItem>

</Tabs>

Yollar için özel ayarlar, burada renkleri yol atlasına uyacak şekilde değiştirebilir veya yollar için yüksek kontrastlı yollar veya kalın ana hatlar ekleyebilirsiniz.
...
Git: *<Translate android="true" ids="shared_string_menu,configure_map,map_widget_map_rendering,text_size"/>*

</TabItem>

<TabItem value="ios" label="iOS">

Git: *<Translate ios="true" ids="shared_string_menu,configure_map,map_widget_renderer,text_size"/>*
...
Bu ayarı ekrandaki "+" veya "-" düğmesine uzun basarak veya şu şekilde seçebilirsiniz:
...
Bu ayar, haritanın büyütmesini değiştirmeye yardımcı olur. Raster ve vektör haritalar için geçerlidir. Raster haritalar için bir büyütme efekti uygular, böylece metin etiketleri daha büyük veya daha küçük görünür. Vektör haritalar için, düşük bir değer ayarlarsanız harita daha az ayrıntılı görünür, harita gürültülü/yavaş görünecektir.
...
Haritadaki adlar OSM topluluğu tarafından istenen dile çevrilmemişse, [transliterasyonlu adları](https://en.wikipedia.org/wiki/Transliteration) kullanabilirsiniz: *<Translate android="true" ids="use_latin_name_if_missing"/>* (Android) veya *<Translate ios="true" ids="translit_names"/>* (iOS) anahtarı.

<Tabs groupId="operating-systems" queryString="current-os">

<TabItem value="android" label="Android">

Git: *<Translate android="true" ids="shared_string_menu,configure_map,map_widget_map_rendering,map_locale"/>*
...
Git: *<Translate ios="true" ids="shared_string_menu,configure_map,shared_string_language,map_locale"/>*
...
- **Yerel adları göster** (yerel ad farklıysa 2. etiket ekler)
...
- [İçe/Dışa Aktarma](../personal/import-export.md)
