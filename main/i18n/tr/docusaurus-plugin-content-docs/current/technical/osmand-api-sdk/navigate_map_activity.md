...
# Harita etkinliğinde gezinme {#navigate-map-activity}
Harita ve opengl oluşturma anahtarı vardır, mapView'da longClickListener'ı vardır, ilk dokunuştan sonra başlangıç noktası seçilir, ikinci dokunuştan sonra bitişi seçer ve rota hesaplamayı başlatır.
