...
**Digital footprint**: We rate IT footprint-capable data like your screen resolution or IP address as sensitive.
Global services aggregating such information can use it to assemble a digital footprint, track users,
