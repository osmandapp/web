...
export default function Render() {
    ...
    return LegendItem({itemsMap: {
        ...
        'Bus trap' : 'barrier/barrier_barrier_bus_trap',
        'Cattle grid' : 'barrier/barrier_barrier_cattle_grid',
