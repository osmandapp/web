...
| [Customize Route line](../navigation/guidance/map-during-navigation.md#route-line-appearance) | Changing the color and width of the route line during navigation. |
...
| [Altitude Widgets - Elevation: Map Center](../widgets/info-widgets.md#elevation-map-center) | Find out the elevation of the current map center above sea level.  |
| [Elevation correction (offline)](../map/tracks/track-context-menu.md#calculate-missing-elevation) | Calculates an altitude graph for your track ([Terrain map](../plugins/topography.md#how-to-download) required for chosen region). |
...
- **Amazon**: you can check it in the [Amazon App store](https://www.amazon.com/s?i=mobile-apps&rh=p_4%3AOsmAnd) open it → click on the Menu → App Store for Android → Your apps and subscriptions → review your order history.
