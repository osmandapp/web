...
| **Activity**  | The option allows you to pre-select an [activity type](../map/tracks/track-context-menu.md#track-activity-type) for a profile, which is then automatically applied to all recorded tracks. |
