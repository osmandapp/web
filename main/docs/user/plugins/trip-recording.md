...
:::info 
Tap the links to get more information about the [**Tracks context menu**](../map/tracks/track-context-menu.md#options), about the [**Appearence**](../map/tracks/appearance.md) of a track on the map, and about adding [**track points**](../map/tracks/track-context-menu.md#waypoints-folder) to the current track. To make necessary changes to the track, for example *Rename track*, use the [**Options**](https://osmand.net/docs/user/map/track-context-menu#options) tab of the Tracks Context menu.  
:::
