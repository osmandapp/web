...
1. How to restore the Topography (formerly Contour lines) plugin purchase - [check here](../troubleshooting/setup.md#how-to-restore-the-topography-formerly-contour-lines-plugin-purchase).
2. Contour Lines, Elevation data or 3D Relief are not displayed - [check here](../troubleshooting/setup.md#contour-lines-elevation-data-or-3d-relief-are-not-displayed)
