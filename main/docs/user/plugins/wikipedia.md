...
1. Purchase paid services if necessary.    
...
4. Display the Wikipedia POIs on the map for the required profile.  



### Purchase and enable plugin  

Depending on the mobile app you are using, whether the Android or iOS version, a [paid subscription](../purchases/index.md) may be required for the Wikipedia plug-in to be included among other plug-ins.
...
| Enable <Translate ios="true" ids="menu,plugins,product_title_wiki"/> |  
