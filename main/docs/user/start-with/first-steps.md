...
- **GPS** / **GSM Network**. Determine your location, follow you in a navigation mode, and record your trip (optional). This permission is asked when you click [my location button](../widgets/map-buttons.md#my-position-and-zoom) or when you [start navigation](../navigation/setup/route-navigation.md#start--stop-navigation).
