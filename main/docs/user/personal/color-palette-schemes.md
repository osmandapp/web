...
Palettes can also be created or edited directly in the app using the [Gradient Palette editor](../plugins/topography.md#modify-color-scheme) (*Android only*).
...
On Android, palettes can also be created or edited directly in the app using the [Gradient Palette editor](../map/tracks/appearance.md#gradient-palettes).
