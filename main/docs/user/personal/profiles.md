...
- **AIS vessel tracker** (Android only). This menu opens *[AIS vessel tracker plugin settings](../plugins/ais-vessel-tracker.md#plugin-settings)*. This plugin allows you to connect AIS tracker to OsmAnd.
