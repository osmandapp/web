...
The special OsmAnd Start plan provides a special opportunity to use the OsmAnd Cloud functionality absolutely free of charge to store and synchronize your Favorite, Settings, and OpenStreetMap (OSM) edits/notes.
