...
|-----------|------------------|
| *Internal app memory* | Only the OsmAnd application has access to its data, and none of the external applications / PCs have access. | 
| *Shared memory* | Multiple OsmAnd applications and multiple external applications can have access. |
| *External storage 1* | Only 1 OsmAnd application has access, as well as the Admin and USB applications. |
| *External storage N* | SDCard: Only 1 OsmAnd application has access, as well as the administrator and USB applications. |
