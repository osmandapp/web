...
- **Add Favorite** –  Allows you to create and save a [favorite](../web/web-favorites.md#favorites-actions) at any point on the map for easy access.
- **Directions from** –  Sets the selected point as the [starting location](../web/web-navigation.md#start-a-route) for navigation.
- **Directions to** – Sets the selected point as the [destination for navigation](../web/web-navigation.md#start-a-route).
