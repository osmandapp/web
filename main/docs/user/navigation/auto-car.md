...
Next turn widget displays distance and type about [next turn maneuvre](../widgets/nav-widgets.md#next-turn) and [street name](../widgets/nav-widgets.md#street-name).
