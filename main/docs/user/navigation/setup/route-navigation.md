...
1. Open the [*Navigation menu*](#navigation-menu):
    ...
    - You can also change the departure point from the [current position](../../map/interact-with-map.md#my-position-and-zoom) to the required one.
...
3. [Start](#start--stop-navigation) navigation or at first [simulate navigation](#simulated-navigation) (with this function you can test your route before actually traveling along it). [On iOS devices](https://support.apple.com/en-us/121430) in EU countries, OsmAnd can also be set as the default navigation app in system settings, allowing it to open automatically for navigation requests.
...
- **<Translate android="true" ids="shared_string_my_location"/>** – Set starting location (default: [*My Current location*](../../map/interact-with-map.md#my-position-and-zoom)).
