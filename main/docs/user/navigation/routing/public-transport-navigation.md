...
To start navigating around the city by public transport, use [the navigation button](../../widgets/map-buttons.md#navigation) on the map screen or select the navigation option in the *Main Menu*.  
