...
| *Allow ferries* | Enables routing via ferry routes. | Usually [ferry routes](https://wiki.openstreetmap.org/wiki/Tag:route%3Dferry) are inaccessible for small boats based on OSM definition. |
