...
Online server builds a route using your starting point and destination. After receiving the track from the server, OsmAnd creates a route using *[Attach to the roads](../setup/gpx-navigation.md#attach-to-the-roads)* feature. So all needed routing information will be taken from our offline maps, and more precise guidance along the route will be provided.  
