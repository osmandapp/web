...
import LegendItemWithSplit from '@site/src/components/docs/LegendItemWithSplit.jsx';
...
<LegendItemWithSplit svgPath={'/img/map-legend/osmand-highways'} 
        svgParts={{
        'highways': 'Highways',
        'motorway': 'Motorway',
        'trunk': 'Trunk',
...
<LegendItemWithSplit svgPath={'/img/map-legend/osmand-railways'}
        svgParts={{
        'rail': 'Rail',
        'bridge': 'Bridge',
        'tunnel': 'Tunnel',
...
<LegendItemWithSplit svgPath={'/img/map-legend/osmand-aerialways'}
        svgParts={{
        'cable_car': 'Cable car',
        'gondola': 'Gondola',
...
<LegendItemWithSplit svgPath={'/img/map-legend/osmand-routes'}
        svgParts={{
        'transport_bus': 'Bus',
...
<LegendItemWithSplit svgPath={'/img/map-legend/osmand-routes-dirtbike'}
        svgParts={{
        'g0': '0',
        'g1': '1',
        'g2': '2',
...
<LegendItemWithSplit svgPath={'/img/map-legend/osmand-via-ferrata'}
        svgParts={{
...
<LegendItemWithSplit svgPath={'/img/map-legend/osmand-path-difficulty'}
        svgParts={{
        'hiking': 'Hiking',
...
<LegendItemWithSplit svgPath={'/img/map-legend/osmand-surface-smoothness'}
        svgParts={{
        'asphalt': 'Asphalt',
...
<LegendItemWithSplit svgPath={'/img/map-legend/osmand-waterways'}
        svgParts={{
        'river': 'River',
        'canal': 'Canal',
        'stream': 'Stream',
...
<LegendItemWithSplit svgPath={'/img/map-legend/osmand-nature'}
        svgParts={{
        'water': 'Water',
