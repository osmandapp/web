...
Short tap a [GPX-track](../map/tracks-on-map/tracks-types.md) on the map  opens [Context track menu](../map/track-context-menu.md).
...
- The list displays the [tracks](../map/tracks-on-map/tracks-types.md#display-tracks-on-the-map) recorded and shown on the map, as well as the [current track recording](../plugins/trip-recording.md#from-widget), to which you can add the selected waypoint.
