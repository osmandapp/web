...
- [Activity tags for GPX tracks](../../plugins/trip-recording.md#recording-settings). Recorded tracks and tracks saved via [Plan a route](../../plan-route/create-route.md) automatically receive an activity type based on the profile used to create them. This helps categorize and filter them later. You can change the activity manually if needed.
