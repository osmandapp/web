...
- **Grid color:** available separately for Day/Night mode. Customizing grid color is a [paid feature](https://osmand.net/docs/user/purchases/android) available in Maps+ (in-app purchase or subscription) and OsmAnd+.
