...
The Compass button indicates the orientation of the map on your device screen. For additional information, refer to the [Interact with map](../map/interact-with-map.md#map-orientation-modes) article.
