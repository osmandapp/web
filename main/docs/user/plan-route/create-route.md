...
- Start editing the route using the [points list](#point-context-menu), start a [new segment](#start-new-segment) using the [Options menu](#menu-options) or [continue](#add-points) the route forward.  
