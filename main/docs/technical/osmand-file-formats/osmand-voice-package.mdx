...
Please checkout [resources project](https://github.com/osmandapp/OsmAnd-resources/) and use the same folder structure as [https://github.com/osmandapp/OsmAnd-resources/tree/master/voice/de](German package) - simply make copy. Once it's done you can change, run [generation script](https://github.com/osmandapp/OsmAnd-resources/blob/master/voice/gen_voice.sh#L4) and specify needed arguments. Help is inside the script.
