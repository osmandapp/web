...
For testing it's possible to use Navigation or Navigation simulation or handy version of [Development plugin](/docs/user/navigation/guidance/voice-navigation#testing-of-voice-prompts-android) which simulates different voice commands to be tested.
