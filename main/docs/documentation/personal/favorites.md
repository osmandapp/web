...
[Switch on/off favorites on the map](/docs/documentation/map/point-layers-on-map#favorites)  - 'Configure map' menu

[Switch on/off favorite names](/docs/documentation/map/point-layers-on-map#favorite--poi-names)  - 'Configure map' menu
...
Click to favorite point on "My Favorites" menu or on favorite point on the map opens [Map Context menu](/docs/documentation/map/map-context-menu#favorites--track-points-from-the-group). Where user can find needed information about point or [add/edit favorite point](/docs/documentation/map/map-context-menu#add--edit-favorite).

### Create

For creating new Favorite an user needs [to tap on the map](/docs/documentation/map/map-context-menu#select-any-point-long-tap) at the place where he wants to add Favorite. 

When an user clicks at chosen place appeares ['Map Context menu'](/docs/documentation/map/map-context-menu) with ['Action menu'](/docs/documentation/map/map-context-menu#add--edit-favorite). 

Click to [**Add**](/docs/documentation/map/map-context-menu#add--edit-favorite) for opening 'Add favorite' menu.
...
For editing a Favorite point an user need [to short tap](/docs/documentation/map/map-context-menu#select-an-object-short-tap) on chosen a Favorite point.

After that, you need to click ['Edit favorite' button on 'Map Context menu'](/docs/documentation/map/map-context-menu#add--edit-favorite). 

'Edit favorite' menu opens. It's look like ['Add favorite' menu](/docs/documentation/personal/favorites#create). But in Action part there is one more action - 'Delete' button. For Android, there is additional 'Delete' button in up corner of 'Edit favorite' menu. 
...
- Using [Search in 'My Favorites' menu (only for Android)](/docs/documentation/personal/favorites#search-android).
...
An order in the Favorites list for Favorites folders is by alfabet. [Personal folder](/docs/documentation/personal/favorites#special-favorites-personal) is the first of the list.
...
An order for [searching list (Android)](/docs/documentation/personal/favorites#search-android) is by distance from the map center on the device screen.
...
Click to any point from Favorite list opens [Map Context menu](/docs/documentation/map/map-context-menu#select-an-object-short-tap) for chosen point.
...
- &nbsp;<Translate android="true" ids="shared_string_add_to_map_markers"/>  or <Translate android="true" ids="remove_from_map_markers"/>   - add or remove all Favorite points from a folder in [Map markers list](/docs/documentation/personal/markers).
...
- '&#128681;' - allows to add or to remove chosen Favorites points (folders) in [Map markers](/docs/documentation/personal/markers) list.
...
You can add or remove your favorites in/from [Map markers list](/docs/documentation/personal/markers).
...
"Personal" folder is a special folder for '<Translate android="true" ids="favorite_home_category"/> ' and '<Translate android="true" ids="work_button"/> ' points of [Navigation Context menu](/docs/documentation/navigation). This folder doesn't have '&#8942;' button, because you can not change the parameters for this folder. 
