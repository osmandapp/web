...
**Proper solution**: use [Track settings](/docs/documentation/plugins/trip-recording) to filter "noisy" points based on your **experience** and **recording device**. You can filter out points by various criteria: 
