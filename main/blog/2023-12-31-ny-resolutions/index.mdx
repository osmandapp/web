...
* Alow to build screens full of widgets without map or with different map views
* Redesign Configure Map to allow easy set up on the go

### New Maps

Next year we would like to focus on different external map sources which could help a lot in different situations. With power of OpenStreetMap we can put almost any layer on top of it and it immediately adds value. Though for many of our users it's hard to find & configure these extra sources, so we want to provide some of the out of the box:

* **Weather** - New forecast data, New sources, New animations!
* **USA Government maps** (PAD-US) and other local authorities maps including private areas. Typically Government Data is not portable to OSM due to license issues though they are open and have lots of valuable information.
...
* A possibility to attach media from your library to favourites, trackes, waypoints.
...
* AI Assitant to help to cope with OsmAnd capabilities :)
