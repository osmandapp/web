...
* Build widget screens without or with different map views
...
* 3D Buildings
* 3D Track log and wind Maps
* Nautical maps

### Routing & Navigation

Last year we've made a huge commmitment to provide 
* Fast routing
* Main navigation widget
* Autozoom / Auto-tilt.
* Settings, Avoid road (AA / CarPlay)
...
**Web**/**Android**/**iOS**.
* Share favorites, tracks, settings and allow collaborative editing 
