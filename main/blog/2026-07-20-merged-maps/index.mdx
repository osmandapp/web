...
OsmAnd has discontinued "merged" maps — large country- or region-level files that were assembled from smaller regional maps. If you have [one of these installed](../2026-07-20-merged-maps/index#which-maps-are-affected), it will no longer receive updates.
:::
