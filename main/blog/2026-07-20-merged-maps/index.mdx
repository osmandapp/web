...
:::info[Discontinued "Merged" Maps]
OsmAnd has discontinued "merged" maps — large country- or region-level files that were assembled from smaller regional maps. If you have [one of these installed](https://osmand.net/blog/merged-maps#which-maps-are-affected), it will no longer receive updates.
:::
...
<details>
<summary><b>▶ Click to view Discontinued Detailed Maps (Argentina, Germany, USA, etc.)</b></summary>
...
<details>
<summary><b>▶ Click to view Discontinued Roads-Only Maps (UK, Ukraine, Netherlands, etc.)</b></summary>
...
- Check [*Maps & Resources → Updates*](../../docs/user/personal/maps-resources#updates-menu) a warning about your installed maps.
