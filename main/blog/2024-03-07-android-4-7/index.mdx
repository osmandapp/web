...
We're thrilled to announce the release of OsmAnd version 4.7 for Android devices, now available for download on Google Play and other app markets. This latest update brings a suite of new features and improvements designed to enhance your navigation experience.
...
- [Fast offline routing](#fast-offline-routing)
...
![3D tracks Android](./img/3D_track_android.png) ![Routes tags Android](./img/3D_track_1_android.png)
...
- The import process for GPX files now includes support for [for tags](https://github.com/osmandapp/OsmAnd/issues/18342) such as `author`, `cmt`, `link`, `keywords`, `copyright`, `email` , allowing for the display of this information in the Track Context menu.
