...
- [Route maneuvers widget combines turn arrow and navigation instructions](#route-guidance-widget)
...
- Improved searching OSM routes and choosing it for navigation
...
- [Android Auto improvements](#android-auto-improvements):
  ...
  - Show full destination name on route preview card.
...
## Route Maneuvers Widget

![Route Guidance Widget](../../blog/2025-03-11-android-5-0/img/route_guidance_widget.png)

The **Route Maneuvers widget** combines essential navigation details into a single, compact display, providing **real-time navigation instructions**, helping you stay on track throughout your journey. These widgets are **active during navigation**, ensuring you never miss a turn.  
...
Find them in:  
*Menu → Configure screen → **Top panel / Bottom panel** → Route maneuvers: Next turn, Second next turn, Lanes*
...
![Route Guidance Widget](./img/route_info_widget.png)
...
## Added full search for OSM Routes

For this release it's now possible to [search](https://osmand.net/docs/user/search/search-all#how-to-use) for all [OSM routes](https://osmand.net/docs/user/map/routes), including hiking, cycling, MTB, and more. This feature provides a comprehensive overview of available routes, helping you discover new paths and plan your adventures with ease.

Just go to Search menu and start find the route you need, or you can choose needed search [categories](https://osmand.net/docs/user/search/search-poi#poi-search-by-categories) - Hikinkg, Cycling, MTB, etc.:

_Search → Categories → Routes_

And use Filters to find the route you need. On Search menu you find info about the route, like distance to the nearest point of the route, route distance, name and icon route.

![Routes](./img/routes.png) ![Routes](./img/routes_1.png) 


Next, tap to the route you need and choose _"Navigate"_ button to start [GPX track navigation](https://osmand.net/docs/user/navigation/setup/gpx-navigation) or download it to your device like [GPX file](https://osmand.net/docs/user/map/tracks/#overview).

![Routes](./img/routes_2.png) ![Routes](./img/routes_3.png)
...
![AIS Vessel Tracking Plugin](../../blog/2025-03-11-android-5-0/img/ais.png)
...
Added enhancements for [**Android Auto**](https://osmand.net/docs/user/navigation/auto-car) users, including:
- [**View ETA and distance to next waypoint**](https://osmand.net/docs/user/navigation/auto-car#eta-next-stop) — Displays *estimated time of arrival* and *distance to the next waypoint* on the Android Auto screen.
- [**Show full destination name on route preview card**](https://osmand.net/docs/user/navigation/auto-car#start-navigation) — Provides a *complete destination name* for better route preview clarity.
