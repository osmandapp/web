...
- ["OsmAnd XV" Gift](https://osmand.net/pricing): We have prepared a special gift for our users, which even includes a limited series of branded T-shirts! Keep an eye out for announcements within the app.
- Free [Cross-Platform Purchases](https://osmand.net/docs/user/purchases/cross): We have finally enabled the ability to use your purchases across different platforms at no extra cost. Buy on iOS and use on Android, or vice versa.
<!--
