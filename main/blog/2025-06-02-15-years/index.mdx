...
- "OsmAnd XV" Gift: We have prepared a special gift for our users, which even includes a limited series of branded T-shirts! Keep an eye out for announcements within the app.
- Free Cross-Platform Purchases: We have finally enabled the ability to use your purchases across different platforms at no extra cost. Buy on iOS and use on Android, or vice versa.
