...
There are thousands official and nonofficial travel routes which symbols (marks) you can see in cities, forests and etc. All these routes are travel routes for your activities. Many of them exist in [OpenStreetMap](https://www.openstreetmap.org/) and you can see them online [here](https://waymarkedtrails.org/) for example.
