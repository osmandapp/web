...
Big Spoiler: OsmAnd Cloud backup for Favourites, OsmAnd Settings and OSM Notes going free. 
...
For this release we have added _OsmAnd Start_. Each user can register their own email for the [OsmAnd Cloud](https://osmand.net/docs/user/personal/osmand-cloud).


Now you can backup your favorites, OSM Edits, OSM Notes and your OsmAnd settings for free. Free OsmAnd Cloud account for Favorites: _OsmAnd Start_
...
[Contour lines](https://osmand.net/docs/user/plugins/contour-lines#contour-lines-map) work with any ["Map source"](https://osmand.net/docs/user/map/configure-map-menu):
