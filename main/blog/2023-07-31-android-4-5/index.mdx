...
Our updates:
- [Slope](https://osmand.net/docs/user/plugins/topography#slope-map) and [Hillshades](https://osmand.net/docs/user/plugins/topography#hillshade-map) can be generated from _Terrain map_ data
