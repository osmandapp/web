...
> **Experimental feature:** In OsmAnd 5.4, the new spatial search algorithm is available only when the [**OsmAnd Development plugin**](https://osmand.net/docs/user/plugins/development) is enabled. This allows us to collect feedback and continue improving the feature before enabling it by default in a future release.
