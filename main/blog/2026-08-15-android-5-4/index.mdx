...
OsmAnd 5.4 brings several improvements to [**Android Auto**](https://osmand.net/docs/user/navigation/auto-car), making the map, search, and navigation experience more convenient on the car display.
