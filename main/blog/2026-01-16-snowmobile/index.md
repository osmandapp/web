...
Choose a snowmobile icon fit for your vehicle, set a distinct profile color, and adjust navigation preferences such as speed display, routing types, or road avoidances. Whether you’re on a short local ride or a cross-country expedition, your settings will be ready the moment you switch profiles.
...
To explore these, simply switch to the Snowmobile map style in OsmAnd (_Menu → Configure map → Map style → Snowmobile_), download the US map region for offline use, and tap any trail for guidance.
