...
["Tilt"gesture](https://osmand.net/docs/user/map/interact-with-map/#gestures) makes 2.5D veiw.
...
*  Added [shops](https://wiki.openstreetmap.org/wiki/Key:shop): wool, motorcycle_parts , rice, water_sports, printer_ink, fuel, hairdresser_supply, tiles, collector. 
* Added: [landuse=greenery](https://wiki.openstreetmap.org/wiki/Tag:landuse%3Dgreenery), [natural=blowhole](https://wiki.openstreetmap.org/wiki/Tag:natural%3Dblowhole), [natural=anthill](https://wiki.openstreetmap.org/wiki/Tag:natural%3Danthill), [carriage=](https://wiki.openstreetmap.org/wiki/Key:carriage), [support "flow_rate" tag](https://wiki.openstreetmap.org/wiki/Key:flow_rate).
* Added [clubs](https://wiki.openstreetmap.org/wiki/Key:club): club_automobile, club_fishing, club_sailing, club_shooting, club_veterans. 
