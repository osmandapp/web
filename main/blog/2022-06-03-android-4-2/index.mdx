...
You can choose which Google Play or "Android API" service OsmAnd will use to determine your location. This can be useful for devices without Google Play services or in case of inaccurate location or altitude data when recording tracks. You can switch **<Translate android="true" id="location_source" />** in:  
