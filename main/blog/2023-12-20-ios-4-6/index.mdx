...
As we noted at [this article](#external-sensors) that external sensors were added. And now you can add [widgets of external sensors](https://osmand.net/docs/user/widgets/info-widgets/#external-sensors-widgets) to a device screen:
...
Additional info were added for Navigaton screen:
