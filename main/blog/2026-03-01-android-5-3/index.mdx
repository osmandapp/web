...
- Added support for creating and editing custom [gradient palettes](#gradient-palettes) for track coloring and terrain coloring;
...
The same gradient palette system has been added to [terrain coloring options](https://osmand.net/docs/user/personal/color-palette-schemes#terrain), allowing you to create custom color schemes for altitude and slope.

_Configure map → Terrain (Slope, Altitude) → Modify → + or All colors_
...
* [**Smart GPX Track Grouping**](https://osmand.net/docs/user/personal/tracks/smart-folder)
    Managing large collections of recordings is now much simpler. A new "Smart Folder" system has been introduced to automatically group tracks by day or month. These folders provide helpful summaries, including total distance, duration, average speed for each specific time period, and etc. 
