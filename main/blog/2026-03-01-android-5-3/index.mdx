...
- New experimental [Astronomy plugin](https://osmand.net/docs/user/plugins/astronomy) with an astronomical overlay that shows the paths of the Sun, planets and stars on the map, with time and date selection and a dedicated activity screen.
