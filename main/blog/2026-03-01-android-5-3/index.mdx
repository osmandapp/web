...
- [Others improvements and optimizations](#improvements), including enhanced search visibility with city and street names, multi-selection support for Favorites, and smart GPX track grouping; as well as refined waypoint navigation, new activity profiles, and a more streamlined plugin concept;
- [Bug fixes](#bug-fixes).
