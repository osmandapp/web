...
* [Bonus: Custom map types](#custom-map-type)
...
Then select [_Follow track_](https://osmand.net/docs/user/navigation/setup/gpx-navigation#how-to-follow-the-track) and click _Reverse track direction_.
