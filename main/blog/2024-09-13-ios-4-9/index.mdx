...
- Fixed a problem with automatic language detection of voice prompts. 
- Fixed a crash in boat profile route parameters.


## Engage with OsmAnd: Share, Suggest, and Connect

If you have any suggestions for improving the app on the iOS platform, please contact us. We appreciate and welcome your contributions to the further development of OsmAnd.
