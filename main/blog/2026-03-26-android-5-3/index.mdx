...
Tracks colored by Speed, Altitude, or Slope now support these customizable [gradient palettes](https://osmand.net/docs/user/map/tracks/appearance#gradient-palettes). You can create **Relative palettes** (auto-scaled to your specific track data) or **Fixed value palettes** (based on absolute numbers), define custom color steps, and even set a unique color for missing data points.
