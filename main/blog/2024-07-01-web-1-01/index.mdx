...
- [Default System Language](#system-language) (in development).
...
- Enhanced [Map Search Options](#explore-map-menu), including:
  ...
  - New [Photo Gallery for POIs](#photo-gallery), showing detailed images.
<!--- Display of [Wikimedia images](#wikimedia-images) on the map (in testing).-->
- Added ability to provide [URLs for specific web sections](#more-urls).
- Updated Favorites Icons (expected in version 4.8).
- New banner with information about the OsmAnd mobile app (coming in version 4.8).
- Fixed several bugs:
...
If you'd like to manually configure the interface (system) language:

- Go to *Menu →* ⚙ *→ Turn off language* auto-detection to choose your preferred language.
...
- **Show weather** – Get up-to-date weather information for the selected area.
...
Our **Explore Map** feature has received a significant upgrade, making it easier to search for places and view points of interest (POIs) with their photos directly on the map.  

To get started:

1. Click the 🔍  icon to open the search tab, which displays popular POI categories. 
2. Select any POI to open its context menu for more detailed information.

![Explore menu](./img/explore.png)

To refine your search by categories, open the Categories Menu and choose the items you are interested in.
...
- **Banner for OsmAnd mobile**. A new [banner](https://github.com/osmandapp/OsmAnd/issues/18825) provides information about the OsmAnd mobile app, including a direct download link (coming in version 4.8).
