...
<iframe src="/astronomy_quiz_new.html" width="100%" height="650px" style={{border: 'none', borderRadius: '20px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)', margin: '20px 0'}}></iframe>
