...
Version 4.6 of the OsmAnd program for Android devices has undergone changes. Go and read what has been added and improved.  
...
- [Updates for Widgets](#widgets-update):
   ...
   - Added [Glide Ratio](#glide-ratio-widget) wwidget.
