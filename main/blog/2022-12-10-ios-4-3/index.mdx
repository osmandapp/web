...
In this release, we added new subscription plans named _"OsmAnd Pro"_ and _"OsmAnd Maps+"_. OsmAnd Pro is a new subscription plan with access to all features, and "Maps+" - with unlimited map downloads and access to paid plugins.

OsmAnd Pro is a cross-platform subscription (you can use it for both Android and iOS versions of OsmAnd after registration on our servers).
...
Weather toolbar: _Menu → Configure screen → Weather toolbar_. Quick weather menu on a device screen.
...
- "Expires" - a list of inactive purchases.
