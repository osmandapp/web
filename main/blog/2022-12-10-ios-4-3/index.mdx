...
For this release we added new subscription plans - Pro and Maps+. OsmAnd Pro is a new subscription plan with access to all features and "Maps+" purchase with unlimited map downloads and paid plugins access.
...
New features for OsmAnd Pro subscribes. Cross-platform.
...
Weather plugin: _Menu → Plugins → Weather_

Download the weather forecast in the _Download maps_ menu for offline use.
...
Tracks can now [be colored by](https://osmand.net/docs/user/map/tracks-on-map#track-appearance) altitude, speed, or slope.
...
Now, you can see OsmAnd maps files in _Files → On my iPhone → OsmAnd Maps_.
