...
![Route Details](./img/widget_navigation.png) 

As our continous effort restructuring widgets and redesigning navigation experience, we plan to add new widgets specific to navigation.

### Configure Map with Map legend
 
![Map legend](./img/configure_map_legend.png) 
...
![Wear os](./img/wearos_navigation.png)

Each year we introduce external device connectivity, 2023 it was external sensor connectivity, 2024 it was OBD-II protocol and 
in 2025 we plan to add Smartwatch connectivity.

We plan to support browse and recording tracks and simple navigation instruction display.
 
### 3D Buildings

We also plan to add 3D buildings support to the map.


### Share Favorites / GPX / Location

We plan to add possibility share files between users.


### Many other features

This list is not complete and we plan lots of other features like

- Advance with our web version to make it feature complete - https://osmand.net/map
- Display weather information along the route
- Autosync with cloud 
- Alternative routes
- Improved plan route functionality
- Adding new widgets 
