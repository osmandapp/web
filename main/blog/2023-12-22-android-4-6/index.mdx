...
- Renamed the *Terrain* menu to [*Topography*](https://osmand.net/docs/user/plugins/topography#configure-map-view) for better understanding and matching terminology.
