...
Color palettes data is available in the [_Maps & Resources_](https://osmand.net/docs/user/personal/maps#local) menu.
...
In this release, we have added the ability to switch between [terrain](https://osmand.net/docs/user/plugins/contour-lines#terrain) color palettes, similar to switching between layers. This can be done using the Quick Actions tool.  
