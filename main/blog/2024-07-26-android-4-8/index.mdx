...
A new 3D view has been added for [My Location](https://osmand.net/docs/user/map/tracks/appearance#3d-track) icons, which improves their visualization on the map. These changes bring the appearance of the icons in alignment with the 3D tilt of the map. 
