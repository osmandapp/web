...
For a deeper dive into all the settings and technical details, feel free to explore the [3D Buildings documentation](https://osmand.net/docs/user/plugins/topography#3d-buildings). Once you are ready, take this quick interactive quiz to see how well you can navigate urban 3D environments!
