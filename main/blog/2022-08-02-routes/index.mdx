...
Clicking on POI opens [Track Context menu](@site/docs/user/map/track-context-menu.md) of travel routes  like it is done for [Routes](/blog/routes#choosing-routes-in-osmand). You can download GPX file of chosen Travel route, and view all route info:
