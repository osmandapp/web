...
To configure it, [follow these steps](@site/docs/user/map/vector-maps#routes): 
...
[Hiking / Cycling / Travel routes](@site/docs/user/map/vector-maps#routes) are clickable. Just tap **the route symbol**, get full route information and download the GPX file for the selected route. (Routes are marked on the map with [OSMC symbols](https://wiki.openstreetmap.org/wiki/Key:osmc:symbol).)
...
Choosing the route opens [Track Context menu](@site/docs/user/map/track-context-menu):
