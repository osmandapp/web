...
* The [App language](#app-language-for-android-13) on Android 13,
...
Added localized POI names for [Map context menu](https://osmand.net/docs/user/map/map-context-menu.md#alternative-names). Click on the POI name to open the full name list.
...
Added new fixed mode for [Map orientation](https://osmand.net/docs/user/map/interact-with-map.md#map-orientation-modes):
...
Added the new settings for [_"Display position"_](https://osmand.net/docs/user/map/interact-with-map.md#map-orientation--compass):

_Menu → Configure profile → [General settings](https://osmand.net/docs/user/personal/profiles.md#appearance)→ Display position_

Here you can choose three variants of your location on the screen map:

- _Center_: use center screen position for the cursor (["My location"](https://osmand.net/docs/user/map/interact-with-map.md#my-location--zoom)),
- _Bottom_: use bottom screen position for the cursor (["My location"](https://osmand.net/docs/user/map/interact-with-map.md#my-location--zoom)),
...
Added _Slope/Speed_ mode for [Analyze track on the map](https://osmand.net/docs/user/map/tracks-on-map.md#analyze-track-on-map).
...
Added ["Nautical miles/feet"](https://osmand.net/docs/user/personal/profiles.md#units--formats) for Units & formats.
...
Added new profile - Moped. It uses a "moped" routing profile, has a bicycle as a parent, and is disabled by default.
...
We redesigned ["Simulate your position"](https://osmand.net/docs/user/plugins/development.md#plugin-settings) by adding a new screen with settings.
