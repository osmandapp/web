...
<table class="blogimage">
  <tr>
    <th><img src={require('./customtravel_1.png').default} alt="Image"/></th>
    <th><img src={require('./customtravel_2.png').default} alt="Image"/></th>
        </tr>
</table> 
...
- Start your console and open the MapCreator folder. Example: cd /home/user/OsmAndMapCreator-main/
- Run <b>./utilites.sh travel-guide-creator</b>
- When asked to provide the path, please paste the path to the folder where you have your files prepared. Example: cd /home/user/MyCustomGuides/
