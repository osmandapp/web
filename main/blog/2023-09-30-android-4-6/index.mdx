...
- Update for [Android Auto](#android-auto-updates).
- [More](#more) updates for the release.
>>>>>>> b57f0ec839bd855cc7baed6d1e48326a87d5b42f
...
**3.** You have the ability to add more than one [Simple widget](https://docs.osmand.net/docs/user/widgets/configure-screen#rows-for-panels) in a single row.
...
<<<<<<< HEAD
Simple _[Glide Ration](https://en.wikipedia.org/wiki/Lift-to-drag_ratio#Glide_ratio)_ widgets have been added for Aircraft usage. The widgets show the ratio of glide to target or average glide for the current flight.  
=======
Simple _[Glide Ratio](https://en.wikipedia.org/wiki/Lift-to-drag_ratio#Glide_ratio)_ widgets were added for Aircraft usage. Widgets show the glide ratio to the target or avearge glide for the current trip:
...
<<<<<<< HEAD
- _Glide ratio to target_ shows the glide ration required to reach the target point. The [Map marker](https://osmand.net/docs/user/personal/markers) should be used as the target point.  
...
=======
- _Glide ratio to target_ shows the glide ratio needed to reach the target point (You need to use [Map marker](https://osmand.net/docs/user/personal/markers) as a target point).
...
[Trash](https://docs.osmand.net/docs/user/personal/osmand-cloud#trash) feature has been added for OsmAnd Cloud:  
...
- The [OpenPlaceReviews](https://osmand.net/docs/user/plugins/openplacereviews) project has been permanently finalized and is only available now up to Android 4.5. 
