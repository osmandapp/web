...
- New ["Marine" nautical map style](#new-nautical-map-style) with extensive customization options;
...
- Improved [OBDII BLE connectivity](#improved-obdii-connectivity);
- Updates of ["Analyze by Interval" feature](#improvements-for-analyze-by-interval);
- Improved [Plan a Route tool](#improved-plan-a-route-tool);
- Added the ability to set [altitude units](#altitude-units-setting) separately from distance units;
...
OsmAnd now supports base [automatic synchronization of your settings and data to the OsmAnd cloud](https://osmand.net/docs/user/personal/osmand-cloud#auto--backup), ensuring that your data is always backed up and accessible from any device.
...
If your GPX track contains [info about heart rate](https://osmand.net/docs/user/map/tracks/track-context-menu#heart-rate-metrics), you can now monitor your heart rate during activities with the "Analyze by Interval" feature. You can see your average, maximum, and minimum heart rate for each interval and for the entire track.
...
- Now dialogues show about missing maps and private roads before [starting navigation](https://osmand.net/docs/user/navigation/auto-car#navigation-features) like in the mobile app.

![Android Auto](./img/aa1.png) ![Android Auto](./img/aa2.png)

- Added support for [pinch to zoom gesture on the map](https://osmand.net/docs/user/navigation/auto-car#interaction-with-the-map).
...
[The context menu for POIs and Favorites](https://osmand.net/docs/user/map/map-context-menu#nearby-popular-places) now includes a "Popular Places" section, making it easier to find and navigate to frequently visited locations.
...
- [Clickable ski slopes and routes on the map](https://osmand.net/docs/user/map/routes#ski-slopes-and-routes) have been added, allowing users to easily access information about ski areas.
...
Added [distance information for the selected point on the track graph](https://osmand.net/docs/user/map/tracks/track-context-menu?current-os=android#altitude--speed-graphs) as an additional parameter in the tooltip.
