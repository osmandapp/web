...
### Wikipedia updates
 ...
 - The [Plugin Wikipedia](https://osmand.net/docs/user/plugins/wikipedia) settings is profile dependent:
...
Added the search bar for [Favorites menu](https://osmand.net/docs/user/personal/favorites): _Menu → My Places → Favorites → Pull down_
...
- added search history and the recent route in [the menu](https://osmand.net/docs/user/navigation/car-play):
...
Added ability to [select routes on the map](https://osmand.net/docs/user/map/vector-maps#routes) for viewing additional information or starting navigation by the chosen route. Just tap on hiking routes on the map to open the Track Context menu:
...
Available to start [navigation by a track](https://osmand.net/docs/user/navigation/gpx-navigation) ÷or download it.
...
Track Context menu → Actions → [Upload to OpenStreetMap](https://osmand.net/docs/user/map/track-context-menu#options)
...
Added options to [disable history](https://osmand.net/docs/user/personal/global-settings#history-1) logging:
...
Added [manually rotated mode](https://osmand.net/docs/user/map/interact-with-map#map-orientation-modes):
...
Improved visibility of [the map ruler](https://osmand.net/docs/user/widgets/radius-ruler#ruler):
...
Added [_Coordinates: map center_](https://osmand.net/docs/user/widgets/info-widgets#coordinates-widget) widget, [_Developer widgets_](https://osmand.net/docs/user/widgets/info-widgets#-developer-widgets), and [_Sunset and sunrise_](https://osmand.net/docs/user/widgets/info-widgets#sunset-and-sunrise-widgets) widgets:
...
For this release, we added the opportunity for using external input devices. Read more [here](https://osmand.net/docs/user/map/interact-with-map#external-input-device-buttons).
...
Added legal warning about using [speed camera alerts](https://osmand.net/docs/user/navigation/map-during-navigation).

#### Voice prompts

Added [support for new languages](https://osmand.net/docs/user/navigation/guidance/voice-navigation): Catalan, Ukrainian, Bulgarian, Indonesian, Slovenian.
...
Added the ["Moped"](https://osmand.net/docs/user/navigation/routing/moped-routing) profile.
