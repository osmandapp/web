...
- The Route detail menu has been updated with the [road side indicator](#roadside-indicator) information.
...
Added Road side indicator for [Route Details](https://osmand.net/docs/user/navigation/setup/route-details#roadside-indicator).  
...
- Fixed:
  - Missing or misplaced [POI data](https://github.com/osmandapp/OsmAnd/issues/2993#issuecomment-2397118471) in search and context menu.
