...
import { getSpeedStats, getAltitudeStats, getOtherStats } from './TrackSegmentStat';
import { useTranslation } from 'react-i18next';
import DividerWithMargin from '../components/dividers/DividerWithMargin';

const SegmentParamsFilter = forwardRef(({ activeSegmentParams, setActiveSegmentParams }, ref) => {
