...
const LiveTrackItemActions = forwardRef(
    (
        ...
        const ownerSharingLabel = isSharing ? 'web:live_track_pause_sharing' : 'web:live_track_start_sharing';
        const ownerSharingIcon = isSharing ? <LocationOffIcon /> : <LocationOnIcon />;
