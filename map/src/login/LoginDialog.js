                    ...
                    <DialogContentText>
                        ...
                        <span>
                            ...
                            cloud storage used: {(ctx.listFiles.totalZipSize / 1024 / 1024.0).toFixed(1)} MB.
                                <br /><br />
                                <a href={`${process.env.REACT_APP_USER_API_SITE}/mapapi/download-backup`} target="_blank" download>Download backup ~{(ctx.listFiles.totalZipSize / 1024 / 1024.0).toFixed(1)} MB</a>
                        </span>
                        }
