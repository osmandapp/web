...
(function (factory, window) {
    ...
    L.Editable = L.Evented.extend({
        ...
        onMouseup: function (e) {
            if (this._mouseDown) {
                ...
                if (Math.abs(distance) < 9 * (window.devicePixelRatio || 1)) this._drawingEditor.onDrawingClick(e, distance);
            }
        },
    ...
    L.Editable.BaseEditor = L.Handler.extend({
        ...
        onDrawingClick: function (e, distance) {
            ...
            this.processDrawingClick(e, distance);
        },
