...
export default function AddRoutingToTrackDialog({setOpenAddRoutingToTrackDialog, setAddRoutingToTrack}) {
    ...
    return <Dialog classes={{paper: classes.paper}} open={true}>
        <DialogTitle>Add segment with routing</DialogTitle>
        <DialogContent>
            <Typography variant="body2">
                Are you sure you want to add a segment with routing?
                Previous track points will be added to one segment. And you can't edit its geometry.
            </Typography>
        </DialogContent>
        <DialogActions>
