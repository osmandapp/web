...
export default function AddNewGroupDialog({dialogOpen, setDialogOpen, setFavoriteGroup}) {
    ...
    return (
        <Dialog open={dialogOpen}>
            ...
            <DialogContent>
                <FavoriteName favoriteName={groupName}
                ...
                >
                    <ListItemText disableTypography
                                  primary={<Typography variant="body1" style={{fontWeight: 'bold'}}> Default
                ...
                <FavoriteShape color={groupColor}
